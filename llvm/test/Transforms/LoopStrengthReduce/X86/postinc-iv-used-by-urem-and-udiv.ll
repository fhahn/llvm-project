...
; CHECK-NEXT:    [[TMP1:%.*]] = mul i64 [[LSR_IV_NEXT2]], -1
; CHECK-NEXT:    [[DEC_1:%.*]] = trunc i64 [[TMP1]] to i32
...
; CHECK:       loop.3:
; CHECK-NEXT:    [[LSR_IV3:%.*]] = phi i64 [ 0, [[LOOP_3_PREHEADER]] ], [ [[LSR_IV_NEXT4:%.*]], [[LOOP_3]] ]
...
; CHECK-NEXT:    [[TMP1]] = sub i64 [[TMP0]], [[LSR_IV_NEXT4]]
...
; CHECK-NEXT:    [[TMP3:%.*]] = sub i64 [[TMP2]], [[LSR_IV_NEXT4]]
; CHECK-NEXT:    call void @use(i64 [[TMP3]])
; CHECK-NEXT:    call void @use(i64 [[LSR_IV_NEXT2]])
; CHECK-NEXT:    [[I22:%.*]] = urem i32 [[IV_5_NEXT]], 53
; CHECK-NEXT:    [[I23:%.*]] = trunc i32 [[I22]] to i8
; CHECK-NEXT:    call void @use.i8(i8 [[I23]])
