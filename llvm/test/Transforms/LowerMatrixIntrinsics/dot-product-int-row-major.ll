...
; CHECK-NEXT:    [[SPLIT16:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 1>
; CHECK-NEXT:    [[SPLIT17:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 2>
; CHECK-NEXT:    [[SPLIT18:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 3>
; CHECK-NEXT:    [[SPLIT19:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 4>
; CHECK-NEXT:    [[SPLIT20:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 5>
; CHECK-NEXT:    [[SPLIT21:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 6>
; CHECK-NEXT:    [[SPLIT22:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 7>
; CHECK-NEXT:    [[SPLIT23:%.*]] = shufflevector <8 x i32> [[B1:%.*]], <8 x i32> poison, <1 x i32> zeroinitializer
; CHECK-NEXT:    [[SPLIT24:%.*]] = shufflevector <8 x i32> [[B1]], <8 x i32> poison, <1 x i32> <i32 1>
; CHECK-NEXT:    [[SPLIT10:%.*]] = shufflevector <8 x i32> [[B1]], <8 x i32> poison, <1 x i32> <i32 2>
; CHECK-NEXT:    [[SPLIT11:%.*]] = shufflevector <8 x i32> [[B1]], <8 x i32> poison, <1 x i32> <i32 3>
; CHECK-NEXT:    [[SPLIT12:%.*]] = shufflevector <8 x i32> [[B1]], <8 x i32> poison, <1 x i32> <i32 4>
; CHECK-NEXT:    [[SPLIT13:%.*]] = shufflevector <8 x i32> [[B1]], <8 x i32> poison, <1 x i32> <i32 5>
; CHECK-NEXT:    [[SPLIT14:%.*]] = shufflevector <8 x i32> [[B1]], <8 x i32> poison, <1 x i32> <i32 6>
; CHECK-NEXT:    [[SPLIT15:%.*]] = shufflevector <8 x i32> [[B1]], <8 x i32> poison, <1 x i32> <i32 7>
; CHECK-NEXT:    [[TMP0:%.*]] = add <1 x i32> [[SPLIT]], [[SPLIT23]]
; CHECK-NEXT:    [[TMP26:%.*]] = add <1 x i32> [[SPLIT16]], [[SPLIT24]]
; CHECK-NEXT:    [[TMP27:%.*]] = add <1 x i32> [[SPLIT17]], [[SPLIT10]]
; CHECK-NEXT:    [[TMP28:%.*]] = add <1 x i32> [[SPLIT18]], [[SPLIT11]]
; CHECK-NEXT:    [[TMP29:%.*]] = add <1 x i32> [[SPLIT19]], [[SPLIT12]]
; CHECK-NEXT:    [[TMP30:%.*]] = add <1 x i32> [[SPLIT20]], [[SPLIT13]]
; CHECK-NEXT:    [[TMP31:%.*]] = add <1 x i32> [[SPLIT21]], [[SPLIT14]]
; CHECK-NEXT:    [[TMP32:%.*]] = add <1 x i32> [[SPLIT22]], [[SPLIT15]]
; CHECK-NEXT:    [[TMP33:%.*]] = shufflevector <1 x i32> [[TMP0]], <1 x i32> [[TMP26]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP34:%.*]] = shufflevector <1 x i32> [[TMP27]], <1 x i32> [[TMP28]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP35:%.*]] = shufflevector <1 x i32> [[TMP29]], <1 x i32> [[TMP30]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP36:%.*]] = shufflevector <1 x i32> [[TMP31]], <1 x i32> [[TMP32]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP37:%.*]] = shufflevector <2 x i32> [[TMP33]], <2 x i32> [[TMP34]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP38:%.*]] = shufflevector <2 x i32> [[TMP35]], <2 x i32> [[TMP36]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[B:%.*]] = shufflevector <4 x i32> [[TMP37]], <4 x i32> [[TMP38]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <8 x i32> [[SPLIT1]], i64 0
...
; CHECK-NEXT:    [[TMP3:%.*]] = extractelement <8 x i32> [[SPLIT1]], i64 1
...
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <8 x i32> [[SPLIT1]], i64 2
...
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <8 x i32> [[SPLIT1]], i64 3
...
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <8 x i32> [[SPLIT1]], i64 4
...
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <8 x i32> [[SPLIT1]], i64 5
...
; CHECK-NEXT:    [[TMP18:%.*]] = extractelement <8 x i32> [[SPLIT1]], i64 6
...
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <8 x i32> [[SPLIT1]], i64 7
...
; CHECK-NEXT:    [[SPLIT14:%.*]] = shufflevector <8 x i32> [[B1]], <8 x i32> poison, <1 x i32> <i32 6>
; CHECK-NEXT:    [[SPLIT15:%.*]] = shufflevector <8 x i32> [[B1]], <8 x i32> poison, <1 x i32> <i32 7>
; CHECK-NEXT:    [[TMP0:%.*]] = sub <1 x i32> [[SPLIT]], [[SPLIT23]]
; CHECK-NEXT:    [[TMP26:%.*]] = sub <1 x i32> [[SPLIT16]], [[SPLIT24]]
; CHECK-NEXT:    [[TMP27:%.*]] = sub <1 x i32> [[SPLIT17]], [[SPLIT10]]
; CHECK-NEXT:    [[TMP28:%.*]] = sub <1 x i32> [[SPLIT18]], [[SPLIT11]]
; CHECK-NEXT:    [[TMP29:%.*]] = sub <1 x i32> [[SPLIT19]], [[SPLIT12]]
; CHECK-NEXT:    [[TMP30:%.*]] = sub <1 x i32> [[SPLIT20]], [[SPLIT13]]
; CHECK-NEXT:    [[TMP31:%.*]] = sub <1 x i32> [[SPLIT21]], [[SPLIT14]]
; CHECK-NEXT:    [[TMP32:%.*]] = sub <1 x i32> [[SPLIT22]], [[SPLIT15]]
; CHECK-NEXT:    [[TMP33:%.*]] = shufflevector <1 x i32> [[TMP0]], <1 x i32> [[TMP26]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP34:%.*]] = shufflevector <1 x i32> [[TMP27]], <1 x i32> [[TMP28]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP35:%.*]] = shufflevector <1 x i32> [[TMP29]], <1 x i32> [[TMP30]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP36:%.*]] = shufflevector <1 x i32> [[TMP31]], <1 x i32> [[TMP32]], <2 x i32> <i32 0, i32 1>
...
; CHECK-NEXT:    [[SPLIT:%.*]] = shufflevector <8 x i32> [[A:%.*]], <8 x i32> poison, <1 x i32> zeroinitializer
; CHECK-NEXT:    [[SPLIT1:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 1>
; CHECK-NEXT:    [[SPLIT24:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 2>
; CHECK-NEXT:    [[SPLIT25:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 3>
; CHECK-NEXT:    [[SPLIT26:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 4>
; CHECK-NEXT:    [[SPLIT27:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 5>
; CHECK-NEXT:    [[SPLIT28:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 6>
; CHECK-NEXT:    [[SPLIT29:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <1 x i32> <i32 7>
; CHECK-NEXT:    [[SPLIT30:%.*]] = shufflevector <8 x i32> [[B:%.*]], <8 x i32> poison, <1 x i32> zeroinitializer
; CHECK-NEXT:    [[SPLIT31:%.*]] = shufflevector <8 x i32> [[B]], <8 x i32> poison, <1 x i32> <i32 1>
; CHECK-NEXT:    [[SPLIT32:%.*]] = shufflevector <8 x i32> [[B]], <8 x i32> poison, <1 x i32> <i32 2>
; CHECK-NEXT:    [[SPLIT11:%.*]] = shufflevector <8 x i32> [[B]], <8 x i32> poison, <1 x i32> <i32 3>
; CHECK-NEXT:    [[SPLIT12:%.*]] = shufflevector <8 x i32> [[B]], <8 x i32> poison, <1 x i32> <i32 4>
; CHECK-NEXT:    [[SPLIT13:%.*]] = shufflevector <8 x i32> [[B]], <8 x i32> poison, <1 x i32> <i32 5>
; CHECK-NEXT:    [[SPLIT14:%.*]] = shufflevector <8 x i32> [[B]], <8 x i32> poison, <1 x i32> <i32 6>
; CHECK-NEXT:    [[SPLIT15:%.*]] = shufflevector <8 x i32> [[B]], <8 x i32> poison, <1 x i32> <i32 7>
; CHECK-NEXT:    [[TMP0:%.*]] = add <1 x i32> [[SPLIT]], [[SPLIT30]]
; CHECK-NEXT:    [[TMP1:%.*]] = add <1 x i32> [[SPLIT1]], [[SPLIT31]]
; CHECK-NEXT:    [[TMP27:%.*]] = add <1 x i32> [[SPLIT24]], [[SPLIT32]]
; CHECK-NEXT:    [[TMP28:%.*]] = add <1 x i32> [[SPLIT25]], [[SPLIT11]]
; CHECK-NEXT:    [[TMP29:%.*]] = add <1 x i32> [[SPLIT26]], [[SPLIT12]]
; CHECK-NEXT:    [[TMP30:%.*]] = add <1 x i32> [[SPLIT27]], [[SPLIT13]]
; CHECK-NEXT:    [[TMP31:%.*]] = add <1 x i32> [[SPLIT28]], [[SPLIT14]]
; CHECK-NEXT:    [[TMP32:%.*]] = add <1 x i32> [[SPLIT29]], [[SPLIT15]]
; CHECK-NEXT:    [[SPLIT16:%.*]] = shufflevector <8 x i32> [[C1:%.*]], <8 x i32> poison, <1 x i32> zeroinitializer
; CHECK-NEXT:    [[SPLIT17:%.*]] = shufflevector <8 x i32> [[C1]], <8 x i32> poison, <1 x i32> <i32 1>
; CHECK-NEXT:    [[SPLIT18:%.*]] = shufflevector <8 x i32> [[C1]], <8 x i32> poison, <1 x i32> <i32 2>
; CHECK-NEXT:    [[SPLIT19:%.*]] = shufflevector <8 x i32> [[C1]], <8 x i32> poison, <1 x i32> <i32 3>
; CHECK-NEXT:    [[SPLIT20:%.*]] = shufflevector <8 x i32> [[C1]], <8 x i32> poison, <1 x i32> <i32 4>
; CHECK-NEXT:    [[SPLIT21:%.*]] = shufflevector <8 x i32> [[C1]], <8 x i32> poison, <1 x i32> <i32 5>
; CHECK-NEXT:    [[SPLIT22:%.*]] = shufflevector <8 x i32> [[C1]], <8 x i32> poison, <1 x i32> <i32 6>
; CHECK-NEXT:    [[SPLIT23:%.*]] = shufflevector <8 x i32> [[C1]], <8 x i32> poison, <1 x i32> <i32 7>
; CHECK-NEXT:    [[TMP33:%.*]] = add <1 x i32> [[TMP0]], [[SPLIT16]]
; CHECK-NEXT:    [[TMP34:%.*]] = add <1 x i32> [[TMP1]], [[SPLIT17]]
; CHECK-NEXT:    [[TMP35:%.*]] = add <1 x i32> [[TMP27]], [[SPLIT18]]
; CHECK-NEXT:    [[TMP36:%.*]] = add <1 x i32> [[TMP28]], [[SPLIT19]]
; CHECK-NEXT:    [[TMP37:%.*]] = add <1 x i32> [[TMP29]], [[SPLIT20]]
; CHECK-NEXT:    [[TMP38:%.*]] = add <1 x i32> [[TMP30]], [[SPLIT21]]
; CHECK-NEXT:    [[TMP39:%.*]] = add <1 x i32> [[TMP31]], [[SPLIT22]]
; CHECK-NEXT:    [[TMP40:%.*]] = add <1 x i32> [[TMP32]], [[SPLIT23]]
; CHECK-NEXT:    [[TMP41:%.*]] = shufflevector <1 x i32> [[TMP33]], <1 x i32> [[TMP34]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP42:%.*]] = shufflevector <1 x i32> [[TMP35]], <1 x i32> [[TMP36]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP43:%.*]] = shufflevector <1 x i32> [[TMP37]], <1 x i32> [[TMP38]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP44:%.*]] = shufflevector <1 x i32> [[TMP39]], <1 x i32> [[TMP40]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP45:%.*]] = shufflevector <2 x i32> [[TMP41]], <2 x i32> [[TMP42]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP46:%.*]] = shufflevector <2 x i32> [[TMP43]], <2 x i32> [[TMP44]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[C:%.*]] = shufflevector <4 x i32> [[TMP45]], <4 x i32> [[TMP46]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <8 x i32> [[SPLIT2]], i64 0
...
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <8 x i32> [[SPLIT2]], i64 1
...
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <8 x i32> [[SPLIT2]], i64 2
...
; CHECK-NEXT:    [[COL_LOAD11:%.*]] = load <1 x i16>, ptr [[RHS_ADDRESS1:%.*]], align 16
; CHECK-NEXT:    [[VEC_GEP11:%.*]] = getelementptr i16, ptr [[RHS_ADDRESS1]], i64 1
; CHECK-NEXT:    [[COL_LOAD12:%.*]] = load <1 x i16>, ptr [[VEC_GEP11]], align 2
; CHECK-NEXT:    [[VEC_GEP13:%.*]] = getelementptr i16, ptr [[RHS_ADDRESS1]], i64 2
; CHECK-NEXT:    [[COL_LOAD14:%.*]] = load <1 x i16>, ptr [[VEC_GEP13]], align 4
; CHECK-NEXT:    [[VEC_GEP15:%.*]] = getelementptr i16, ptr [[RHS_ADDRESS1]], i64 3
; CHECK-NEXT:    [[COL_LOAD16:%.*]] = load <1 x i16>, ptr [[VEC_GEP15]], align 2
; CHECK-NEXT:    [[VEC_GEP17:%.*]] = getelementptr i16, ptr [[RHS_ADDRESS1]], i64 4
; CHECK-NEXT:    [[COL_LOAD18:%.*]] = load <1 x i16>, ptr [[VEC_GEP17]], align 8
; CHECK-NEXT:    [[VEC_GEP19:%.*]] = getelementptr i16, ptr [[RHS_ADDRESS1]], i64 5
; CHECK-NEXT:    [[COL_LOAD20:%.*]] = load <1 x i16>, ptr [[VEC_GEP19]], align 2
; CHECK-NEXT:    [[TMP19:%.*]] = shufflevector <1 x i16> [[COL_LOAD1]], <1 x i16> [[COL_LOAD2]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP20:%.*]] = shufflevector <1 x i16> [[COL_LOAD4]], <1 x i16> [[COL_LOAD6]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP21:%.*]] = shufflevector <1 x i16> [[COL_LOAD8]], <1 x i16> [[COL_LOAD10]], <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP22:%.*]] = shufflevector <2 x i16> [[TMP19]], <2 x i16> [[TMP20]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP23:%.*]] = shufflevector <2 x i16> [[TMP21]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP24:%.*]] = shufflevector <4 x i16> [[TMP22]], <4 x i16> [[TMP23]], <6 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5>
; CHECK-NEXT:    [[COL_LOAD:%.*]] = shufflevector <6 x i16> [[TMP24]], <6 x i16> poison, <6 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5>
; CHECK-NEXT:    [[BLOCK:%.*]] = shufflevector <1 x i16> [[COL_LOAD11]], <1 x i16> poison, <1 x i32> zeroinitializer
...
; CHECK-NEXT:    [[BLOCK11:%.*]] = shufflevector <1 x i16> [[COL_LOAD12]], <1 x i16> poison, <1 x i32> zeroinitializer
...
; CHECK-NEXT:    [[BLOCK14:%.*]] = shufflevector <1 x i16> [[COL_LOAD14]], <1 x i16> poison, <1 x i32> zeroinitializer
...
; CHECK-NEXT:    [[BLOCK17:%.*]] = shufflevector <1 x i16> [[COL_LOAD16]], <1 x i16> poison, <1 x i32> zeroinitializer
...
; CHECK-NEXT:    [[BLOCK20:%.*]] = shufflevector <1 x i16> [[COL_LOAD18]], <1 x i16> poison, <1 x i32> zeroinitializer
...
; CHECK-NEXT:    [[BLOCK23:%.*]] = shufflevector <1 x i16> [[COL_LOAD20]], <1 x i16> poison, <1 x i32> zeroinitializer
