...
; Variant of @relational_exit_cond but with uadd.with.overflow.
...
define void @uadd_with_overflow_ov_unused_must_not_fold(i8 %n) {
; CHECK-LABEL: define void @uadd_with_overflow_ov_unused_must_not_fold(
; CHECK-SAME: i8 [[N:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[LOOP_HEADER:.*]]
; CHECK:       [[LOOP_HEADER]]:
