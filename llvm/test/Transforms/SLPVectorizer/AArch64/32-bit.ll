...
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -S < %s | FileCheck --check-prefix=VPLAN %s
...
;
; VPLAN-LABEL: define ptr @foo(
; VPLAN-SAME: ptr [[THIS:%.*]], ptr [[RHS:%.*]]) {
; VPLAN-NEXT:  [[ENTRY:.*:]]
; VPLAN-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x i8>, ptr [[RHS]], align 1, !tbaa [[BOOL_TBAA0:![0-9]+]]
; VPLAN-NEXT:    [[WIDE_LOAD1:%.*]] = load <4 x i8>, ptr [[THIS]], align 1, !tbaa [[BOOL_TBAA0]]
; VPLAN-NEXT:    [[TMP0:%.*]] = or <4 x i8> [[WIDE_LOAD]], [[WIDE_LOAD1]]
; VPLAN-NEXT:    store <4 x i8> [[TMP0]], ptr [[THIS]], align 1, !tbaa [[BOOL_TBAA0]]
; VPLAN-NEXT:    ret ptr [[THIS]]
;
entry:
...
;.
; VPLAN: [[BOOL_TBAA0]] = !{[[META1:![0-9]+]], [[META2:![0-9]+]], i64 0}
; VPLAN: [[META1]] = !{!"S", [[META2]], i64 0, [[META2]], i64 1, [[META2]], i64 2, [[META2]], i64 3}
; VPLAN: [[META2]] = !{!"bool", [[META3:![0-9]+]], i64 0}
; VPLAN: [[META3]] = !{!"omnipotent char", [[META4:![0-9]+]], i64 0}
; VPLAN: [[META4]] = !{!"Simple C++ TBAA"}
;.
