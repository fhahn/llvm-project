...
; VPLAN-LABEL: @foo(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr i8, ptr [[B:%.*]], i64 12
; VPLAN-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX_3]], align 4
; VPLAN-NEXT:    [[ADD_3:%.*]] = udiv i32 [[TMP0]], 2
; VPLAN-NEXT:    [[ARRAYIDX2_2:%.*]] = getelementptr i8, ptr [[A:%.*]], i64 8
; VPLAN-NEXT:    [[ARRAYIDX2_3:%.*]] = getelementptr i8, ptr [[A]], i64 12
; VPLAN-NEXT:    [[TMP1:%.*]] = load <2 x i32>, ptr [[B]], align 4
; VPLAN-NEXT:    [[TMP2:%.*]] = udiv <2 x i32> [[TMP1]], <i32 3, i32 8>
; VPLAN-NEXT:    [[TMP3:%.*]] = extractelement <2 x i32> [[TMP2]], i32 0
; VPLAN-NEXT:    store <2 x i32> [[TMP2]], ptr [[A]], align 4
; VPLAN-NEXT:    store i32 [[TMP3]], ptr [[ARRAYIDX2_2]], align 4
; VPLAN-NEXT:    store i32 [[ADD_3]], ptr [[ARRAYIDX2_3]], align 4
; VPLAN-NEXT:    ret void
;
entry:
