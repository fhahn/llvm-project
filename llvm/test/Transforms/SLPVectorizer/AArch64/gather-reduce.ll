...
; RUN: opt -S -passes=slp-vectorizer -slp-use-vplan-codegen < %s | FileCheck %s --check-prefix=GENERIC
; RUN: opt -S -mcpu=kryo -passes=slp-vectorizer -slp-use-vplan-codegen < %s | FileCheck %s --check-prefix=KRYO
