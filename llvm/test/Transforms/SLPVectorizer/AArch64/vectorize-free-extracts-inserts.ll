...
; RUN: opt -passes=slp-vectorizer -S %s | FileCheck --check-prefixes=CHECK,LEGACY %s
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -S %s | FileCheck --check-prefixes=CHECK,VPLAN %s
...
; LEGACY-LABEL: @noop_extracts_first_2_lanes(
; LEGACY-NEXT:  bb:
; LEGACY-NEXT:    [[V_1:%.*]] = load <2 x double>, ptr [[PTR_1:%.*]], align 8
; LEGACY-NEXT:    [[V1_LANE_0:%.*]] = extractelement <2 x double> [[V_1]], i32 0
; LEGACY-NEXT:    [[V1_LANE_1:%.*]] = extractelement <2 x double> [[V_1]], i32 1
; LEGACY-NEXT:    [[V_2:%.*]] = load <4 x double>, ptr [[PTR_2:%.*]], align 16
; LEGACY-NEXT:    [[TMP0:%.*]] = shufflevector <4 x double> [[V_2]], <4 x double> poison, <2 x i32> <i32 2, i32 3>
; LEGACY-NEXT:    [[TMP1:%.*]] = fmul <2 x double> [[V_1]], [[TMP0]]
; LEGACY-NEXT:    call void @use(double [[V1_LANE_0]])
; LEGACY-NEXT:    call void @use(double [[V1_LANE_1]])
; LEGACY-NEXT:    store <2 x double> [[TMP1]], ptr [[PTR_1]], align 8
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @noop_extracts_first_2_lanes(
; VPLAN-NEXT:  bb:
; VPLAN-NEXT:    [[V_1:%.*]] = load <2 x double>, ptr [[PTR_1:%.*]], align 8
; VPLAN-NEXT:    [[TMP2:%.*]] = extractelement <2 x double> [[V_1]], i32 0
; VPLAN-NEXT:    [[V_2:%.*]] = load <4 x double>, ptr [[PTR_2:%.*]], align 16
; VPLAN-NEXT:    [[TMP0:%.*]] = shufflevector <4 x double> [[V_2]], <4 x double> poison, <2 x i32> <i32 2, i32 3>
; VPLAN-NEXT:    [[TMP1:%.*]] = fmul <2 x double> [[V_1]], [[TMP0]]
; VPLAN-NEXT:    call void @use(double [[TMP2]])
; VPLAN-NEXT:    [[TMP3:%.*]] = extractelement <2 x double> [[V_1]], i32 1
; VPLAN-NEXT:    call void @use(double [[TMP3]])
; VPLAN-NEXT:    store <2 x double> [[TMP1]], ptr [[PTR_1]], align 8
; VPLAN-NEXT:    ret void
;
bb:
...
; LEGACY-LABEL: @extracts_first_2_lanes_different_vectors(
; LEGACY-NEXT:  bb:
; LEGACY-NEXT:    [[V_1:%.*]] = load <2 x double>, ptr [[PTR_1:%.*]], align 8
; LEGACY-NEXT:    [[V1_LANE_0:%.*]] = extractelement <2 x double> [[V_1]], i32 0
; LEGACY-NEXT:    [[V_3:%.*]] = load <2 x double>, ptr [[PTR_3:%.*]], align 8
; LEGACY-NEXT:    [[V3_LANE_1:%.*]] = extractelement <2 x double> [[V_3]], i32 1
; LEGACY-NEXT:    [[V_2:%.*]] = load <4 x double>, ptr [[PTR_2:%.*]], align 16
; LEGACY-NEXT:    [[TMP0:%.*]] = shufflevector <2 x double> [[V_1]], <2 x double> [[V_3]], <2 x i32> <i32 0, i32 3>
; LEGACY-NEXT:    [[TMP1:%.*]] = shufflevector <4 x double> [[V_2]], <4 x double> poison, <2 x i32> <i32 2, i32 2>
; LEGACY-NEXT:    [[TMP2:%.*]] = fmul <2 x double> [[TMP0]], [[TMP1]]
; LEGACY-NEXT:    call void @use(double [[V1_LANE_0]])
; LEGACY-NEXT:    call void @use(double [[V3_LANE_1]])
; LEGACY-NEXT:    store <2 x double> [[TMP2]], ptr [[PTR_1]], align 8
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @extracts_first_2_lanes_different_vectors(
; VPLAN-NEXT:  bb:
; VPLAN-NEXT:    [[V_1:%.*]] = load <2 x double>, ptr [[PTR_1:%.*]], align 8
; VPLAN-NEXT:    [[V1_LANE_0:%.*]] = extractelement <2 x double> [[V_1]], i32 0
; VPLAN-NEXT:    [[V_3:%.*]] = load <2 x double>, ptr [[PTR_3:%.*]], align 8
; VPLAN-NEXT:    [[V3_LANE_1:%.*]] = extractelement <2 x double> [[V_3]], i32 1
; VPLAN-NEXT:    [[V_2:%.*]] = load <4 x double>, ptr [[PTR_2:%.*]], align 16
; VPLAN-NEXT:    [[V2_LANE_2:%.*]] = extractelement <4 x double> [[V_2]], i32 2
; VPLAN-NEXT:    [[TMP0:%.*]] = shufflevector <2 x double> [[V_1]], <2 x double> [[V_3]], <2 x i32> <i32 0, i32 3>
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x double> poison, double [[V2_LANE_2]], i32 0
; VPLAN-NEXT:    [[TMP2:%.*]] = shufflevector <2 x double> [[TMP1]], <2 x double> poison, <2 x i32> zeroinitializer
; VPLAN-NEXT:    [[TMP3:%.*]] = fmul <2 x double> [[TMP0]], [[TMP2]]
; VPLAN-NEXT:    call void @use(double [[V1_LANE_0]])
; VPLAN-NEXT:    call void @use(double [[V3_LANE_1]])
; VPLAN-NEXT:    store <2 x double> [[TMP3]], ptr [[PTR_1]], align 8
; VPLAN-NEXT:    ret void
;
bb:
  %v.1 = load <2 x double>, ptr %ptr.1, align 8
...
; LEGACY-LABEL: @noop_extract_second_2_lanes(
; LEGACY-NEXT:  bb:
; LEGACY-NEXT:    [[V_1:%.*]] = load <4 x double>, ptr [[PTR_1:%.*]], align 8
; LEGACY-NEXT:    [[V1_LANE_2:%.*]] = extractelement <4 x double> [[V_1]], i32 2
; LEGACY-NEXT:    [[V1_LANE_3:%.*]] = extractelement <4 x double> [[V_1]], i32 3
; LEGACY-NEXT:    [[V_2:%.*]] = load <4 x double>, ptr [[PTR_2:%.*]], align 16
; LEGACY-NEXT:    [[TMP0:%.*]] = shufflevector <4 x double> [[V_1]], <4 x double> poison, <2 x i32> <i32 2, i32 3>
; LEGACY-NEXT:    [[TMP1:%.*]] = shufflevector <4 x double> [[V_2]], <4 x double> poison, <2 x i32> <i32 2, i32 2>
; LEGACY-NEXT:    [[TMP2:%.*]] = fmul <2 x double> [[TMP0]], [[TMP1]]
; LEGACY-NEXT:    [[TMP3:%.*]] = shufflevector <2 x double> [[TMP2]], <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; LEGACY-NEXT:    [[A_INS_11:%.*]] = shufflevector <4 x double> zeroinitializer, <4 x double> [[TMP3]], <4 x i32> <i32 4, i32 5, i32 2, i32 3>
; LEGACY-NEXT:    call void @use(double [[V1_LANE_2]])
; LEGACY-NEXT:    call void @use(double [[V1_LANE_3]])
; LEGACY-NEXT:    store <4 x double> [[A_INS_11]], ptr [[PTR_1]], align 8
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @noop_extract_second_2_lanes(
; VPLAN-NEXT:  bb:
; VPLAN-NEXT:    [[V_1:%.*]] = load <4 x double>, ptr [[PTR_1:%.*]], align 8
; VPLAN-NEXT:    [[V1_LANE_2:%.*]] = extractelement <4 x double> [[V_1]], i32 2
; VPLAN-NEXT:    [[V1_LANE_3:%.*]] = extractelement <4 x double> [[V_1]], i32 3
; VPLAN-NEXT:    [[V_2:%.*]] = load <4 x double>, ptr [[PTR_2:%.*]], align 16
; VPLAN-NEXT:    [[V2_LANE_2:%.*]] = extractelement <4 x double> [[V_2]], i32 2
; VPLAN-NEXT:    [[TMP0:%.*]] = shufflevector <4 x double> [[V_1]], <4 x double> poison, <2 x i32> <i32 2, i32 3>
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x double> poison, double [[V2_LANE_2]], i32 0
; VPLAN-NEXT:    [[TMP2:%.*]] = shufflevector <2 x double> [[TMP1]], <2 x double> poison, <2 x i32> zeroinitializer
; VPLAN-NEXT:    [[TMP3:%.*]] = fmul <2 x double> [[TMP0]], [[TMP2]]
; VPLAN-NEXT:    [[TMP4:%.*]] = shufflevector <2 x double> [[TMP3]], <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; VPLAN-NEXT:    [[TMP5:%.*]] = shufflevector <4 x double> zeroinitializer, <4 x double> [[TMP4]], <4 x i32> <i32 4, i32 5, i32 2, i32 3>
; VPLAN-NEXT:    call void @use(double [[V1_LANE_2]])
; VPLAN-NEXT:    call void @use(double [[V1_LANE_3]])
; VPLAN-NEXT:    store <4 x double> [[TMP5]], ptr [[PTR_1]], align 8
; VPLAN-NEXT:    ret void
;
bb:
...
; LEGACY-LABEL: @extract_lanes_1_and_2(
; LEGACY-NEXT:  bb:
; LEGACY-NEXT:    [[V_1:%.*]] = load <4 x double>, ptr [[PTR_1:%.*]], align 8
; LEGACY-NEXT:    [[V1_LANE_1:%.*]] = extractelement <4 x double> [[V_1]], i32 1
; LEGACY-NEXT:    [[V1_LANE_2:%.*]] = extractelement <4 x double> [[V_1]], i32 2
; LEGACY-NEXT:    [[V_2:%.*]] = load <4 x double>, ptr [[PTR_2:%.*]], align 16
; LEGACY-NEXT:    [[TMP0:%.*]] = shufflevector <4 x double> [[V_1]], <4 x double> poison, <2 x i32> <i32 1, i32 2>
; LEGACY-NEXT:    [[TMP1:%.*]] = shufflevector <4 x double> [[V_2]], <4 x double> poison, <2 x i32> <i32 2, i32 2>
; LEGACY-NEXT:    [[TMP2:%.*]] = fmul <2 x double> [[TMP0]], [[TMP1]]
; LEGACY-NEXT:    [[TMP3:%.*]] = shufflevector <2 x double> [[TMP2]], <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; LEGACY-NEXT:    [[A_INS_11:%.*]] = shufflevector <4 x double> zeroinitializer, <4 x double> [[TMP3]], <4 x i32> <i32 4, i32 5, i32 2, i32 3>
...
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @extract_lanes_1_and_2(
; VPLAN-NEXT:  bb:
; VPLAN-NEXT:    [[V_1:%.*]] = load <4 x double>, ptr [[PTR_1:%.*]], align 8
; VPLAN-NEXT:    [[V1_LANE_1:%.*]] = extractelement <4 x double> [[V_1]], i32 1
; VPLAN-NEXT:    [[V1_LANE_2:%.*]] = extractelement <4 x double> [[V_1]], i32 2
; VPLAN-NEXT:    [[V_2:%.*]] = load <4 x double>, ptr [[PTR_2:%.*]], align 16
; VPLAN-NEXT:    [[V2_LANE_2:%.*]] = extractelement <4 x double> [[V_2]], i32 2
; VPLAN-NEXT:    [[TMP0:%.*]] = shufflevector <4 x double> [[V_1]], <4 x double> poison, <2 x i32> <i32 1, i32 2>
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x double> poison, double [[V2_LANE_2]], i32 0
; VPLAN-NEXT:    [[TMP2:%.*]] = shufflevector <2 x double> [[TMP1]], <2 x double> poison, <2 x i32> zeroinitializer
; VPLAN-NEXT:    [[TMP3:%.*]] = fmul <2 x double> [[TMP0]], [[TMP2]]
; VPLAN-NEXT:    [[TMP4:%.*]] = shufflevector <2 x double> [[TMP3]], <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; VPLAN-NEXT:    [[TMP5:%.*]] = shufflevector <4 x double> zeroinitializer, <4 x double> [[TMP4]], <4 x i32> <i32 4, i32 5, i32 2, i32 3>
; VPLAN-NEXT:    call void @use(double [[V1_LANE_1]])
; VPLAN-NEXT:    call void @use(double [[V1_LANE_2]])
; VPLAN-NEXT:    store <4 x double> [[TMP5]], ptr [[PTR_1]], align 8
; VPLAN-NEXT:    ret void
;
