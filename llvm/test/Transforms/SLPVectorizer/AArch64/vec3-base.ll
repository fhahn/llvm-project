...
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -slp-vectorize-non-power-of-2 -mtriple=arm64-apple-ios -S %s | FileCheck --check-prefixes=VPLAN-VPLAN,VPLAN-VPLAN-NON-POW2 %s
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -slp-vectorize-non-power-of-2=false -mtriple=arm64-apple-ios -S %s | FileCheck --check-prefixes=VPLAN-VPLAN,VPLAN-VPLAN-POW2-ONLY %s
...
;
; VPLAN-VPLAN-NON-POW2-LABEL: @v3_load_i32_mul_by_constant_store(
; VPLAN-VPLAN-NON-POW2-NEXT:  entry:
; VPLAN-VPLAN-NON-POW2-NEXT:    [[GEP_SRC_0:%.*]] = getelementptr inbounds i32, ptr [[SRC:%.*]], i32 0
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP0:%.*]] = load <3 x i32>, ptr [[GEP_SRC_0]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP1:%.*]] = mul nsw <3 x i32> [[TMP0]], splat (i32 10)
; VPLAN-VPLAN-NON-POW2-NEXT:    store <3 x i32> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    ret void
;
; VPLAN-VPLAN-POW2-ONLY-LABEL: @v3_load_i32_mul_by_constant_store(
; VPLAN-VPLAN-POW2-ONLY-NEXT:  entry:
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_0:%.*]] = getelementptr inbounds i32, ptr [[SRC:%.*]], i32 0
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_2:%.*]] = getelementptr inbounds i32, ptr [[SRC]], i32 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[L_SRC_2:%.*]] = load i32, ptr [[GEP_SRC_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[MUL_2:%.*]] = mul nsw i32 [[L_SRC_2]], 10
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP0:%.*]] = load <2 x i32>, ptr [[GEP_SRC_0]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP1:%.*]] = mul nsw <2 x i32> [[TMP0]], splat (i32 10)
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store <2 x i32> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[DST_2:%.*]] = getelementptr i32, ptr [[DST]], i32 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store i32 [[MUL_2]], ptr [[DST_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    ret void
;
; VPLAN-VPLAN-LABEL: @v3_load_i32_udiv_by_constant_store(
; VPLAN-VPLAN-NEXT:  entry:
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_0:%.*]] = getelementptr inbounds i32, ptr [[SRC:%.*]], i32 0
; VPLAN-VPLAN-NEXT:    [[L_SRC_0:%.*]] = load i32, ptr [[GEP_SRC_0]], align 4
; VPLAN-VPLAN-NEXT:    [[MUL_0:%.*]] = udiv i32 10, [[L_SRC_0]]
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_1:%.*]] = getelementptr inbounds i32, ptr [[SRC]], i32 1
; VPLAN-VPLAN-NEXT:    [[L_SRC_1:%.*]] = load i32, ptr [[GEP_SRC_1]], align 4
; VPLAN-VPLAN-NEXT:    [[MUL_1:%.*]] = udiv i32 10, [[L_SRC_1]]
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_2:%.*]] = getelementptr inbounds i32, ptr [[SRC]], i32 2
; VPLAN-VPLAN-NEXT:    [[L_SRC_2:%.*]] = load i32, ptr [[GEP_SRC_2]], align 4
; VPLAN-VPLAN-NEXT:    [[MUL_2:%.*]] = udiv i32 10, [[L_SRC_2]]
; VPLAN-VPLAN-NEXT:    store i32 [[MUL_0]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-NEXT:    [[DST_1:%.*]] = getelementptr i32, ptr [[DST]], i32 1
; VPLAN-VPLAN-NEXT:    store i32 [[MUL_1]], ptr [[DST_1]], align 4
; VPLAN-VPLAN-NEXT:    [[DST_2:%.*]] = getelementptr i32, ptr [[DST]], i32 2
; VPLAN-VPLAN-NEXT:    store i32 [[MUL_2]], ptr [[DST_2]], align 4
...
; POW2-ONLY-NEXT:    ret void
;
; VPLAN-VPLAN-NON-POW2-LABEL: @v3_load_i32_mul_store(
; VPLAN-VPLAN-NON-POW2-NEXT:  entry:
; VPLAN-VPLAN-NON-POW2-NEXT:    [[GEP_SRC_1_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_1:%.*]], i32 0
; VPLAN-VPLAN-NON-POW2-NEXT:    [[GEP_SRC_2_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_2:%.*]], i32 0
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP0:%.*]] = load <3 x i32>, ptr [[GEP_SRC_1_0]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP1:%.*]] = load <3 x i32>, ptr [[GEP_SRC_2_0]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP2:%.*]] = mul nsw <3 x i32> [[TMP0]], [[TMP1]]
; VPLAN-VPLAN-NON-POW2-NEXT:    store <3 x i32> [[TMP2]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    ret void
;
; VPLAN-VPLAN-POW2-ONLY-LABEL: @v3_load_i32_mul_store(
; VPLAN-VPLAN-POW2-ONLY-NEXT:  entry:
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_1_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_1:%.*]], i32 0
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_2_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_2:%.*]], i32 0
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_1_2:%.*]] = getelementptr inbounds i32, ptr [[SRC_1]], i32 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[L_SRC_1_2:%.*]] = load i32, ptr [[GEP_SRC_1_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_2_2:%.*]] = getelementptr inbounds i32, ptr [[SRC_2]], i32 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[L_SRC_2_2:%.*]] = load i32, ptr [[GEP_SRC_2_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[MUL_2:%.*]] = mul nsw i32 [[L_SRC_1_2]], [[L_SRC_2_2]]
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP0:%.*]] = load <2 x i32>, ptr [[GEP_SRC_1_0]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP1:%.*]] = load <2 x i32>, ptr [[GEP_SRC_2_0]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP2:%.*]] = mul nsw <2 x i32> [[TMP0]], [[TMP1]]
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store <2 x i32> [[TMP2]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[DST_2:%.*]] = getelementptr i32, ptr [[DST]], i32 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store i32 [[MUL_2]], ptr [[DST_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    ret void
;
...
; POW2-ONLY-NEXT:    ret void
;
; VPLAN-VPLAN-NON-POW2-LABEL: @v3_load_i32_mul_add_const_store(
; VPLAN-VPLAN-NON-POW2-NEXT:  entry:
; VPLAN-VPLAN-NON-POW2-NEXT:    [[GEP_SRC_1_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_1:%.*]], i32 0
; VPLAN-VPLAN-NON-POW2-NEXT:    [[GEP_SRC_2_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_2:%.*]], i32 0
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP0:%.*]] = load <3 x i32>, ptr [[GEP_SRC_1_0]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP1:%.*]] = load <3 x i32>, ptr [[GEP_SRC_2_0]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP2:%.*]] = mul nsw <3 x i32> [[TMP0]], [[TMP1]]
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP3:%.*]] = add <3 x i32> [[TMP2]], splat (i32 9)
; VPLAN-VPLAN-NON-POW2-NEXT:    store <3 x i32> [[TMP3]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    ret void
;
; VPLAN-VPLAN-POW2-ONLY-LABEL: @v3_load_i32_mul_add_const_store(
; VPLAN-VPLAN-POW2-ONLY-NEXT:  entry:
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_1_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_1:%.*]], i32 0
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_2_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_2:%.*]], i32 0
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_1_2:%.*]] = getelementptr inbounds i32, ptr [[SRC_1]], i32 2
...
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[L_SRC_2_2:%.*]] = load i32, ptr [[GEP_SRC_2_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[MUL_2:%.*]] = mul nsw i32 [[L_SRC_1_2]], [[L_SRC_2_2]]
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[ADD_2:%.*]] = add i32 [[MUL_2]], 9
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP0:%.*]] = load <2 x i32>, ptr [[GEP_SRC_1_0]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP1:%.*]] = load <2 x i32>, ptr [[GEP_SRC_2_0]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP2:%.*]] = mul nsw <2 x i32> [[TMP0]], [[TMP1]]
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP3:%.*]] = add <2 x i32> [[TMP2]], splat (i32 9)
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store <2 x i32> [[TMP3]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[DST_2:%.*]] = getelementptr i32, ptr [[DST]], i32 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store i32 [[ADD_2]], ptr [[DST_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    ret void
;
entry:
  %gep.src.1.0 = getelementptr inbounds i32, ptr %src.1, i32 0
...
; POW2-ONLY-NEXT:    ret void
;
; VPLAN-VPLAN-NON-POW2-LABEL: @v3_load_f32_fadd_fadd_by_constant_store(
; VPLAN-VPLAN-NON-POW2-NEXT:  entry:
; VPLAN-VPLAN-NON-POW2-NEXT:    [[GEP_SRC_0:%.*]] = getelementptr inbounds float, ptr [[SRC:%.*]], i32 0
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP0:%.*]] = load <3 x float>, ptr [[GEP_SRC_0]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP1:%.*]] = fadd <3 x float> [[TMP0]], splat (float 1.000000e+01)
; VPLAN-VPLAN-NON-POW2-NEXT:    store <3 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    ret void
;
; VPLAN-VPLAN-POW2-ONLY-LABEL: @v3_load_f32_fadd_fadd_by_constant_store(
; VPLAN-VPLAN-POW2-ONLY-NEXT:  entry:
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_0:%.*]] = getelementptr inbounds float, ptr [[SRC:%.*]], i32 0
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[GEP_SRC_2:%.*]] = getelementptr inbounds float, ptr [[SRC]], i32 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[L_SRC_2:%.*]] = load float, ptr [[GEP_SRC_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[FADD_2:%.*]] = fadd float [[L_SRC_2]], 1.000000e+01
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP0:%.*]] = load <2 x float>, ptr [[GEP_SRC_0]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP1:%.*]] = fadd <2 x float> [[TMP0]], splat (float 1.000000e+01)
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store <2 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[DST_2:%.*]] = getelementptr float, ptr [[DST]], i32 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store float [[FADD_2]], ptr [[DST_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    ret void
;
entry:
...
; POW2-ONLY-NEXT:    ret void
;
; VPLAN-VPLAN-NON-POW2-LABEL: @phi_store3(
; VPLAN-VPLAN-NON-POW2-NEXT:  entry:
; VPLAN-VPLAN-NON-POW2-NEXT:    br label [[EXIT:%.*]]
; VPLAN-VPLAN-NON-POW2:       invoke.cont8.loopexit:
; VPLAN-VPLAN-NON-POW2-NEXT:    br label [[EXIT]]
; VPLAN-VPLAN-NON-POW2:       exit:
; VPLAN-VPLAN-NON-POW2-NEXT:    [[TMP0:%.*]] = phi <3 x i32> [ <i32 1, i32 2, i32 3>, [[ENTRY:%.*]] ], [ poison, [[INVOKE_CONT8_LOOPEXIT:%.*]] ]
; VPLAN-VPLAN-NON-POW2-NEXT:    store <3 x i32> [[TMP0]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    ret void
;
; VPLAN-VPLAN-POW2-ONLY-LABEL: @phi_store3(
; VPLAN-VPLAN-POW2-ONLY-NEXT:  entry:
; VPLAN-VPLAN-POW2-ONLY-NEXT:    br label [[EXIT:%.*]]
; VPLAN-VPLAN-POW2-ONLY:       invoke.cont8.loopexit:
; VPLAN-VPLAN-POW2-ONLY-NEXT:    br label [[EXIT]]
; VPLAN-VPLAN-POW2-ONLY:       exit:
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[P_2:%.*]] = phi i32 [ 3, [[ENTRY:%.*]] ], [ 0, [[INVOKE_CONT8_LOOPEXIT:%.*]] ]
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[TMP0:%.*]] = phi <2 x i32> [ <i32 1, i32 2>, [[ENTRY]] ], [ poison, [[INVOKE_CONT8_LOOPEXIT]] ]
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[DST_2:%.*]] = getelementptr i32, ptr [[DST:%.*]], i32 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store <2 x i32> [[TMP0]], ptr [[DST]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store i32 [[P_2]], ptr [[DST_2]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    ret void
;
entry:
  br label %exit
...
; POW2-ONLY-NEXT:    ret void
;
; VPLAN-VPLAN-NON-POW2-LABEL: @store_try_reorder(
; VPLAN-VPLAN-NON-POW2-NEXT:  entry:
; VPLAN-VPLAN-NON-POW2-NEXT:    store <3 x i32> zeroinitializer, ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-NON-POW2-NEXT:    ret void
;
; VPLAN-VPLAN-POW2-ONLY-LABEL: @store_try_reorder(
; VPLAN-VPLAN-POW2-ONLY-NEXT:  entry:
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store <2 x i32> zeroinitializer, ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[ADD216:%.*]] = sub i32 0, 0
; VPLAN-VPLAN-POW2-ONLY-NEXT:    [[ARRAYIDX_I1891:%.*]] = getelementptr i32, ptr [[DST]], i64 2
; VPLAN-VPLAN-POW2-ONLY-NEXT:    store i32 [[ADD216]], ptr [[ARRAYIDX_I1891]], align 4
; VPLAN-VPLAN-POW2-ONLY-NEXT:    ret void
;
entry:
  %add = add i32 0, 0
...
; CHECK-NEXT:    ret void
;
; VPLAN-VPLAN-LABEL: @vec3_fpext_cost(
; VPLAN-VPLAN-NEXT:  entry:
; VPLAN-VPLAN-NEXT:    [[ARRAYIDX80:%.*]] = getelementptr float, ptr [[COLOUR:%.*]], i64 2
; VPLAN-VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x float> poison, float [[TMP0:%.*]], i32 0
; VPLAN-VPLAN-NEXT:    [[TMP2:%.*]] = shufflevector <2 x float> [[TMP1]], <2 x float> poison, <2 x i32> zeroinitializer
; VPLAN-VPLAN-NEXT:    [[TMP3:%.*]] = fpext <2 x float> [[TMP2]] to <2 x double>
; VPLAN-VPLAN-NEXT:    [[TMP4:%.*]] = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> [[TMP3]], <2 x double> zeroinitializer, <2 x double> zeroinitializer)
; VPLAN-VPLAN-NEXT:    [[TMP5:%.*]] = fptrunc <2 x double> [[TMP4]] to <2 x float>
; VPLAN-VPLAN-NEXT:    store <2 x float> [[TMP5]], ptr [[COLOUR]], align 4
; VPLAN-VPLAN-NEXT:    [[CONV78:%.*]] = fpext float [[TMP0]] to double
; VPLAN-VPLAN-NEXT:    [[TMP6:%.*]] = call double @llvm.fmuladd.f64(double [[CONV78]], double 0.000000e+00, double 0.000000e+00)
; VPLAN-VPLAN-NEXT:    [[CONV82:%.*]] = fptrunc double [[TMP6]] to float
; VPLAN-VPLAN-NEXT:    store float [[CONV82]], ptr [[ARRAYIDX80]], align 4
; VPLAN-VPLAN-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    ret void
;
; VPLAN-VPLAN-LABEL: @fpext_gather(
; VPLAN-VPLAN-NEXT:  entry:
; VPLAN-VPLAN-NEXT:    [[TMP0:%.*]] = insertelement <2 x double> poison, double [[CONV:%.*]], i32 0
; VPLAN-VPLAN-NEXT:    [[TMP1:%.*]] = shufflevector <2 x double> [[TMP0]], <2 x double> poison, <2 x i32> zeroinitializer
; VPLAN-VPLAN-NEXT:    [[TMP2:%.*]] = fptrunc <2 x double> [[TMP1]] to <2 x float>
; VPLAN-VPLAN-NEXT:    [[LENGTHS:%.*]] = getelementptr float, ptr [[DST:%.*]], i64 0
; VPLAN-VPLAN-NEXT:    [[TMP3:%.*]] = extractelement <2 x float> [[TMP2]], i32 0
; VPLAN-VPLAN-NEXT:    store float [[TMP3]], ptr [[LENGTHS]], align 4
; VPLAN-VPLAN-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr float, ptr [[DST]], i64 1
; VPLAN-VPLAN-NEXT:    store <2 x float> [[TMP2]], ptr [[ARRAYIDX32]], align 4
; VPLAN-VPLAN-NEXT:    ret void
;
entry:
