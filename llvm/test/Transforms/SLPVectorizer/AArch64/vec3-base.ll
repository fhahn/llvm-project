...
; PADDING-NEXT:    [[TMP1:%.*]] = mul nsw <3 x i32> [[TMP0]], <i32 10, i32 10, i32 10>
...
; PADDING-NEXT:    [[TMP1:%.*]] = load <3 x i32>, ptr [[GEP_SRC_2_0]], align 4
; PADDING-NEXT:    [[TMP2:%.*]] = mul nsw <3 x i32> [[TMP0]], [[TMP1]]
; PADDING-NEXT:    store <3 x i32> [[TMP2]], ptr [[DST:%.*]], align 4
; PADDING-NEXT:    ret void
;
...
; PADDING-NEXT:    [[TMP1:%.*]] = load <3 x i32>, ptr [[GEP_SRC_2_0]], align 4
; PADDING-NEXT:    [[TMP2:%.*]] = mul nsw <3 x i32> [[TMP0]], [[TMP1]]
; PADDING-NEXT:    [[TMP3:%.*]] = add <3 x i32> [[TMP2]], <i32 9, i32 9, i32 9>
...
; PADDING-NEXT:    [[TMP1:%.*]] = fadd <3 x float> [[TMP0]], <float 1.000000e+01, float 1.000000e+01, float 1.000000e+01>
; PADDING-NEXT:    store <3 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; PADDING-NEXT:    ret void
;
...
; PADDING-NEXT:    br label [[EXIT]]
; PADDING:       exit:
; PADDING-NEXT:    [[TMP0:%.*]] = phi <3 x i32> [ <i32 1, i32 2, i32 3>, [[ENTRY:%.*]] ], [ poison, [[INVOKE_CONT8_LOOPEXIT:%.*]] ]
; PADDING-NEXT:    store <3 x i32> [[TMP0]], ptr [[DST:%.*]], align 4
; PADDING-NEXT:    ret void
;
...
; PADDING-LABEL: @store_try_reorder(
; PADDING-NEXT:  entry:
; PADDING-NEXT:    store <3 x i32> zeroinitializer, ptr [[DST:%.*]], align 4
; PADDING-NEXT:    ret void
;
; NO-PADDING-LABEL: @store_try_reorder(
; NO-PADDING-NEXT:  entry:
; NO-PADDING-NEXT:    [[ADD:%.*]] = add i32 0, 0
; NO-PADDING-NEXT:    store i32 [[ADD]], ptr [[DST:%.*]], align 4
; NO-PADDING-NEXT:    [[ARRAYIDX_I1887:%.*]] = getelementptr i32, ptr [[DST]], i64 1
; NO-PADDING-NEXT:    store <2 x i32> zeroinitializer, ptr [[ARRAYIDX_I1887]], align 4
; NO-PADDING-NEXT:    ret void
;
entry:
  %add = add i32 0, 0
