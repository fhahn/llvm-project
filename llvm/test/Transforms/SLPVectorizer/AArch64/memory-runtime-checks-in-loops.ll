...
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen  -mtriple=arm64-apple-ios -S %s | FileCheck %s
; RUN: opt -aa-pipeline='basic-aa,scoped-noalias-aa' -passes=slp-vectorizer -slp-use-vplan-codegen -mtriple=arm64-apple-darwin -S %s | FileCheck %s
