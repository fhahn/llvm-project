...
; RUN: opt -S -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -passes=slp-vectorizer,dce -slp-use-vplan-codegen < %s | FileCheck -check-prefixes=VPLAN-GCN %s
...
; GCN-NEXT:    ret void
;
; VPLAN-GCN-LABEL: define void @phi_4(
; VPLAN-GCN-SAME: ptr addrspace(3) [[INPTR0:%.*]], ptr addrspace(3) [[INPTR1:%.*]], ptr [[OUT:%.*]], ptr [[OUT1:%.*]], ptr [[OUT2:%.*]], i32 [[FLAG:%.*]]) #[[ATTR0:[0-9]+]] {
; VPLAN-GCN-NEXT:  [[ENTRY:.*]]:
; VPLAN-GCN-NEXT:    [[WIDE_LOAD:%.*]] = load <2 x i16>, ptr addrspace(3) [[INPTR0]], align 8
; VPLAN-GCN-NEXT:    [[GEP2:%.*]] = getelementptr i16, ptr addrspace(3) [[INPTR0]], i32 2
; VPLAN-GCN-NEXT:    [[WIDE_LOAD2:%.*]] = load <2 x i16>, ptr addrspace(3) [[GEP2]], align 2
; VPLAN-GCN-NEXT:    [[GEP4:%.*]] = getelementptr i16, ptr addrspace(3) [[INPTR0]], i32 4
; VPLAN-GCN-NEXT:    [[WIDE_LOAD4:%.*]] = load <2 x i16>, ptr addrspace(3) [[GEP4]], align 8
; VPLAN-GCN-NEXT:    [[GEP6:%.*]] = getelementptr i16, ptr addrspace(3) [[INPTR0]], i32 6
; VPLAN-GCN-NEXT:    [[WIDE_LOAD6:%.*]] = load <2 x i16>, ptr addrspace(3) [[GEP6]], align 2
; VPLAN-GCN-NEXT:    [[GEP8:%.*]] = getelementptr i16, ptr addrspace(3) [[INPTR0]], i32 8
; VPLAN-GCN-NEXT:    [[WIDE_LOAD8:%.*]] = load <2 x i16>, ptr addrspace(3) [[GEP8]], align 8
; VPLAN-GCN-NEXT:    [[GEP10:%.*]] = getelementptr i16, ptr addrspace(3) [[INPTR0]], i32 10
; VPLAN-GCN-NEXT:    [[WIDE_LOAD10:%.*]] = load <2 x i16>, ptr addrspace(3) [[GEP10]], align 2
; VPLAN-GCN-NEXT:    [[GEP12:%.*]] = getelementptr i16, ptr addrspace(3) [[INPTR0]], i32 12
; VPLAN-GCN-NEXT:    [[WIDE_LOAD12:%.*]] = load <2 x i16>, ptr addrspace(3) [[GEP12]], align 8
; VPLAN-GCN-NEXT:    [[GEP14:%.*]] = getelementptr i16, ptr addrspace(3) [[INPTR0]], i32 14
; VPLAN-GCN-NEXT:    [[WIDE_LOAD14:%.*]] = load <2 x i16>, ptr addrspace(3) [[GEP14]], align 2
; VPLAN-GCN-NEXT:    br label %[[DO_BODY:.*]]
; VPLAN-GCN:       [[DO_BODY]]:
; VPLAN-GCN-NEXT:    [[TMP0:%.*]] = phi <2 x i16> [ [[WIDE_LOAD]], %[[ENTRY]] ], [ [[WIDE_LOAD1:%.*]], %[[DO_BODY]] ]
; VPLAN-GCN-NEXT:    [[TMP1:%.*]] = phi <2 x i16> [ [[WIDE_LOAD2]], %[[ENTRY]] ], [ [[WIDE_LOAD3:%.*]], %[[DO_BODY]] ]
; VPLAN-GCN-NEXT:    [[TMP2:%.*]] = phi <2 x i16> [ [[WIDE_LOAD4]], %[[ENTRY]] ], [ [[WIDE_LOAD5:%.*]], %[[DO_BODY]] ]
; VPLAN-GCN-NEXT:    [[TMP3:%.*]] = phi <2 x i16> [ [[WIDE_LOAD6]], %[[ENTRY]] ], [ [[WIDE_LOAD7:%.*]], %[[DO_BODY]] ]
; VPLAN-GCN-NEXT:    [[TMP4:%.*]] = phi <2 x i16> [ [[WIDE_LOAD8]], %[[ENTRY]] ], [ [[WIDE_LOAD9:%.*]], %[[DO_BODY]] ]
; VPLAN-GCN-NEXT:    [[TMP5:%.*]] = phi <2 x i16> [ [[WIDE_LOAD10]], %[[ENTRY]] ], [ [[WIDE_LOAD11:%.*]], %[[DO_BODY]] ]
; VPLAN-GCN-NEXT:    [[TMP6:%.*]] = phi <2 x i16> [ [[WIDE_LOAD12]], %[[ENTRY]] ], [ [[WIDE_LOAD13:%.*]], %[[DO_BODY]] ]
; VPLAN-GCN-NEXT:    [[TMP7:%.*]] = phi <2 x i16> [ [[WIDE_LOAD14]], %[[ENTRY]] ], [ [[WIDE_LOAD15:%.*]], %[[DO_BODY]] ]
; VPLAN-GCN-NEXT:    [[WIDE_LOAD1]] = load <2 x i16>, ptr addrspace(3) [[INPTR0]], align 8
; VPLAN-GCN-NEXT:    [[WIDE_LOAD3]] = load <2 x i16>, ptr addrspace(3) [[GEP2]], align 2
; VPLAN-GCN-NEXT:    [[WIDE_LOAD5]] = load <2 x i16>, ptr addrspace(3) [[GEP4]], align 8
; VPLAN-GCN-NEXT:    [[WIDE_LOAD7]] = load <2 x i16>, ptr addrspace(3) [[GEP6]], align 2
; VPLAN-GCN-NEXT:    [[WIDE_LOAD9]] = load <2 x i16>, ptr addrspace(3) [[GEP8]], align 8
; VPLAN-GCN-NEXT:    [[WIDE_LOAD11]] = load <2 x i16>, ptr addrspace(3) [[GEP10]], align 2
; VPLAN-GCN-NEXT:    [[WIDE_LOAD13]] = load <2 x i16>, ptr addrspace(3) [[GEP12]], align 8
; VPLAN-GCN-NEXT:    [[WIDE_LOAD15]] = load <2 x i16>, ptr addrspace(3) [[GEP14]], align 2
; VPLAN-GCN-NEXT:    [[CMP:%.*]] = icmp eq i32 [[FLAG]], 0
; VPLAN-GCN-NEXT:    br i1 [[CMP]], label %[[EXIT:.*]], label %[[DO_BODY]]
; VPLAN-GCN:       [[EXIT]]:
; VPLAN-GCN-NEXT:    [[TMP49:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD1]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP50:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD3]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP8:%.*]] = shufflevector <16 x i16> [[TMP49]], <16 x i16> [[TMP50]], <16 x i32> <i32 0, i32 1, i32 16, i32 17, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP9:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD5]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP10:%.*]] = shufflevector <16 x i16> [[TMP8]], <16 x i16> [[TMP9]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 16, i32 17, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP11:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD7]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP12:%.*]] = shufflevector <16 x i16> [[TMP10]], <16 x i16> [[TMP11]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 16, i32 17, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP13:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD9]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP14:%.*]] = shufflevector <16 x i16> [[TMP12]], <16 x i16> [[TMP13]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 16, i32 17, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP15:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD11]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP16:%.*]] = shufflevector <16 x i16> [[TMP14]], <16 x i16> [[TMP15]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 16, i32 17, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP17:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD13]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP18:%.*]] = shufflevector <16 x i16> [[TMP16]], <16 x i16> [[TMP17]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP19:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD15]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP20:%.*]] = shufflevector <16 x i16> [[TMP18]], <16 x i16> [[TMP19]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 16, i32 17>
; VPLAN-GCN-NEXT:    [[TMP51:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP52:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD2]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP21:%.*]] = shufflevector <16 x i16> [[TMP51]], <16 x i16> [[TMP52]], <16 x i32> <i32 0, i32 1, i32 16, i32 17, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP22:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD4]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP23:%.*]] = shufflevector <16 x i16> [[TMP21]], <16 x i16> [[TMP22]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 16, i32 17, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP24:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD6]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP25:%.*]] = shufflevector <16 x i16> [[TMP23]], <16 x i16> [[TMP24]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 16, i32 17, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP26:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD8]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP27:%.*]] = shufflevector <16 x i16> [[TMP25]], <16 x i16> [[TMP26]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 16, i32 17, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP28:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD10]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP29:%.*]] = shufflevector <16 x i16> [[TMP27]], <16 x i16> [[TMP28]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 16, i32 17, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP30:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD12]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP31:%.*]] = shufflevector <16 x i16> [[TMP29]], <16 x i16> [[TMP30]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP32:%.*]] = shufflevector <2 x i16> [[WIDE_LOAD14]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP33:%.*]] = shufflevector <16 x i16> [[TMP31]], <16 x i16> [[TMP32]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 16, i32 17>
; VPLAN-GCN-NEXT:    [[TMP34:%.*]] = shufflevector <2 x i16> [[TMP0]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP35:%.*]] = shufflevector <2 x i16> [[TMP1]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP36:%.*]] = shufflevector <16 x i16> [[TMP34]], <16 x i16> [[TMP35]], <16 x i32> <i32 0, i32 1, i32 16, i32 17, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP37:%.*]] = shufflevector <2 x i16> [[TMP2]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP38:%.*]] = shufflevector <16 x i16> [[TMP36]], <16 x i16> [[TMP37]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 16, i32 17, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP39:%.*]] = shufflevector <2 x i16> [[TMP3]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP40:%.*]] = shufflevector <16 x i16> [[TMP38]], <16 x i16> [[TMP39]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 16, i32 17, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP41:%.*]] = shufflevector <2 x i16> [[TMP4]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP42:%.*]] = shufflevector <16 x i16> [[TMP40]], <16 x i16> [[TMP41]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 16, i32 17, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP43:%.*]] = shufflevector <2 x i16> [[TMP5]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP44:%.*]] = shufflevector <16 x i16> [[TMP42]], <16 x i16> [[TMP43]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 16, i32 17, i32 12, i32 13, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP45:%.*]] = shufflevector <2 x i16> [[TMP6]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP46:%.*]] = shufflevector <16 x i16> [[TMP44]], <16 x i16> [[TMP45]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 14, i32 15>
; VPLAN-GCN-NEXT:    [[TMP47:%.*]] = shufflevector <2 x i16> [[TMP7]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-GCN-NEXT:    [[TMP48:%.*]] = shufflevector <16 x i16> [[TMP46]], <16 x i16> [[TMP47]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 16, i32 17>
; VPLAN-GCN-NEXT:    store <16 x i16> [[TMP33]], ptr [[OUT]], align 32
; VPLAN-GCN-NEXT:    store <16 x i16> [[TMP20]], ptr [[OUT1]], align 32
; VPLAN-GCN-NEXT:    store <16 x i16> [[TMP48]], ptr [[OUT2]], align 32
