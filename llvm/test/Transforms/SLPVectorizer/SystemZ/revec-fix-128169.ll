...
; RUN: opt -mtriple=s390x-unknown-linux-gnu -mcpu=z17 -passes=slp-vectorizer -slp-use-vplan-codegen -S -slp-revec < %s | FileCheck %s
; RUN: opt -mtriple=s390x-unknown-linux-gnu -mcpu=z17 -passes=slp-vectorizer -slp-use-vplan-codegen -S -slp-revec -slp-threshold=-1000 < %s | FileCheck %s --check-prefix=THRESH
