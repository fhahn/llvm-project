...
; RUN: opt -S --passes=slp-vectorizer -slp-use-vplan-codegen -mtriple=s390x-ibm-linux -mcpu=z13 -slp-max-reg-size=256 -slp-vectorize-hor-store -slp-vectorize-non-power-of-2 < %s | FileCheck --check-prefix=VPLAN %s
...
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: define void @p(
; VPLAN-SAME: ) #[[ATTR0:[0-9]+]] {
; VPLAN-NEXT:  [[ENTRY:.*:]]
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr getelementptr inbounds nuw (i8, ptr @c, i64 52), align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = extractelement <4 x i32> [[TMP0]], i32 0
; VPLAN-NEXT:    [[TMP2:%.*]] = extractelement <4 x i32> [[TMP0]], i32 2
; VPLAN-NEXT:    [[TMP3:%.*]] = xor <4 x i32> [[TMP0]], splat (i32 1)
; VPLAN-NEXT:    store <4 x i32> [[TMP3]], ptr getelementptr inbounds nuw (i8, ptr @c, i64 52), align 4
; VPLAN-NEXT:    [[TMP4:%.*]] = load <7 x i32>, ptr getelementptr inbounds nuw (i8, ptr @c, i64 200), align 4
; VPLAN-NEXT:    [[TMP5:%.*]] = extractelement <7 x i32> [[TMP4]], i32 3
; VPLAN-NEXT:    [[OR_1_5_I_3:%.*]] = or i32 [[TMP1]], [[TMP5]]
; VPLAN-NEXT:    store i32 [[OR_1_5_I_3]], ptr @j.0, align 4
; VPLAN-NEXT:    [[TMP6:%.*]] = extractelement <7 x i32> [[TMP4]], i32 5
; VPLAN-NEXT:    [[TMP7:%.*]] = xor <7 x i32> [[TMP4]], splat (i32 1)
; VPLAN-NEXT:    store <7 x i32> [[TMP7]], ptr getelementptr inbounds nuw (i8, ptr @c, i64 200), align 4
; VPLAN-NEXT:    [[TMP8:%.*]] = load <4 x i32>, ptr getelementptr inbounds nuw (i8, ptr @c, i64 252), align 4
; VPLAN-NEXT:    [[TMP9:%.*]] = extractelement <4 x i32> [[TMP8]], i32 1
; VPLAN-NEXT:    [[TMP11:%.*]] = or i32 [[TMP9]], [[TMP2]]
; VPLAN-NEXT:    [[OR_1_5_I_5:%.*]] = or i32 [[TMP11]], [[TMP6]]
; VPLAN-NEXT:    [[TMP10:%.*]] = extractelement <4 x i32> [[TMP8]], i32 2
; VPLAN-NEXT:    [[OR_1_6_I_5:%.*]] = or i32 [[OR_1_5_I_5]], [[TMP10]]
; VPLAN-NEXT:    store i32 [[OR_1_6_I_5]], ptr @j.0, align 4
; VPLAN-NEXT:    [[TMP12:%.*]] = xor <4 x i32> [[TMP8]], splat (i32 1)
; VPLAN-NEXT:    store <4 x i32> [[TMP12]], ptr getelementptr inbounds nuw (i8, ptr @c, i64 252), align 4
; VPLAN-NEXT:    ret void
;
entry:
