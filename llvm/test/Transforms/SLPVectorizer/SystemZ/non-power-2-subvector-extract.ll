...
; RUN: opt -S --passes=slp-vectorizer -slp-use-vplan-codegen -mtriple=s390x-ibm-linux -mcpu=z13 -slp-max-reg-size=256 -slp-vectorize-hor-store -slp-vectorize-non-power-of-2 < %s | FileCheck %s
