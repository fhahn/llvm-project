...
; RUN: opt -slp-use-vplan-codegen -mtriple=wasm32 -mattr=+simd128 -passes=slp-vectorizer -S %s | FileCheck %s --check-prefix=SIMD128
; RUN: opt -mtriple=wasm32 -passes=slp-vectorizer -S %s | FileCheck %s --check-prefix=NO-SIMD128
; RUN: opt -slp-use-vplan-codegen -mtriple=wasm32 -passes=slp-vectorizer -S %s | FileCheck %s --check-prefix=NO-SIMD128
