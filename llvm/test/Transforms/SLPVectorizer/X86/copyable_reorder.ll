...
; RUN: opt < %s -passes=slp-vectorizer -slp-threshold=-200 -mtriple=x86_64-unknown-linux -mcpu=core-avx2 -S | FileCheck %s --check-prefixes=CHECK,LEGACY
; RUN: opt -slp-use-vplan-codegen < %s -passes=slp-vectorizer -slp-threshold=-200 -mtriple=x86_64-unknown-linux -mcpu=core-avx2 -S | FileCheck %s --check-prefixes=CHECK,VPLAN
...
; LEGACY-LABEL: @test_sub_zero_copyable_not_swapped(
; LEGACY-NEXT:  entry:
; LEGACY-NEXT:    [[GEP_SRC_FAR0:%.*]] = getelementptr inbounds i32, ptr [[Z:%.*]], i64 0
; LEGACY-NEXT:    [[GEP_SRC_NEAR0:%.*]] = getelementptr inbounds i32, ptr [[Z]], i64 1
; LEGACY-NEXT:    [[GEP_SRC_FAR1:%.*]] = getelementptr inbounds i32, ptr [[Z]], i64 2
; LEGACY-NEXT:    [[GEP_SRC_NEAR1:%.*]] = getelementptr inbounds i32, ptr [[Z]], i64 3
; LEGACY-NEXT:    [[GEP_DST0:%.*]] = getelementptr inbounds i32, ptr [[Z]], i64 64
; LEGACY-NEXT:    [[V0:%.*]] = load i32, ptr [[GEP_SRC_FAR0]], align 4
; LEGACY-NEXT:    [[V1:%.*]] = load i32, ptr [[GEP_SRC_NEAR0]], align 4
; LEGACY-NEXT:    [[V2:%.*]] = load i32, ptr [[GEP_SRC_FAR1]], align 4
; LEGACY-NEXT:    [[V3:%.*]] = load i32, ptr [[GEP_SRC_NEAR1]], align 4
; LEGACY-NEXT:    [[TMP0:%.*]] = insertelement <2 x i32> poison, i32 [[V0]], i64 0
; LEGACY-NEXT:    [[TMP1:%.*]] = insertelement <2 x i32> [[TMP0]], i32 [[V2]], i64 1
; LEGACY-NEXT:    [[TMP2:%.*]] = sub nsw <2 x i32> zeroinitializer, [[TMP1]]
; LEGACY-NEXT:    [[TMP3:%.*]] = shufflevector <2 x i32> [[TMP2]], <2 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 1, i32 poison>
; LEGACY-NEXT:    [[TMP4:%.*]] = insertelement <4 x i32> [[TMP3]], i32 [[V1]], i64 1
; LEGACY-NEXT:    [[TMP5:%.*]] = insertelement <4 x i32> [[TMP4]], i32 [[V3]], i64 3
; LEGACY-NEXT:    store <4 x i32> [[TMP5]], ptr [[GEP_DST0]], align 4
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @test_sub_zero_copyable_not_swapped(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[GEP_SRC_FAR0:%.*]] = getelementptr inbounds i32, ptr [[Z:%.*]], i64 0
; VPLAN-NEXT:    [[GEP_SRC_NEAR0:%.*]] = getelementptr inbounds i32, ptr [[Z]], i64 1
; VPLAN-NEXT:    [[GEP_SRC_FAR1:%.*]] = getelementptr inbounds i32, ptr [[Z]], i64 2
; VPLAN-NEXT:    [[GEP_SRC_NEAR1:%.*]] = getelementptr inbounds i32, ptr [[Z]], i64 3
; VPLAN-NEXT:    [[GEP_DST0:%.*]] = getelementptr inbounds i32, ptr [[Z]], i64 64
; VPLAN-NEXT:    [[V0:%.*]] = load i32, ptr [[GEP_SRC_FAR0]], align 4
; VPLAN-NEXT:    [[V1:%.*]] = load i32, ptr [[GEP_SRC_NEAR0]], align 4
; VPLAN-NEXT:    [[V2:%.*]] = load i32, ptr [[GEP_SRC_FAR1]], align 4
; VPLAN-NEXT:    [[V3:%.*]] = load i32, ptr [[GEP_SRC_NEAR1]], align 4
; VPLAN-NEXT:    [[TMP0:%.*]] = insertelement <2 x i32> poison, i32 [[V0]], i64 0
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x i32> [[TMP0]], i32 [[V2]], i64 1
; VPLAN-NEXT:    [[TMP2:%.*]] = sub nsw <2 x i32> zeroinitializer, [[TMP1]]
; VPLAN-NEXT:    [[TMP3:%.*]] = extractelement <2 x i32> [[TMP2]], i64 0
; VPLAN-NEXT:    [[TMP4:%.*]] = extractelement <2 x i32> [[TMP2]], i64 1
; VPLAN-NEXT:    [[TMP5:%.*]] = insertelement <4 x i32> poison, i32 [[TMP3]], i64 0
; VPLAN-NEXT:    [[TMP6:%.*]] = insertelement <4 x i32> [[TMP5]], i32 [[V1]], i64 1
; VPLAN-NEXT:    [[TMP7:%.*]] = insertelement <4 x i32> [[TMP6]], i32 [[TMP4]], i64 2
; VPLAN-NEXT:    [[TMP8:%.*]] = insertelement <4 x i32> [[TMP7]], i32 [[V3]], i64 3
; VPLAN-NEXT:    store <4 x i32> [[TMP8]], ptr [[GEP_DST0]], align 4
; VPLAN-NEXT:    ret void
;
entry:
