...
; LEGACY-LABEL: @test_add_mul(
; LEGACY-NEXT:  entry:
; LEGACY-NEXT:    [[TMP0:%.*]] = insertelement <4 x i32> poison, i32 [[A0:%.*]], i32 0
; LEGACY-NEXT:    [[TMP1:%.*]] = insertelement <4 x i32> [[TMP0]], i32 [[A1:%.*]], i32 1
; LEGACY-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> [[TMP1]], i32 [[A2:%.*]], i32 2
; LEGACY-NEXT:    [[TMP3:%.*]] = insertelement <4 x i32> [[TMP2]], i32 [[A3:%.*]], i32 3
; LEGACY-NEXT:    [[TMP4:%.*]] = add <4 x i32> [[TMP3]], <i32 1146, i32 146, i32 42, i32 0>
; LEGACY-NEXT:    [[TMP5:%.*]] = load <4 x i32>, ptr [[ARR1:%.*]], align 4
; LEGACY-NEXT:    [[TMP6:%.*]] = add nsw <4 x i32> [[TMP5]], [[TMP4]]
; LEGACY-NEXT:    [[TMP7:%.*]] = mul <4 x i32> [[TMP5]], [[TMP4]]
; LEGACY-NEXT:    [[TMP8:%.*]] = shufflevector <4 x i32> [[TMP6]], <4 x i32> [[TMP7]], <4 x i32> <i32 0, i32 1, i32 6, i32 3>
; LEGACY-NEXT:    store <4 x i32> [[TMP8]], ptr [[ARR2:%.*]], align 4
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @test_add_mul(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = insertelement <4 x i32> poison, i32 [[A0:%.*]], i32 0
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <4 x i32> [[TMP0]], i32 [[A1:%.*]], i32 1
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> [[TMP1]], i32 [[A2:%.*]], i32 2
; VPLAN-NEXT:    [[TMP3:%.*]] = insertelement <4 x i32> [[TMP2]], i32 [[A3:%.*]], i32 3
; VPLAN-NEXT:    [[TMP4:%.*]] = add <4 x i32> [[TMP3]], <i32 1146, i32 146, i32 42, i32 0>
; VPLAN-NEXT:    [[TMP5:%.*]] = load <4 x i32>, ptr [[ARR1:%.*]], align 4
; VPLAN-NEXT:    [[TMP6:%.*]] = add nsw <4 x i32> [[TMP5]], [[TMP4]]
; VPLAN-NEXT:    [[TMP7:%.*]] = mul <4 x i32> [[TMP5]], [[TMP4]]
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <4 x i32> [[TMP6]], <4 x i32> [[TMP7]], <4 x i32> <i32 0, i32 1, i32 6, i32 3>
; VPLAN-NEXT:    store <4 x i32> [[TMP8]], ptr [[ARR2:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
  %gep1.1 = getelementptr i32, ptr %arr1, i32 1
...
; LEGACY-LABEL: @test_add_mul_commuted(
; LEGACY-NEXT:  entry:
; LEGACY-NEXT:    [[TMP0:%.*]] = insertelement <4 x i32> poison, i32 [[A0:%.*]], i32 0
; LEGACY-NEXT:    [[TMP1:%.*]] = insertelement <4 x i32> [[TMP0]], i32 [[A1:%.*]], i32 1
; LEGACY-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> [[TMP1]], i32 [[A2:%.*]], i32 2
; LEGACY-NEXT:    [[TMP3:%.*]] = insertelement <4 x i32> [[TMP2]], i32 [[A3:%.*]], i32 3
; LEGACY-NEXT:    [[TMP4:%.*]] = add <4 x i32> <i32 1146, i32 146, i32 42, i32 0>, [[TMP3]]
; LEGACY-NEXT:    [[TMP5:%.*]] = load <4 x i32>, ptr [[ARR1:%.*]], align 4
; LEGACY-NEXT:    [[TMP6:%.*]] = add nsw <4 x i32> [[TMP5]], [[TMP4]]
; LEGACY-NEXT:    [[TMP7:%.*]] = mul <4 x i32> [[TMP5]], [[TMP4]]
; LEGACY-NEXT:    [[TMP8:%.*]] = shufflevector <4 x i32> [[TMP6]], <4 x i32> [[TMP7]], <4 x i32> <i32 0, i32 1, i32 6, i32 3>
...
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @test_add_mul_commuted(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = insertelement <4 x i32> poison, i32 [[A0:%.*]], i32 0
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <4 x i32> [[TMP0]], i32 [[A1:%.*]], i32 1
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> [[TMP1]], i32 [[A2:%.*]], i32 2
; VPLAN-NEXT:    [[TMP3:%.*]] = insertelement <4 x i32> [[TMP2]], i32 [[A3:%.*]], i32 3
; VPLAN-NEXT:    [[TMP4:%.*]] = add <4 x i32> <i32 1146, i32 146, i32 42, i32 0>, [[TMP3]]
; VPLAN-NEXT:    [[TMP5:%.*]] = load <4 x i32>, ptr [[ARR1:%.*]], align 4
; VPLAN-NEXT:    [[TMP6:%.*]] = add nsw <4 x i32> [[TMP5]], [[TMP4]]
; VPLAN-NEXT:    [[TMP7:%.*]] = mul <4 x i32> [[TMP5]], [[TMP4]]
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <4 x i32> [[TMP6]], <4 x i32> [[TMP7]], <4 x i32> <i32 0, i32 1, i32 6, i32 3>
...
; LEGACY-LABEL: @test_add_udiv_sub(
; LEGACY-NEXT:  entry:
; LEGACY-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[ARR1:%.*]], align 4
; LEGACY-NEXT:    [[TMP1:%.*]] = insertelement <4 x i32> <i32 1, i32 1, i32 poison, i32 1>, i32 [[A2:%.*]], i32 2
; LEGACY-NEXT:    [[TMP2:%.*]] = sub <4 x i32> [[TMP1]], <i32 0, i32 0, i32 42, i32 0>
; LEGACY-NEXT:    [[TMP3:%.*]] = insertelement <4 x i32> <i32 poison, i32 poison, i32 0, i32 poison>, i32 [[A0:%.*]], i32 0
; LEGACY-NEXT:    [[TMP4:%.*]] = insertelement <4 x i32> [[TMP3]], i32 [[A1:%.*]], i32 1
; LEGACY-NEXT:    [[TMP5:%.*]] = insertelement <4 x i32> [[TMP4]], i32 [[A3:%.*]], i32 3
; LEGACY-NEXT:    [[TMP6:%.*]] = add nsw <4 x i32> <i32 1146, i32 146, i32 0, i32 0>, [[TMP5]]
...
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @test_add_udiv_sub(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[ARR1:%.*]], align 4
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> <i32 1, i32 1, i32 poison, i32 1>, i32 [[A2:%.*]], i32 2
; VPLAN-NEXT:    [[TMP3:%.*]] = sub <4 x i32> [[TMP2]], <i32 0, i32 0, i32 42, i32 0>
; VPLAN-NEXT:    [[TMP4:%.*]] = insertelement <4 x i32> <i32 poison, i32 poison, i32 0, i32 poison>, i32 [[A0:%.*]], i32 0
; VPLAN-NEXT:    [[TMP5:%.*]] = insertelement <4 x i32> [[TMP4]], i32 [[A1:%.*]], i32 1
; VPLAN-NEXT:    [[TMP6:%.*]] = insertelement <4 x i32> [[TMP5]], i32 [[A3:%.*]], i32 3
; VPLAN-NEXT:    [[TMP8:%.*]] = add <4 x i32> <i32 1146, i32 146, i32 0, i32 0>, [[TMP6]]
