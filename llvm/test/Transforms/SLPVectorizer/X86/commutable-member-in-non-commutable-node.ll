...
; RUN: opt --passes=slp-vectorizer -slp-use-vplan-codegen -S -mtriple=x86_64-unknown-linux-gnu -mattr=+avx512f < %s | FileCheck --check-prefix=VPLAN %s
...
; VPLAN-SAME: i32 [[ARG:%.*]]) #[[ATTR0:[0-9]+]] {
; VPLAN-NEXT:  [[BB:.*:]]
; VPLAN-NEXT:    [[TMP0:%.*]] = load <2 x i32>, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) null, i64 896), align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = add <2 x i32> [[TMP0]], zeroinitializer
; VPLAN-NEXT:    [[TMP3:%.*]] = insertelement <2 x i32> <i32 poison, i32 0>, i32 [[ARG]], i32 0
; VPLAN-NEXT:    [[TMP4:%.*]] = sub <2 x i32> [[TMP1]], [[TMP3]]
; VPLAN-NEXT:    store <2 x i32> [[TMP4]], ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) null, i64 896), align 4
