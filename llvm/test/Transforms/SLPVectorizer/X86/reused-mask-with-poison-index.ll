...
; RUN: opt -slp-use-vplan-codegen -S --passes=slp-vectorizer -mtriple=x86_64-unknown-linux < %s | FileCheck %s --check-prefix=VPLAN
...
;
; VPLAN-LABEL: define fastcc i32 @test(
; VPLAN-SAME: ptr [[TMP0:%.*]], <2 x float> [[TMP1:%.*]], i1 [[TMP2:%.*]], float [[TMP3:%.*]], float [[TMP4:%.*]]) {
; VPLAN-NEXT:    [[TMP6:%.*]] = extractelement <2 x float> [[TMP1]], i64 0
; VPLAN-NEXT:    [[TMP7:%.*]] = extractelement <2 x float> [[TMP1]], i64 1
; VPLAN-NEXT:    br label %[[BB8:.*]]
; VPLAN:       [[BB8]]:
; VPLAN-NEXT:    [[TMP9:%.*]] = phi float [ 0.000000e+00, [[TMP5:%.*]] ], [ [[TMP56:%.*]], %[[TMP54:.*]] ]
; VPLAN-NEXT:    [[TMP10:%.*]] = phi float [ 0.000000e+00, [[TMP5]] ], [ [[TMP57:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP11:%.*]] = phi float [ [[TMP4]], [[TMP5]] ], [ [[TMP58:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP12:%.*]] = phi float [ [[TMP7]], [[TMP5]] ], [ [[TMP59:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP13:%.*]] = phi float [ [[TMP6]], [[TMP5]] ], [ [[TMP60:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP14:%.*]] = phi float [ 0.000000e+00, [[TMP5]] ], [ [[TMP61:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP15:%.*]] = phi float [ 0.000000e+00, [[TMP5]] ], [ [[TMP62:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP16:%.*]] = phi float [ undef, [[TMP5]] ], [ [[TMP63:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP17:%.*]] = phi <2 x float> [ zeroinitializer, [[TMP5]] ], [ poison, %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP18:%.*]] = phi float [ [[TMP4]], [[TMP5]] ], [ [[TMP64:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP19:%.*]] = phi float [ [[TMP4]], [[TMP5]] ], [ [[TMP65:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP20:%.*]] = phi float [ [[TMP4]], [[TMP5]] ], [ [[TMP66:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP21:%.*]] = phi float [ [[TMP4]], [[TMP5]] ], [ [[TMP67:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP22:%.*]] = phi float [ 0.000000e+00, [[TMP5]] ], [ [[TMP69:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP23:%.*]] = phi float [ 0.000000e+00, [[TMP5]] ], [ [[TMP68:%.*]], %[[TMP54]] ]
; VPLAN-NEXT:    [[TMP24:%.*]] = phi <4 x float> [ zeroinitializer, [[TMP5]] ], [ poison, %[[TMP54]] ]
; VPLAN-NEXT:    br i1 false, label %[[BB55:.*]], label %[[BB25:.*]]
; VPLAN:       [[BB25]]:
; VPLAN-NEXT:    [[TMP26:%.*]] = fcmp olt float [[TMP21]], 0.000000e+00
; VPLAN-NEXT:    br i1 [[TMP26]], label %[[BB55]], label %[[BB27:.*]]
; VPLAN:       [[BB27]]:
; VPLAN-NEXT:    [[TMP28:%.*]] = fcmp olt float [[TMP20]], 0.000000e+00
; VPLAN-NEXT:    br i1 [[TMP28]], label %[[BB55]], label %[[BB29:.*]]
; VPLAN:       [[BB29]]:
; VPLAN-NEXT:    [[TMP30:%.*]] = insertelement <4 x float> poison, float [[TMP3]], i32 0
; VPLAN-NEXT:    [[TMP31:%.*]] = shufflevector <4 x float> [[TMP30]], <4 x float> poison, <4 x i32> zeroinitializer
; VPLAN-NEXT:    [[TMP32:%.*]] = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> [[TMP31]], <4 x float> zeroinitializer, <4 x float> zeroinitializer)
; VPLAN-NEXT:    [[TMP33:%.*]] = extractelement <4 x float> [[TMP24]], i32 0
; VPLAN-NEXT:    [[TMP34:%.*]] = fsub float [[TMP16]], [[TMP33]]
; VPLAN-NEXT:    [[TMP35:%.*]] = extractelement <4 x float> [[TMP24]], i32 1
; VPLAN-NEXT:    [[TMP36:%.*]] = fsub float [[TMP15]], [[TMP35]]
; VPLAN-NEXT:    [[TMP37:%.*]] = insertelement <2 x float> zeroinitializer, float [[TMP14]], i64 0
; VPLAN-NEXT:    [[TMP38:%.*]] = shufflevector <4 x float> [[TMP24]], <4 x float> poison, <2 x i32> <i32 poison, i32 2>
; VPLAN-NEXT:    [[TMP39:%.*]] = shufflevector <2 x float> [[TMP37]], <2 x float> [[TMP38]], <2 x i32> <i32 0, i32 3>
; VPLAN-NEXT:    [[TMP40:%.*]] = insertelement <2 x float> zeroinitializer, float [[TMP36]], i64 0
; VPLAN-NEXT:    [[TMP41:%.*]] = insertelement <2 x float> zeroinitializer, float [[TMP34]], i64 0
; VPLAN-NEXT:    [[TMP42:%.*]] = fmul <2 x float> [[TMP40]], [[TMP41]]
; VPLAN-NEXT:    [[TMP43:%.*]] = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> [[TMP39]], <2 x float> [[TMP17]], <2 x float> [[TMP42]])
; VPLAN-NEXT:    [[TMP44:%.*]] = extractelement <2 x float> [[TMP43]], i64 0
; VPLAN-NEXT:    [[TMP45:%.*]] = fcmp ogt float [[TMP44]], 0.000000e+00
; VPLAN-NEXT:    br i1 [[TMP45]], label %[[BB46:.*]], label %[[BB48:.*]]
; VPLAN:       [[BB46]]:
; VPLAN-NEXT:    br label %[[BB48]]
; VPLAN:       [[BB47:.*]]:
; VPLAN-NEXT:    br label %[[BB48]]
; VPLAN:       [[BB48]]:
; VPLAN-NEXT:    [[TMP49:%.*]] = phi float [ [[TMP12]], %[[BB47]] ], [ [[TMP18]], %[[BB46]] ], [ 0.000000e+00, %[[BB29]] ]
; VPLAN-NEXT:    [[TMP50:%.*]] = phi float [ [[TMP13]], %[[BB47]] ], [ [[TMP19]], %[[BB46]] ], [ 0.000000e+00, %[[BB29]] ]
; VPLAN-NEXT:    br i1 [[TMP2]], label %[[BB55]], label %[[BB51:.*]]
; VPLAN:       [[BB51]]:
; VPLAN-NEXT:    [[TMP52:%.*]] = extractelement <2 x float> [[TMP1]], i64 0
; VPLAN-NEXT:    [[TMP53:%.*]] = extractelement <4 x float> [[TMP24]], i32 3
; VPLAN-NEXT:    br label %[[BB55]]
; VPLAN:       [[TMP54]]:
; VPLAN-NEXT:    br label %[[BB8]]
; VPLAN:       [[BB55]]:
; VPLAN-NEXT:    [[TMP56]] = phi float [ [[TMP9]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ 0.000000e+00, %[[BB51]] ], [ [[TMP3]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP57]] = phi float [ [[TMP10]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ [[TMP53]], %[[BB51]] ], [ 0.000000e+00, %[[BB48]] ]
; VPLAN-NEXT:    [[TMP58]] = phi float [ [[TMP11]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ 0.000000e+00, %[[BB51]] ], [ [[TMP3]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP59]] = phi float [ [[TMP12]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ 0.000000e+00, %[[BB51]] ], [ 0.000000e+00, %[[BB48]] ]
; VPLAN-NEXT:    [[TMP60]] = phi float [ [[TMP13]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ [[TMP52]], %[[BB51]] ], [ 0.000000e+00, %[[BB48]] ]
; VPLAN-NEXT:    [[TMP61]] = phi float [ [[TMP14]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ 0.000000e+00, %[[BB51]] ], [ [[TMP9]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP62]] = phi float [ [[TMP15]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ [[TMP53]], %[[BB51]] ], [ [[TMP10]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP63]] = phi float [ [[TMP16]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ 0.000000e+00, %[[BB51]] ], [ 0.000000e+00, %[[BB48]] ]
; VPLAN-NEXT:    [[TMP64]] = phi float [ [[TMP18]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ 0.000000e+00, %[[BB51]] ], [ [[TMP3]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP65]] = phi float [ [[TMP19]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ [[TMP52]], %[[BB51]] ], [ 0.000000e+00, %[[BB48]] ]
; VPLAN-NEXT:    [[TMP66]] = phi float [ [[TMP20]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ 0.000000e+00, %[[BB51]] ], [ [[TMP49]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP67]] = phi float [ [[TMP21]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ [[TMP52]], %[[BB51]] ], [ [[TMP50]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP68]] = phi float [ [[TMP23]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ 0.000000e+00, %[[BB51]] ], [ [[TMP23]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP69]] = phi float [ [[TMP22]], %[[BB27]] ], [ 0.000000e+00, %[[BB25]] ], [ 0.000000e+00, %[[BB8]] ], [ 0.000000e+00, %[[BB51]] ], [ [[TMP22]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP70:%.*]] = phi <4 x float> [ [[TMP24]], %[[BB27]] ], [ [[TMP24]], %[[BB25]] ], [ zeroinitializer, %[[BB8]] ], [ [[TMP32]], %[[BB51]] ], [ [[TMP32]], %[[BB48]] ]
; VPLAN-NEXT:    [[TMP71:%.*]] = tail call float @llvm.fmuladd.f32(float [[TMP69]], float [[TMP68]], float 0.000000e+00)
; VPLAN-NEXT:    store float [[TMP71]], ptr [[TMP0]], align 4
