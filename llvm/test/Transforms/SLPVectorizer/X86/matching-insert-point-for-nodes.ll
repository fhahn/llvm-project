...
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -S -slp-threshold=-99999 -mtriple=x86_64-unknown-linux-gnu < %s | FileCheck %s --check-prefix=VPLAN
...
; VPLAN:       [[BB1]]:
; VPLAN-NEXT:    [[TMP0:%.*]] = phi <2 x i32> [ [[TMP14:%.*]], %[[BB24:.*]] ], [ zeroinitializer, %[[BB]] ]
; VPLAN-NEXT:    [[TMP1:%.*]] = phi <4 x i32> [ [[TMP13:%.*]], %[[BB24]] ], [ <i32 poison, i32 poison, i32 0, i32 0>, %[[BB]] ]
; VPLAN-NEXT:    [[TMP2:%.*]] = extractelement <2 x i32> [[TMP0]], i32 0
; VPLAN-NEXT:    [[TMP3:%.*]] = extractelement <2 x i32> [[TMP0]], i32 1
; VPLAN-NEXT:    br i1 false, label %[[BB4:.*]], label %[[BB11:.*]]
; VPLAN:       [[BB4]]:
; VPLAN-NEXT:    [[TMP4:%.*]] = phi <2 x double> [ zeroinitializer, %[[BB1]] ]
; VPLAN-NEXT:    [[TMP5:%.*]] = phi <4 x i32> [ [[TMP1]], %[[BB1]] ]
; VPLAN-NEXT:    br label %[[BB19:.*]]
; VPLAN:       [[BB11]]:
; VPLAN-NEXT:    br i1 false, label %[[BB12:.*]], label %[[BB16:.*]]
; VPLAN:       [[BB12]]:
; VPLAN-NEXT:    [[OR:%.*]] = or i32 0, [[TMP2]]
; VPLAN-NEXT:    [[TMP6:%.*]] = insertelement <2 x i32> poison, i32 [[OR]], i32 0
; VPLAN-NEXT:    [[TMP7:%.*]] = insertelement <2 x i32> [[TMP6]], i32 [[TMP3]], i32 1
; VPLAN-NEXT:    br label %[[BB13:.*]]
; VPLAN:       [[BB13]]:
; VPLAN-NEXT:    [[TMP8:%.*]] = phi <2 x i32> [ [[TMP7]], %[[BB12]] ]
; VPLAN-NEXT:    br label %[[BB16]]
; VPLAN:       [[BB16]]:
; VPLAN-NEXT:    [[TMP9:%.*]] = phi <2 x i32> [ zeroinitializer, %[[BB11]] ], [ [[TMP8]], %[[BB13]] ]
; VPLAN-NEXT:    [[TMP10:%.*]] = extractelement <2 x i32> [[TMP9]], i32 0
; VPLAN-NEXT:    [[TMP11:%.*]] = extractelement <2 x i32> [[TMP9]], i32 1
; VPLAN-NEXT:    br label %[[BB19]]
; VPLAN:       [[BB19]]:
; VPLAN-NEXT:    [[PHI20:%.*]] = phi i32 [ 0, %[[BB4]] ], [ [[TMP11]], %[[BB16]] ]
; VPLAN-NEXT:    [[PHI21:%.*]] = phi i32 [ 0, %[[BB4]] ], [ [[TMP10]], %[[BB16]] ]
; VPLAN-NEXT:    [[PHI22:%.*]] = phi double [ 0.000000e+00, %[[BB4]] ], [ 0.000000e+00, %[[BB16]] ]
; VPLAN-NEXT:    [[OR23:%.*]] = or i32 [[PHI21]], 0
; VPLAN-NEXT:    br label %[[BB24]]
; VPLAN:       [[BB24]]:
; VPLAN-NEXT:    [[LSHR:%.*]] = lshr i32 [[PHI20]], 0
; VPLAN-NEXT:    [[AND:%.*]] = and i32 [[LSHR]], 0
; VPLAN-NEXT:    [[LSHR25:%.*]] = lshr i32 [[TMP3]], [[AND]]
; VPLAN-NEXT:    [[OR26:%.*]] = or i32 0, [[OR23]]
; VPLAN-NEXT:    [[TMP12:%.*]] = insertelement <4 x i32> poison, i32 [[OR26]], i32 2
; VPLAN-NEXT:    [[TMP13]] = insertelement <4 x i32> [[TMP12]], i32 [[LSHR25]], i32 3
; VPLAN-NEXT:    [[TMP14]] = insertelement <2 x i32> <i32 0, i32 poison>, i32 [[LSHR25]], i32 1
; VPLAN-NEXT:    br label %[[BB1]]
;
bb:
  br label %bb1
