...
; RUN: opt -slp-use-vplan-codegen -S -mtriple=x86_64-pc-linux-gnu -mcpu=generic -passes=slp-vectorizer --slp-max-reg-size=256 -pass-remarks-output=%t < %s | FileCheck %s
