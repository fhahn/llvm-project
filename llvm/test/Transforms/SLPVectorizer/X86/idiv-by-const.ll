...
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mcpu=x86-64 | FileCheck %s --check-prefixes=SSE
; RUN: opt -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mcpu=x86-64-v2 | FileCheck %s --check-prefixes=SSE
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mcpu=x86-64-v2 | FileCheck %s --check-prefixes=SSE
; RUN: opt -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mcpu=x86-64-v3 | FileCheck %s --check-prefix=AVX2
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mcpu=x86-64-v3 | FileCheck %s --check-prefix=AVX2
; RUN: opt -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mattr=+avx512f | FileCheck %s --check-prefix=AVX512F
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mattr=+avx512f | FileCheck %s --check-prefix=AVX512F
; RUN: opt -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mattr=+avx512f,+avx512dq | FileCheck %s --check-prefix=AVX512DQ
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mattr=+avx512f,+avx512dq | FileCheck %s --check-prefix=AVX512DQ
...
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -S < %s -mtriple=x86_64-- -mattr=+avx512f,+avx512dq,+avx512vl,+prefer-256-bit | FileCheck %s --check-prefix=AVX512DQ256
