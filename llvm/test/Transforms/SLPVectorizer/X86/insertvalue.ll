...
; RUN: opt < %s -passes=slp-vectorizer -S -mtriple=x86_64-unknown-linux-gnu -mcpu=corei7-avx | FileCheck --check-prefixes=CHECK,LEGACY %s
; RUN: opt -slp-use-vplan-codegen < %s -passes=slp-vectorizer -S -mtriple=x86_64-unknown-linux-gnu -mcpu=corei7-avx | FileCheck --check-prefixes=CHECK,VPLAN %s

define void @julia_2xdouble(ptr sret([2 x double]), ptr, ptr, ptr) {
; LEGACY-LABEL: @julia_2xdouble(
; LEGACY-NEXT:  top:
; LEGACY-NEXT:    [[TMP4:%.*]] = load <2 x double>, ptr [[TMP2:%.*]], align 4
; LEGACY-NEXT:    [[TMP5:%.*]] = load <2 x double>, ptr [[TMP3:%.*]], align 4
; LEGACY-NEXT:    [[TMP6:%.*]] = fmul <2 x double> [[TMP4]], [[TMP5]]
; LEGACY-NEXT:    [[TMP7:%.*]] = load <2 x double>, ptr [[TMP1:%.*]], align 4
; LEGACY-NEXT:    [[TMP8:%.*]] = fadd <2 x double> [[TMP6]], [[TMP7]]
; LEGACY-NEXT:    [[TMP9:%.*]] = extractelement <2 x double> [[TMP8]], i32 0
; LEGACY-NEXT:    [[I0:%.*]] = insertvalue [2 x double] undef, double [[TMP9]], 0
; LEGACY-NEXT:    [[TMP10:%.*]] = extractelement <2 x double> [[TMP8]], i32 1
; LEGACY-NEXT:    [[I1:%.*]] = insertvalue [2 x double] [[I0]], double [[TMP10]], 1
; LEGACY-NEXT:    store [2 x double] [[I1]], ptr [[TMP0:%.*]], align 4
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @julia_2xdouble(
; VPLAN-NEXT:  top:
; VPLAN-NEXT:    [[TMP4:%.*]] = load <2 x double>, ptr [[TMP2:%.*]], align 4
; VPLAN-NEXT:    [[TMP5:%.*]] = load <2 x double>, ptr [[TMP3:%.*]], align 4
; VPLAN-NEXT:    [[TMP6:%.*]] = fmul <2 x double> [[TMP4]], [[TMP5]]
; VPLAN-NEXT:    [[TMP7:%.*]] = load <2 x double>, ptr [[TMP1:%.*]], align 4
; VPLAN-NEXT:    [[TMP8:%.*]] = fadd <2 x double> [[TMP6]], [[TMP7]]
; VPLAN-NEXT:    [[TMP9:%.*]] = extractelement <2 x double> [[TMP8]], i32 0
; VPLAN-NEXT:    [[I0:%.*]] = insertvalue [2 x double] undef, double [[TMP9]], 0
; VPLAN-NEXT:    [[TMP10:%.*]] = extractelement <2 x double> [[TMP8]], i32 1
; VPLAN-NEXT:    [[I1:%.*]] = insertvalue [2 x double] [[I0]], double [[TMP10]], 1
; VPLAN-NEXT:    store [2 x double] [[I1]], ptr [[TMP0:%.*]], align 4
; VPLAN-NEXT:    ret void
;
top:
...
; LEGACY-LABEL: @julia_4xfloat(
; LEGACY-NEXT:  top:
; LEGACY-NEXT:    [[TMP4:%.*]] = load <4 x float>, ptr [[TMP2:%.*]], align 4
; LEGACY-NEXT:    [[TMP5:%.*]] = load <4 x float>, ptr [[TMP3:%.*]], align 4
; LEGACY-NEXT:    [[TMP6:%.*]] = fmul <4 x float> [[TMP4]], [[TMP5]]
; LEGACY-NEXT:    [[TMP7:%.*]] = load <4 x float>, ptr [[TMP1:%.*]], align 4
; LEGACY-NEXT:    [[TMP8:%.*]] = fadd <4 x float> [[TMP6]], [[TMP7]]
; LEGACY-NEXT:    [[TMP9:%.*]] = extractelement <4 x float> [[TMP8]], i32 0
; LEGACY-NEXT:    [[I0:%.*]] = insertvalue [4 x float] undef, float [[TMP9]], 0
; LEGACY-NEXT:    [[TMP10:%.*]] = extractelement <4 x float> [[TMP8]], i32 1
; LEGACY-NEXT:    [[I1:%.*]] = insertvalue [4 x float] [[I0]], float [[TMP10]], 1
; LEGACY-NEXT:    [[TMP11:%.*]] = extractelement <4 x float> [[TMP8]], i32 2
; LEGACY-NEXT:    [[I2:%.*]] = insertvalue [4 x float] [[I1]], float [[TMP11]], 2
; LEGACY-NEXT:    [[TMP12:%.*]] = extractelement <4 x float> [[TMP8]], i32 3
; LEGACY-NEXT:    [[I3:%.*]] = insertvalue [4 x float] [[I2]], float [[TMP12]], 3
; LEGACY-NEXT:    store [4 x float] [[I3]], ptr [[TMP0:%.*]], align 4
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @julia_4xfloat(
; VPLAN-NEXT:  top:
; VPLAN-NEXT:    [[TMP4:%.*]] = load <4 x float>, ptr [[TMP2:%.*]], align 4
; VPLAN-NEXT:    [[TMP5:%.*]] = load <4 x float>, ptr [[TMP3:%.*]], align 4
; VPLAN-NEXT:    [[TMP6:%.*]] = fmul <4 x float> [[TMP4]], [[TMP5]]
; VPLAN-NEXT:    [[TMP7:%.*]] = load <4 x float>, ptr [[TMP1:%.*]], align 4
; VPLAN-NEXT:    [[TMP8:%.*]] = fadd <4 x float> [[TMP6]], [[TMP7]]
; VPLAN-NEXT:    [[TMP9:%.*]] = extractelement <4 x float> [[TMP8]], i32 0
; VPLAN-NEXT:    [[I0:%.*]] = insertvalue [4 x float] undef, float [[TMP9]], 0
; VPLAN-NEXT:    [[TMP10:%.*]] = extractelement <4 x float> [[TMP8]], i32 1
; VPLAN-NEXT:    [[I1:%.*]] = insertvalue [4 x float] [[I0]], float [[TMP10]], 1
; VPLAN-NEXT:    [[TMP11:%.*]] = extractelement <4 x float> [[TMP8]], i32 2
; VPLAN-NEXT:    [[I2:%.*]] = insertvalue [4 x float] [[I1]], float [[TMP11]], 2
; VPLAN-NEXT:    [[TMP12:%.*]] = extractelement <4 x float> [[TMP8]], i32 3
; VPLAN-NEXT:    [[I3:%.*]] = insertvalue [4 x float] [[I2]], float [[TMP12]], 3
; VPLAN-NEXT:    store [4 x float] [[I3]], ptr [[TMP0:%.*]], align 4
; VPLAN-NEXT:    ret void
;
top:
