...
; RUN: opt < %s -passes=slp-vectorizer -slp-use-vplan-codegen -S -slp-schedule-budget=3 -mtriple=x86_64-apple-macosx10.8.0 -mcpu=corei7-avx | FileCheck %s -check-prefix VPLAN
; RUN: opt < %s -strip-debug -passes=slp-vectorizer -slp-use-vplan-codegen -S -slp-schedule-budget=3 -mtriple=x86_64-apple-macosx10.8.0 -mcpu=corei7-avx | FileCheck %s -check-prefix VPLAN
