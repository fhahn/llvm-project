...
; RUN: opt -slp-use-vplan-codegen -S --passes=slp-vectorizer -mtriple=x86_64-unknown-linux-gnu -mcpu=icelake-server -slp-threshold=-5 < %s | FileCheck %s --check-prefix=VPLAN
...
; CHECK-NEXT:    [[OP_RDX1:%.*]] = add i32 [[OP_RDX]], [[CONV635]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <4 x i32> [[TMP8]], i32 [[OP_RDX1]], i32 3
...
; CHECK-NEXT:    [[TMP13:%.*]] = lshr <4 x i32> [[TMP12]], <i32 1, i32 2, i32 1, i32 1>
; CHECK-NEXT:    [[TMP14:%.*]] = trunc <4 x i32> [[TMP13]] to <4 x i16>
; CHECK-NEXT:    store <4 x i16> [[TMP14]], ptr [[ARRAYIDX590]], align 2
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: define void @intrapred_luma(
; VPLAN-SAME: ptr [[TMP0:%.*]], i16 [[TMP1:%.*]], i32 [[CONV593:%.*]]) #[[ATTR0:[0-9]+]] {
; VPLAN-NEXT:  [[ENTRY:.*:]]
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <2 x i16> poison, i16 [[TMP1]], i32 0
; VPLAN-NEXT:    [[TMP3:%.*]] = shufflevector <2 x i16> [[TMP2]], <2 x i16> poison, <2 x i32> zeroinitializer
; VPLAN-NEXT:    [[TMP4:%.*]] = zext <2 x i16> [[TMP3]] to <2 x i32>
; VPLAN-NEXT:    [[TMP5:%.*]] = extractelement <2 x i32> [[TMP4]], i32 0
; VPLAN-NEXT:    [[ADD596:%.*]] = add i32 [[TMP5]], 1
; VPLAN-NEXT:    [[DOTPRE:%.*]] = load ptr, ptr [[TMP0]], align 8
; VPLAN-NEXT:    [[ARRAYIDX590:%.*]] = getelementptr i8, ptr [[DOTPRE]], i64 4304
; VPLAN-NEXT:    [[TMP6:%.*]] = shl <2 x i32> [[TMP4]], <i32 1, i32 0>
; VPLAN-NEXT:    [[CONV635:%.*]] = zext i16 [[TMP1]] to i32
; VPLAN-NEXT:    [[OP_RDX:%.*]] = add i32 2, [[CONV593]]
; VPLAN-NEXT:    [[OP_RDX1:%.*]] = add i32 [[OP_RDX]], [[CONV635]]
; VPLAN-NEXT:    [[TMP7:%.*]] = insertelement <4 x i32> poison, i32 [[ADD596]], i32 0
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <2 x i32> [[TMP6]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; VPLAN-NEXT:    [[TMP9:%.*]] = shufflevector <4 x i32> [[TMP7]], <4 x i32> [[TMP8]], <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
; VPLAN-NEXT:    [[TMP10:%.*]] = insertelement <4 x i32> [[TMP9]], i32 [[OP_RDX1]], i32 3
; VPLAN-NEXT:    [[TMP11:%.*]] = insertelement <4 x i32> <i32 poison, i32 0, i32 poison, i32 poison>, i32 [[CONV593]], i32 0
; VPLAN-NEXT:    [[TMP12:%.*]] = shufflevector <4 x i32> [[TMP11]], <4 x i32> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
; VPLAN-NEXT:    [[TMP13:%.*]] = or <4 x i32> [[TMP10]], [[TMP12]]
; VPLAN-NEXT:    [[TMP14:%.*]] = lshr <4 x i32> [[TMP13]], <i32 1, i32 2, i32 1, i32 1>
; VPLAN-NEXT:    [[TMP15:%.*]] = trunc <4 x i32> [[TMP14]] to <4 x i16>
; VPLAN-NEXT:    store <4 x i16> [[TMP15]], ptr [[ARRAYIDX590]], align 2
; VPLAN-NEXT:    ret void
;
entry:
