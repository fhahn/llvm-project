...
; RUN: opt -slp-use-vplan-codegen < %s -passes=slp-vectorizer,dce -S -mtriple=x86_64-apple-macosx10.8.0 -mcpu=corei7-avx | FileCheck --check-prefix=VPLAN %s
...
; VPLAN-NEXT:    [[INTREEUSER:%.*]] = fadd double [[TMP4]], [[TMP4]]
; VPLAN-NEXT:    [[TMP7:%.*]] = extractelement <2 x double> [[TMP3]], i32 0
; VPLAN-NEXT:    [[TMP5:%.*]] = extractelement <2 x double> [[TMP3]], i32 1
; VPLAN-NEXT:    [[CMP11:%.*]] = fcmp ogt double [[TMP7]], [[TMP5]]
...
; VPLAN:       for.end:
; VPLAN-NEXT:    store double [[INTREEUSER]], ptr [[A]], align 8
; VPLAN-NEXT:    ret void
;
entry:
