...
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -slp-vectorize-non-power-of-2 -mtriple=x86_64-apple-macosx -S %s | FileCheck --check-prefixes=VPLAN-VPLAN,VPLAN-VPLAN-NON-POW2 %s
...
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -slp-vectorize-non-power-of-2=false -mtriple=x86_64-apple-macosx -S %s | FileCheck --check-prefixes=VPLAN-VPLAN,VPLAN-VPLAN-POW2-ONLY %s
...
; CHECK-NEXT:    ret void
;
; VPLAN-VPLAN-LABEL: @v3_load_i32_mul_by_constant_store(
...
; VPLAN-VPLAN-NEXT:    [[MUL_0:%.*]] = mul nsw i32 [[L_SRC_0]], 10
...
; VPLAN-VPLAN-NEXT:    [[MUL_1:%.*]] = mul nsw i32 [[L_SRC_1]], 10
...
; VPLAN-VPLAN-NEXT:    [[MUL_2:%.*]] = mul nsw i32 [[L_SRC_2]], 10
...
; CHECK-NEXT:    ret void
;
; VPLAN-VPLAN-LABEL: @v3_load_i32_mul_store(
; VPLAN-VPLAN-NEXT:  entry:
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_1_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_1:%.*]], i32 0
; VPLAN-VPLAN-NEXT:    [[L_SRC_1_0:%.*]] = load i32, ptr [[GEP_SRC_1_0]], align 4
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_2_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_2:%.*]], i32 0
; VPLAN-VPLAN-NEXT:    [[L_SRC_2_0:%.*]] = load i32, ptr [[GEP_SRC_2_0]], align 4
; VPLAN-VPLAN-NEXT:    [[MUL_0:%.*]] = mul nsw i32 [[L_SRC_1_0]], [[L_SRC_2_0]]
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_1_1:%.*]] = getelementptr inbounds i32, ptr [[SRC_1]], i32 1
; VPLAN-VPLAN-NEXT:    [[L_SRC_1_1:%.*]] = load i32, ptr [[GEP_SRC_1_1]], align 4
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_2_1:%.*]] = getelementptr inbounds i32, ptr [[SRC_2]], i32 1
; VPLAN-VPLAN-NEXT:    [[L_SRC_2_1:%.*]] = load i32, ptr [[GEP_SRC_2_1]], align 4
; VPLAN-VPLAN-NEXT:    [[MUL_1:%.*]] = mul nsw i32 [[L_SRC_1_1]], [[L_SRC_2_1]]
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_1_2:%.*]] = getelementptr inbounds i32, ptr [[SRC_1]], i32 2
; VPLAN-VPLAN-NEXT:    [[L_SRC_1_2:%.*]] = load i32, ptr [[GEP_SRC_1_2]], align 4
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_2_2:%.*]] = getelementptr inbounds i32, ptr [[SRC_2]], i32 2
; VPLAN-VPLAN-NEXT:    [[L_SRC_2_2:%.*]] = load i32, ptr [[GEP_SRC_2_2]], align 4
; VPLAN-VPLAN-NEXT:    [[MUL_2:%.*]] = mul nsw i32 [[L_SRC_1_2]], [[L_SRC_2_2]]
; VPLAN-VPLAN-NEXT:    store i32 [[MUL_0]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-NEXT:    [[DST_1:%.*]] = getelementptr i32, ptr [[DST]], i32 1
; VPLAN-VPLAN-NEXT:    store i32 [[MUL_1]], ptr [[DST_1]], align 4
; VPLAN-VPLAN-NEXT:    [[DST_2:%.*]] = getelementptr i32, ptr [[DST]], i32 2
...
; CHECK-NEXT:    ret void
;
; VPLAN-VPLAN-LABEL: @v3_load_i32_mul_add_const_store(
; VPLAN-VPLAN-NEXT:  entry:
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_1_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_1:%.*]], i32 0
; VPLAN-VPLAN-NEXT:    [[L_SRC_1_0:%.*]] = load i32, ptr [[GEP_SRC_1_0]], align 4
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_2_0:%.*]] = getelementptr inbounds i32, ptr [[SRC_2:%.*]], i32 0
; VPLAN-VPLAN-NEXT:    [[L_SRC_2_0:%.*]] = load i32, ptr [[GEP_SRC_2_0]], align 4
; VPLAN-VPLAN-NEXT:    [[MUL_0:%.*]] = mul nsw i32 [[L_SRC_1_0]], [[L_SRC_2_0]]
; VPLAN-VPLAN-NEXT:    [[ADD_0:%.*]] = add i32 [[MUL_0]], 9
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_1_1:%.*]] = getelementptr inbounds i32, ptr [[SRC_1]], i32 1
; VPLAN-VPLAN-NEXT:    [[L_SRC_1_1:%.*]] = load i32, ptr [[GEP_SRC_1_1]], align 4
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_2_1:%.*]] = getelementptr inbounds i32, ptr [[SRC_2]], i32 1
; VPLAN-VPLAN-NEXT:    [[L_SRC_2_1:%.*]] = load i32, ptr [[GEP_SRC_2_1]], align 4
; VPLAN-VPLAN-NEXT:    [[MUL_1:%.*]] = mul nsw i32 [[L_SRC_1_1]], [[L_SRC_2_1]]
; VPLAN-VPLAN-NEXT:    [[ADD_1:%.*]] = add i32 [[MUL_1]], 9
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_1_2:%.*]] = getelementptr inbounds i32, ptr [[SRC_1]], i32 2
; VPLAN-VPLAN-NEXT:    [[L_SRC_1_2:%.*]] = load i32, ptr [[GEP_SRC_1_2]], align 4
; VPLAN-VPLAN-NEXT:    [[GEP_SRC_2_2:%.*]] = getelementptr inbounds i32, ptr [[SRC_2]], i32 2
; VPLAN-VPLAN-NEXT:    [[L_SRC_2_2:%.*]] = load i32, ptr [[GEP_SRC_2_2]], align 4
; VPLAN-VPLAN-NEXT:    [[MUL_2:%.*]] = mul nsw i32 [[L_SRC_1_2]], [[L_SRC_2_2]]
; VPLAN-VPLAN-NEXT:    [[ADD_2:%.*]] = add i32 [[MUL_2]], 9
; VPLAN-VPLAN-NEXT:    store i32 [[ADD_0]], ptr [[DST:%.*]], align 4
; VPLAN-VPLAN-NEXT:    [[DST_1:%.*]] = getelementptr i32, ptr [[DST]], i32 1
; VPLAN-VPLAN-NEXT:    store i32 [[ADD_1]], ptr [[DST_1]], align 4
; VPLAN-VPLAN-NEXT:    [[DST_2:%.*]] = getelementptr i32, ptr [[DST]], i32 2
; VPLAN-VPLAN-NEXT:    store i32 [[ADD_2]], ptr [[DST_2]], align 4
; VPLAN-VPLAN-NEXT:    ret void
;
entry:
  %gep.src.1.0 = getelementptr inbounds i32, ptr %src.1, i32 0
...
; CHECK-NEXT:    ret void
;
; VPLAN-VPLAN-LABEL: @phi_store3(
; VPLAN-VPLAN-NEXT:  entry:
; VPLAN-VPLAN-NEXT:    br label [[EXIT:%.*]]
; VPLAN-VPLAN:       invoke.cont8.loopexit:
; VPLAN-VPLAN-NEXT:    br label [[EXIT]]
; VPLAN-VPLAN:       exit:
; VPLAN-VPLAN-NEXT:    [[P_2:%.*]] = phi i32 [ 3, [[ENTRY:%.*]] ], [ 0, [[INVOKE_CONT8_LOOPEXIT:%.*]] ]
; VPLAN-VPLAN-NEXT:    [[TMP0:%.*]] = phi <2 x i32> [ <i32 1, i32 2>, [[ENTRY]] ], [ poison, [[INVOKE_CONT8_LOOPEXIT]] ]
; VPLAN-VPLAN-NEXT:    [[DST_2:%.*]] = getelementptr i32, ptr [[DST:%.*]], i32 2
; VPLAN-VPLAN-NEXT:    store <2 x i32> [[TMP0]], ptr [[DST]], align 4
; VPLAN-VPLAN-NEXT:    store i32 [[P_2]], ptr [[DST_2]], align 4
; VPLAN-VPLAN-NEXT:    ret void
;
entry:
  br label %exit
