...
; RUN: opt -S -passes=slp-vectorizer -slp-use-vplan-codegen -mattr=+sse  < %s | FileCheck %s --check-prefixes=CHECK,SSE
; RUN: opt -S -passes=slp-vectorizer -slp-use-vplan-codegen -mattr=+avx512f < %s | FileCheck %s --check-prefixes=CHECK,AVX512
