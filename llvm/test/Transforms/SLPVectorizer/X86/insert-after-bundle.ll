...
; RUN: opt -S -passes=slp-vectorizer -slp-use-vplan-codegen -mattr=+sse  < %s | FileCheck %s --check-prefixes=VPLAN-VPLAN,VPLAN-VPLAN-SSE
; RUN: opt -S -passes=slp-vectorizer -slp-use-vplan-codegen -mattr=+avx512f < %s | FileCheck %s --check-prefixes=VPLAN-VPLAN,VPLAN-VPLAN-AVX512
...
;
; VPLAN-VPLAN-LABEL: @foo(
; VPLAN-VPLAN-NEXT:  entry:
; VPLAN-VPLAN-NEXT:    [[CMP:%.*]] = icmp slt i32 [[X:%.*]], [[Y:%.*]]
; VPLAN-VPLAN-NEXT:    [[B_A:%.*]] = select i1 [[CMP]], i32 [[B:%.*]], i32 [[A:%.*]]
; VPLAN-VPLAN-NEXT:    [[RETVAL_0:%.*]] = trunc i32 [[B_A]] to i8
; VPLAN-VPLAN-NEXT:    ret i8 [[RETVAL_0]]
;
entry:
...
; CHECK-NEXT:    ret void
;
; VPLAN-VPLAN-LABEL: @bar(
; VPLAN-VPLAN-NEXT:  entry:
; VPLAN-VPLAN-NEXT:    br label [[FOR_BODY:%.*]]
; VPLAN-VPLAN:       for.body:
; VPLAN-VPLAN-NEXT:    [[I_0356:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[INC:%.*]], [[FOR_BODY]] ]
; VPLAN-VPLAN-NEXT:    [[A_ADDR_0355:%.*]] = phi ptr [ [[A:%.*]], [[ENTRY]] ], [ [[ADD_PTR:%.*]], [[FOR_BODY]] ]
; VPLAN-VPLAN-NEXT:    [[E_ADDR_0354:%.*]] = phi ptr [ [[E:%.*]], [[ENTRY]] ], [ [[ADD_PTR192:%.*]], [[FOR_BODY]] ]
; VPLAN-VPLAN-NEXT:    [[D_ADDR_0353:%.*]] = phi ptr [ [[D:%.*]], [[ENTRY]] ], [ [[ADD_PTR191:%.*]], [[FOR_BODY]] ]
; VPLAN-VPLAN-NEXT:    [[C_ADDR_0352:%.*]] = phi ptr [ [[C:%.*]], [[ENTRY]] ], [ [[ADD_PTR190:%.*]], [[FOR_BODY]] ]
; VPLAN-VPLAN-NEXT:    [[B_ADDR_0351:%.*]] = phi ptr [ [[B:%.*]], [[ENTRY]] ], [ [[ADD_PTR189:%.*]], [[FOR_BODY]] ]
; VPLAN-VPLAN-NEXT:    [[WIDE_LOAD:%.*]] = load <16 x i8>, ptr [[C_ADDR_0352]], align 1
; VPLAN-VPLAN-NEXT:    [[WIDE_LOAD1:%.*]] = load <16 x i8>, ptr [[D_ADDR_0353]], align 1
; VPLAN-VPLAN-NEXT:    [[WIDE_LOAD2:%.*]] = load <16 x i8>, ptr [[A_ADDR_0355]], align 1
; VPLAN-VPLAN-NEXT:    [[WIDE_LOAD3:%.*]] = load <16 x i8>, ptr [[B_ADDR_0351]], align 1
; VPLAN-VPLAN-NEXT:    [[TMP0:%.*]] = icmp ult <16 x i8> [[WIDE_LOAD]], [[WIDE_LOAD1]]
; VPLAN-VPLAN-NEXT:    [[TMP1:%.*]] = select <16 x i1> [[TMP0]], <16 x i8> [[WIDE_LOAD3]], <16 x i8> [[WIDE_LOAD2]]
; VPLAN-VPLAN-NEXT:    [[TMP2:%.*]] = zext <16 x i8> [[TMP1]] to <16 x i32>
; VPLAN-VPLAN-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <16 x i32> poison, i32 [[W:%.*]], i32 0
; VPLAN-VPLAN-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <16 x i32> [[BROADCAST_SPLATINSERT]], <16 x i32> poison, <16 x i32> zeroinitializer
; VPLAN-VPLAN-NEXT:    [[TMP3:%.*]] = mul <16 x i32> [[TMP2]], [[BROADCAST_SPLAT]]
; VPLAN-VPLAN-NEXT:    [[TMP4:%.*]] = trunc <16 x i32> [[TMP3]] to <16 x i8>
; VPLAN-VPLAN-NEXT:    store <16 x i8> [[TMP4]], ptr [[E_ADDR_0354]], align 1
; VPLAN-VPLAN-NEXT:    [[INC]] = add nuw nsw i32 [[I_0356]], 1
; VPLAN-VPLAN-NEXT:    [[ADD_PTR]] = getelementptr inbounds i8, ptr [[A_ADDR_0355]], i64 16
; VPLAN-VPLAN-NEXT:    [[ADD_PTR189]] = getelementptr inbounds i8, ptr [[B_ADDR_0351]], i64 16
; VPLAN-VPLAN-NEXT:    [[ADD_PTR190]] = getelementptr inbounds i8, ptr [[C_ADDR_0352]], i64 16
; VPLAN-VPLAN-NEXT:    [[ADD_PTR191]] = getelementptr inbounds i8, ptr [[D_ADDR_0353]], i64 16
; VPLAN-VPLAN-NEXT:    [[ADD_PTR192]] = getelementptr inbounds i8, ptr [[E_ADDR_0354]], i64 16
; VPLAN-VPLAN-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[INC]], 8
; VPLAN-VPLAN-NEXT:    br i1 [[EXITCOND]], label [[FOR_END:%.*]], label [[FOR_BODY]]
; VPLAN-VPLAN:       for.end:
; VPLAN-VPLAN-NEXT:    ret void
;
entry:
  br label %for.body
...
;
; VPLAN-VPLAN-SSE-LABEL: @foo1(
; VPLAN-VPLAN-SSE-NEXT:  entry:
; VPLAN-VPLAN-SSE-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr @ib, align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP1:%.*]] = xor <4 x i32> [[TMP0]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP1]], ptr @ia, align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP2:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 4), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP3:%.*]] = xor <4 x i32> [[TMP2]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP3]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 4), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP4:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 8), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP5:%.*]] = xor <4 x i32> [[TMP4]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP5]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 8), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP6:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 12), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP7:%.*]] = xor <4 x i32> [[TMP6]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP7]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 12), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP8:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 16), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP9:%.*]] = xor <4 x i32> [[TMP8]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP9]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 16), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP10:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 20), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP11:%.*]] = xor <4 x i32> [[TMP10]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP11]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 20), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP12:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 24), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP13:%.*]] = xor <4 x i32> [[TMP12]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP13]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 24), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP14:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 28), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP15:%.*]] = xor <4 x i32> [[TMP14]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP15]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 28), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP16:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 32), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP17:%.*]] = xor <4 x i32> [[TMP16]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP17]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 32), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP18:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 36), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP19:%.*]] = xor <4 x i32> [[TMP18]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP19]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 36), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP20:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 40), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP21:%.*]] = xor <4 x i32> [[TMP20]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP21]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 40), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP22:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 44), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP23:%.*]] = xor <4 x i32> [[TMP22]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP23]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 44), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP24:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 48), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP25:%.*]] = xor <4 x i32> [[TMP24]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP25]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 48), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP26:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 52), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP27:%.*]] = xor <4 x i32> [[TMP26]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP27]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 52), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP28:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 56), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP29:%.*]] = xor <4 x i32> [[TMP28]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP29]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 56), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP30:%.*]] = load <4 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 60), align 16
; VPLAN-VPLAN-SSE-NEXT:    [[TMP31:%.*]] = xor <4 x i32> [[TMP30]], splat (i32 -1)
; VPLAN-VPLAN-SSE-NEXT:    store <4 x i32> [[TMP31]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 60), align 16
; VPLAN-VPLAN-SSE-NEXT:    br label [[FOR_BODY5:%.*]]
; VPLAN-VPLAN-SSE:       for.cond3:
; VPLAN-VPLAN-SSE-NEXT:    [[INDVARS_IV_NEXT:%.*]] = add nuw nsw i64 [[INDVARS_IV:%.*]], 1
; VPLAN-VPLAN-SSE-NEXT:    [[CMP4:%.*]] = icmp ult i64 [[INDVARS_IV]], 63
; VPLAN-VPLAN-SSE-NEXT:    br i1 [[CMP4]], label [[FOR_BODY5]], label [[FOR_END14:%.*]]
; VPLAN-VPLAN-SSE:       for.body5:
; VPLAN-VPLAN-SSE-NEXT:    [[INDVARS_IV]] = phi i64 [ 0, [[ENTRY:%.*]] ], [ [[INDVARS_IV_NEXT]], [[FOR_COND3:%.*]] ]
; VPLAN-VPLAN-SSE-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds [64 x i32], ptr @ia, i64 0, i64 [[INDVARS_IV]]
; VPLAN-VPLAN-SSE-NEXT:    [[TMP32:%.*]] = load i32, ptr [[ARRAYIDX7]], align 4
; VPLAN-VPLAN-SSE-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds [64 x i32], ptr @ib, i64 0, i64 [[INDVARS_IV]]
; VPLAN-VPLAN-SSE-NEXT:    [[TMP33:%.*]] = load i32, ptr [[ARRAYIDX9]], align 4
; VPLAN-VPLAN-SSE-NEXT:    [[NEG10:%.*]] = xor i32 [[TMP33]], -1
; VPLAN-VPLAN-SSE-NEXT:    [[CMP11:%.*]] = icmp eq i32 [[TMP32]], [[NEG10]]
; VPLAN-VPLAN-SSE-NEXT:    br i1 [[CMP11]], label [[FOR_COND3]], label [[IF_THEN:%.*]]
; VPLAN-VPLAN-SSE:       if.then:
; VPLAN-VPLAN-SSE-NEXT:    tail call void @abort()
; VPLAN-VPLAN-SSE-NEXT:    unreachable
; VPLAN-VPLAN-SSE:       for.end14:
; VPLAN-VPLAN-SSE-NEXT:    ret i32 0
;
; VPLAN-VPLAN-AVX512-LABEL: @foo1(
; VPLAN-VPLAN-AVX512-NEXT:  entry:
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP0:%.*]] = load <16 x i32>, ptr @ib, align 16
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP1:%.*]] = xor <16 x i32> [[TMP0]], splat (i32 -1)
; VPLAN-VPLAN-AVX512-NEXT:    store <16 x i32> [[TMP1]], ptr @ia, align 16
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP2:%.*]] = load <16 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 16), align 16
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP3:%.*]] = xor <16 x i32> [[TMP2]], splat (i32 -1)
; VPLAN-VPLAN-AVX512-NEXT:    store <16 x i32> [[TMP3]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 16), align 16
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP4:%.*]] = load <16 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 32), align 16
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP5:%.*]] = xor <16 x i32> [[TMP4]], splat (i32 -1)
; VPLAN-VPLAN-AVX512-NEXT:    store <16 x i32> [[TMP5]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 32), align 16
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP6:%.*]] = load <16 x i32>, ptr getelementptr inbounds ([64 x i32], ptr @ib, i64 0, i64 48), align 16
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP7:%.*]] = xor <16 x i32> [[TMP6]], splat (i32 -1)
; VPLAN-VPLAN-AVX512-NEXT:    store <16 x i32> [[TMP7]], ptr getelementptr inbounds ([64 x i32], ptr @ia, i64 0, i64 48), align 16
; VPLAN-VPLAN-AVX512-NEXT:    br label [[FOR_BODY5:%.*]]
; VPLAN-VPLAN-AVX512:       for.cond3:
; VPLAN-VPLAN-AVX512-NEXT:    [[INDVARS_IV_NEXT:%.*]] = add nuw nsw i64 [[INDVARS_IV:%.*]], 1
; VPLAN-VPLAN-AVX512-NEXT:    [[CMP4:%.*]] = icmp ult i64 [[INDVARS_IV]], 63
; VPLAN-VPLAN-AVX512-NEXT:    br i1 [[CMP4]], label [[FOR_BODY5]], label [[FOR_END14:%.*]]
; VPLAN-VPLAN-AVX512:       for.body5:
; VPLAN-VPLAN-AVX512-NEXT:    [[INDVARS_IV]] = phi i64 [ 0, [[ENTRY:%.*]] ], [ [[INDVARS_IV_NEXT]], [[FOR_COND3:%.*]] ]
; VPLAN-VPLAN-AVX512-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds [64 x i32], ptr @ia, i64 0, i64 [[INDVARS_IV]]
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP8:%.*]] = load i32, ptr [[ARRAYIDX7]], align 4
; VPLAN-VPLAN-AVX512-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds [64 x i32], ptr @ib, i64 0, i64 [[INDVARS_IV]]
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP9:%.*]] = load i32, ptr [[ARRAYIDX9]], align 4
; VPLAN-VPLAN-AVX512-NEXT:    [[NEG10:%.*]] = xor i32 [[TMP9]], -1
; VPLAN-VPLAN-AVX512-NEXT:    [[CMP11:%.*]] = icmp eq i32 [[TMP8]], [[NEG10]]
; VPLAN-VPLAN-AVX512-NEXT:    br i1 [[CMP11]], label [[FOR_COND3]], label [[IF_THEN:%.*]]
; VPLAN-VPLAN-AVX512:       if.then:
; VPLAN-VPLAN-AVX512-NEXT:    tail call void @abort()
; VPLAN-VPLAN-AVX512-NEXT:    unreachable
; VPLAN-VPLAN-AVX512:       for.end14:
; VPLAN-VPLAN-AVX512-NEXT:    ret i32 0
;
entry:
