...
; CHECK-NEXT:    [[TMP3:%.*]] = shufflevector <8 x double> [[TMP2]], <8 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 0>
; CHECK-NEXT:    [[TMP4:%.*]] = fmul <8 x double> zeroinitializer, [[TMP3]]
; CHECK-NEXT:    [[TMP5:%.*]] = select <8 x i1> zeroinitializer, <8 x double> [[TMP4]], <8 x double> zeroinitializer
; CHECK-NEXT:    [[TMP6:%.*]] = fcmp olt <8 x double> [[TMP5]], zeroinitializer
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <8 x i1> [[TMP6]], i32 0
