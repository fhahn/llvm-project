...
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -slp-vectorize-non-power-of-2 -mtriple=x86_64-apple-macosx -S %s | FileCheck --check-prefixes=VPLAN,VPLAN-NON-POW2 %s
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -slp-vectorize-non-power-of-2=false -mtriple=x86_64-apple-macosx -S %s | FileCheck --check-prefixes=VPLAN,VPLAN-POW2-ONLY %s
...
; VPLAN-NEXT:    [[CONV613:%.*]] = fptrunc double [[CONV503]] to float
; VPLAN-NEXT:    store float [[CONV613]], ptr [[BBOX651]], align 8
; VPLAN-NEXT:    [[BBOX_SROA_6_0_BBOX666_SROA_IDX:%.*]] = getelementptr float, ptr [[OBJECT]], i64 1
; VPLAN-NEXT:    [[TMP12:%.*]] = insertelement <2 x double> poison, double [[TMP11]], i32 0
; VPLAN-NEXT:    [[TMP13:%.*]] = insertelement <2 x double> [[TMP12]], double [[CONV520]], i32 1
; VPLAN-NEXT:    [[TMP14:%.*]] = fptrunc <2 x double> [[TMP13]] to <2 x float>
; VPLAN-NEXT:    store <2 x float> [[TMP14]], ptr [[BBOX_SROA_6_0_BBOX666_SROA_IDX]], align 4
...
; VPLAN-NEXT:    [[TMP0:%.*]] = insertelement <2 x double> poison, double [[SUB19]], i32 0
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x double> [[TMP0]], double [[ADD]], i32 1
; VPLAN-NEXT:    [[TMP2:%.*]] = fptrunc <2 x double> [[TMP1]] to <2 x float>
; VPLAN-NEXT:    store <2 x float> [[TMP2]], ptr [[M]], align 4
...
; POW2-ONLY-NEXT:    ret void
;
; VPLAN-NON-POW2-LABEL: define void @vec3_extract(
; VPLAN-NON-POW2-SAME: <3 x i16> [[PIXEL_SROA_0_4_VEC_INSERT606:%.*]], ptr [[CALL3_I536:%.*]]) {
; VPLAN-NON-POW2-NEXT:  entry:
; VPLAN-NON-POW2-NEXT:    [[TMP2:%.*]] = shufflevector <3 x i16> [[PIXEL_SROA_0_4_VEC_INSERT606]], <3 x i16> poison, <3 x i32> <i32 0, i32 1, i32 2>
; VPLAN-NON-POW2-NEXT:    store <3 x i16> [[TMP2]], ptr [[CALL3_I536]], align 2
; VPLAN-NON-POW2-NEXT:    ret void
;
; VPLAN-POW2-ONLY-LABEL: define void @vec3_extract(
; VPLAN-POW2-ONLY-SAME: <3 x i16> [[PIXEL_SROA_0_4_VEC_INSERT606:%.*]], ptr [[CALL3_I536:%.*]]) {
; VPLAN-POW2-ONLY-NEXT:  entry:
; VPLAN-POW2-ONLY-NEXT:    [[PIXEL_SROA_0_4_VEC_EXTRACT:%.*]] = extractelement <3 x i16> [[PIXEL_SROA_0_4_VEC_INSERT606]], i64 2
; VPLAN-POW2-ONLY-NEXT:    [[RED668:%.*]] = getelementptr i16, ptr [[CALL3_I536]], i64 2
; VPLAN-POW2-ONLY-NEXT:    store i16 [[PIXEL_SROA_0_4_VEC_EXTRACT]], ptr [[RED668]], align 2
; VPLAN-POW2-ONLY-NEXT:    [[TMP1:%.*]] = shufflevector <3 x i16> [[PIXEL_SROA_0_4_VEC_INSERT606]], <3 x i16> poison, <2 x i32> <i32 0, i32 1>
; VPLAN-POW2-ONLY-NEXT:    store <2 x i16> [[TMP1]], ptr [[CALL3_I536]], align 2
; VPLAN-POW2-ONLY-NEXT:    ret void
;
entry:
