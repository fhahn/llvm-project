...
; RUN: opt -slp-use-vplan-codegen -S --passes=slp-vectorizer -mtriple=x86_64-unknown-linux < %s | FileCheck %s
...
; CHECK-NEXT:    [[TMP42:%.*]] = insertelement <16 x i1> <i1 poison, i1 false, i1 poison, i1 poison, i1 false, i1 poison, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 poison, i1 false, i1 false, i1 poison>, i1 false, i64 0
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <16 x i1> [[TMP42]], i1 false, i64 5
...
; CHECK-NEXT:    [[TMP51:%.*]] = extractelement <16 x float> [[TMP29]], i64 1
