...
; VPLAN-SAME: ptr [[TMP0:%.*]], <8 x i8> [[TMP1:%.*]]) {
; VPLAN-NEXT:    [[TMP3:%.*]] = load i8, ptr [[TMP0]], align 2
; VPLAN-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[TMP0]], i64 13436
; VPLAN-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[TMP0]], i64 13444
; VPLAN-NEXT:    [[TMP9:%.*]] = load i8, ptr [[TMP8]], align 4
; VPLAN-NEXT:    [[TMP10:%.*]] = getelementptr i8, ptr [[TMP0]], i64 13544
; VPLAN-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr [[TMP0]], i64 13536
; VPLAN-NEXT:    [[TMP15:%.*]] = load <8 x i8>, ptr [[TMP7]], align 4
; VPLAN-NEXT:    [[TMP16:%.*]] = insertelement <8 x i8> poison, i8 [[TMP9]], i32 0
; VPLAN-NEXT:    [[TMP17:%.*]] = insertelement <8 x i8> [[TMP16]], i8 [[TMP3]], i32 1
; VPLAN-NEXT:    [[TMP18:%.*]] = shufflevector <8 x i8> [[TMP17]], <8 x i8> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
; VPLAN-NEXT:    [[TMP19:%.*]] = or <8 x i8> [[TMP18]], [[TMP15]]
; VPLAN-NEXT:    store <8 x i8> [[TMP19]], ptr [[TMP10]], align 4
; VPLAN-NEXT:    [[TMP27:%.*]] = shufflevector <8 x i8> [[TMP1]], <8 x i8> poison, <8 x i32> <i32 0, i32 0, i32 2, i32 3, i32 4, i32 5, i32 0, i32 7>
; VPLAN-NEXT:    [[TMP28:%.*]] = or <8 x i8> [[TMP15]], [[TMP27]]
; VPLAN-NEXT:    store <8 x i8> [[TMP28]], ptr [[TMP11]], align 4
; VPLAN-NEXT:    ret void
;
