...
; RUN: opt < %s -passes=slp-vectorizer,dce -slp-use-vplan-codegen -slp-threshold=-100 -S -mtriple=i386-apple-macosx10.8.0 -mcpu=corei7-avx | FileCheck --check-prefix=VPLAN %s
; RUN: opt < %s -passes=slp-vectorizer,dce -slp-use-vplan-codegen -slp-threshold=-100 -S -mtriple=i386-apple-macosx10.8.0 -mattr=+sse2 | FileCheck --check-prefix=VPLAN-SSE2 %s
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @shuffle_operands1(
; VPLAN-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[FROM:%.*]], align 4
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> poison, double [[V1:%.*]], i32 0
; VPLAN-NEXT:    [[TMP3:%.*]] = insertelement <2 x double> [[TMP2]], double [[V2:%.*]], i32 1
; VPLAN-NEXT:    [[TMP4:%.*]] = fadd <2 x double> [[TMP1]], [[TMP3]]
; VPLAN-NEXT:    store <2 x double> [[TMP4]], ptr [[TO:%.*]], align 4
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @shuffle_operands1(
; VPLAN-SSE2-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[FROM:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> poison, double [[V1:%.*]], i32 0
; VPLAN-SSE2-NEXT:    [[TMP3:%.*]] = insertelement <2 x double> [[TMP2]], double [[V2:%.*]], i32 1
; VPLAN-SSE2-NEXT:    [[TMP4:%.*]] = fadd <2 x double> [[TMP1]], [[TMP3]]
; VPLAN-SSE2-NEXT:    store <2 x double> [[TMP4]], ptr [[TO:%.*]], align 4
; VPLAN-SSE2-NEXT:    ret void
;
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @vecload_vs_broadcast(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    br label [[LP:%.*]]
; VPLAN:       lp:
; VPLAN-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
; VPLAN-NEXT:    [[TMP0:%.*]] = load <2 x double>, ptr [[FROM:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = shufflevector <2 x double> [[TMP0]], <2 x double> poison, <2 x i32> <i32 poison, i32 0>
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> [[TMP1]], double [[P]], i32 0
; VPLAN-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP0]], [[TMP2]]
; VPLAN-NEXT:    store <2 x double> [[TMP3]], ptr [[TO:%.*]], align 4
; VPLAN-NEXT:    br i1 [[C:%.*]], label [[LP]], label [[EXT:%.*]]
; VPLAN:       ext:
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @vecload_vs_broadcast(
; VPLAN-SSE2-NEXT:  entry:
; VPLAN-SSE2-NEXT:    br label [[LP:%.*]]
; VPLAN-SSE2:       lp:
; VPLAN-SSE2-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
; VPLAN-SSE2-NEXT:    [[TMP0:%.*]] = load <2 x double>, ptr [[FROM:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP1:%.*]] = shufflevector <2 x double> [[TMP0]], <2 x double> poison, <2 x i32> <i32 poison, i32 0>
; VPLAN-SSE2-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> [[TMP1]], double [[P]], i32 0
; VPLAN-SSE2-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP0]], [[TMP2]]
; VPLAN-SSE2-NEXT:    store <2 x double> [[TMP3]], ptr [[TO:%.*]], align 4
; VPLAN-SSE2-NEXT:    br i1 [[C:%.*]], label [[LP]], label [[EXT:%.*]]
; VPLAN-SSE2:       ext:
; VPLAN-SSE2-NEXT:    ret void
;
entry:
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @vecload_vs_broadcast2(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    br label [[LP:%.*]]
; VPLAN:       lp:
; VPLAN-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
...
; VPLAN-NEXT:    [[TMP1:%.*]] = shufflevector <2 x double> [[TMP0]], <2 x double> poison, <2 x i32> <i32 poison, i32 0>
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> [[TMP1]], double [[P]], i32 0
; VPLAN-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP2]], [[TMP0]]
; VPLAN-NEXT:    store <2 x double> [[TMP3]], ptr [[TO:%.*]], align 4
; VPLAN-NEXT:    br i1 [[C:%.*]], label [[LP]], label [[EXT:%.*]]
; VPLAN:       ext:
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @vecload_vs_broadcast2(
; VPLAN-SSE2-NEXT:  entry:
; VPLAN-SSE2-NEXT:    br label [[LP:%.*]]
; VPLAN-SSE2:       lp:
; VPLAN-SSE2-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
...
; VPLAN-SSE2-NEXT:    [[TMP1:%.*]] = shufflevector <2 x double> [[TMP0]], <2 x double> poison, <2 x i32> <i32 poison, i32 0>
; VPLAN-SSE2-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> [[TMP1]], double [[P]], i32 0
; VPLAN-SSE2-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP2]], [[TMP0]]
; VPLAN-SSE2-NEXT:    store <2 x double> [[TMP3]], ptr [[TO:%.*]], align 4
; VPLAN-SSE2-NEXT:    br i1 [[C:%.*]], label [[LP]], label [[EXT:%.*]]
; VPLAN-SSE2:       ext:
; VPLAN-SSE2-NEXT:    ret void
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @vecload_vs_broadcast3(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    br label [[LP:%.*]]
; VPLAN:       lp:
; VPLAN-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
...
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @vecload_vs_broadcast3(
; VPLAN-SSE2-NEXT:  entry:
; VPLAN-SSE2-NEXT:    br label [[LP:%.*]]
; VPLAN-SSE2:       lp:
; VPLAN-SSE2-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @shuffle_nodes_match1(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    br label [[LP:%.*]]
; VPLAN:       lp:
; VPLAN-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
; VPLAN-NEXT:    [[FROM_1:%.*]] = getelementptr double, ptr [[FROM:%.*]], i64 1
; VPLAN-NEXT:    [[V0_1:%.*]] = load double, ptr [[FROM]], align 4
; VPLAN-NEXT:    [[V0_2:%.*]] = load double, ptr [[FROM_1]], align 4
; VPLAN-NEXT:    [[TMP0:%.*]] = insertelement <2 x double> poison, double [[V0_2]], i32 0
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x double> [[TMP0]], double [[P]], i32 1
; VPLAN-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <2 x double> poison, double [[V0_1]], i32 0
; VPLAN-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <2 x double> [[BROADCAST_SPLATINSERT]], <2 x double> poison, <2 x i32> zeroinitializer
; VPLAN-NEXT:    [[TMP2:%.*]] = fadd <2 x double> [[TMP1]], [[BROADCAST_SPLAT]]
; VPLAN-NEXT:    store <2 x double> [[TMP2]], ptr [[TO:%.*]], align 4
; VPLAN-NEXT:    br i1 [[C:%.*]], label [[LP]], label [[EXT:%.*]]
; VPLAN:       ext:
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @shuffle_nodes_match1(
; VPLAN-SSE2-NEXT:  entry:
; VPLAN-SSE2-NEXT:    br label [[LP:%.*]]
; VPLAN-SSE2:       lp:
; VPLAN-SSE2-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
; VPLAN-SSE2-NEXT:    [[TMP0:%.*]] = load <2 x double>, ptr [[FROM:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP1:%.*]] = shufflevector <2 x double> [[TMP0]], <2 x double> poison, <2 x i32> <i32 1, i32 0>
; VPLAN-SSE2-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> [[TMP0]], double [[P]], i32 1
; VPLAN-SSE2-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP2]], [[TMP1]]
; VPLAN-SSE2-NEXT:    store <2 x double> [[TMP3]], ptr [[TO:%.*]], align 4
; VPLAN-SSE2-NEXT:    br i1 [[C:%.*]], label [[LP]], label [[EXT:%.*]]
; VPLAN-SSE2:       ext:
; VPLAN-SSE2-NEXT:    ret void
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @vecload_vs_broadcast4(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    br label [[LP:%.*]]
; VPLAN:       lp:
; VPLAN-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
; VPLAN-NEXT:    [[TMP0:%.*]] = load <2 x double>, ptr [[FROM:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = shufflevector <2 x double> [[TMP0]], <2 x double> poison, <2 x i32> <i32 1, i32 0>
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> [[TMP0]], double [[P]], i32 1
; VPLAN-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP2]], [[TMP1]]
; VPLAN-NEXT:    store <2 x double> [[TMP3]], ptr [[TO:%.*]], align 4
; VPLAN-NEXT:    br i1 [[C:%.*]], label [[LP]], label [[EXT:%.*]]
; VPLAN:       ext:
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @vecload_vs_broadcast4(
; VPLAN-SSE2-NEXT:  entry:
; VPLAN-SSE2-NEXT:    br label [[LP:%.*]]
; VPLAN-SSE2:       lp:
; VPLAN-SSE2-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
...
; CHECK-NEXT:    [[V0_1:%.*]] = load double, ptr [[FROM]], align 4
; CHECK-NEXT:    [[V0_2:%.*]] = load double, ptr [[FROM_1]], align 4
; CHECK-NEXT:    [[TMP5:%.*]] = insertelement <2 x double> poison, double [[V0_1]], i32 0
; CHECK-NEXT:    [[TMP1:%.*]] = shufflevector <2 x double> [[TMP5]], <2 x double> poison, <2 x i32> zeroinitializer
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @shuffle_nodes_match2(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    br label [[LP:%.*]]
; VPLAN:       lp:
; VPLAN-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
...
; VPLAN-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <2 x double> poison, double [[V0_1]], i32 0
; VPLAN-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <2 x double> [[BROADCAST_SPLATINSERT]], <2 x double> poison, <2 x i32> zeroinitializer
; VPLAN-NEXT:    [[TMP3:%.*]] = insertelement <2 x double> poison, double [[V0_2]], i32 0
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x double> [[TMP3]], double [[P]], i32 1
; VPLAN-NEXT:    [[TMP2:%.*]] = fadd <2 x double> [[BROADCAST_SPLAT]], [[TMP1]]
; VPLAN-NEXT:    store <2 x double> [[TMP2]], ptr [[TO:%.*]], align 4
; VPLAN-NEXT:    br i1 [[C:%.*]], label [[LP]], label [[EXT:%.*]]
; VPLAN:       ext:
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @shuffle_nodes_match2(
; VPLAN-SSE2-NEXT:  entry:
; VPLAN-SSE2-NEXT:    br label [[LP:%.*]]
; VPLAN-SSE2:       lp:
; VPLAN-SSE2-NEXT:    [[P:%.*]] = phi double [ 1.000000e+00, [[LP]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
...
; VPLAN-SSE2-NEXT:    [[TMP1:%.*]] = shufflevector <2 x double> [[TMP0]], <2 x double> poison, <2 x i32> <i32 1, i32 0>
; VPLAN-SSE2-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> [[TMP0]], double [[P]], i32 1
; VPLAN-SSE2-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP1]], [[TMP2]]
; VPLAN-SSE2-NEXT:    store <2 x double> [[TMP3]], ptr [[TO:%.*]], align 4
; VPLAN-SSE2-NEXT:    br i1 [[C:%.*]], label [[LP]], label [[EXT:%.*]]
; VPLAN-SSE2:       ext:
; VPLAN-SSE2-NEXT:    ret void
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @good_load_order(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    br label [[FOR_COND1_PREHEADER:%.*]]
; VPLAN:       for.cond1.preheader:
; VPLAN-NEXT:    [[TMP0:%.*]] = load float, ptr @a, align 16
; VPLAN-NEXT:    br label [[FOR_BODY3:%.*]]
; VPLAN:       for.body3:
; VPLAN-NEXT:    [[TMP1:%.*]] = phi float [ [[TMP0]], [[FOR_COND1_PREHEADER]] ], [ [[TMP10:%.*]], [[FOR_BODY3]] ]
; VPLAN-NEXT:    [[INDVARS_IV:%.*]] = phi i64 [ 0, [[FOR_COND1_PREHEADER]] ], [ [[INDVARS_IV_NEXT:%.*]], [[FOR_BODY3]] ]
; VPLAN-NEXT:    [[TMP2:%.*]] = add nsw i64 [[INDVARS_IV]], 1
; VPLAN-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [32000 x float], ptr @a, i64 0, i64 [[TMP2]]
; VPLAN-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [32000 x float], ptr @a, i64 0, i64 [[INDVARS_IV]]
; VPLAN-NEXT:    [[TMP3:%.*]] = add nsw i64 [[INDVARS_IV]], 4
; VPLAN-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds [32000 x float], ptr @a, i64 0, i64 [[TMP3]]
; VPLAN-NEXT:    [[TMP4:%.*]] = load float, ptr [[ARRAYIDX31]], align 4
; VPLAN-NEXT:    [[TMP5:%.*]] = load <4 x float>, ptr [[ARRAYIDX]], align 4
; VPLAN-NEXT:    [[TMP6:%.*]] = shufflevector <4 x float> [[TMP5]], <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 2>
; VPLAN-NEXT:    [[TMP7:%.*]] = insertelement <4 x float> poison, float [[TMP1]], i32 0
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <4 x float> [[TMP6]], <4 x float> [[TMP7]], <4 x i32> <i32 4, i32 1, i32 2, i32 3>
; VPLAN-NEXT:    [[TMP9:%.*]] = fmul <4 x float> [[TMP5]], [[TMP8]]
; VPLAN-NEXT:    store <4 x float> [[TMP9]], ptr [[ARRAYIDX5]], align 4
; VPLAN-NEXT:    [[INDVARS_IV_NEXT]] = add nuw nsw i64 [[INDVARS_IV]], 5
; VPLAN-NEXT:    [[ARRAYIDX41:%.*]] = getelementptr inbounds [32000 x float], ptr @a, i64 0, i64 [[INDVARS_IV_NEXT]]
; VPLAN-NEXT:    [[TMP10]] = load float, ptr [[ARRAYIDX41]], align 4
; VPLAN-NEXT:    [[MUL45:%.*]] = fmul float [[TMP10]], [[TMP4]]
; VPLAN-NEXT:    store float [[MUL45]], ptr [[ARRAYIDX31]], align 4
; VPLAN-NEXT:    [[TMP11:%.*]] = trunc i64 [[INDVARS_IV_NEXT]] to i32
; VPLAN-NEXT:    [[CMP2:%.*]] = icmp slt i32 [[TMP11]], 31995
; VPLAN-NEXT:    br i1 [[CMP2]], label [[FOR_BODY3]], label [[FOR_END:%.*]]
; VPLAN:       for.end:
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @good_load_order(
; VPLAN-SSE2-NEXT:  entry:
; VPLAN-SSE2-NEXT:    br label [[FOR_COND1_PREHEADER:%.*]]
; VPLAN-SSE2:       for.cond1.preheader:
; VPLAN-SSE2-NEXT:    [[TMP0:%.*]] = load float, ptr @a, align 16
; VPLAN-SSE2-NEXT:    br label [[FOR_BODY3:%.*]]
; VPLAN-SSE2:       for.body3:
; VPLAN-SSE2-NEXT:    [[TMP1:%.*]] = phi float [ [[TMP0]], [[FOR_COND1_PREHEADER]] ], [ [[TMP10:%.*]], [[FOR_BODY3]] ]
; VPLAN-SSE2-NEXT:    [[INDVARS_IV:%.*]] = phi i64 [ 0, [[FOR_COND1_PREHEADER]] ], [ [[INDVARS_IV_NEXT:%.*]], [[FOR_BODY3]] ]
; VPLAN-SSE2-NEXT:    [[TMP2:%.*]] = add nsw i64 [[INDVARS_IV]], 1
; VPLAN-SSE2-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [32000 x float], ptr @a, i64 0, i64 [[TMP2]]
; VPLAN-SSE2-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [32000 x float], ptr @a, i64 0, i64 [[INDVARS_IV]]
; VPLAN-SSE2-NEXT:    [[TMP3:%.*]] = add nsw i64 [[INDVARS_IV]], 4
; VPLAN-SSE2-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds [32000 x float], ptr @a, i64 0, i64 [[TMP3]]
; VPLAN-SSE2-NEXT:    [[TMP4:%.*]] = load float, ptr [[ARRAYIDX31]], align 4
; VPLAN-SSE2-NEXT:    [[TMP5:%.*]] = load <4 x float>, ptr [[ARRAYIDX]], align 4
; VPLAN-SSE2-NEXT:    [[TMP6:%.*]] = shufflevector <4 x float> [[TMP5]], <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 2>
; VPLAN-SSE2-NEXT:    [[TMP7:%.*]] = insertelement <4 x float> poison, float [[TMP1]], i32 0
; VPLAN-SSE2-NEXT:    [[TMP8:%.*]] = shufflevector <4 x float> [[TMP6]], <4 x float> [[TMP7]], <4 x i32> <i32 4, i32 1, i32 2, i32 3>
; VPLAN-SSE2-NEXT:    [[TMP9:%.*]] = fmul <4 x float> [[TMP5]], [[TMP8]]
; VPLAN-SSE2-NEXT:    store <4 x float> [[TMP9]], ptr [[ARRAYIDX5]], align 4
; VPLAN-SSE2-NEXT:    [[INDVARS_IV_NEXT]] = add nuw nsw i64 [[INDVARS_IV]], 5
; VPLAN-SSE2-NEXT:    [[ARRAYIDX41:%.*]] = getelementptr inbounds [32000 x float], ptr @a, i64 0, i64 [[INDVARS_IV_NEXT]]
; VPLAN-SSE2-NEXT:    [[TMP10]] = load float, ptr [[ARRAYIDX41]], align 4
; VPLAN-SSE2-NEXT:    [[MUL45:%.*]] = fmul float [[TMP10]], [[TMP4]]
; VPLAN-SSE2-NEXT:    store float [[MUL45]], ptr [[ARRAYIDX31]], align 4
; VPLAN-SSE2-NEXT:    [[TMP11:%.*]] = trunc i64 [[INDVARS_IV_NEXT]] to i32
; VPLAN-SSE2-NEXT:    [[CMP2:%.*]] = icmp slt i32 [[TMP11]], 31995
; VPLAN-SSE2-NEXT:    br i1 [[CMP2]], label [[FOR_BODY3]], label [[FOR_END:%.*]]
; VPLAN-SSE2:       for.end:
; VPLAN-SSE2-NEXT:    ret void
;
entry:
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @load_reorder_double(
; VPLAN-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[B:%.*]], align 4
; VPLAN-NEXT:    [[TMP2:%.*]] = load <2 x double>, ptr [[A:%.*]], align 4
; VPLAN-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP1]], [[TMP2]]
; VPLAN-NEXT:    store <2 x double> [[TMP3]], ptr [[C:%.*]], align 4
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @load_reorder_double(
; VPLAN-SSE2-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[B:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP2:%.*]] = load <2 x double>, ptr [[A:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP1]], [[TMP2]]
; VPLAN-SSE2-NEXT:    store <2 x double> [[TMP3]], ptr [[C:%.*]], align 4
; VPLAN-SSE2-NEXT:    ret void
;
  %1 = load double, ptr %a
  %2 = load double, ptr %b
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @load_reorder_float(
; VPLAN-NEXT:    [[TMP1:%.*]] = load <4 x float>, ptr [[A:%.*]], align 4
; VPLAN-NEXT:    [[TMP2:%.*]] = load <4 x float>, ptr [[B:%.*]], align 4
; VPLAN-NEXT:    [[TMP3:%.*]] = fadd <4 x float> [[TMP1]], [[TMP2]]
; VPLAN-NEXT:    store <4 x float> [[TMP3]], ptr [[C:%.*]], align 4
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @load_reorder_float(
; VPLAN-SSE2-NEXT:    [[TMP1:%.*]] = load <4 x float>, ptr [[A:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP2:%.*]] = load <4 x float>, ptr [[B:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP3:%.*]] = fadd <4 x float> [[TMP1]], [[TMP2]]
; VPLAN-SSE2-NEXT:    store <4 x float> [[TMP3]], ptr [[C:%.*]], align 4
; VPLAN-SSE2-NEXT:    ret void
;
  %1 = load float, ptr %a
  %2 = load float, ptr %b
...
; SSE2-NEXT:    ret void
;
; VPLAN-LABEL: @opcode_reorder(
; VPLAN-NEXT:    [[TMP1:%.*]] = load <4 x float>, ptr [[B:%.*]], align 4
; VPLAN-NEXT:    [[TMP2:%.*]] = load <4 x float>, ptr [[C:%.*]], align 4
; VPLAN-NEXT:    [[TMP3:%.*]] = fadd <4 x float> [[TMP1]], [[TMP2]]
; VPLAN-NEXT:    [[TMP4:%.*]] = load <4 x float>, ptr [[D:%.*]], align 4
; VPLAN-NEXT:    [[TMP5:%.*]] = fadd <4 x float> [[TMP4]], [[TMP3]]
; VPLAN-NEXT:    store <4 x float> [[TMP5]], ptr [[A:%.*]], align 4
; VPLAN-NEXT:    ret void
;
; VPLAN-SSE2-LABEL: @opcode_reorder(
; VPLAN-SSE2-NEXT:    [[TMP1:%.*]] = load <4 x float>, ptr [[B:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP2:%.*]] = load <4 x float>, ptr [[C:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP3:%.*]] = fadd <4 x float> [[TMP1]], [[TMP2]]
; VPLAN-SSE2-NEXT:    [[TMP4:%.*]] = load <4 x float>, ptr [[D:%.*]], align 4
; VPLAN-SSE2-NEXT:    [[TMP5:%.*]] = fadd <4 x float> [[TMP4]], [[TMP3]]
; VPLAN-SSE2-NEXT:    store <4 x float> [[TMP5]], ptr [[A:%.*]], align 4
; VPLAN-SSE2-NEXT:    ret void
;
  %1 = load float, ptr %b
  %2 = load float, ptr %c
