...
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -slp-vectorize-hor -slp-vectorize-hor-store -S < %s -mtriple=x86_64-apple-macosx -mcpu=haswell | FileCheck %s --check-prefixes=VPLAN-VPLAN,VPLAN-VPLAN-AVX2
...
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -slp-vectorize-hor -slp-vectorize-hor-store -S < %s -mtriple=x86_64-apple-macosx -mcpu=x86-64-v4 | FileCheck %s --check-prefixes=VPLAN-VPLAN,VPLAN-VPLAN-AVX512
...
;
; VPLAN-VPLAN-LABEL: @_Z9load_le32Ph(
; VPLAN-VPLAN-NEXT:  entry:
; VPLAN-VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i8>, ptr [[DATA:%.*]], align 1
; VPLAN-VPLAN-NEXT:    [[TMP1:%.*]] = zext <4 x i8> [[TMP0]] to <4 x i32>
; VPLAN-VPLAN-NEXT:    [[TMP2:%.*]] = shl <4 x i32> [[TMP1]], <i32 0, i32 8, i32 16, i32 24>
; VPLAN-VPLAN-NEXT:    [[TMP3:%.*]] = call i32 @llvm.vector.reduce.or.v4i32(<4 x i32> [[TMP2]])
; VPLAN-VPLAN-NEXT:    ret i32 [[TMP3]]
;
entry:
...
;
; VPLAN-VPLAN-AVX2-LABEL: @PR16739_byref(
; VPLAN-VPLAN-AVX2-NEXT:    [[GEP2:%.*]] = getelementptr inbounds <4 x float>, ptr [[X:%.*]], i64 0, i64 2
; VPLAN-VPLAN-AVX2-NEXT:    [[TMP1:%.*]] = load <2 x float>, ptr [[X]], align 4
; VPLAN-VPLAN-AVX2-NEXT:    [[X2:%.*]] = load float, ptr [[GEP2]], align 4
; VPLAN-VPLAN-AVX2-NEXT:    [[TMP2:%.*]] = shufflevector <2 x float> [[TMP1]], <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; VPLAN-VPLAN-AVX2-NEXT:    [[I2:%.*]] = insertelement <4 x float> [[TMP2]], float [[X2]], i32 2
; VPLAN-VPLAN-AVX2-NEXT:    [[I3:%.*]] = insertelement <4 x float> [[I2]], float [[X2]], i32 3
; VPLAN-VPLAN-AVX2-NEXT:    ret <4 x float> [[I3]]
;
...
;
; VPLAN-VPLAN-AVX512-LABEL: @PR16739_byref(
; VPLAN-VPLAN-AVX512-NEXT:    [[GEP1:%.*]] = getelementptr inbounds <4 x float>, ptr [[X:%.*]], i64 0, i64 1
; VPLAN-VPLAN-AVX512-NEXT:    [[X0:%.*]] = load float, ptr [[X]], align 4
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP1:%.*]] = load <2 x float>, ptr [[GEP1]], align 4
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP4:%.*]] = extractelement <2 x float> [[TMP1]], i32 1
; VPLAN-VPLAN-AVX512-NEXT:    [[I0:%.*]] = insertelement <4 x float> poison, float [[X0]], i32 0
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP2:%.*]] = shufflevector <2 x float> [[TMP1]], <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; VPLAN-VPLAN-AVX512-NEXT:    [[I21:%.*]] = shufflevector <4 x float> [[I0]], <4 x float> [[TMP2]], <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
; VPLAN-VPLAN-AVX512-NEXT:    [[TMP3:%.*]] = insertelement <4 x float> [[I21]], float [[TMP4]], i32 3
; VPLAN-VPLAN-AVX512-NEXT:    ret <4 x float> [[TMP3]]
;
...
;
; VPLAN-VPLAN-LABEL: @PR16739_byref_alt(
; VPLAN-VPLAN-NEXT:    [[TMP1:%.*]] = load <2 x float>, ptr [[X:%.*]], align 4
; VPLAN-VPLAN-NEXT:    [[TMP2:%.*]] = shufflevector <2 x float> [[TMP1]], <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
; VPLAN-VPLAN-NEXT:    ret <4 x float> [[TMP2]]
;
  %gep1 = getelementptr inbounds <4 x float>, ptr %x, i64 0, i64 1
  %x0 = load float, ptr %x
  %x1 = load float, ptr %gep1
...
;
; VPLAN-VPLAN-LABEL: @PR16739_byval(
; VPLAN-VPLAN-NEXT:    [[TMP1:%.*]] = load <2 x i64>, ptr [[X:%.*]], align 16
; VPLAN-VPLAN-NEXT:    [[TMP2:%.*]] = shufflevector <2 x i64> [[TMP1]], <2 x i64> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
; VPLAN-VPLAN-NEXT:    [[TMP3:%.*]] = lshr <4 x i64> [[TMP2]], <i64 0, i64 32, i64 0, i64 0>
; VPLAN-VPLAN-NEXT:    [[TMP4:%.*]] = trunc <4 x i64> [[TMP3]] to <4 x i32>
; VPLAN-VPLAN-NEXT:    [[TMP5:%.*]] = bitcast <4 x i32> [[TMP4]] to <4 x float>
; VPLAN-VPLAN-NEXT:    ret <4 x float> [[TMP5]]
;
...
; CHECK-NEXT:    ret void
;
; VPLAN-VPLAN-LABEL: @PR43578_prefer128(
; VPLAN-VPLAN-NEXT:    [[P2:%.*]] = getelementptr inbounds i64, ptr [[P:%.*]], i64 2
; VPLAN-VPLAN-NEXT:    [[Q2:%.*]] = getelementptr inbounds i64, ptr [[Q:%.*]], i64 2
; VPLAN-VPLAN-NEXT:    [[TMP1:%.*]] = load <2 x i64>, ptr [[P]], align 2
; VPLAN-VPLAN-NEXT:    [[TMP2:%.*]] = load <2 x i64>, ptr [[Q]], align 2
; VPLAN-VPLAN-NEXT:    [[TMP3:%.*]] = sub nsw <2 x i64> [[TMP1]], [[TMP2]]
; VPLAN-VPLAN-NEXT:    [[TMP6:%.*]] = load <2 x i64>, ptr [[P2]], align 2
; VPLAN-VPLAN-NEXT:    [[TMP7:%.*]] = load <2 x i64>, ptr [[Q2]], align 2
; VPLAN-VPLAN-NEXT:    [[TMP8:%.*]] = sub nsw <2 x i64> [[TMP6]], [[TMP7]]
; VPLAN-VPLAN-NEXT:    [[TMP4:%.*]] = extractelement <2 x i64> [[TMP3]], i32 0
; VPLAN-VPLAN-NEXT:    [[G0:%.*]] = getelementptr inbounds i32, ptr [[R:%.*]], i64 [[TMP4]]
; VPLAN-VPLAN-NEXT:    [[TMP5:%.*]] = extractelement <2 x i64> [[TMP3]], i32 1
; VPLAN-VPLAN-NEXT:    [[G1:%.*]] = getelementptr inbounds i32, ptr [[R]], i64 [[TMP5]]
; VPLAN-VPLAN-NEXT:    [[TMP9:%.*]] = extractelement <2 x i64> [[TMP8]], i32 0
; VPLAN-VPLAN-NEXT:    [[G2:%.*]] = getelementptr inbounds i32, ptr [[R]], i64 [[TMP9]]
; VPLAN-VPLAN-NEXT:    [[TMP10:%.*]] = extractelement <2 x i64> [[TMP8]], i32 1
; VPLAN-VPLAN-NEXT:    [[G3:%.*]] = getelementptr inbounds i32, ptr [[R]], i64 [[TMP10]]
