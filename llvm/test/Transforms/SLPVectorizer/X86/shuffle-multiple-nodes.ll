...
; RUN: opt -slp-use-vplan-codegen -S --passes=slp-vectorizer -mtriple=x86_64-unknown-linux-gnu -mattr=+avx512f < %s | FileCheck --check-prefix=VPLAN %s
...
;
; VPLAN-LABEL: define i32 @main
; VPLAN-SAME: (<16 x i32> [[BC47_I:%.*]], <16 x i32> [[BC:%.*]]) #[[ATTR0:[0-9]+]] {
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = extractelement <16 x i32> [[BC47_I]], i64 0
; VPLAN-NEXT:    [[TMP1:%.*]] = extractelement <16 x i32> [[BC]], i64 0
; VPLAN-NEXT:    [[TMP2:%.*]] = extractelement <16 x i32> splat (i32 1), i64 0
; VPLAN-NEXT:    [[TMP3:%.*]] = extractelement <16 x i32> zeroinitializer, i64 0
; VPLAN-NEXT:    [[TMP4:%.*]] = extractelement <16 x i32> zeroinitializer, i64 0
; VPLAN-NEXT:    [[TMP5:%.*]] = extractelement <16 x i32> splat (i32 -1), i64 0
; VPLAN-NEXT:    [[TMP6:%.*]] = extractelement <16 x i32> zeroinitializer, i64 1
; VPLAN-NEXT:    [[TMP7:%.*]] = extractelement <16 x i32> zeroinitializer, i64 0
; VPLAN-NEXT:    [[TMP8:%.*]] = insertelement <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 poison, i32 0, i32 0>, i32 [[TMP5]], i32 5
; VPLAN-NEXT:    [[TMP9:%.*]] = mul <8 x i32> zeroinitializer, [[TMP8]]
; VPLAN-NEXT:    [[TMP10:%.*]] = insertelement <8 x i32> <i32 poison, i32 0, i32 0, i32 0, i32 0, i32 poison, i32 0, i32 0>, i32 [[TMP1]], i32 0
; VPLAN-NEXT:    [[TMP11:%.*]] = insertelement <8 x i32> [[TMP10]], i32 [[TMP0]], i32 5
; VPLAN-NEXT:    [[TMP12:%.*]] = insertelement <8 x i32> poison, i32 [[TMP2]], i32 0
; VPLAN-NEXT:    [[TMP13:%.*]] = insertelement <8 x i32> [[TMP12]], i32 [[TMP1]], i32 1
; VPLAN-NEXT:    [[TMP14:%.*]] = insertelement <8 x i32> [[TMP13]], i32 [[TMP3]], i32 2
; VPLAN-NEXT:    [[TMP15:%.*]] = insertelement <8 x i32> [[TMP14]], i32 [[TMP0]], i32 3
; VPLAN-NEXT:    [[TMP16:%.*]] = insertelement <8 x i32> [[TMP15]], i32 [[TMP5]], i32 4
; VPLAN-NEXT:    [[TMP17:%.*]] = insertelement <8 x i32> [[TMP16]], i32 [[TMP6]], i32 5
; VPLAN-NEXT:    [[TMP18:%.*]] = insertelement <8 x i32> [[TMP17]], i32 [[TMP4]], i32 6
; VPLAN-NEXT:    [[TMP19:%.*]] = insertelement <8 x i32> [[TMP18]], i32 [[TMP7]], i32 7
; VPLAN-NEXT:    [[TMP20:%.*]] = mul <8 x i32> [[TMP11]], [[TMP19]]
; VPLAN-NEXT:    [[TMP21:%.*]] = sub <8 x i32> [[TMP20]], [[TMP9]]
; VPLAN-NEXT:    [[TMP22:%.*]] = add <8 x i32> [[TMP20]], [[TMP9]]
; VPLAN-NEXT:    [[TMP23:%.*]] = shufflevector <8 x i32> [[TMP21]], <8 x i32> [[TMP22]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 4, i32 13, i32 6, i32 15>
; VPLAN-NEXT:    store <8 x i32> [[TMP23]], ptr null, align 16
