...
; RUN: opt -slp-use-vplan-codegen -S --passes=slp-vectorizer -mtriple=x86_64-unknown-linux-gnu -slp-threshold=-99999 < %s | FileCheck %s --check-prefix=VPLAN
...
; VPLAN-SAME: ptr addrspace(1) [[ARG:%.*]]) {
; VPLAN-NEXT:  [[BB:.*:]]
; VPLAN-NEXT:    br label %[[BB1:.*]]
; VPLAN:       [[BB1]]:
; VPLAN-NEXT:    [[TMP0:%.*]] = insertelement <2 x ptr addrspace(1)> poison, ptr addrspace(1) [[ARG]], i32 0
; VPLAN-NEXT:    [[TMP1:%.*]] = shufflevector <2 x ptr addrspace(1)> [[TMP0]], <2 x ptr addrspace(1)> poison, <2 x i32> zeroinitializer
; VPLAN-NEXT:    [[TMP2:%.*]] = getelementptr i8, <2 x ptr addrspace(1)> [[TMP1]], <2 x i64> <i64 21, i64 22>
; VPLAN-NEXT:    [[TMP3:%.*]] = extractelement <2 x ptr addrspace(1)> [[TMP2]], i32 1
; VPLAN-NEXT:    [[TMP4:%.*]] = insertelement <2 x ptr addrspace(1)> poison, ptr addrspace(1) [[ARG]], i32 0
; VPLAN-NEXT:    [[TMP5:%.*]] = shufflevector <2 x ptr addrspace(1)> [[TMP4]], <2 x ptr addrspace(1)> poison, <2 x i32> zeroinitializer
; VPLAN-NEXT:    [[TMP6:%.*]] = getelementptr i8, <2 x ptr addrspace(1)> [[TMP5]], <2 x i64> <i64 20, i64 21>
; VPLAN-NEXT:    br i1 false, label %[[BB73:.*]], label %[[BB150:.*]]
; VPLAN:       [[BB4:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB68:.*]], label %[[BB70:.*]]
; VPLAN:       [[BB5:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB64:.*]], label %[[BB66:.*]]
; VPLAN:       [[BB6:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB60:.*]], label %[[BB62:.*]]
; VPLAN:       [[BB7:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB8:.*]], label %[[BB58:.*]]
; VPLAN:       [[BB8]]:
; VPLAN-NEXT:    br i1 false, label %[[BB54:.*]], label %[[BB56:.*]]
; VPLAN:       [[BB9:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB50:.*]], label %[[BB52:.*]]
; VPLAN:       [[BB10:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB46:.*]], label %[[BB48:.*]]
; VPLAN:       [[BB11:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB42:.*]], label %[[BB44:.*]]
; VPLAN:       [[BB12:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB38:.*]], label %[[BB40:.*]]
; VPLAN:       [[BB13:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB36:.*]], label %[[BB122:.*]]
; VPLAN:       [[BB14:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB32:.*]], label %[[BB34:.*]]
; VPLAN:       [[BB15:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB28:.*]], label %[[BB30:.*]]
; VPLAN:       [[BB16:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB17:.*]], label %[[BB26:.*]]
; VPLAN:       [[BB17]]:
; VPLAN-NEXT:    br i1 false, label %[[BB22:.*]], label %[[BB24:.*]]
; VPLAN:       [[BB18:.*:]]
; VPLAN-NEXT:    br i1 false, label %[[BB19:.*]], label %[[BB20:.*]]
; VPLAN:       [[BB19]]:
; VPLAN-NEXT:    [[LOAD:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB20]]:
; VPLAN-NEXT:    [[LOAD21:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB22]]:
; VPLAN-NEXT:    [[LOAD23:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB24]]:
; VPLAN-NEXT:    [[LOAD25:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB26]]:
; VPLAN-NEXT:    [[LOAD27:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB28]]:
; VPLAN-NEXT:    [[LOAD29:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB30]]:
; VPLAN-NEXT:    [[LOAD31:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB32]]:
; VPLAN-NEXT:    [[LOAD33:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB34]]:
; VPLAN-NEXT:    [[LOAD35:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB36]]:
; VPLAN-NEXT:    [[LOAD37:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB38]]:
; VPLAN-NEXT:    [[LOAD39:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB40]]:
; VPLAN-NEXT:    [[LOAD41:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB42]]:
; VPLAN-NEXT:    [[LOAD43:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB44]]:
; VPLAN-NEXT:    [[LOAD45:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB46]]:
; VPLAN-NEXT:    [[LOAD47:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB48]]:
; VPLAN-NEXT:    [[LOAD49:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB50]]:
; VPLAN-NEXT:    [[LOAD51:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB52]]:
; VPLAN-NEXT:    [[LOAD53:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB54]]:
; VPLAN-NEXT:    [[LOAD55:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB56]]:
; VPLAN-NEXT:    [[LOAD57:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB58]]:
; VPLAN-NEXT:    [[LOAD59:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB60]]:
; VPLAN-NEXT:    [[LOAD61:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB62]]:
; VPLAN-NEXT:    [[LOAD63:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB64]]:
; VPLAN-NEXT:    [[LOAD65:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB66]]:
; VPLAN-NEXT:    [[LOAD67:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB68]]:
; VPLAN-NEXT:    [[LOAD69:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB70]]:
; VPLAN-NEXT:    [[LOAD71:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB72:.*]]:
; VPLAN-NEXT:    br i1 false, label %[[BB142:.*]], label %[[BB79:.*]]
; VPLAN:       [[BB73]]:
; VPLAN-NEXT:    [[TMP7:%.*]] = shufflevector <2 x ptr addrspace(1)> [[TMP2]], <2 x ptr addrspace(1)> <ptr addrspace(1) poison, ptr addrspace(1) null>, <2 x i32> <i32 1, i32 3>
; VPLAN-NEXT:    br i1 false, label %[[BB146:.*]], label %[[BB74:.*]]
; VPLAN:       [[BB74]]:
; VPLAN-NEXT:    br i1 false, label %[[BB75:.*]], label %[[BB76:.*]]
; VPLAN:       [[BB75]]:
; VPLAN-NEXT:    br label %[[BB150]]
; VPLAN:       [[BB76]]:
; VPLAN-NEXT:    br i1 false, label %[[BB153:.*]], label %[[BB77:.*]]
; VPLAN:       [[BB77]]:
; VPLAN-NEXT:    [[LOAD78:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB79]]:
; VPLAN-NEXT:    br i1 false, label %[[BB146]], label %[[BB81:.*]]
; VPLAN:       [[BB80:.*]]:
; VPLAN-NEXT:    br label %[[BB150]]
; VPLAN:       [[BB81]]:
; VPLAN-NEXT:    [[LOAD82:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB83:.*]]:
; VPLAN-NEXT:    br label %[[BB138:.*]]
; VPLAN:       [[BB84:.*]]:
; VPLAN-NEXT:    br i1 false, label %[[BB142]], label %[[BB85:.*]]
; VPLAN:       [[BB85]]:
; VPLAN-NEXT:    br i1 false, label %[[BB146]], label %[[BB86:.*]]
; VPLAN:       [[BB86]]:
; VPLAN-NEXT:    [[LOAD87:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB88:.*]]:
; VPLAN-NEXT:    br label %[[BB134:.*]]
; VPLAN:       [[BB89:.*]]:
; VPLAN-NEXT:    br i1 false, label %[[BB138]], label %[[BB90:.*]]
; VPLAN:       [[BB90]]:
; VPLAN-NEXT:    br i1 false, label %[[BB142]], label %[[BB91:.*]]
; VPLAN:       [[BB91]]:
; VPLAN-NEXT:    [[LOAD92:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB93:.*]]:
; VPLAN-NEXT:    br label %[[BB130:.*]]
; VPLAN:       [[BB94:.*]]:
; VPLAN-NEXT:    br i1 false, label %[[BB134]], label %[[BB95:.*]]
; VPLAN:       [[BB95]]:
; VPLAN-NEXT:    br i1 false, label %[[BB138]], label %[[BB96:.*]]
; VPLAN:       [[BB96]]:
; VPLAN-NEXT:    [[LOAD97:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB98:.*]]:
; VPLAN-NEXT:    br label %[[BB126:.*]]
; VPLAN:       [[BB99:.*]]:
; VPLAN-NEXT:    br i1 false, label %[[BB130]], label %[[BB100:.*]]
; VPLAN:       [[BB100]]:
; VPLAN-NEXT:    br i1 false, label %[[BB134]], label %[[BB101:.*]]
; VPLAN:       [[BB101]]:
; VPLAN-NEXT:    [[LOAD102:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB103:.*]]:
; VPLAN-NEXT:    br label %[[BB124:.*]]
; VPLAN:       [[BB104:.*]]:
; VPLAN-NEXT:    br i1 false, label %[[BB126]], label %[[BB105:.*]]
; VPLAN:       [[BB105]]:
; VPLAN-NEXT:    br i1 false, label %[[BB130]], label %[[BB106:.*]]
; VPLAN:       [[BB106]]:
; VPLAN-NEXT:    [[LOAD107:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB108:.*]]:
; VPLAN-NEXT:    br label %[[BB124]]
; VPLAN:       [[BB109:.*]]:
; VPLAN-NEXT:    br i1 false, label %[[BB126]], label %[[BB110:.*]]
; VPLAN:       [[BB110]]:
; VPLAN-NEXT:    [[LOAD111:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB112:.*]]:
; VPLAN-NEXT:    [[LOAD113:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    br label %[[BB124]]
; VPLAN:       [[BB114:.*:]]
; VPLAN-NEXT:    [[LOAD115:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB116:.*:]]
; VPLAN-NEXT:    [[LOAD117:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB118:.*:]]
; VPLAN-NEXT:    [[LOAD119:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB120:.*:]]
; VPLAN-NEXT:    [[LOAD121:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB122]]:
; VPLAN-NEXT:    [[LOAD123:%.*]] = load i8, ptr addrspace(1) [[TMP3]], align 1
; VPLAN-NEXT:    ret i32 0
; VPLAN:       [[BB124]]:
; VPLAN-NEXT:    [[PHI:%.*]] = phi ptr addrspace(1) [ null, %[[BB112]] ], [ [[TMP3]], %[[BB108]] ], [ null, %[[BB103]] ]
; VPLAN-NEXT:    [[PHI125:%.*]] = phi ptr addrspace(1) [ null, %[[BB112]] ], [ null, %[[BB108]] ], [ [[TMP3]], %[[BB103]] ]
; VPLAN-NEXT:    br label %[[BB126]]
; VPLAN:       [[BB126]]:
; VPLAN-NEXT:    [[PHI127:%.*]] = phi ptr addrspace(1) [ null, %[[BB124]] ], [ null, %[[BB98]] ], [ null, %[[BB104]] ], [ [[TMP3]], %[[BB109]] ]
; VPLAN-NEXT:    [[PHI128:%.*]] = phi ptr addrspace(1) [ null, %[[BB124]] ], [ null, %[[BB98]] ], [ [[TMP3]], %[[BB104]] ], [ null, %[[BB109]] ]
; VPLAN-NEXT:    [[PHI129:%.*]] = phi ptr addrspace(1) [ null, %[[BB124]] ], [ [[TMP3]], %[[BB98]] ], [ null, %[[BB104]] ], [ null, %[[BB109]] ]
; VPLAN-NEXT:    br label %[[BB130]]
; VPLAN:       [[BB130]]:
; VPLAN-NEXT:    [[PHI131:%.*]] = phi ptr addrspace(1) [ null, %[[BB126]] ], [ null, %[[BB93]] ], [ null, %[[BB99]] ], [ [[TMP3]], %[[BB105]] ]
; VPLAN-NEXT:    [[PHI132:%.*]] = phi ptr addrspace(1) [ null, %[[BB126]] ], [ null, %[[BB93]] ], [ [[TMP3]], %[[BB99]] ], [ null, %[[BB105]] ]
; VPLAN-NEXT:    [[PHI133:%.*]] = phi ptr addrspace(1) [ null, %[[BB126]] ], [ [[TMP3]], %[[BB93]] ], [ null, %[[BB99]] ], [ null, %[[BB105]] ]
; VPLAN-NEXT:    br label %[[BB134]]
; VPLAN:       [[BB134]]:
; VPLAN-NEXT:    [[PHI135:%.*]] = phi ptr addrspace(1) [ null, %[[BB130]] ], [ null, %[[BB88]] ], [ null, %[[BB94]] ], [ [[TMP3]], %[[BB100]] ]
; VPLAN-NEXT:    [[PHI136:%.*]] = phi ptr addrspace(1) [ null, %[[BB130]] ], [ null, %[[BB88]] ], [ [[TMP3]], %[[BB94]] ], [ null, %[[BB100]] ]
; VPLAN-NEXT:    [[PHI137:%.*]] = phi ptr addrspace(1) [ null, %[[BB130]] ], [ [[TMP3]], %[[BB88]] ], [ null, %[[BB94]] ], [ null, %[[BB100]] ]
; VPLAN-NEXT:    br label %[[BB138]]
; VPLAN:       [[BB138]]:
; VPLAN-NEXT:    [[PHI139:%.*]] = phi ptr addrspace(1) [ null, %[[BB134]] ], [ null, %[[BB83]] ], [ null, %[[BB89]] ], [ [[TMP3]], %[[BB95]] ]
; VPLAN-NEXT:    [[PHI140:%.*]] = phi ptr addrspace(1) [ null, %[[BB134]] ], [ null, %[[BB83]] ], [ [[TMP3]], %[[BB89]] ], [ null, %[[BB95]] ]
; VPLAN-NEXT:    [[PHI141:%.*]] = phi ptr addrspace(1) [ null, %[[BB134]] ], [ [[TMP3]], %[[BB83]] ], [ null, %[[BB89]] ], [ null, %[[BB95]] ]
; VPLAN-NEXT:    br label %[[BB142]]
; VPLAN:       [[BB142]]:
; VPLAN-NEXT:    [[PHI143:%.*]] = phi ptr addrspace(1) [ null, %[[BB138]] ], [ null, %[[BB72]] ], [ null, %[[BB84]] ], [ [[TMP3]], %[[BB90]] ]
; VPLAN-NEXT:    [[PHI144:%.*]] = phi ptr addrspace(1) [ null, %[[BB138]] ], [ null, %[[BB72]] ], [ [[TMP3]], %[[BB84]] ], [ null, %[[BB90]] ]
; VPLAN-NEXT:    [[PHI145:%.*]] = phi ptr addrspace(1) [ null, %[[BB138]] ], [ [[TMP3]], %[[BB72]] ], [ null, %[[BB84]] ], [ null, %[[BB90]] ]
; VPLAN-NEXT:    br label %[[BB146]]
; VPLAN:       [[BB146]]:
; VPLAN-NEXT:    [[PHI147:%.*]] = phi ptr addrspace(1) [ null, %[[BB142]] ], [ null, %[[BB73]] ], [ null, %[[BB79]] ], [ [[TMP3]], %[[BB85]] ]
; VPLAN-NEXT:    [[TMP8:%.*]] = phi <2 x ptr addrspace(1)> [ poison, %[[BB142]] ], [ [[TMP7]], %[[BB73]] ], [ poison, %[[BB79]] ], [ poison, %[[BB85]] ]
; VPLAN-NEXT:    br label %[[BB150]]
; VPLAN:       [[BB150]]:
; VPLAN-NEXT:    [[TMP9:%.*]] = phi <2 x ptr addrspace(1)> [ [[TMP2]], %[[BB75]] ], [ poison, %[[BB80]] ], [ zeroinitializer, %[[BB146]] ], [ [[TMP6]], %[[BB1]] ]
; VPLAN-NEXT:    br label %[[BB153]]
; VPLAN:       [[BB153]]:
; VPLAN-NEXT:    [[PHI154:%.*]] = phi ptr addrspace(1) [ null, %[[BB150]] ], [ [[TMP3]], %[[BB76]] ]
; VPLAN-NEXT:    ret i32 0
;
bb:
  br label %bb1
