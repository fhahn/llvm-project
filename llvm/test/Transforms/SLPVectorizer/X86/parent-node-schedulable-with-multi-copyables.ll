...
; RUN: opt -slp-use-vplan-codegen -passes=slp-vectorizer -S -slp-threshold=-100 -mtriple=x86_64-unknown-linux-gnu < %s | FileCheck %s --check-prefix=VPLAN
...
; CHECK-NEXT:    [[TMP8:%.*]] = xor <2 x i64> [[TMP5]], [[TMP7]]
; CHECK-NEXT:    [[TMP9:%.*]] = or <2 x i64> [[TMP5]], [[TMP7]]
...
; CHECK-NEXT:    [[TMP17:%.*]] = phi <4 x i8> [ [[TMP16]], %[[EGGS_EXIT_I_PEEL]] ], [ <i8 poison, i8 0, i8 0, i8 0>, %[[BB2]] ]
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <4 x i8> [[TMP17]], <4 x i8> poison, <8 x i32> <i32 2, i32 3, i32 2, i32 1, i32 2, i32 2, i32 2, i32 2>
; CHECK-NEXT:    br i1 [[LOAD1_I]], label %[[BB12_8_I]], label %[[BB12_1_THREAD_I:.*]]
; CHECK:       [[BB12_1_THREAD_I]]:
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <8 x i8> [[TMP4]], i32 0
; CHECK-NEXT:    [[ICMP5_3_I:%.*]] = icmp eq i8 [[TMP19]], 0
...
; CHECK-NEXT:    [[ICMP5_4_I:%.*]] = icmp eq i8 [[TMP20]], 0
; CHECK-NEXT:    br i1 [[ICMP5_4_I]], label %[[BB12_4_I:.*]], label %[[BB8_4_I:.*]]
; CHECK:       [[BB8_4_I]]:
; CHECK-NEXT:    br label %[[BB12_4_I]]
; CHECK:       [[BB12_4_I]]:
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <8 x i8> [[TMP4]], i32 5
; CHECK-NEXT:    [[ICMP5_5_I:%.*]] = icmp eq i8 [[TMP21]], 0
; CHECK-NEXT:    br i1 [[ICMP5_5_I]], label %[[BB12_5_I:.*]], label %[[BB8_5_I:.*]]
; CHECK:       [[BB8_5_I]]:
; CHECK-NEXT:    br label %[[BB12_5_I]]
; CHECK:       [[BB12_5_I]]:
; CHECK-NEXT:    [[TMP22:%.*]] = extractelement <8 x i8> [[TMP4]], i32 1
; CHECK-NEXT:    [[ICMP5_7_I:%.*]] = icmp eq i8 [[TMP22]], 0
; CHECK-NEXT:    br i1 [[ICMP5_7_I]], label %[[BB12_7_I:.*]], label %[[BB8_7_I:.*]]
; CHECK:       [[BB8_7_I]]:
; CHECK-NEXT:    br label %[[BB12_7_I]]
; CHECK:       [[BB12_7_I]]:
; CHECK-NEXT:    [[TMP23:%.*]] = extractelement <8 x i8> [[TMP4]], i32 3
; CHECK-NEXT:    [[ICMP5_8_I:%.*]] = icmp eq i8 [[TMP23]], 0
...
; CHECK-NEXT:    br label %[[BB2]]
;
; VPLAN-LABEL: define i64 @test(
; VPLAN-SAME: ptr [[ARG1:%.*]], i64 [[ALLOCA_PROMOTED344:%.*]], i8 [[LOAD_311_I:%.*]], i1 [[LOAD1_I:%.*]]) {
; VPLAN-NEXT:  [[BB:.*]]:
; VPLAN-NEXT:    [[TMP0:%.*]] = insertelement <8 x i8> <i8 0, i8 0, i8 poison, i8 0, i8 0, i8 0, i8 0, i8 0>, i8 [[LOAD_311_I]], i32 2
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <8 x i8> <i8 0, i8 poison, i8 0, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison>, i8 [[LOAD_311_I]], i32 1
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <2 x i64> poison, i64 [[ALLOCA_PROMOTED344]], i32 1
; VPLAN-NEXT:    br label %[[BB2:.*]]
; VPLAN:       [[BB2]]:
; VPLAN-NEXT:    [[TMP3:%.*]] = phi <8 x i8> [ zeroinitializer, %[[BB]] ], [ [[TMP32:%.*]], %[[BB12_8_I:.*]] ]
; VPLAN-NEXT:    [[TMP4:%.*]] = phi <2 x i64> [ zeroinitializer, %[[BB]] ], [ [[TMP33:%.*]], %[[BB12_8_I]] ]
; VPLAN-NEXT:    [[TMP5:%.*]] = extractelement <8 x i8> [[TMP3]], i32 0
; VPLAN-NEXT:    [[TMP6:%.*]] = extractelement <8 x i8> [[TMP3]], i32 1
; VPLAN-NEXT:    [[TMP7:%.*]] = extractelement <8 x i8> [[TMP3]], i32 2
; VPLAN-NEXT:    [[TMP8:%.*]] = extractelement <8 x i8> [[TMP3]], i32 3
; VPLAN-NEXT:    [[TMP9:%.*]] = extractelement <8 x i8> [[TMP3]], i32 4
; VPLAN-NEXT:    [[TMP10:%.*]] = extractelement <8 x i8> [[TMP3]], i32 5
; VPLAN-NEXT:    [[TMP11:%.*]] = extractelement <8 x i8> [[TMP3]], i32 6
; VPLAN-NEXT:    [[TMP12:%.*]] = extractelement <8 x i8> [[TMP3]], i32 7
; VPLAN-NEXT:    br i1 [[LOAD1_I]], label %[[SPAM_EXIT:.*]], label %[[BB4_LR_PH_I:.*]]
; VPLAN:       [[BB4_LR_PH_I]]:
; VPLAN-NEXT:    br i1 true, label %[[BB3_I_I_PEEL:.*]], label %[[EGGS_EXIT_I_PEEL:.*]]
; VPLAN:       [[BB3_I_I_PEEL]]:
; VPLAN-NEXT:    [[TMP13:%.*]] = and <2 x i64> [[TMP4]], splat (i64 1)
; VPLAN-NEXT:    [[LOAD4_I_I_PEEL:%.*]] = load i64, ptr [[ARG1]], align 8
; VPLAN-NEXT:    [[SHL_I_I_PEEL:%.*]] = shl i64 [[LOAD4_I_I_PEEL]], 1
; VPLAN-NEXT:    [[TMP14:%.*]] = shufflevector <2 x i64> [[TMP4]], <2 x i64> poison, <2 x i32> <i32 1, i32 poison>
; VPLAN-NEXT:    [[TMP15:%.*]] = insertelement <2 x i64> [[TMP14]], i64 [[SHL_I_I_PEEL]], i32 1
; VPLAN-NEXT:    [[TMP16:%.*]] = xor <2 x i64> [[TMP13]], [[TMP15]]
; VPLAN-NEXT:    [[TMP17:%.*]] = or <2 x i64> [[TMP13]], [[TMP15]]
; VPLAN-NEXT:    [[TMP18:%.*]] = shufflevector <2 x i64> [[TMP16]], <2 x i64> [[TMP17]], <2 x i32> <i32 0, i32 3>
; VPLAN-NEXT:    [[TMP19:%.*]] = trunc <2 x i64> [[TMP18]] to <2 x i8>
; VPLAN-NEXT:    [[TMP20:%.*]] = shufflevector <2 x i8> [[TMP19]], <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; VPLAN-NEXT:    [[TMP21:%.*]] = shufflevector <4 x i8> [[TMP20]], <4 x i8> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 poison>
; VPLAN-NEXT:    [[TMP22:%.*]] = shufflevector <4 x i8> [[TMP21]], <4 x i8> poison, <4 x i32> <i32 poison, i32 1, i32 2, i32 2>
; VPLAN-NEXT:    [[TMP23:%.*]] = extractelement <2 x i64> [[TMP18]], i32 0
; VPLAN-NEXT:    br label %[[EGGS_EXIT_I_PEEL]]
; VPLAN:       [[EGGS_EXIT_I_PEEL]]:
; VPLAN-NEXT:    [[LOAD5_I_I93_PEEL:%.*]] = phi i64 [ [[TMP23]], %[[BB3_I_I_PEEL]] ], [ 0, %[[BB4_LR_PH_I]] ]
; VPLAN-NEXT:    [[TMP24:%.*]] = phi <4 x i8> [ [[TMP22]], %[[BB3_I_I_PEEL]] ], [ <i8 poison, i8 0, i8 0, i8 0>, %[[BB4_LR_PH_I]] ]
; VPLAN-NEXT:    br label %[[SPAM_EXIT]]
; VPLAN:       [[SPAM_EXIT]]:
; VPLAN-NEXT:    [[GETELEMENTPTR_I_I_PROMOTED346:%.*]] = phi i64 [ [[LOAD5_I_I93_PEEL]], %[[EGGS_EXIT_I_PEEL]] ], [ 0, %[[BB2]] ]
; VPLAN-NEXT:    [[LOAD_8_I:%.*]] = phi i8 [ 0, %[[EGGS_EXIT_I_PEEL]] ], [ 1, %[[BB2]] ]
; VPLAN-NEXT:    [[TMP25:%.*]] = phi <4 x i8> [ [[TMP24]], %[[EGGS_EXIT_I_PEEL]] ], [ <i8 poison, i8 0, i8 0, i8 0>, %[[BB2]] ]
; VPLAN-NEXT:    [[TMP26:%.*]] = shufflevector <4 x i8> [[TMP25]], <4 x i8> poison, <8 x i32> <i32 2, i32 3, i32 2, i32 1, i32 2, i32 2, i32 2, i32 2>
; VPLAN-NEXT:    br i1 [[LOAD1_I]], label %[[BB12_8_I]], label %[[BB12_1_THREAD_I:.*]]
; VPLAN:       [[BB12_1_THREAD_I]]:
; VPLAN-NEXT:    [[ICMP5_3_I:%.*]] = icmp eq i8 [[TMP5]], 0
; VPLAN-NEXT:    br i1 [[ICMP5_3_I]], label %[[BB12_3_I:.*]], label %[[BB8_3_I:.*]]
; VPLAN:       [[BB8_3_I]]:
; VPLAN-NEXT:    br label %[[BB12_3_I]]
; VPLAN:       [[BB12_3_I]]:
; VPLAN-NEXT:    [[ICMP5_4_I:%.*]] = icmp eq i8 [[TMP12]], 0
; VPLAN-NEXT:    br i1 [[ICMP5_4_I]], label %[[BB12_4_I:.*]], label %[[BB8_4_I:.*]]
; VPLAN:       [[BB8_4_I]]:
; VPLAN-NEXT:    br label %[[BB12_4_I]]
; VPLAN:       [[BB12_4_I]]:
; VPLAN-NEXT:    [[ICMP5_5_I:%.*]] = icmp eq i8 [[TMP10]], 0
; VPLAN-NEXT:    br i1 [[ICMP5_5_I]], label %[[BB12_5_I:.*]], label %[[BB8_5_I:.*]]
; VPLAN:       [[BB8_5_I]]:
; VPLAN-NEXT:    br label %[[BB12_5_I]]
; VPLAN:       [[BB12_5_I]]:
; VPLAN-NEXT:    [[ICMP5_7_I:%.*]] = icmp eq i8 [[TMP6]], 0
; VPLAN-NEXT:    br i1 [[ICMP5_7_I]], label %[[BB12_7_I:.*]], label %[[BB8_7_I:.*]]
; VPLAN:       [[BB8_7_I]]:
; VPLAN-NEXT:    br label %[[BB12_7_I]]
; VPLAN:       [[BB12_7_I]]:
; VPLAN-NEXT:    [[ICMP5_8_I:%.*]] = icmp eq i8 [[TMP8]], 0
; VPLAN-NEXT:    br i1 [[ICMP5_8_I]], label %[[BB12_8_I]], label %[[BB8_8_I:.*]]
; VPLAN:       [[BB8_8_I]]:
; VPLAN-NEXT:    [[TMP27:%.*]] = insertelement <8 x i8> [[TMP1]], i8 [[LOAD_8_I]], i32 3
; VPLAN-NEXT:    [[TMP28:%.*]] = insertelement <8 x i8> [[TMP27]], i8 [[TMP7]], i32 5
; VPLAN-NEXT:    [[TMP29:%.*]] = insertelement <8 x i8> [[TMP28]], i8 [[TMP9]], i32 6
; VPLAN-NEXT:    [[TMP30:%.*]] = insertelement <8 x i8> [[TMP29]], i8 [[TMP11]], i32 7
; VPLAN-NEXT:    [[TMP31:%.*]] = shufflevector <8 x i8> [[TMP30]], <8 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 3, i32 5, i32 6, i32 7>
; VPLAN-NEXT:    br label %[[BB12_8_I]]
; VPLAN:       [[BB12_8_I]]:
; VPLAN-NEXT:    [[TMP32]] = phi <8 x i8> [ [[TMP0]], %[[BB12_7_I]] ], [ [[TMP31]], %[[BB8_8_I]] ], [ [[TMP26]], %[[SPAM_EXIT]] ]
; VPLAN-NEXT:    [[TMP33]] = insertelement <2 x i64> [[TMP2]], i64 [[GETELEMENTPTR_I_I_PROMOTED346]], i32 0
; VPLAN-NEXT:    br label %[[BB2]]
;
bb:
  br label %bb2
