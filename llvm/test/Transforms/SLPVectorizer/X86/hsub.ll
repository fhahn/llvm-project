...
; RUN: opt -slp-use-vplan-codegen < %s -mtriple=x86_64-unknown -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=VPLAN,VPLAN-SSE
...
; RUN: opt -slp-use-vplan-codegen < %s -mtriple=x86_64-unknown -mcpu=corei7-avx -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=VPLAN,VPLAN-AVX,VPLAN-AVX1
; RUN: opt < %s -mtriple=x86_64-unknown -mcpu=core-avx2 -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,AVX,AVX2
; RUN: opt -slp-use-vplan-codegen < %s -mtriple=x86_64-unknown -mcpu=core-avx2 -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=VPLAN,VPLAN-AVX,VPLAN-AVX2
; RUN: opt < %s -mtriple=x86_64-unknown -mcpu=knl -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,AVX,AVX512
; RUN: opt -slp-use-vplan-codegen < %s -mtriple=x86_64-unknown -mcpu=knl -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=VPLAN,VPLAN-AVX,VPLAN-AVX512
; RUN: opt < %s -mtriple=x86_64-unknown -mcpu=skx -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,AVX,AVX512
; RUN: opt -slp-use-vplan-codegen < %s -mtriple=x86_64-unknown -mcpu=skx -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=VPLAN,VPLAN-AVX,VPLAN-AVX512
...
;
; VPLAN-LABEL: @test_v2f64(
; VPLAN-NEXT:    [[TMP2:%.*]] = shufflevector <2 x double> [[A:%.*]], <2 x double> [[B:%.*]], <2 x i32> <i32 0, i32 2>
; VPLAN-NEXT:    [[TMP4:%.*]] = shufflevector <2 x double> [[A]], <2 x double> [[B]], <2 x i32> <i32 1, i32 3>
; VPLAN-NEXT:    [[TMP5:%.*]] = fsub <2 x double> [[TMP2]], [[TMP4]]
; VPLAN-NEXT:    ret <2 x double> [[TMP5]]
;
...
;
; VPLAN-LABEL: @test_v4f32(
; VPLAN-NEXT:    [[TMP4:%.*]] = shufflevector <4 x float> [[A:%.*]], <4 x float> [[B:%.*]], <4 x i32> <i32 0, i32 2, i32 4, i32 6>
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <4 x float> [[A]], <4 x float> [[B]], <4 x i32> <i32 1, i32 3, i32 5, i32 7>
; VPLAN-NEXT:    [[TMP9:%.*]] = fsub <4 x float> [[TMP4]], [[TMP8]]
; VPLAN-NEXT:    ret <4 x float> [[TMP9]]
;
...
;
; VPLAN-LABEL: @test_v2i64(
; VPLAN-NEXT:    [[TMP2:%.*]] = shufflevector <2 x i64> [[A:%.*]], <2 x i64> [[B:%.*]], <2 x i32> <i32 0, i32 2>
; VPLAN-NEXT:    [[TMP4:%.*]] = shufflevector <2 x i64> [[A]], <2 x i64> [[B]], <2 x i32> <i32 1, i32 3>
; VPLAN-NEXT:    [[TMP5:%.*]] = sub <2 x i64> [[TMP2]], [[TMP4]]
; VPLAN-NEXT:    ret <2 x i64> [[TMP5]]
;
...
;
; VPLAN-LABEL: @test_v4i32(
; VPLAN-NEXT:    [[TMP4:%.*]] = shufflevector <4 x i32> [[A:%.*]], <4 x i32> [[B:%.*]], <4 x i32> <i32 0, i32 2, i32 4, i32 6>
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <4 x i32> [[A]], <4 x i32> [[B]], <4 x i32> <i32 1, i32 3, i32 5, i32 7>
; VPLAN-NEXT:    [[TMP9:%.*]] = sub <4 x i32> [[TMP4]], [[TMP8]]
; VPLAN-NEXT:    ret <4 x i32> [[TMP9]]
;
...
;
; VPLAN-LABEL: @test_v8i16(
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <8 x i16> [[A:%.*]], <8 x i16> [[B:%.*]], <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
; VPLAN-NEXT:    [[TMP16:%.*]] = shufflevector <8 x i16> [[A]], <8 x i16> [[B]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
; VPLAN-NEXT:    [[TMP17:%.*]] = sub <8 x i16> [[TMP8]], [[TMP16]]
; VPLAN-NEXT:    ret <8 x i16> [[TMP17]]
;
...
; SSE-NEXT:    [[TMP7:%.*]] = fsub <4 x double> [[TMP3]], [[TMP6]]
; SSE-NEXT:    ret <4 x double> [[TMP7]]
;
; VPLAN-LABEL: @test_v4f64(
; VPLAN-NEXT:    [[TMP4:%.*]] = shufflevector <4 x double> [[A:%.*]], <4 x double> [[B:%.*]], <4 x i32> <i32 0, i32 4, i32 2, i32 6>
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <4 x double> [[A]], <4 x double> [[B]], <4 x i32> <i32 1, i32 5, i32 3, i32 7>
; VPLAN-NEXT:    [[TMP9:%.*]] = fsub <4 x double> [[TMP4]], [[TMP8]]
; VPLAN-NEXT:    ret <4 x double> [[TMP9]]
;
...
; SLM-NEXT:    [[TMP7:%.*]] = fsub <4 x double> [[TMP3]], [[TMP6]]
...
; SSE-NEXT:    [[TMP7:%.*]] = fsub <8 x float> [[TMP3]], [[TMP6]]
; SSE-NEXT:    ret <8 x float> [[TMP7]]
;
; VPLAN-LABEL: @test_v8f32(
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <8 x float> [[A:%.*]], <8 x float> [[B:%.*]], <8 x i32> <i32 0, i32 2, i32 8, i32 10, i32 4, i32 6, i32 12, i32 14>
; VPLAN-NEXT:    [[TMP16:%.*]] = shufflevector <8 x float> [[A]], <8 x float> [[B]], <8 x i32> <i32 1, i32 3, i32 9, i32 11, i32 5, i32 7, i32 13, i32 15>
; VPLAN-NEXT:    [[TMP17:%.*]] = fsub <8 x float> [[TMP8]], [[TMP16]]
; VPLAN-NEXT:    ret <8 x float> [[TMP17]]
;
...
; SLM-NEXT:    [[TMP7:%.*]] = fsub <8 x float> [[TMP3]], [[TMP6]]
...
; SSE-NEXT:    [[TMP7:%.*]] = sub <4 x i64> [[TMP3]], [[TMP6]]
; SSE-NEXT:    ret <4 x i64> [[TMP7]]
;
; VPLAN-LABEL: @test_v4i64(
; VPLAN-NEXT:    [[TMP4:%.*]] = shufflevector <4 x i64> [[A:%.*]], <4 x i64> [[B:%.*]], <4 x i32> <i32 0, i32 4, i32 2, i32 6>
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <4 x i64> [[A]], <4 x i64> [[B]], <4 x i32> <i32 1, i32 5, i32 3, i32 7>
; VPLAN-NEXT:    [[TMP9:%.*]] = sub <4 x i64> [[TMP4]], [[TMP8]]
; VPLAN-NEXT:    ret <4 x i64> [[TMP9]]
;
...
; SLM-NEXT:    [[TMP7:%.*]] = sub <4 x i64> [[TMP3]], [[TMP6]]
...
; SSE-NEXT:    [[TMP7:%.*]] = sub <8 x i32> [[TMP3]], [[TMP6]]
; SSE-NEXT:    ret <8 x i32> [[TMP7]]
;
; VPLAN-LABEL: @test_v8i32(
; VPLAN-NEXT:    [[TMP8:%.*]] = shufflevector <8 x i32> [[A:%.*]], <8 x i32> [[B:%.*]], <8 x i32> <i32 0, i32 2, i32 8, i32 10, i32 4, i32 6, i32 12, i32 14>
; VPLAN-NEXT:    [[TMP16:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> [[B]], <8 x i32> <i32 1, i32 3, i32 9, i32 11, i32 5, i32 7, i32 13, i32 15>
; VPLAN-NEXT:    [[TMP17:%.*]] = sub <8 x i32> [[TMP8]], [[TMP16]]
; VPLAN-NEXT:    ret <8 x i32> [[TMP17]]
;
...
; SLM-NEXT:    [[TMP7:%.*]] = sub <8 x i32> [[TMP3]], [[TMP6]]
...
; SSE-NEXT:    [[TMP7:%.*]] = sub <16 x i16> [[TMP3]], [[TMP6]]
; SSE-NEXT:    ret <16 x i16> [[TMP7]]
;
; VPLAN-LABEL: @test_v16i16(
; VPLAN-NEXT:    [[TMP16:%.*]] = shufflevector <16 x i16> [[A:%.*]], <16 x i16> [[B:%.*]], <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 16, i32 18, i32 20, i32 22, i32 8, i32 10, i32 12, i32 14, i32 24, i32 26, i32 28, i32 30>
; VPLAN-NEXT:    [[TMP32:%.*]] = shufflevector <16 x i16> [[A]], <16 x i16> [[B]], <16 x i32> <i32 1, i32 3, i32 5, i32 7, i32 17, i32 19, i32 21, i32 23, i32 9, i32 11, i32 13, i32 15, i32 25, i32 27, i32 29, i32 31>
; VPLAN-NEXT:    [[TMP33:%.*]] = sub <16 x i16> [[TMP16]], [[TMP32]]
; VPLAN-NEXT:    ret <16 x i16> [[TMP33]]
;
...
; SLM-NEXT:    [[TMP7:%.*]] = sub <16 x i16> [[TMP3]], [[TMP6]]
