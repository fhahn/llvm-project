...
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -slp-vectorize-non-power-of-2 -S -mtriple=x86_64-unknown-linux-gnu -mcpu=bdver2 < %s | FileCheck --check-prefix=VPLAN %s
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -slp-vectorize-non-power-of-2=false -S -mtriple=x86_64-unknown-linux-gnu -mcpu=bdver2 < %s | FileCheck --check-prefix=VPLAN %s
...
; VPLAN-LABEL: @add0(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = add nsw <4 x i32> [[TMP0]], <i32 1, i32 1, i32 2, i32 3>
; VPLAN-NEXT:    store <4 x i32> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = add <4 x i32> [[TMP0]], <i32 0, i32 1, i32 2, i32 3>
; VPLAN-NEXT:    store <4 x i32> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = add <4 x i32> [[TMP0]], <i32 -1, i32 0, i32 -2, i32 -3>
; VPLAN-NEXT:    store <4 x i32> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = add nsw <4 x i32> [[TMP0]], <i32 4, i32 -1, i32 -2, i32 -3>
; VPLAN-NEXT:    store <4 x i32> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = sub <4 x i32> [[TMP0]], <i32 1, i32 -1, i32 0, i32 -3>
; VPLAN-NEXT:    store <4 x i32> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-LABEL: @mul(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[INCDEC_PTR2:%.*]] = getelementptr inbounds i32, ptr [[SRC:%.*]], i64 2
; VPLAN-NEXT:    [[INCDEC_PTR4:%.*]] = getelementptr inbounds i32, ptr [[DST:%.*]], i64 2
; VPLAN-NEXT:    [[TMP0:%.*]] = load <2 x i32>, ptr [[SRC]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = mul nsw <2 x i32> [[TMP0]], <i32 257, i32 -3>
; VPLAN-NEXT:    store <2 x i32> [[TMP1]], ptr [[DST]], align 4
; VPLAN-NEXT:    [[INCDEC_PTR5:%.*]] = getelementptr inbounds i32, ptr [[SRC]], i64 3
; VPLAN-NEXT:    [[TMP2:%.*]] = load i32, ptr [[INCDEC_PTR2]], align 4
; VPLAN-NEXT:    [[INCDEC_PTR7:%.*]] = getelementptr inbounds i32, ptr [[DST]], i64 3
; VPLAN-NEXT:    store i32 [[TMP2]], ptr [[INCDEC_PTR4]], align 4
; VPLAN-NEXT:    [[TMP3:%.*]] = load i32, ptr [[INCDEC_PTR5]], align 4
; VPLAN-NEXT:    [[MUL9:%.*]] = mul nsw i32 [[TMP3]], -9
; VPLAN-NEXT:    store i32 [[MUL9]], ptr [[INCDEC_PTR7]], align 4
; VPLAN-NEXT:    ret void
;
entry:
  %incdec.ptr = getelementptr inbounds i32, ptr %src, i64 1
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = shl <4 x i32> [[TMP0]], <i32 0, i32 1, i32 2, i32 3>
; VPLAN-NEXT:    store <4 x i32> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = shl <4 x i32> [[TMP0]], <i32 7, i32 1, i32 2, i32 3>
; VPLAN-NEXT:    store <4 x i32> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-LABEL: @add0f(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = fadd fast <4 x float> [[TMP0]], <float 1.000000e+00, float 1.000000e+00, float 2.000000e+00, float 3.000000e+00>
; VPLAN-NEXT:    store <4 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = fadd <4 x float> [[TMP0]], <float -0.000000e+00, float 1.000000e+00, float 2.000000e+00, float 3.000000e+00>
; VPLAN-NEXT:    store <4 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = fadd <4 x float> [[TMP0]], <float -1.000000e+00, float -0.000000e+00, float -2.000000e+00, float -3.000000e+00>
; VPLAN-NEXT:    store <4 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = fadd fast <4 x float> [[TMP0]], <float 4.000000e+00, float -1.000000e+00, float -2.000000e+00, float -3.000000e+00>
; VPLAN-NEXT:    store <4 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: @addsub0f(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[INCDEC_PTR:%.*]] = getelementptr inbounds float, ptr [[SRC:%.*]], i64 1
; VPLAN-NEXT:    [[TMP0:%.*]] = load float, ptr [[SRC]], align 4
; VPLAN-NEXT:    [[SUB:%.*]] = fadd fast float [[TMP0]], -1.000000e+00
; VPLAN-NEXT:    [[INCDEC_PTR1:%.*]] = getelementptr inbounds float, ptr [[DST:%.*]], i64 1
; VPLAN-NEXT:    store float [[SUB]], ptr [[DST]], align 4
; VPLAN-NEXT:    [[INCDEC_PTR2:%.*]] = getelementptr inbounds float, ptr [[SRC]], i64 2
; VPLAN-NEXT:    [[TMP1:%.*]] = load float, ptr [[INCDEC_PTR]], align 4
; VPLAN-NEXT:    [[INCDEC_PTR3:%.*]] = getelementptr inbounds float, ptr [[DST]], i64 2
; VPLAN-NEXT:    store float [[TMP1]], ptr [[INCDEC_PTR1]], align 4
; VPLAN-NEXT:    [[TMP2:%.*]] = load <2 x float>, ptr [[INCDEC_PTR2]], align 4
; VPLAN-NEXT:    [[TMP3:%.*]] = fadd fast <2 x float> [[TMP2]], <float -2.000000e+00, float -3.000000e+00>
; VPLAN-NEXT:    [[TMP4:%.*]] = fsub fast <2 x float> [[TMP2]], <float -2.000000e+00, float -3.000000e+00>
; VPLAN-NEXT:    [[TMP5:%.*]] = shufflevector <2 x float> [[TMP3]], <2 x float> [[TMP4]], <2 x i32> <i32 0, i32 3>
; VPLAN-NEXT:    store <2 x float> [[TMP5]], ptr [[INCDEC_PTR3]], align 4
; VPLAN-NEXT:    ret void
;
entry:
  %incdec.ptr = getelementptr inbounds float, ptr %src, i64 1
...
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: @addsub1f(
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[INCDEC_PTR2:%.*]] = getelementptr inbounds float, ptr [[SRC:%.*]], i64 2
; VPLAN-NEXT:    [[INCDEC_PTR3:%.*]] = getelementptr inbounds float, ptr [[DST:%.*]], i64 2
; VPLAN-NEXT:    [[TMP0:%.*]] = load <2 x float>, ptr [[SRC]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = fadd fast <2 x float> [[TMP0]], splat (float -1.000000e+00)
; VPLAN-NEXT:    [[TMP2:%.*]] = fsub fast <2 x float> [[TMP0]], splat (float -1.000000e+00)
; VPLAN-NEXT:    [[TMP3:%.*]] = shufflevector <2 x float> [[TMP1]], <2 x float> [[TMP2]], <2 x i32> <i32 0, i32 3>
; VPLAN-NEXT:    store <2 x float> [[TMP3]], ptr [[DST]], align 4
; VPLAN-NEXT:    [[INCDEC_PTR4:%.*]] = getelementptr inbounds float, ptr [[SRC]], i64 3
; VPLAN-NEXT:    [[TMP4:%.*]] = load float, ptr [[INCDEC_PTR2]], align 4
; VPLAN-NEXT:    [[INCDEC_PTR6:%.*]] = getelementptr inbounds float, ptr [[DST]], i64 3
; VPLAN-NEXT:    store float [[TMP4]], ptr [[INCDEC_PTR3]], align 4
; VPLAN-NEXT:    [[TMP5:%.*]] = load float, ptr [[INCDEC_PTR4]], align 4
; VPLAN-NEXT:    [[SUB8:%.*]] = fsub fast float [[TMP5]], -3.000000e+00
; VPLAN-NEXT:    store float [[SUB8]], ptr [[INCDEC_PTR6]], align 4
; VPLAN-NEXT:    ret void
;
entry:
  %incdec.ptr = getelementptr inbounds float, ptr %src, i64 1
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = fmul <4 x float> [[TMP0]], <float 2.570000e+02, float -3.000000e+00, float 1.000000e+00, float -9.000000e+00>
; VPLAN-NEXT:    store <4 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = fadd <4 x float> [[TMP0]], <float 1.000000e+00, float 1.000000e+00, float 2.000000e+00, float 3.000000e+00>
; VPLAN-NEXT:    store <4 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
...
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[SRC:%.*]], align 4
; VPLAN-NEXT:    [[TMP1:%.*]] = fadd <4 x float> [[TMP0]], <float 4.000000e+00, float -1.000000e+00, float -2.000000e+00, float -3.000000e+00>
; VPLAN-NEXT:    store <4 x float> [[TMP1]], ptr [[DST:%.*]], align 4
; VPLAN-NEXT:    ret void
;
entry:
