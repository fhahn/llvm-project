...
; PADDING-NEXT:    [[TMP2:%.*]] = add nsw <3 x i32> [[TMP1]], <i32 1, i32 2, i32 3>
; PADDING-NEXT:    store <3 x i32> [[TMP2]], ptr [[INCDEC_PTR1]], align 4
...
; PADDING-NEXT:    store i32 [[TMP0]], ptr [[DST]], align 4
; PADDING-NEXT:    [[TMP1:%.*]] = load <3 x i32>, ptr [[INCDEC_PTR]], align 4
; PADDING-NEXT:    [[TMP2:%.*]] = shl <3 x i32> [[TMP1]], <i32 1, i32 2, i32 3>
; PADDING-NEXT:    store <3 x i32> [[TMP2]], ptr [[INCDEC_PTR1]], align 4
; PADDING-NEXT:    ret void
;
...
; PADDING-NEXT:    [[TMP2:%.*]] = fadd fast <3 x float> [[TMP1]], <float 1.000000e+00, float 2.000000e+00, float 3.000000e+00>
; PADDING-NEXT:    store <3 x float> [[TMP2]], ptr [[INCDEC_PTR1]], align 4
; PADDING-NEXT:    ret void
;
...
; PADDING-NEXT:    store float [[TMP0]], ptr [[DST]], align 4
; PADDING-NEXT:    [[TMP1:%.*]] = load <3 x float>, ptr [[INCDEC_PTR]], align 4
; PADDING-NEXT:    [[TMP2:%.*]] = fadd <3 x float> [[TMP1]], <float 1.000000e+00, float 2.000000e+00, float 3.000000e+00>
; PADDING-NEXT:    store <3 x float> [[TMP2]], ptr [[INCDEC_PTR1]], align 4
; PADDING-NEXT:    ret void
;
