...
; RUN: opt -passes=slp-vectorizer -slp-threshold=-999 -S -mtriple=x86_64-unknown-linux-gnu -mcpu=skylake < %s | FileCheck --check-prefixes=CHECK,LEGACY %s
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -slp-threshold=-999 -S -mtriple=x86_64-unknown-linux-gnu -mcpu=skylake < %s | FileCheck --check-prefixes=CHECK,VPLAN %s
...
; LEGACY-LABEL: @basecase(
; LEGACY-NEXT:    [[TMP1:%.*]] = load <2 x ptr>, ptr [[A:%.*]], align 8
; LEGACY-NEXT:    store ptr null, ptr [[A]], align 8
; LEGACY-NEXT:    [[TMP2:%.*]] = getelementptr i8, <2 x ptr> [[TMP1]], <2 x i32> splat (i32 1)
; LEGACY-NEXT:    store <2 x ptr> [[TMP2]], ptr [[B:%.*]], align 8
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @basecase(
; VPLAN-NEXT:    [[TMP1:%.*]] = load <2 x ptr>, ptr [[A:%.*]], align 8
; VPLAN-NEXT:    store ptr null, ptr [[A]], align 8
; VPLAN-NEXT:    [[TMP2:%.*]] = getelementptr i8, <2 x ptr> [[TMP1]], <2 x i32> splat (i32 1)
; VPLAN-NEXT:    store <2 x ptr> [[TMP2]], ptr [[B:%.*]], align 8
; VPLAN-NEXT:    ret void
;
...
; LEGACY-LABEL: @allocas(
; LEGACY-NEXT:    [[V1:%.*]] = alloca i8, align 1
; LEGACY-NEXT:    [[V2:%.*]] = alloca i8, align 1
; LEGACY-NEXT:    [[TMP1:%.*]] = insertelement <2 x ptr> poison, ptr [[V1]], i32 0
; LEGACY-NEXT:    [[TMP2:%.*]] = insertelement <2 x ptr> [[TMP1]], ptr [[V2]], i32 1
; LEGACY-NEXT:    [[TMP3:%.*]] = getelementptr i8, <2 x ptr> [[TMP2]], <2 x i32> splat (i32 1)
; LEGACY-NEXT:    [[ADD1:%.*]] = getelementptr i8, ptr [[V1]], i32 1
; LEGACY-NEXT:    store ptr [[ADD1]], ptr [[A:%.*]], align 8
; LEGACY-NEXT:    store <2 x ptr> [[TMP3]], ptr [[B:%.*]], align 8
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @allocas(
; VPLAN-NEXT:    [[V1:%.*]] = alloca i8, align 1
; VPLAN-NEXT:    [[V2:%.*]] = alloca i8, align 1
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x ptr> poison, ptr [[V1]], i32 0
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <2 x ptr> [[TMP1]], ptr [[V2]], i32 1
; VPLAN-NEXT:    [[TMP3:%.*]] = getelementptr i8, <2 x ptr> [[TMP2]], <2 x i32> splat (i32 1)
; VPLAN-NEXT:    [[TMP4:%.*]] = extractelement <2 x ptr> [[TMP3]], i32 0
; VPLAN-NEXT:    store ptr [[TMP4]], ptr [[A:%.*]], align 8
; VPLAN-NEXT:    store <2 x ptr> [[TMP3]], ptr [[B:%.*]], align 8
; VPLAN-NEXT:    ret void
;
...
; LEGACY-LABEL: @stacksave2(
; LEGACY-NEXT:    [[V1:%.*]] = alloca i8, align 1
; LEGACY-NEXT:    [[STACK:%.*]] = call ptr @llvm.stacksave.p0()
; LEGACY-NEXT:    [[V2:%.*]] = alloca inalloca i8, align 1
; LEGACY-NEXT:    [[TMP1:%.*]] = insertelement <2 x ptr> poison, ptr [[V1]], i32 0
; LEGACY-NEXT:    [[TMP2:%.*]] = insertelement <2 x ptr> [[TMP1]], ptr [[V2]], i32 1
; LEGACY-NEXT:    [[TMP3:%.*]] = getelementptr i8, <2 x ptr> [[TMP2]], <2 x i32> splat (i32 1)
; LEGACY-NEXT:    [[ADD1:%.*]] = getelementptr i8, ptr [[V1]], i32 1
; LEGACY-NEXT:    store ptr [[ADD1]], ptr [[A:%.*]], align 8
; LEGACY-NEXT:    call void @use(ptr inalloca(i8) [[V2]]) #[[ATTR5:[0-9]+]]
; LEGACY-NEXT:    call void @llvm.stackrestore.p0(ptr [[STACK]])
; LEGACY-NEXT:    store <2 x ptr> [[TMP3]], ptr [[B:%.*]], align 8
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @stacksave2(
; VPLAN-NEXT:    [[V1:%.*]] = alloca i8, align 1
; VPLAN-NEXT:    [[STACK:%.*]] = call ptr @llvm.stacksave.p0()
; VPLAN-NEXT:    [[V2:%.*]] = alloca inalloca i8, align 1
; VPLAN-NEXT:    [[TMP1:%.*]] = insertelement <2 x ptr> poison, ptr [[V1]], i32 0
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <2 x ptr> [[TMP1]], ptr [[V2]], i32 1
; VPLAN-NEXT:    [[TMP3:%.*]] = getelementptr i8, <2 x ptr> [[TMP2]], <2 x i32> splat (i32 1)
; VPLAN-NEXT:    [[TMP4:%.*]] = extractelement <2 x ptr> [[TMP3]], i32 0
; VPLAN-NEXT:    store ptr [[TMP4]], ptr [[A:%.*]], align 8
; VPLAN-NEXT:    call void @use(ptr inalloca(i8) [[V2]]) #[[ATTR5:[0-9]+]]
; VPLAN-NEXT:    call void @llvm.stackrestore.p0(ptr [[STACK]])
; VPLAN-NEXT:    store <2 x ptr> [[TMP3]], ptr [[B:%.*]], align 8
; VPLAN-NEXT:    ret void
;
...
; LEGACY-LABEL: @stacksave4(
; LEGACY-NEXT:    [[TMP1:%.*]] = load <2 x ptr>, ptr [[A:%.*]], align 8
; LEGACY-NEXT:    [[TMP2:%.*]] = getelementptr i8, <2 x ptr> [[TMP1]], <2 x i32> splat (i32 1)
; LEGACY-NEXT:    [[STACK:%.*]] = call ptr @llvm.stacksave.p0()
; LEGACY-NEXT:    [[X:%.*]] = alloca inalloca i8, align 1
; LEGACY-NEXT:    call void @use(ptr inalloca(i8) [[X]]) #[[ATTR4]]
; LEGACY-NEXT:    call void @llvm.stackrestore.p0(ptr [[STACK]])
; LEGACY-NEXT:    store <2 x ptr> [[TMP2]], ptr [[B:%.*]], align 8
; LEGACY-NEXT:    ret void
;
; VPLAN-LABEL: @stacksave4(
; VPLAN-NEXT:    [[TMP1:%.*]] = load <2 x ptr>, ptr [[A:%.*]], align 8
; VPLAN-NEXT:    [[TMP2:%.*]] = getelementptr i8, <2 x ptr> [[TMP1]], <2 x i32> splat (i32 1)
; VPLAN-NEXT:    [[STACK:%.*]] = call ptr @llvm.stacksave.p0()
; VPLAN-NEXT:    [[X:%.*]] = alloca inalloca i8, align 1
; VPLAN-NEXT:    call void @use(ptr inalloca(i8) [[X]]) #[[ATTR4]]
; VPLAN-NEXT:    call void @llvm.stackrestore.p0(ptr [[STACK]])
; VPLAN-NEXT:    store <2 x ptr> [[TMP2]], ptr [[B:%.*]], align 8
; VPLAN-NEXT:    ret void
;
