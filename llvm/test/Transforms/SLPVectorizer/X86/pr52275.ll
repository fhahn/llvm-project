...
; RUN: opt -slp-use-vplan-codegen < %s -passes=slp-vectorizer -S -mcpu=core-i7 | FileCheck %s
; RUN: opt < %s -passes=slp-vectorizer -slp-threshold=-100 -S -mcpu=core-i7 | FileCheck %s --check-prefix=FORCE_SLP
; RUN: opt -slp-use-vplan-codegen < %s -passes=slp-vectorizer -slp-threshold=-100 -S -mcpu=core-i7 | FileCheck %s --check-prefix=FORCE_SLP
