...
; RUN: %if aarch64-registered-target %{ opt -S -passes=slp-vectorizer -slp-use-vplan-codegen -mtriple aarch64-unknown-linux-gnu < %s | FileCheck %s --check-prefix=AARCH86 %}
