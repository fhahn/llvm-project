...
; RUN: opt -mtriple=riscv64 -mcpu=sifive-p870-d -passes=slp-vectorizer -S -slp-revec -slp-enable-strided-stores -slp-threshold=-100 %s | FileCheck %s
; RUN: opt -slp-use-vplan-codegen -mtriple=riscv64 -mcpu=sifive-p870-d -passes=slp-vectorizer -S -slp-revec -slp-enable-strided-stores -slp-threshold=-100 %s | FileCheck %s
...
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP4]] to <2 x i64>
