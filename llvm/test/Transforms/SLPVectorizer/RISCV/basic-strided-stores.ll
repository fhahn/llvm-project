...
; RUN: opt -mtriple=riscv64 -mattr=+m,+v -passes=slp-vectorizer -slp-use-vplan-codegen -S < %s | FileCheck --check-prefix=VPLAN %s
...
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: define void @constant_stride_2(
; VPLAN-SAME: ptr [[PL:%.*]], ptr [[PS:%.*]]) #[[ATTR0:[0-9]+]] {
...
; VPLAN-NEXT:    [[GEP_S5:%.*]] = getelementptr i8, ptr [[PS]], i64 10
; VPLAN-NEXT:    [[GEP_S6:%.*]] = getelementptr i8, ptr [[PS]], i64 12
; VPLAN-NEXT:    [[GEP_S7:%.*]] = getelementptr i8, ptr [[PS]], i64 14
...
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: define void @constant_stride_7(
...
; VPLAN-NEXT:    [[LOAD7:%.*]] = load i8, ptr [[GEP_L7]], align 1
; VPLAN-NEXT:    [[GEP_S0:%.*]] = getelementptr i8, ptr [[PS]], i64 0
; VPLAN-NEXT:    [[GEP_S1:%.*]] = getelementptr i8, ptr [[PS]], i64 7
; VPLAN-NEXT:    [[GEP_S2:%.*]] = getelementptr i8, ptr [[PS]], i64 14
; VPLAN-NEXT:    [[GEP_S3:%.*]] = getelementptr i8, ptr [[PS]], i64 21
; VPLAN-NEXT:    [[GEP_S4:%.*]] = getelementptr i8, ptr [[PS]], i64 28
; VPLAN-NEXT:    [[GEP_S5:%.*]] = getelementptr i8, ptr [[PS]], i64 35
; VPLAN-NEXT:    [[GEP_S6:%.*]] = getelementptr i8, ptr [[PS]], i64 42
; VPLAN-NEXT:    [[GEP_S7:%.*]] = getelementptr i8, ptr [[PS]], i64 49
; VPLAN-NEXT:    store i8 [[LOAD0]], ptr [[GEP_S0]], align 1
; VPLAN-NEXT:    store i8 [[LOAD1]], ptr [[GEP_S1]], align 1
; VPLAN-NEXT:    store i8 [[LOAD2]], ptr [[GEP_S2]], align 1
; VPLAN-NEXT:    store i8 [[LOAD3]], ptr [[GEP_S3]], align 1
...
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: define void @constant_stride_0(
; VPLAN-SAME: ptr [[PL:%.*]], ptr [[PS:%.*]]) #[[ATTR0]] {
; VPLAN-NEXT:    [[GEP_L0:%.*]] = getelementptr i8, ptr [[PL]], i64 0
; VPLAN-NEXT:    [[GEP_L1:%.*]] = getelementptr i8, ptr [[PL]], i64 1
; VPLAN-NEXT:    [[GEP_L2:%.*]] = getelementptr i8, ptr [[PL]], i64 2
...
; VPLAN-NEXT:    [[LOAD6:%.*]] = load i8, ptr [[GEP_L6]], align 1
; VPLAN-NEXT:    [[LOAD7:%.*]] = load i8, ptr [[GEP_L7]], align 1
; VPLAN-NEXT:    store i8 [[LOAD0]], ptr [[PS]], align 1
; VPLAN-NEXT:    store i8 [[LOAD1]], ptr [[PS]], align 1
; VPLAN-NEXT:    store i8 [[LOAD2]], ptr [[PS]], align 1
; VPLAN-NEXT:    store i8 [[LOAD3]], ptr [[PS]], align 1
; VPLAN-NEXT:    store i8 [[LOAD4]], ptr [[PS]], align 1
; VPLAN-NEXT:    store i8 [[LOAD5]], ptr [[PS]], align 1
; VPLAN-NEXT:    store i8 [[LOAD6]], ptr [[PS]], align 1
; VPLAN-NEXT:    store i8 [[LOAD7]], ptr [[PS]], align 1
; VPLAN-NEXT:    ret void
;
  %gep_l0 = getelementptr i8, ptr %pl, i64 0
  %gep_l1 = getelementptr i8, ptr %pl, i64 1
...
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: define void @two_constant_strides(
; VPLAN-SAME: ptr [[PL:%.*]], ptr [[PS:%.*]]) #[[ATTR0]] {
; VPLAN-NEXT:    [[GEP_L0:%.*]] = getelementptr i8, ptr [[PL]], i64 0
; VPLAN-NEXT:    [[GEP_L1:%.*]] = getelementptr i8, ptr [[PL]], i64 1
; VPLAN-NEXT:    [[GEP_L2:%.*]] = getelementptr i8, ptr [[PL]], i64 2
...
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: define void @constant_strides_variable_gap(
; VPLAN-SAME: ptr [[PL:%.*]], ptr [[PS:%.*]], i64 [[GAP:%.*]]) #[[ATTR0]] {
; VPLAN-NEXT:    [[GEP_L0:%.*]] = getelementptr i8, ptr [[PL]], i64 0
; VPLAN-NEXT:    [[GEP_L1:%.*]] = getelementptr i8, ptr [[PL]], i64 1
; VPLAN-NEXT:    [[GEP_L2:%.*]] = getelementptr i8, ptr [[PL]], i64 2
; VPLAN-NEXT:    [[GEP_L3:%.*]] = getelementptr i8, ptr [[PL]], i64 3
...
; VPLAN-NEXT:    [[GEP_S2:%.*]] = getelementptr i8, ptr [[PS]], i64 14
; VPLAN-NEXT:    [[GEP_S3:%.*]] = getelementptr i8, ptr [[PS]], i64 21
; VPLAN-NEXT:    [[GAP_PS:%.*]] = getelementptr i8, ptr [[PS]], i64 [[GAP]]
; VPLAN-NEXT:    [[GEP_S4:%.*]] = getelementptr i8, ptr [[GAP_PS]], i64 28
; VPLAN-NEXT:    [[GEP_S5:%.*]] = getelementptr i8, ptr [[GAP_PS]], i64 35
; VPLAN-NEXT:    [[GEP_S6:%.*]] = getelementptr i8, ptr [[GAP_PS]], i64 42
; VPLAN-NEXT:    [[GEP_S7:%.*]] = getelementptr i8, ptr [[GAP_PS]], i64 49
; VPLAN-NEXT:    store i8 [[LOAD0]], ptr [[GEP_S0]], align 1
; VPLAN-NEXT:    store i8 [[LOAD1]], ptr [[GEP_S1]], align 1
; VPLAN-NEXT:    store i8 [[LOAD2]], ptr [[GEP_S2]], align 1
; VPLAN-NEXT:    store i8 [[LOAD3]], ptr [[GEP_S3]], align 1
...
; CHECK-NEXT:    ret void
;
; VPLAN-LABEL: define void @overlapping_strides(
; VPLAN-SAME: ptr [[PL:%.*]], ptr [[PS:%.*]]) #[[ATTR0]] {
; VPLAN-NEXT:    [[GEP_L0:%.*]] = getelementptr i8, ptr [[PL]], i64 0
; VPLAN-NEXT:    [[GEP_L1:%.*]] = getelementptr i8, ptr [[PL]], i64 1
; VPLAN-NEXT:    [[GEP_L2:%.*]] = getelementptr i8, ptr [[PL]], i64 2
...
; VPLAN-NEXT:    [[GEP_S5:%.*]] = getelementptr i8, ptr [[PS]], i64 8
; VPLAN-NEXT:    [[GEP_S6:%.*]] = getelementptr i8, ptr [[PS]], i64 11
; VPLAN-NEXT:    [[GEP_S7:%.*]] = getelementptr i8, ptr [[PS]], i64 14
; VPLAN-NEXT:    store i8 [[LOAD0]], ptr [[GEP_S0]], align 1
; VPLAN-NEXT:    store i8 [[LOAD1]], ptr [[GEP_S1]], align 1
; VPLAN-NEXT:    store i8 [[LOAD2]], ptr [[GEP_S2]], align 1
