...
; RUN: opt --passes=slp-vectorizer -slp-use-vplan-codegen --mtriple=riscv64 -mattr="+v,+zvfh" -S < %s | FileCheck %s
; RUN: opt --passes=slp-vectorizer -slp-use-vplan-codegen --mtriple=riscv64 -mattr="+v,+zvfhmin" -S < %s | FileCheck %s --check-prefix=ZVFHMIN
