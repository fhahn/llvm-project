...
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -S -slp-threshold=-19 -mattr=+v -mtriple riscv32 < %s | FileCheck %s
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -S -slp-threshold=-55 -mattr=+v -mtriple riscv32 < %s | FileCheck %s --check-prefix=EXP
