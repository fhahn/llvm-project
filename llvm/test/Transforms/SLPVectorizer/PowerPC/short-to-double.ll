...
; RUN: opt -S -mtriple=powerpc64-linux-gnu -mcpu=pwr9 -mattr=+vsx -passes=slp-vectorizer -slp-use-vplan-codegen < %s | FileCheck %s --check-prefix=CHECK-P9
; RUN: opt -S -mtriple=powerpc64-linux-gnu -mcpu=pwr8 -mattr=+vsx -passes=slp-vectorizer -slp-use-vplan-codegen < %s | FileCheck %s --check-prefix=CHECK-P8
