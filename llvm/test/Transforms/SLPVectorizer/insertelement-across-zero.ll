...
; RUN: opt -S --passes=slp-vectorizer -slp-use-vplan-codegen < %s | FileCheck --check-prefix=VPLAN %s
...
; CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <16 x i8> [[LUPTO132421]], <16 x i8> <i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 0, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison>, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 23, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP5:%.*]] = insertelement <16 x i8> [[TMP4]], i8 [[TMP0]], i32 0
; CHECK-NEXT:    [[TMP6:%.*]] = insertelement <16 x i8> [[TMP5]], i8 [[TMP1]], i32 1
...
; VPLAN-SAME: i8 [[TMP0:%.*]], i8 [[TMP1:%.*]]) {
; VPLAN-NEXT:  entry:
; VPLAN-NEXT:    [[TMP2:%.*]] = load <8 x i8>, ptr getelementptr (i8, ptr null, i32 8), align 1
; VPLAN-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i8> [[TMP2]], <8 x i8> poison, <16 x i32> <i32 7, i32 6, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison>
; VPLAN-NEXT:    [[LUPTO132421:%.*]] = shufflevector <16 x i8> zeroinitializer, <16 x i8> [[TMP3]], <16 x i32> <i32 16, i32 17, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 14, i32 15>
; VPLAN-NEXT:    [[LI15:%.*]] = extractelement <16 x i8> [[LUPTO132421]], i64 15
; VPLAN-NEXT:    [[TMP4:%.*]] = insertelement <16 x i8> <i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 0, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison, i8 poison>, i8 [[TMP0]], i32 0
; VPLAN-NEXT:    [[TMP5:%.*]] = insertelement <16 x i8> [[TMP4]], i8 [[TMP1]], i32 1
; VPLAN-NEXT:    [[TMP6:%.*]] = insertelement <16 x i8> [[TMP5]], i8 [[TMP0]], i32 2
; VPLAN-NEXT:    [[TMP7:%.*]] = insertelement <16 x i8> [[TMP6]], i8 [[TMP0]], i32 3
; VPLAN-NEXT:    [[TMP8:%.*]] = insertelement <16 x i8> [[TMP7]], i8 [[TMP0]], i32 4
; VPLAN-NEXT:    [[TMP9:%.*]] = insertelement <16 x i8> [[TMP8]], i8 [[TMP0]], i32 5
; VPLAN-NEXT:    [[TMP10:%.*]] = insertelement <16 x i8> [[TMP9]], i8 [[TMP0]], i32 6
; VPLAN-NEXT:    [[TMP11:%.*]] = insertelement <16 x i8> [[TMP10]], i8 [[TMP0]], i32 8
; VPLAN-NEXT:    [[TMP12:%.*]] = shufflevector <8 x i8> [[TMP2]], <8 x i8> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-NEXT:    [[TMP13:%.*]] = shufflevector <16 x i8> [[TMP11]], <16 x i8> [[TMP12]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 17, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; VPLAN-NEXT:    [[TMP14:%.*]] = insertelement <16 x i8> [[TMP13]], i8 [[TMP0]], i32 10
; VPLAN-NEXT:    [[TMP15:%.*]] = insertelement <16 x i8> [[TMP14]], i8 [[TMP0]], i32 11
; VPLAN-NEXT:    [[TMP16:%.*]] = insertelement <16 x i8> [[TMP15]], i8 [[TMP0]], i32 12
; VPLAN-NEXT:    [[TMP17:%.*]] = insertelement <16 x i8> [[TMP16]], i8 [[TMP0]], i32 13
; VPLAN-NEXT:    [[TMP18:%.*]] = insertelement <16 x i8> [[TMP17]], i8 [[TMP0]], i32 14
; VPLAN-NEXT:    [[TMP19:%.*]] = insertelement <16 x i8> [[TMP18]], i8 [[LI15]], i32 15
; VPLAN-NEXT:    [[TMP20:%.*]] = icmp ne <16 x i8> zeroinitializer, [[TMP19]]
; VPLAN-NEXT:    ret void
;
entry:
