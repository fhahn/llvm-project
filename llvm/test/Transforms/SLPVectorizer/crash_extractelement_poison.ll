...
; VPLAN-NEXT:  [[ENTRY:.*:]]
; VPLAN-NEXT:    [[L:%.*]] = load <4 x i8>, ptr getelementptr (i8, ptr null, i32 8), align 1
; VPLAN-NEXT:    [[LI15:%.*]] = extractelement <4 x i8> [[L]], i64 15
; VPLAN-NEXT:    [[TMP2:%.*]] = insertelement <4 x i8> poison, i8 [[TMP0]], i32 0
; VPLAN-NEXT:    [[TMP3:%.*]] = insertelement <4 x i8> [[TMP2]], i8 [[TMP1]], i32 1
; VPLAN-NEXT:    [[TMP4:%.*]] = insertelement <4 x i8> [[TMP3]], i8 [[TMP0]], i32 2
; VPLAN-NEXT:    [[TMP5:%.*]] = insertelement <4 x i8> [[TMP4]], i8 [[LI15]], i32 3
; VPLAN-NEXT:    [[TMP6:%.*]] = icmp ne <4 x i8> [[TMP5]], zeroinitializer
; VPLAN-NEXT:    ret void
;
entry:
