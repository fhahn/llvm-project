...
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -S -slp-revec -slp-max-reg-size=1024 -slp-threshold=-100 %s | FileCheck %s
; RUN: opt -passes=slp-vectorizer -slp-use-vplan-codegen -S -slp-revec -slp-max-reg-size=1024 -slp-threshold=-100 %s | FileCheck %s --check-prefix COMBINE
