...
; CHECK-ORDERED-TF-NEXT:    [[TMP15:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-ORDERED-TF-NEXT:    [[TMP16:%.*]] = mul i64 [[TMP15]], 8
>>>>>>> daeefff9fb72 ([VPlan] Replace CalculateTripCountMinusVF with explicit VPInstructions (WIP).)
...
>>>>>>> 0841855a0e63 ([VPlan] Replace CalculateTripCountMinusVF with explicit VPInstructions (WIP).)
...
>>>>>>> c04b7e5c6ab0 ([VPlan] Initial modeling of runtime VF * UF as VPValue.)
=======
; CHECK-ORDERED-TF-NEXT:    [[TMP13:%.*]] = sub i64 [[N]], [[TMP6]]
; CHECK-ORDERED-TF-NEXT:    [[TMP14:%.*]] = sub i64 [[N]], [[TMP6]]
; CHECK-ORDERED-TF-NEXT:    [[TMP15:%.*]] = sub i64 [[N]], [[TMP6]]
