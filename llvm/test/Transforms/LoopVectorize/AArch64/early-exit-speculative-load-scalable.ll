...
; CHECK-SAME: i64 [[CHUNK_START:%.*]], ptr [[A:%.*]], ptr [[B:%.*]]) #[[ATTR1:[0-9]+]] {
; CHECK-NEXT:  [[ORACLE_ENTRY:.*]]:
; CHECK-NEXT:    [[TMP0:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-NEXT:    [[TMP1:%.*]] = mul nuw i64 [[TMP0]], 16
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[ADJUSTED_IV:%.*]] = phi i64 [ [[CHUNK_START]], %[[ORACLE_ENTRY]] ], [ [[TMP10:%.*]], %[[LOOP_LATCH:.*]] ]
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 1, %[[ORACLE_ENTRY]] ], [ [[TMP9:%.*]], %[[LOOP_LATCH]] ]
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[ADJUSTED_IV]]
; CHECK-NEXT:    [[TMP5:%.*]] = load i8, ptr [[TMP4]], align 1
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[ADJUSTED_IV]]
...
; CHECK-NEXT:    [[TMP11:%.*]] = icmp eq i64 [[INDEX]], [[TMP1]]
; CHECK-NEXT:    br i1 [[TMP11]], label %[[ORACLE_EXIT]], label %[[LOOP]]
; CHECK:       [[ORACLE_EXIT]]:
; CHECK-NEXT:    ret i64 [[INDEX]]
;
;.
