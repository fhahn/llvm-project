...
; CHECK-NEXT:    [[TMP26:%.*]] = zext i8 [[TMP25]] to i64
; CHECK-NEXT:    [[TMP28:%.*]] = or i64 [[TMP26]], 1
...
; CHECK-NEXT:    store i64 [[TMP28]], ptr [[TMP115]], align 8, !alias.scope [[META3]]
...
; CHECK-NEXT:    store i64 [[TMP28]], ptr [[TMP121]], align 8, !alias.scope [[META3]]
...
; CHECK-NEXT:    store i64 [[TMP28]], ptr [[TMP40]], align 8, !alias.scope [[META3]]
...
; CHECK-NEXT:    store i64 [[TMP28]], ptr [[TMP45]], align 8, !alias.scope [[META3]]
