...
; CHECK:       [[ORACLE_EXIT]]:
; CHECK-NEXT:    [[TMP11:%.*]] = mul i64 [[VEC_PHI]], 2
...
; CHECK-NEXT:    br i1 [[TMP9]], label %[[ORACLE_EXIT]], label %[[LOOP]]
; CHECK:       [[ORACLE_EXIT]]:
; CHECK-NEXT:    [[TMP11:%.*]] = mul i64 [[VEC_PHI]], 4
; CHECK-NEXT:    ret i64 [[TMP11]]
;
;
; CHECK-LABEL: define internal i64 @speculativeLoadOracle.2(
; CHECK-SAME: i64 [[CHUNK_START:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], ptr [[C:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  [[ORACLE_ENTRY:.*]]:
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[ADJUSTED_IV:%.*]] = phi i64 [ [[CHUNK_START]], %[[ORACLE_ENTRY]] ], [ [[TMP11:%.*]], %[[LOOP_LATCH:.*]] ]
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi i64 [ 1, %[[ORACLE_ENTRY]] ], [ [[TMP10:%.*]], %[[LOOP_LATCH]] ]
...
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i8, ptr [[C]], i64 [[ADJUSTED_IV]]
