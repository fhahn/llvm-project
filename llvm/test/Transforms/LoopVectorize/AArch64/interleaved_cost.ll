...
; VF_2:         Found an estimated cost of 6 for VF 2 For instruction: %tmp2 = load i64, ptr %tmp0, align 8
; VF_2-NEXT:    Found an estimated cost of 6 for VF 2 For instruction: %tmp3 = load i64, ptr %tmp1, align 8
