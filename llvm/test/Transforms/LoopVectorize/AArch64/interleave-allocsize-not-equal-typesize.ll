...
; CHECK-NEXT:    [[TMP28:%.*]] = getelementptr inbounds i64, ptr [[SRC]], i64 [[TMP0]]
; CHECK-NEXT:    [[TMP29:%.*]] = getelementptr inbounds i64, ptr [[SRC]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP30:%.*]] = getelementptr inbounds i64, ptr [[SRC]], i64 [[TMP2]]
; CHECK-NEXT:    [[TMP31:%.*]] = getelementptr inbounds i64, ptr [[SRC]], i64 [[TMP3]]
; CHECK-NEXT:    [[WIDE_VEC:%.*]] = load <4 x i32>, ptr [[TMP28]], align 4, !alias.scope [[META0:![0-9]+]]
; CHECK-NEXT:    [[STRIDED_VEC:%.*]] = shufflevector <4 x i32> [[WIDE_VEC]], <4 x i32> poison, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[WIDE_VEC2:%.*]] = load <4 x i32>, ptr [[TMP30]], align 4, !alias.scope [[META0]]
; CHECK-NEXT:    [[STRIDED_VEC3:%.*]] = shufflevector <4 x i32> [[WIDE_VEC2]], <4 x i32> poison, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP40:%.*]] = getelementptr inbounds i32, ptr [[TMP28]], i64 1
; CHECK-NEXT:    [[TMP42:%.*]] = getelementptr inbounds i32, ptr [[TMP29]], i64 1
; CHECK-NEXT:    [[TMP44:%.*]] = getelementptr inbounds i32, ptr [[TMP30]], i64 1
; CHECK-NEXT:    [[TMP46:%.*]] = getelementptr inbounds i32, ptr [[TMP31]], i64 1
; CHECK-NEXT:    [[TMP12:%.*]] = load i24, ptr [[TMP40]], align 4, !alias.scope [[META0]]
; CHECK-NEXT:    [[TMP13:%.*]] = load i24, ptr [[TMP42]], align 4, !alias.scope [[META0]]
; CHECK-NEXT:    [[TMP14:%.*]] = insertelement <2 x i24> poison, i24 [[TMP12]], i32 0
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <2 x i24> [[TMP14]], i24 [[TMP13]], i32 1
; CHECK-NEXT:    [[TMP16:%.*]] = load i24, ptr [[TMP44]], align 4, !alias.scope [[META0]]
; CHECK-NEXT:    [[TMP17:%.*]] = load i24, ptr [[TMP46]], align 4, !alias.scope [[META0]]
; CHECK-NEXT:    [[TMP18:%.*]] = insertelement <2 x i24> poison, i24 [[TMP16]], i32 0
; CHECK-NEXT:    [[TMP19:%.*]] = insertelement <2 x i24> [[TMP18]], i24 [[TMP17]], i32 1
; CHECK-NEXT:    [[TMP20:%.*]] = zext <2 x i24> [[TMP15]] to <2 x i32>
; CHECK-NEXT:    [[TMP21:%.*]] = zext <2 x i24> [[TMP19]] to <2 x i32>
; CHECK-NEXT:    [[TMP22:%.*]] = add <2 x i32> [[STRIDED_VEC]], [[TMP20]]
; CHECK-NEXT:    [[TMP24:%.*]] = add <2 x i32> [[STRIDED_VEC3]], [[TMP21]]
; CHECK-NEXT:    [[TMP23:%.*]] = getelementptr inbounds i32, ptr [[DST]], i64 [[TMP0]]
; CHECK-NEXT:    [[TMP26:%.*]] = getelementptr inbounds i32, ptr [[TMP23]], i64 2
; CHECK-NEXT:    store <2 x i32> [[TMP22]], ptr [[TMP23]], align 4, !alias.scope [[META3:![0-9]+]], !noalias [[META0]]
; CHECK-NEXT:    store <2 x i32> [[TMP24]], ptr [[TMP26]], align 4, !alias.scope [[META3]], !noalias [[META0]]
