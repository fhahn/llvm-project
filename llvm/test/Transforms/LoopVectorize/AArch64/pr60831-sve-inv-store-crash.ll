...
; RUN: opt -passes=loop-vectorize -S -force-vector-interleave=2 -tail-folding-policy=dont-fold-tail < %s | FileCheck --check-prefix=IC2 %s
...
; CHECK-NEXT:    store i64 [[IND_ESCAPE]], ptr [[TMP14:%.*]], align 1
...
; IC2-NEXT:    [[IND_ESCAPE:%.*]] = sub i64 [[N_VEC]], 1
; IC2-NEXT:    store i64 [[IND_ESCAPE]], ptr [[DST:%.*]], align 1
...
; CHECK-NEXT:    [[IND_ESCAPE:%.*]] = sub i64 [[TMP5]], 1
; CHECK-NEXT:    store i64 [[IND_ESCAPE]], ptr [[DST:%.*]], align 1
; CHECK-NEXT:    br i1 [[CMP_N]], label [[EXIT:%.*]], label [[SCALAR_PH]]
; CHECK:       scalar.ph:
...
; IC2-NEXT:    [[IND_ESCAPE:%.*]] = sub i64 [[TMP6]], 1
; IC2-NEXT:    store i64 [[IND_ESCAPE]], ptr [[DST:%.*]], align 1
; IC2-NEXT:    br i1 [[CMP_N]], label [[EXIT:%.*]], label [[SCALAR_PH]]
; IC2:       scalar.ph:
...
; CHECK-NEXT:    [[IND_ESCAPE:%.*]] = sub i64 [[OFFSET_IDX]], 2
; CHECK-NEXT:    store i64 [[IND_ESCAPE]], ptr [[DST:%.*]], align 1
; CHECK-NEXT:    br i1 [[CMP_N]], label [[EXIT:%.*]], label [[SCALAR_PH]]
; CHECK:       scalar.ph:
...
; IC2-NEXT:    [[TMP4:%.*]] = shl nuw i64 [[TMP3]], 3
; IC2-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[TMP2]], [[TMP4]]
; IC2-NEXT:    br i1 [[MIN_ITERS_CHECK]], label [[SCALAR_PH:%.*]], label [[VECTOR_PH:%.*]]
; IC2:       vector.ph:
; IC2-NEXT:    [[N_MOD_VF:%.*]] = urem i64 [[TMP2]], [[TMP4]]
; IC2-NEXT:    [[N_VEC:%.*]] = sub i64 [[TMP2]], [[N_MOD_VF]]
; IC2-NEXT:    [[TMP10:%.*]] = shl i64 [[N_VEC]], 1
; IC2-NEXT:    [[OFFSET_IDX:%.*]] = add i64 [[START]], [[TMP10]]
; IC2-NEXT:    br label [[VECTOR_BODY:%.*]]
; IC2:       vector.body:
; IC2-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
; IC2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP4]]
...
; IC2-NEXT:    [[IND_ESCAPE:%.*]] = sub i64 [[OFFSET_IDX]], 2
; IC2-NEXT:    store i64 [[IND_ESCAPE]], ptr [[DST:%.*]], align 1
; IC2-NEXT:    br i1 [[CMP_N]], label [[EXIT:%.*]], label [[SCALAR_PH]]
; IC2:       scalar.ph:
