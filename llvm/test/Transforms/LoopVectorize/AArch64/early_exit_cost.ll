...
; COMMON-NEXT:    br i1 [[TMP2]], label %[[VECTOR_PH:.*]], label %[[SCALAR_PH:.*]]
; COMMON:       [[VECTOR_PH]]:
...
; DEFAULT-NEXT:    br i1 [[TMP2]], label %[[VECTOR_PH:.*]], label %[[SCALAR_PH:.*]]
; DEFAULT:       [[VECTOR_PH]]:
...
; MAX-BW-NEXT:    br i1 [[TMP2]], label %[[VECTOR_PH:.*]], label %[[SCALAR_PH:.*]]
; MAX-BW:       [[VECTOR_PH]]:
...
; PREFER-SVE-NEXT:    br i1 [[TMP8]], label %[[VECTOR_PH:.*]], label %[[SCALAR_PH]]
