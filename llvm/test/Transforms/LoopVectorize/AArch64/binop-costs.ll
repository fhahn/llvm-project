...
; CHECK:  Cost of 5 for VF 2: EMIT-SCALAR ir<%div> = udiv vp<[[VP7:%[0-9]+]]>, ir<3>
; CHECK:  Cost of 0 for VF 2: IR %div = udiv i8 %iv.trunc, 3
; CHECK:  Cost of 5 for VF 4: EMIT-SCALAR ir<%div> = udiv vp<[[VP7]]>, ir<3>
; CHECK:  Cost of 0 for VF 4: IR %div = udiv i8 %iv.trunc, 3
; CHECK:  Cost of 5 for VF vscale x 1: EMIT-SCALAR ir<%div> = udiv vp<[[VP7]]>, ir<3>
; CHECK:  Cost of 5 for VF vscale x 2: EMIT-SCALAR ir<%div> = udiv vp<[[VP7]]>, ir<3>
; CHECK:  Cost of 0 for VF vscale x 2: IR %div = udiv i8 %iv.trunc, 3
; CHECK:  Cost of 5 for VF vscale x 4: EMIT-SCALAR ir<%div> = udiv vp<[[VP7]]>, ir<3>
