...
; DEFAULT-NEXT:    [[TMP0:%.*]] = add i64 [[N]], 1
; DEFAULT-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[TMP0]], 26
...
; DEFAULT-NEXT:    [[N_VEC:%.*]] = sub i64 [[TMP0]], [[N_MOD_VF]]
; DEFAULT-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <2 x i32> poison, i32 [[MUL_X]], i64 0
; DEFAULT-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <2 x i32> [[BROADCAST_SPLATINSERT]], <2 x i32> poison, <2 x i32> zeroinitializer
; DEFAULT-NEXT:    br label %[[VECTOR_BODY:.*]]
; DEFAULT:       [[VECTOR_BODY]]:
; DEFAULT-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; DEFAULT-NEXT:    [[VEC_IND:%.*]] = phi <2 x i32> [ <i32 0, i32 1>, %[[VECTOR_PH]] ], [ [[VEC_IND_NEXT:%.*]], %[[VECTOR_BODY]] ]
; DEFAULT-NEXT:    [[STEP_ADD:%.*]] = add <2 x i32> [[VEC_IND]], splat (i32 2)
; DEFAULT-NEXT:    [[TMP13:%.*]] = mul <2 x i32> [[BROADCAST_SPLAT]], [[VEC_IND]]
; DEFAULT-NEXT:    [[TMP14:%.*]] = mul <2 x i32> [[BROADCAST_SPLAT]], [[STEP_ADD]]
; DEFAULT-NEXT:    [[TMP15:%.*]] = zext <2 x i32> [[TMP13]] to <2 x i64>
; DEFAULT-NEXT:    [[TMP17:%.*]] = extractelement <2 x i64> [[TMP15]], i32 0
; DEFAULT-NEXT:    [[TMP18:%.*]] = extractelement <2 x i64> [[TMP15]], i32 1
; DEFAULT-NEXT:    [[TMP22:%.*]] = zext <2 x i32> [[TMP14]] to <2 x i64>
; DEFAULT-NEXT:    [[TMP25:%.*]] = extractelement <2 x i64> [[TMP22]], i32 0
; DEFAULT-NEXT:    [[TMP26:%.*]] = extractelement <2 x i64> [[TMP22]], i32 1
; DEFAULT-NEXT:    [[TMP19:%.*]] = getelementptr i32, ptr [[DST]], i64 [[TMP17]]
; DEFAULT-NEXT:    [[TMP20:%.*]] = getelementptr i32, ptr [[DST]], i64 [[TMP18]]
; DEFAULT-NEXT:    [[TMP23:%.*]] = getelementptr i32, ptr [[DST]], i64 [[TMP25]]
; DEFAULT-NEXT:    [[TMP24:%.*]] = getelementptr i32, ptr [[DST]], i64 [[TMP26]]
; DEFAULT-NEXT:    store i32 1, ptr [[TMP19]], align 4
; DEFAULT-NEXT:    store i32 1, ptr [[TMP20]], align 4
; DEFAULT-NEXT:    store i32 1, ptr [[TMP23]], align 4
; DEFAULT-NEXT:    store i32 1, ptr [[TMP24]], align 4
; DEFAULT-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; DEFAULT-NEXT:    [[VEC_IND_NEXT]] = add <2 x i32> [[STEP_ADD]], splat (i32 2)
...
; DEFAULT-NEXT:    [[TMP0:%.*]] = add i64 [[N]], 1
; DEFAULT-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[TMP0]], 24
; DEFAULT-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_SCEVCHECK:.*]]
; DEFAULT:       [[VECTOR_SCEVCHECK]]:
...
; DEFAULT-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <2 x i32> poison, i32 [[MUL]], i64 0
; DEFAULT-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <2 x i32> [[BROADCAST_SPLATINSERT]], <2 x i32> poison, <2 x i32> zeroinitializer
; DEFAULT-NEXT:    br label %[[VECTOR_BODY:.*]]
; DEFAULT:       [[VECTOR_BODY]]:
; DEFAULT-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; DEFAULT-NEXT:    [[OFFSET_IDX:%.*]] = add i32 [[TMP16]], 0
; DEFAULT-NEXT:    [[TMP17:%.*]] = add i32 [[TMP16]], 1
; DEFAULT-NEXT:    [[TMP27:%.*]] = add i32 [[TMP16]], 2
; DEFAULT-NEXT:    [[TMP18:%.*]] = add i32 [[TMP16]], 3
; DEFAULT-NEXT:    [[TMP19:%.*]] = mul <2 x i32> [[BROADCAST_SPLAT]], [[VEC_IND]]
; DEFAULT-NEXT:    [[TMP28:%.*]] = mul <2 x i32> [[BROADCAST_SPLAT]], [[STEP_ADD]]
; DEFAULT-NEXT:    [[TMP31:%.*]] = zext <2 x i32> [[TMP19]] to <2 x i64>
; DEFAULT-NEXT:    [[TMP20:%.*]] = extractelement <2 x i64> [[TMP31]], i32 0
; DEFAULT-NEXT:    [[TMP21:%.*]] = extractelement <2 x i64> [[TMP31]], i32 1
; DEFAULT-NEXT:    [[TMP32:%.*]] = zext <2 x i32> [[TMP28]] to <2 x i64>
; DEFAULT-NEXT:    [[TMP25:%.*]] = extractelement <2 x i64> [[TMP32]], i32 0
; DEFAULT-NEXT:    [[TMP26:%.*]] = extractelement <2 x i64> [[TMP32]], i32 1
...
; DEFAULT-NEXT:    store i32 [[TMP27]], ptr [[TMP29]], align 4
; DEFAULT-NEXT:    store i32 [[TMP18]], ptr [[TMP30]], align 4
; DEFAULT-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; DEFAULT-NEXT:    [[VEC_IND_NEXT]] = add <2 x i32> [[STEP_ADD]], splat (i32 2)
...
; DEFAULT-NEXT:    [[TMP0:%.*]] = add i64 [[N]], 1
; DEFAULT-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[TMP0]], 22
; DEFAULT-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_SCEVCHECK:.*]]
; DEFAULT:       [[VECTOR_SCEVCHECK]]:
; DEFAULT-NEXT:    [[TMP1:%.*]] = sub i32 -1, [[X]]
...
; DEFAULT-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <2 x i32> poison, i32 [[ADD]], i64 0
; DEFAULT-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <2 x i32> [[BROADCAST_SPLATINSERT]], <2 x i32> poison, <2 x i32> zeroinitializer
; DEFAULT-NEXT:    br label %[[VECTOR_BODY:.*]]
; DEFAULT:       [[VECTOR_BODY]]:
; DEFAULT-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; DEFAULT-NEXT:    [[OFFSET_IDX:%.*]] = add i32 [[TMP15]], 0
; DEFAULT-NEXT:    [[TMP16:%.*]] = add i32 [[TMP15]], 1
; DEFAULT-NEXT:    [[TMP26:%.*]] = add i32 [[TMP15]], 2
; DEFAULT-NEXT:    [[TMP17:%.*]] = add i32 [[TMP15]], 3
; DEFAULT-NEXT:    [[TMP18:%.*]] = mul <2 x i32> [[BROADCAST_SPLAT]], [[VEC_IND]]
; DEFAULT-NEXT:    [[TMP27:%.*]] = mul <2 x i32> [[BROADCAST_SPLAT]], [[STEP_ADD]]
; DEFAULT-NEXT:    [[TMP30:%.*]] = zext <2 x i32> [[TMP18]] to <2 x i64>
; DEFAULT-NEXT:    [[TMP19:%.*]] = extractelement <2 x i64> [[TMP30]], i32 0
; DEFAULT-NEXT:    [[TMP20:%.*]] = extractelement <2 x i64> [[TMP30]], i32 1
; DEFAULT-NEXT:    [[TMP31:%.*]] = zext <2 x i32> [[TMP27]] to <2 x i64>
; DEFAULT-NEXT:    [[TMP24:%.*]] = extractelement <2 x i64> [[TMP31]], i32 0
; DEFAULT-NEXT:    [[TMP25:%.*]] = extractelement <2 x i64> [[TMP31]], i32 1
...
; DEFAULT-NEXT:    store i32 [[TMP26]], ptr [[TMP28]], align 4
; DEFAULT-NEXT:    store i32 [[TMP17]], ptr [[TMP29]], align 4
; DEFAULT-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; DEFAULT-NEXT:    [[VEC_IND_NEXT]] = add <2 x i32> [[STEP_ADD]], splat (i32 2)
