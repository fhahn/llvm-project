...
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[CMP_N6:%.*]], label %[[FOR_COND_CLEANUP]], label %[[VEC_EPILOG_SCALAR_PH]], !prof [[PROF7]]
...
; CHECK-V1-IC1:    br i1 [[TMP9:%.*]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !prof [[PROF13:![0-9]+]], !llvm.loop [[LOOP14:![0-9]+]]
; CHECK-V1-IC1:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
; CHECK-V1-IC1:    br i1 [[CMP_N6:%.*]], label %[[FOR_COND_CLEANUP]], label %[[VEC_EPILOG_SCALAR_PH]], !prof [[PROF16:![0-9]+]]
; CHECK-V1-IC1:  [[VEC_EPILOG_SCALAR_PH]]:
; CHECK-V1-IC1:    br label %[[FOR_BODY:.*]]
; CHECK-V1-IC1:  [[FOR_BODY]]:
; CHECK-V1-IC1:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !prof [[PROF5]], !llvm.loop [[LOOP17:![0-9]+]]
; CHECK-V1-IC1:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V1-IC1-FORCE-EPI2:    br label %[[VECTOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VECTOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[TMP5:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !prof [[PROF13:![0-9]+]], !llvm.loop [[LOOP14:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI2:  [[MIDDLE_BLOCK]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[CMP_N:%.*]], label %[[FOR_COND_CLEANUP:.*]], label %[[VEC_EPILOG_ITER_CHECK:.*]], !prof [[PROF13]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VEC_EPILOG_ITER_CHECK]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[MIN_EPILOG_ITERS_CHECK:%.*]], label %[[VEC_EPILOG_SCALAR_PH]], label %[[VEC_EPILOG_PH]], !prof [[PROF16:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VEC_EPILOG_PH]]:
; CHECK-V1-IC1-FORCE-EPI2:    br label %[[VEC_EPILOG_VECTOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VEC_EPILOG_VECTOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[TMP9:%.*]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !prof [[PROF5]], !llvm.loop [[LOOP17:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[CMP_N6:%.*]], label %[[FOR_COND_CLEANUP]], label %[[VEC_EPILOG_SCALAR_PH]], !prof [[PROF7]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VEC_EPILOG_SCALAR_PH]]:
; CHECK-V1-IC1-FORCE-EPI2:    br label %[[FOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI2:  [[FOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !prof [[PROF10]], !llvm.loop [[LOOP19:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI2:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V2-IC4:    br label %[[VEC_EPILOG_VECTOR_BODY:.*]]
; CHECK-V2-IC4:  [[VEC_EPILOG_VECTOR_BODY]]:
; CHECK-V2-IC4:    br i1 [[TMP13:%.*]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !prof [[PROF11]], !llvm.loop [[LOOP16:![0-9]+]]
; CHECK-V2-IC4:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
; CHECK-V2-IC4:    br i1 [[CMP_N9:%.*]], label %[[FOR_COND_CLEANUP]], label %[[VEC_EPILOG_SCALAR_PH]], !prof [[PROF18:![0-9]+]]
; CHECK-V2-IC4:  [[VEC_EPILOG_SCALAR_PH]]:
; CHECK-V2-IC4:    br label %[[FOR_BODY:.*]]
; CHECK-V2-IC4:  [[FOR_BODY]]:
; CHECK-V2-IC4:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !prof [[PROF11]], !llvm.loop [[LOOP19:![0-9]+]]
; CHECK-V2-IC4:  [[FOR_COND_CLEANUP]]:
;
entry:
  br label %for.body
...
; CHECK-V1-IC1:    br label %[[VECTOR_BODY:.*]]
; CHECK-V1-IC1:  [[VECTOR_BODY]]:
; CHECK-V1-IC1:    br i1 [[TMP6:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP19:![0-9]+]]
; CHECK-V1-IC1:  [[MIDDLE_BLOCK]]:
; CHECK-V1-IC1:    br i1 [[CMP_N:%.*]], label %[[FOR_COND_CLEANUP:.*]], label %[[SCALAR_PH]]
; CHECK-V1-IC1:  [[SCALAR_PH]]:
; CHECK-V1-IC1:    br label %[[FOR_BODY:.*]]
; CHECK-V1-IC1:  [[FOR_BODY]]:
; CHECK-V1-IC1:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !llvm.loop [[LOOP20:![0-9]+]]
; CHECK-V1-IC1:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V1-IC1-FORCE-EPI2:    br label %[[VECTOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VECTOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[TMP5:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP20:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI2:  [[MIDDLE_BLOCK]]:
...
; CHECK-V1-IC1-FORCE-EPI2:    br label %[[VEC_EPILOG_VECTOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VEC_EPILOG_VECTOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[TMP9:%.*]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP21:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[CMP_N7:%.*]], label %[[FOR_COND_CLEANUP]], label %[[VEC_EPILOG_SCALAR_PH]]
; CHECK-V1-IC1-FORCE-EPI2:  [[VEC_EPILOG_SCALAR_PH]]:
; CHECK-V1-IC1-FORCE-EPI2:    br label %[[FOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI2:  [[FOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI2:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !llvm.loop [[LOOP22:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI2:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V2-IC4:    br label %[[VECTOR_BODY:.*]]
; CHECK-V2-IC4:  [[VECTOR_BODY]]:
; CHECK-V2-IC4:    br i1 [[TMP9:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP20:![0-9]+]]
; CHECK-V2-IC4:  [[MIDDLE_BLOCK]]:
...
; CHECK-V1-IC1: [[PROF6]] = !{!"branch_weights", i32 1, i32 3}
; CHECK-V1-IC1: [[LOOP7]] = distinct !{[[LOOP7]], [[META3]], [[META2]], [[META8:![0-9]+]]}
; CHECK-V1-IC1: [[META8]] = !{!"llvm.loop.estimated_trip_count", i32 4}
...
; CHECK-V1-IC1: [[PROF13]] = !{!"branch_weights", i32 1, i32 0}
; CHECK-V1-IC1: [[LOOP14]] = distinct !{[[LOOP14]], [[META2]], [[META3]], [[META15:![0-9]+]]}
; CHECK-V1-IC1: [[META15]] = !{!"llvm.loop.estimated_trip_count", i32 1}
; CHECK-V1-IC1: [[PROF16]] = !{!"branch_weights", i32 1, i32 15}
; CHECK-V1-IC1: [[LOOP17]] = distinct !{[[LOOP17]], [[META3]], [[META2]], [[META18:![0-9]+]]}
; CHECK-V1-IC1: [[META18]] = !{!"llvm.loop.estimated_trip_count", i32 8}
; CHECK-V1-IC1: [[LOOP19]] = distinct !{[[LOOP19]], [[META2]], [[META3]]}
; CHECK-V1-IC1: [[LOOP20]] = distinct !{[[LOOP20]], [[META3]], [[META2]]}
;.
...
; CHECK-V1-IC1-FORCE-EPI2: [[PROF7]] = !{!"branch_weights", i32 1, i32 1}
; CHECK-V1-IC1-FORCE-EPI2: [[LOOP8]] = distinct !{[[LOOP8]], [[META2]], [[META3]], [[META9:![0-9]+]]}
; CHECK-V1-IC1-FORCE-EPI2: [[META9]] = !{!"llvm.loop.estimated_trip_count", i32 2}
; CHECK-V1-IC1-FORCE-EPI2: [[PROF10]] = !{!"branch_weights", i32 1, i32 0}
; CHECK-V1-IC1-FORCE-EPI2: [[LOOP11]] = distinct !{[[LOOP11]], [[META3]], [[META2]], [[META12:![0-9]+]]}
; CHECK-V1-IC1-FORCE-EPI2: [[META12]] = !{!"llvm.loop.estimated_trip_count", i32 1}
; CHECK-V1-IC1-FORCE-EPI2: [[PROF13]] = !{!"branch_weights", i32 1, i32 31}
; CHECK-V1-IC1-FORCE-EPI2: [[LOOP14]] = distinct !{[[LOOP14]], [[META2]], [[META3]], [[META15:![0-9]+]]}
; CHECK-V1-IC1-FORCE-EPI2: [[META15]] = !{!"llvm.loop.estimated_trip_count", i32 32}
; CHECK-V1-IC1-FORCE-EPI2: [[PROF16]] = !{!"branch_weights", i32 2, i32 30}
; CHECK-V1-IC1-FORCE-EPI2: [[LOOP17]] = distinct !{[[LOOP17]], [[META2]], [[META3]], [[META18:![0-9]+]]}
; CHECK-V1-IC1-FORCE-EPI2: [[META18]] = !{!"llvm.loop.estimated_trip_count", i32 8}
; CHECK-V1-IC1-FORCE-EPI2: [[LOOP19]] = distinct !{[[LOOP19]], [[META3]], [[META2]], [[META12]]}
; CHECK-V1-IC1-FORCE-EPI2: [[LOOP20]] = distinct !{[[LOOP20]], [[META2]], [[META3]]}
; CHECK-V1-IC1-FORCE-EPI2: [[LOOP21]] = distinct !{[[LOOP21]], [[META2]], [[META3]]}
; CHECK-V1-IC1-FORCE-EPI2: [[LOOP22]] = distinct !{[[LOOP22]], [[META3]], [[META2]]}
;.
...
; CHECK-V2-IC1: [[PROF7]] = !{!"branch_weights", i32 1, i32 1}
; CHECK-V2-IC1: [[LOOP8]] = distinct !{[[LOOP8]], [[META4]], [[META3]], [[META9:![0-9]+]]}
; CHECK-V2-IC1: [[META9]] = !{!"llvm.loop.estimated_trip_count", i32 2}
...
; CHECK-V2-IC1: [[LOOP15]] = distinct !{[[LOOP15]], [[META3]], [[META4]], [[META9]]}
...
; CHECK-V2-IC4: [[LOOP9]] = distinct !{[[LOOP9]], [[META3]], [[META4]], [[META10:![0-9]+]]}
; CHECK-V2-IC4: [[META10]] = !{!"llvm.loop.estimated_trip_count", i32 2}
...
; CHECK-V2-IC4: [[LOOP16]] = distinct !{[[LOOP16]], [[META3]], [[META4]], [[META17:![0-9]+]]}
; CHECK-V2-IC4: [[META17]] = !{!"llvm.loop.estimated_trip_count", i32 4}
; CHECK-V2-IC4: [[PROF18]] = !{!"branch_weights", i32 1, i32 7}
; CHECK-V2-IC4: [[LOOP19]] = distinct !{[[LOOP19]], [[META4]], [[META3]], [[META17]]}
