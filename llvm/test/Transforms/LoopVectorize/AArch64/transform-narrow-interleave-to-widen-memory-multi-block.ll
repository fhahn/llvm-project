...
; VF2IC1:       [[VECTOR_BODY]]:
; VF2IC1-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[LOOP_LATCH3:.*]] ]
...
; VF2IC1-NEXT:    [[TMP2:%.*]] = shufflevector <2 x i64> [[STRIDED_VEC]], <2 x i64> [[STRIDED_VEC1]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; VF2IC1-NEXT:    [[INTERLEAVED_VEC:%.*]] = shufflevector <4 x i64> [[TMP2]], <4 x i64> poison, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
; VF2IC1-NEXT:    store <4 x i64> [[INTERLEAVED_VEC]], ptr [[TMP1]], align 8
; VF2IC1-NEXT:    br i1 [[C]], label %[[THEN2:.*]], label %[[LOOP_LATCH3]]
; VF2IC1:       [[THEN2]]:
; VF2IC1-NEXT:    store i8 1, ptr [[DST_0]], align 1
; VF2IC1-NEXT:    br label %[[LOOP_LATCH3]]
; VF2IC1:       [[LOOP_LATCH3]]:
; VF2IC1-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, ptr [[DST_1]], i64 [[INDEX]]
; VF2IC1-NEXT:    store <2 x i8> zeroinitializer, ptr [[TMP3]], align 1
; VF2IC1-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 2
; VF2IC1-NEXT:    [[TMP4:%.*]] = icmp eq i64 [[INDEX_NEXT]], 100
; VF2IC1-NEXT:    br i1 [[TMP4]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; VF2IC1:       [[MIDDLE_BLOCK]]:
...
; VF2IC2:       [[VECTOR_BODY]]:
; VF2IC2-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[LOOP_LATCH7:.*]] ]
...
; VF2IC2-NEXT:    br i1 [[C]], label %[[THEN6:.*]], label %[[LOOP_LATCH7]]
; VF2IC2:       [[THEN6]]:
; VF2IC2-NEXT:    store i8 1, ptr [[DST_0]], align 1
; VF2IC2-NEXT:    br label %[[LOOP_LATCH7]]
; VF2IC2:       [[LOOP_LATCH7]]:
; VF2IC2-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i8, ptr [[DST_1]], i64 [[INDEX]]
; VF2IC2-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i8, ptr [[TMP7]], i64 2
; VF2IC2-NEXT:    store <2 x i8> zeroinitializer, ptr [[TMP7]], align 1
; VF2IC2-NEXT:    store <2 x i8> zeroinitializer, ptr [[TMP8]], align 1
; VF2IC2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; VF2IC2-NEXT:    [[TMP9:%.*]] = icmp eq i64 [[INDEX_NEXT]], 100
; VF2IC2-NEXT:    br i1 [[TMP9]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; VF2IC2:       [[MIDDLE_BLOCK]]:
