...
; CHECK-INTERLEAVE1-NEXT:    [[TMP3:%.*]] = zext i8 [[B]] to i16
; CHECK-INTERLEAVE1-NEXT:    [[TMP4:%.*]] = mul i16 [[TMP3]], [[TMP3]]
; CHECK-INTERLEAVE1-NEXT:    [[TMP5:%.*]] = zext i16 [[TMP4]] to i32
; CHECK-INTERLEAVE1-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[TMP5]], i64 0
; CHECK-INTERLEAVE1-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; CHECK-INTERLEAVE1-NEXT:    [[TMP9:%.*]] = sext i16 [[TMP1]] to i32
; CHECK-INTERLEAVE1-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP9]] to i64
; CHECK-INTERLEAVE1-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK-INTERLEAVE1:       vector.body:
; CHECK-INTERLEAVE1-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-INTERLEAVE1-NEXT:    [[VEC_PHI:%.*]] = phi <8 x i32> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
; CHECK-INTERLEAVE1-NEXT:    [[TMP8]] = add <8 x i32> [[VEC_PHI]], [[BROADCAST_SPLAT]]
...
; CHECK-INTERLEAVE1:       middle.block:
; CHECK-INTERLEAVE1-NEXT:    [[TMP10:%.*]] = call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> [[TMP8]])
...
; CHECK-INTERLEAVED-NEXT:    [[TMP3:%.*]] = zext i8 [[B]] to i16
; CHECK-INTERLEAVED-NEXT:    [[TMP4:%.*]] = mul i16 [[TMP3]], [[TMP3]]
; CHECK-INTERLEAVED-NEXT:    [[TMP5:%.*]] = zext i16 [[TMP4]] to i32
; CHECK-INTERLEAVED-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[TMP5]], i64 0
; CHECK-INTERLEAVED-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; CHECK-INTERLEAVED-NEXT:    [[TMP10:%.*]] = sext i16 [[TMP1]] to i32
; CHECK-INTERLEAVED-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP10]] to i64
; CHECK-INTERLEAVED-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK-INTERLEAVED:       vector.body:
; CHECK-INTERLEAVED-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-INTERLEAVED-NEXT:    [[TMP8]] = add <8 x i32> [[VEC_PHI]], [[BROADCAST_SPLAT]]
; CHECK-INTERLEAVED-NEXT:    [[TMP9]] = add <8 x i32> [[VEC_PHI1]], [[BROADCAST_SPLAT]]
; CHECK-INTERLEAVED-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 16
...
; CHECK-INTERLEAVED-NEXT:    [[TMP11:%.*]] = call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> [[BIN_RDX]])
...
; CHECK-MAXBW-NEXT:    [[TMP3:%.*]] = zext i8 [[B]] to i16
; CHECK-MAXBW-NEXT:    [[TMP4:%.*]] = mul i16 [[TMP3]], [[TMP3]]
; CHECK-MAXBW-NEXT:    [[TMP5:%.*]] = zext i16 [[TMP4]] to i32
; CHECK-MAXBW-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[TMP5]], i64 0
; CHECK-MAXBW-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; CHECK-MAXBW-NEXT:    [[TMP9:%.*]] = sext i16 [[TMP1]] to i32
; CHECK-MAXBW-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP9]] to i64
; CHECK-MAXBW-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK-MAXBW:       vector.body:
; CHECK-MAXBW-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-MAXBW-NEXT:    [[VEC_PHI:%.*]] = phi <8 x i32> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
; CHECK-MAXBW-NEXT:    [[TMP8]] = add <8 x i32> [[VEC_PHI]], [[BROADCAST_SPLAT]]
...
; CHECK-MAXBW:       middle.block:
; CHECK-MAXBW-NEXT:    [[TMP10:%.*]] = call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> [[TMP8]])
...
; CHECK-INTERLEAVE1-NEXT:    [[TMP10:%.*]] = zext i8 [[B]] to i16
; CHECK-INTERLEAVE1-NEXT:    [[TMP11:%.*]] = mul i16 [[TMP10]], [[TMP10]]
; CHECK-INTERLEAVE1-NEXT:    [[TMP12:%.*]] = zext i16 [[TMP11]] to i64
; CHECK-INTERLEAVE1-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i64> poison, i64 [[TMP12]], i64 0
; CHECK-INTERLEAVE1-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i64> [[BROADCAST_SPLATINSERT]], <8 x i64> poison, <8 x i32> zeroinitializer
; CHECK-INTERLEAVE1-NEXT:    [[TMP6:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-INTERLEAVE1-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP6]] to i64
; CHECK-INTERLEAVE1-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK-INTERLEAVE1:       vector.body:
; CHECK-INTERLEAVE1-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-INTERLEAVED-NEXT:    [[TMP11:%.*]] = mul i16 [[TMP8]], [[TMP8]]
; CHECK-INTERLEAVED-NEXT:    [[TMP12:%.*]] = zext i16 [[TMP11]] to i64
; CHECK-INTERLEAVED-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i64> poison, i64 [[TMP12]], i64 0
; CHECK-INTERLEAVED-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i64> [[BROADCAST_SPLATINSERT]], <8 x i64> poison, <8 x i32> zeroinitializer
; CHECK-INTERLEAVED-NEXT:    [[TMP13:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-INTERLEAVED-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP13]] to i64
; CHECK-INTERLEAVED-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK-INTERLEAVED:       vector.body:
; CHECK-INTERLEAVED-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-MAXBW-NEXT:    [[TMP10:%.*]] = zext i8 [[B]] to i16
; CHECK-MAXBW-NEXT:    [[TMP11:%.*]] = mul i16 [[TMP10]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[TMP12:%.*]] = zext i16 [[TMP11]] to i64
; CHECK-MAXBW-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i64> poison, i64 [[TMP12]], i64 0
; CHECK-MAXBW-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i64> [[BROADCAST_SPLATINSERT]], <8 x i64> poison, <8 x i32> zeroinitializer
; CHECK-MAXBW-NEXT:    [[TMP6:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-MAXBW-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP6]] to i64
; CHECK-MAXBW-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK-MAXBW:       vector.body:
; CHECK-MAXBW-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-INTERLEAVE1-NEXT:    [[TMP10:%.*]] = zext i8 [[B]] to i16
; CHECK-INTERLEAVE1-NEXT:    [[TMP11:%.*]] = mul i16 [[TMP10]], [[TMP10]]
; CHECK-INTERLEAVE1-NEXT:    [[TMP12:%.*]] = sext i16 [[TMP11]] to i32
; CHECK-INTERLEAVE1-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[TMP12]], i64 0
; CHECK-INTERLEAVE1-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; CHECK-INTERLEAVE1-NEXT:    [[TMP6:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-INTERLEAVE1-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP6]] to i64
; CHECK-INTERLEAVE1-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK-INTERLEAVE1:       vector.body:
...
; CHECK-INTERLEAVED-NEXT:    [[TMP8:%.*]] = zext i8 [[B]] to i16
; CHECK-INTERLEAVED-NEXT:    [[TMP11:%.*]] = mul i16 [[TMP8]], [[TMP8]]
; CHECK-INTERLEAVED-NEXT:    [[TMP12:%.*]] = sext i16 [[TMP11]] to i32
; CHECK-INTERLEAVED-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[TMP12]], i64 0
; CHECK-INTERLEAVED-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; CHECK-INTERLEAVED-NEXT:    [[TMP13:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-INTERLEAVED-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP13]] to i64
; CHECK-INTERLEAVED-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK-INTERLEAVED:       vector.body:
...
; CHECK-MAXBW-NEXT:    [[TMP10:%.*]] = zext i8 [[B]] to i16
; CHECK-MAXBW-NEXT:    [[TMP11:%.*]] = mul i16 [[TMP10]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[TMP12:%.*]] = sext i16 [[TMP11]] to i32
; CHECK-MAXBW-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[TMP12]], i64 0
; CHECK-MAXBW-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; CHECK-MAXBW-NEXT:    [[TMP6:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-MAXBW-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP6]] to i64
; CHECK-MAXBW-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK-MAXBW:       vector.body:
...
; CHECK-INTERLEAVE1-NEXT:    [[N_VEC:%.*]] = sub i64 [[TMP0]], [[N_MOD_VF]]
; CHECK-INTERLEAVE1-NEXT:    [[TMP4:%.*]] = load i16, ptr [[A]], align 2
; CHECK-INTERLEAVE1-NEXT:    [[TMP10:%.*]] = sext i8 [[B]] to i16
; CHECK-INTERLEAVE1-NEXT:    [[TMP11:%.*]] = mul i16 [[TMP10]], [[TMP10]]
; CHECK-INTERLEAVE1-NEXT:    [[TMP12:%.*]] = zext i16 [[TMP11]] to i32
; CHECK-INTERLEAVE1-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[TMP12]], i64 0
; CHECK-INTERLEAVE1-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; CHECK-INTERLEAVE1-NEXT:    [[TMP6:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-INTERLEAVE1-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP6]] to i64
...
; CHECK-INTERLEAVED-NEXT:    [[TMP11:%.*]] = mul i16 [[TMP8]], [[TMP8]]
; CHECK-INTERLEAVED-NEXT:    [[TMP12:%.*]] = zext i16 [[TMP11]] to i32
; CHECK-INTERLEAVED-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[TMP12]], i64 0
; CHECK-INTERLEAVED-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; CHECK-INTERLEAVED-NEXT:    [[TMP13:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-INTERLEAVED-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP13]] to i64
...
; CHECK-MAXBW-NEXT:    [[N_VEC:%.*]] = sub i64 [[TMP0]], [[N_MOD_VF]]
; CHECK-MAXBW-NEXT:    [[TMP4:%.*]] = load i16, ptr [[A]], align 2
; CHECK-MAXBW-NEXT:    [[TMP10:%.*]] = sext i8 [[B]] to i16
; CHECK-MAXBW-NEXT:    [[TMP11:%.*]] = mul i16 [[TMP10]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[TMP12:%.*]] = zext i16 [[TMP11]] to i32
; CHECK-MAXBW-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[TMP12]], i64 0
; CHECK-MAXBW-NEXT:    [[TMP3:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; CHECK-MAXBW-NEXT:    [[TMP6:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-MAXBW-NEXT:    [[TMP7:%.*]] = sext i32 [[TMP6]] to i64
