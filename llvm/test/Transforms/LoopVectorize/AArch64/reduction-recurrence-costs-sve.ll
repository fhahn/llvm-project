...
; DEFAULT-NEXT:    [[TMP5:%.*]] = lshr i32 [[X]], 1
; DEFAULT-NEXT:    [[TMP4:%.*]] = shl i32 [[X]], 1
; DEFAULT-NEXT:    [[TMP3:%.*]] = or i32 [[TMP5]], [[TMP4]]
...
; DEFAULT-NEXT:    [[TMP9:%.*]] = and i32 [[TMP7]], 1
; DEFAULT-NEXT:    [[TMP8:%.*]] = xor i32 [[TMP9]], 1
; DEFAULT-NEXT:    [[TMP17:%.*]] = zext i32 [[TMP8]] to i64
; DEFAULT-NEXT:    [[TMP10:%.*]] = getelementptr i32, ptr [[SRC_1]], i64 [[TMP1]]
; DEFAULT-NEXT:    [[TMP11:%.*]] = load i32, ptr [[TMP10]], align 4
; DEFAULT-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <4 x i32> poison, i32 [[TMP11]], i64 0
...
; DEFAULT-NEXT:    [[TMP19:%.*]] = load i32, ptr [[TMP18]], align 4
; DEFAULT-NEXT:    [[TMP20:%.*]] = load i32, ptr [[TMP18]], align 4
; DEFAULT-NEXT:    [[TMP21:%.*]] = load i32, ptr [[TMP18]], align 4
...
; DEFAULT-NEXT:    [[VECTOR_RECUR:%.*]] = phi <4 x i32> [ <i32 poison, i32 poison, i32 poison, i32 0>, %[[VECTOR_PH]] ], [ [[BROADCAST_SPLAT2]], %[[LOOP]] ]
...
; DEFAULT-NEXT:    [[TMP27:%.*]] = shufflevector <4 x i32> [[VECTOR_RECUR]], <4 x i32> [[BROADCAST_SPLAT2]], <4 x i32> <i32 3, i32 4, i32 5, i32 6>
; DEFAULT-NEXT:    [[TMP28]] = shufflevector <4 x i32> [[BROADCAST_SPLAT2]], <4 x i32> [[BROADCAST_SPLAT2]], <4 x i32> <i32 3, i32 4, i32 5, i32 6>
...
; DEFAULT-NEXT:    [[TMP41:%.*]] = or <4 x i32> [[BROADCAST_SPLAT8]], [[TMP38]]
; DEFAULT-NEXT:    [[TMP42:%.*]] = or <4 x i32> [[BROADCAST_SPLAT8]], [[TMP39]]
; DEFAULT-NEXT:    [[TMP43:%.*]] = or <4 x i32> [[BROADCAST_SPLAT8]], [[TMP40]]
...
; DEFAULT:       [[SCALAR_PH]]:
; DEFAULT-NEXT:    [[SCALAR_RECUR_INIT:%.*]] = phi i32 [ [[TMP11]], %[[MIDDLE_BLOCK]] ], [ 0, %[[ENTRY]] ]
...
; VSCALEFORTUNING2-NEXT:    [[TMP5:%.*]] = lshr i32 [[X]], 1
; VSCALEFORTUNING2-NEXT:    [[TMP4:%.*]] = shl i32 [[X]], 1
; VSCALEFORTUNING2-NEXT:    [[TMP3:%.*]] = or i32 [[TMP5]], [[TMP4]]
...
; VSCALEFORTUNING2-NEXT:    [[TMP9:%.*]] = and i32 [[TMP16]], 1
; VSCALEFORTUNING2-NEXT:    [[TMP8:%.*]] = xor i32 [[TMP9]], 1
; VSCALEFORTUNING2-NEXT:    [[TMP17:%.*]] = zext i32 [[TMP8]] to i64
; VSCALEFORTUNING2-NEXT:    [[TMP10:%.*]] = getelementptr i32, ptr [[SRC_1]], i64 [[TMP7]]
; VSCALEFORTUNING2-NEXT:    [[TMP11:%.*]] = load i32, ptr [[TMP10]], align 4
; VSCALEFORTUNING2-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <4 x i32> poison, i32 [[TMP11]], i64 0
...
; VSCALEFORTUNING2-NEXT:    [[TMP19:%.*]] = load i32, ptr [[TMP18]], align 4
; VSCALEFORTUNING2-NEXT:    [[TMP20:%.*]] = load i32, ptr [[TMP18]], align 4
; VSCALEFORTUNING2-NEXT:    [[TMP21:%.*]] = load i32, ptr [[TMP18]], align 4
...
; VSCALEFORTUNING2-NEXT:    [[VECTOR_RECUR:%.*]] = phi <4 x i32> [ <i32 poison, i32 poison, i32 poison, i32 0>, %[[VECTOR_PH]] ], [ [[BROADCAST_SPLAT2]], %[[VECTOR_BODY]] ]
...
; VSCALEFORTUNING2-NEXT:    [[TMP27:%.*]] = shufflevector <4 x i32> [[VECTOR_RECUR]], <4 x i32> [[BROADCAST_SPLAT2]], <4 x i32> <i32 3, i32 4, i32 5, i32 6>
; VSCALEFORTUNING2-NEXT:    [[TMP28]] = shufflevector <4 x i32> [[BROADCAST_SPLAT2]], <4 x i32> [[BROADCAST_SPLAT2]], <4 x i32> <i32 3, i32 4, i32 5, i32 6>
...
; VSCALEFORTUNING2-NEXT:    [[TMP41:%.*]] = or <4 x i32> [[BROADCAST_SPLAT8]], [[TMP38]]
; VSCALEFORTUNING2-NEXT:    [[TMP42:%.*]] = or <4 x i32> [[BROADCAST_SPLAT8]], [[TMP39]]
; VSCALEFORTUNING2-NEXT:    [[TMP43:%.*]] = or <4 x i32> [[BROADCAST_SPLAT8]], [[TMP40]]
...
; VSCALEFORTUNING2-NEXT:    [[SCALAR_RECUR_INIT:%.*]] = phi i32 [ [[TMP11]], %[[MIDDLE_BLOCK]] ], [ 0, %[[ENTRY]] ]
...
; VSCALEFORTUNING2-NEXT:    [[TMP117:%.*]] = phi i32 [ [[SCALAR_RECUR_INIT]], %[[SCALAR_PH]] ], [ [[TMP57:%.*]], %[[LOOP]] ]
; VSCALEFORTUNING2-NEXT:    [[TMP55:%.*]] = phi i32 [ [[SCALAR_RECUR_INIT11]], %[[SCALAR_PH]] ], [ [[TMP117]], %[[LOOP]] ]
...
; PRED-NEXT:    [[TMP4:%.*]] = lshr i32 [[X]], 1
; PRED-NEXT:    [[TMP6:%.*]] = shl i32 [[X]], 1
; PRED-NEXT:    [[TMP5:%.*]] = or i32 [[TMP4]], [[TMP6]]
...
; PRED-NEXT:    [[TMP8:%.*]] = and i32 [[TMP20]], 1
; PRED-NEXT:    [[TMP9:%.*]] = xor i32 [[TMP8]], 1
; PRED-NEXT:    [[TMP10:%.*]] = zext i32 [[TMP9]] to i64
; PRED-NEXT:    [[TMP14:%.*]] = getelementptr i32, ptr [[SRC_1]], i64 [[TMP11]]
; PRED-NEXT:    [[TMP12:%.*]] = load i32, ptr [[TMP14]], align 4
; PRED-NEXT:    [[BROADCAST_SPLATINSERT2:%.*]] = insertelement <vscale x 4 x i32> poison, i32 [[TMP12]], i64 0
...
; PRED-NEXT:    [[TMP13:%.*]] = getelementptr i32, ptr [[SRC_2]], i64 [[TMP10]]
; PRED-NEXT:    [[BROADCAST_SPLATINSERT7:%.*]] = insertelement <vscale x 4 x ptr> poison, ptr [[TMP13]], i64 0
...
; PRED-NEXT:    [[VECTOR_RECUR:%.*]] = phi <vscale x 4 x i32> [ [[VECTOR_RECUR_INIT]], %[[VECTOR_PH]] ], [ [[TMP16]], %[[VECTOR_BODY]] ]
...
; PRED-NEXT:    [[TMP29]] = call <vscale x 4 x i32> @llvm.vector.splice.right.nxv4i32(<vscale x 4 x i32> [[VECTOR_RECUR]], <vscale x 4 x i32> [[TMP16]], i32 1)
...
; PRED-NEXT:    [[TMP34:%.*]] = or <vscale x 4 x i32> [[BROADCAST_SPLAT6]], [[TMP33]]
