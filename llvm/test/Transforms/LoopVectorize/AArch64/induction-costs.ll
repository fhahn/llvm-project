...
; CHECK-NEXT:    [[MIN_ITERS_CHECK2:%.*]] = icmp ult i64 [[TMP0]], 4
...
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX18:%.*]] = phi i64 [ 0, %[[VECTOR_PH1]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX18]], 4
; CHECK-NEXT:    [[TMP85:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP85]], label %[[VEC_EPILOG_VECTOR_BODY1:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP26:![0-9]+]]
; CHECK:       [[VEC_EPILOG_VECTOR_BODY1]]:
; CHECK-NEXT:    [[TMP92:%.*]] = mul i64 [[INDEX18]], 3
; CHECK-NEXT:    [[TMP95:%.*]] = add i64 [[TMP92]], 9
; CHECK-NEXT:    [[NEXT_GEP26:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP95]]
; CHECK-NEXT:    [[TMP107:%.*]] = load i8, ptr [[NEXT_GEP26]], align 1
; CHECK-NEXT:    [[TMP8:%.*]] = zext i8 [[TMP107]] to i32
; CHECK-NEXT:    [[TMP125:%.*]] = getelementptr i8, ptr [[NEXT_GEP26]], i64 3
; CHECK-NEXT:    [[TMP10:%.*]] = ptrtoint ptr [[TMP125]] to i64
...
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], %[[VEC_EPILOG_VECTOR_BODY1]] ], [ 0, %[[ITER_CHECK]] ]
; CHECK-NEXT:    [[BC_RESUME_VAL1:%.*]] = phi ptr [ [[TMP2]], %[[VEC_EPILOG_VECTOR_BODY1]] ], [ [[START]], %[[ITER_CHECK]] ]
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[IV:%.*]] = phi i64 [ [[BC_RESUME_VAL]], %[[VEC_EPILOG_PH1]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; CHECK-NEXT:    [[PTR_IV:%.*]] = phi ptr [ [[BC_RESUME_VAL1]], %[[VEC_EPILOG_PH1]] ], [ [[PTR_IV_NEXT:%.*]], %[[LOOP]] ]
...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[PTR_INT_LCSSA:%.*]] = phi i64 [ [[PTR_INT]], %[[LOOP]] ], [ [[TMP10]], %[[VEC_EPILOG_VECTOR_BODY1]] ]
