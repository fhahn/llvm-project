...
; CHECK: Cost of 4 for VF 8: EMIT ir<%exitcond.not> = icmp eq ir<%indvars.iv.next>, ir<16>
...
; CHECK: Cost of 0 for VF 16: EMIT ir<%exitcond.not> = icmp eq ir<%indvars.iv.next>, ir<16>
