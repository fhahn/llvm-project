...
; CHECK:       LV: Scalarizing: %i.next = add nuw nsw i64 %i, 2
...
; CHECK-LABEL: PR33193
; The induction cast %i.next is handled by VPlan's induction recipes and is no
; longer reported by the legacy scalarization analysis.
