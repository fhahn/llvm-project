...
; CHECK: Cost of 4 for VF 2: REPLICATE store ir<%tmp2>, ir<%tmp0>.1
;
...
; CHECK: Cost of 4 for VF 2: REPLICATE store ir<%tmp2>, vp<%next.gep>
;
...
;
; CHECK: Scalarizing and predicating: store i32 %tmp2, ptr %tmp0, align 4
; CHECK: Cost of 3 for VF 2: REPLICATE ir<%tmp2> = add nsw ir<%tmp1>, ir<%x>
; CHECK: Cost of 4 for VF 2: REPLICATE store ir<%tmp2>, ir<%tmp0>.1
;
...
; CHECK: Cost of 1 for VF 2: REPLICATE ir<%tmp5> = sub ir<%tmp4>, ir<%x>
; CHECK: Cost of 4 for VF 2: REPLICATE store ir<%tmp5>, ir<%tmp0>.1
;
