...
; RUN: opt -S -passes=loop-vectorize -enable-vplan-native-path -disable-outer-loop-memory-safety-check -mtriple aarch64-gnu-linux < %s | FileCheck %s
...
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <2 x ptr> [[TMP0]], i64 0
; CHECK-NEXT:    store <2 x i64> [[VEC_IND]], ptr [[TMP7]], align 4
...
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <2 x ptr> [[TMP2]], i64 0
; CHECK-NEXT:    store <2 x i64> [[TMP1]], ptr [[TMP8]], align 4
