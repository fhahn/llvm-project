...
; CHECK-NEXT:    [[STRIDED_VEC2:%.*]] = load <2 x double>, ptr [[TMP2]], align 4
; CHECK-NEXT:    [[STRIDED_VEC5:%.*]] = load <2 x double>, ptr [[TMP3]], align 4
; CHECK-NEXT:    [[TMP5:%.*]] = fadd <2 x double> [[STRIDED_VEC2]], splat (double 1.000000e+00)
; CHECK-NEXT:    [[TMP11:%.*]] = fadd <2 x double> [[STRIDED_VEC5]], splat (double 1.000000e+00)
...
; CHECK-NEXT:    store <2 x double> [[TMP11]], ptr [[TMP9]], align 4
...
; CHECK-NEXT:    [[STRIDED_VEC2:%.*]] = load <2 x double>, ptr [[TMP2]], align 4
; CHECK-NEXT:    [[STRIDED_VEC5:%.*]] = load <2 x double>, ptr [[TMP3]], align 4
; CHECK-NEXT:    [[TMP5:%.*]] = fadd <2 x double> splat (double 1.000000e+00), [[STRIDED_VEC2]]
; CHECK-NEXT:    [[TMP11:%.*]] = fadd <2 x double> splat (double 1.000000e+00), [[STRIDED_VEC5]]
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw { double, double }, ptr [[RES]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr inbounds nuw { double, double }, ptr [[RES]], i64 [[TMP1]]
; CHECK-NEXT:    store <2 x double> [[TMP5]], ptr [[TMP8]], align 4
; CHECK-NEXT:    store <2 x double> [[TMP11]], ptr [[TMP9]], align 4
...
; CHECK-NEXT:    [[STRIDED_VEC2:%.*]] = load <2 x double>, ptr [[TMP1]], align 4
; CHECK-NEXT:    [[STRIDED_VEC5:%.*]] = load <2 x double>, ptr [[TMP2]], align 4
; CHECK-NEXT:    [[TMP12:%.*]] = fadd <2 x double> [[STRIDED_VEC2]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP13:%.*]] = fadd <2 x double> [[STRIDED_VEC5]], [[BROADCAST_SPLAT]]
...
; CHECK-NEXT:    [[STRIDED_VEC2:%.*]] = load <2 x double>, ptr [[TMP1]], align 4
; CHECK-NEXT:    [[STRIDED_VEC5:%.*]] = load <2 x double>, ptr [[TMP2]], align 4
; CHECK-NEXT:    [[TMP12:%.*]] = fadd <2 x double> [[BROADCAST_SPLAT]], [[STRIDED_VEC2]]
; CHECK-NEXT:    [[TMP13:%.*]] = fadd <2 x double> [[BROADCAST_SPLAT]], [[STRIDED_VEC5]]
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr inbounds nuw { double, double }, ptr [[RES]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw { double, double }, ptr [[RES]], i64 [[TMP0]]
; CHECK-NEXT:    store <2 x double> [[TMP12]], ptr [[TMP7]], align 4
; CHECK-NEXT:    store <2 x double> [[TMP13]], ptr [[TMP8]], align 4
