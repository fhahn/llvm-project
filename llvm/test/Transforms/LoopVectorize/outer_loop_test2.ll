...
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [1024 x i32], ptr @A, i64 0, i64 [[INDEX]]
; CHECK-NEXT:    store <4 x i32> [[BROADCAST_SPLAT2]], ptr [[TMP14]], align 4, !llvm.access.group [[ACC_GRP0:![0-9]+]]
; CHECK-NEXT:    br i1 [[CMP220]], label %[[FOR_BODY3_LR_PH3:.*]], label %[[VECTOR_LATCH]]
; CHECK:       [[FOR_BODY3_LR_PH3]]:
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x i32>, ptr [[TMP14]], align 4, !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    [[WIDE_MASKED_GATHER5:%.*]] = call <4 x i32> @llvm.masked.gather.v4i32.v4p0(<4 x ptr> align 4 [[TMP4]], <4 x i1> splat (i1 true), <4 x i32> poison), !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    store <4 x i32> [[TMP6]], ptr [[TMP14]], align 4, !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    store i32 [[C]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP0]]
; CHECK-NEXT:    br i1 [[CMP220]], label %[[FOR_BODY3_LR_PH:.*]], label %[[FOR_INC9]]
; CHECK:       [[FOR_BODY3_LR_PH]]:
; CHECK-NEXT:    [[A_VAL:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = phi i32 [ [[A_VAL]], %[[FOR_BODY3_LR_PH]] ], [ [[ADD8:%.*]], %[[FOR_BODY3]] ]
; CHECK-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [1024 x i32], ptr @B, i64 0, i64 [[INDVARS_IV]]
; CHECK-NEXT:    [[TMP13:%.*]] = load i32, ptr [[ARRAYIDX5]], align 4, !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    [[ACCUM_NEXT_LCSSA:%.*]] = phi i32 [ [[ADD8]], %[[FOR_BODY3]] ]
; CHECK-NEXT:    store i32 [[ACCUM_NEXT_LCSSA]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    br i1 [[EXITCOND28]], label %[[FOR_END11_LOOPEXIT]], label %[[FOR_BODY]], !llvm.loop [[LOOP5:![0-9]+]]
...
inner.ph:
  %a.val = load i32, ptr %gep.A, align 4, !llvm.access.group !4
...
inner:
  ...
  %b.val = load i32, ptr %gep.B, align 4, !llvm.access.group !4
...
inner.exit:
  store i32 %accum.next, ptr %gep.A, align 4, !llvm.access.group !4
