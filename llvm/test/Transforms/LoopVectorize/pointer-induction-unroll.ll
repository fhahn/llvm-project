...
; STRIDED-NEXT:    [[OFFSET_IDX:%.*]] = mul i64 [[INDEX]], [[TMP3]]
; STRIDED-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr null, i64 [[OFFSET_IDX]]
; STRIDED-NEXT:    [[DOTCAST:%.*]] = trunc i64 [[INDEX]] to i32
; STRIDED-NEXT:    [[OFFSET_IDX2:%.*]] = add i32 30, [[DOTCAST]]
; STRIDED-NEXT:    [[TMP5:%.*]] = add i32 [[OFFSET_IDX2]], 0
; STRIDED-NEXT:    [[TMP6:%.*]] = add i32 [[OFFSET_IDX2]], 1
; STRIDED-NEXT:    [[TMP7:%.*]] = add i32 [[OFFSET_IDX2]], 2
; STRIDED-NEXT:    [[TMP8:%.*]] = add i32 [[OFFSET_IDX2]], 3
; STRIDED-NEXT:    [[TMP9:%.*]] = getelementptr ptr, ptr [[CALL:%.*]], i32 [[TMP5]]
...
; STRIDED-NEXT:    store ptr [[TMP4]], ptr [[TMP9]], align 4
; STRIDED-NEXT:    store ptr [[TMP4]], ptr [[TMP10]], align 4
; STRIDED-NEXT:    store ptr [[TMP4]], ptr [[TMP11]], align 4
; STRIDED-NEXT:    store ptr [[TMP4]], ptr [[TMP12]], align 4
; STRIDED-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; STRIDED-NEXT:    [[TMP13:%.*]] = icmp eq i64 [[INDEX_NEXT]], 4294967264
; STRIDED-NEXT:    br i1 [[TMP13]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
...
; STRIDED:       for.cond:
; STRIDED-NEXT:    [[TMP14:%.*]] = phi i32 [ [[BC_RESUME_VAL]], [[SCALAR_PH]] ], [ [[INC:%.*]], [[FOR_COND]] ]
; STRIDED-NEXT:    [[P_0:%.*]] = phi ptr [ [[BC_RESUME_VAL1]], [[SCALAR_PH]] ], [ [[ADD_PTR:%.*]], [[FOR_COND]] ]
; STRIDED-NEXT:    [[ADD_PTR]] = getelementptr i8, ptr [[P_0]], i32 [[MUL]]
; STRIDED-NEXT:    [[ARRAYIDX:%.*]] = getelementptr ptr, ptr [[CALL]], i32 [[TMP14]]
; STRIDED-NEXT:    store ptr [[P_0]], ptr [[ARRAYIDX]], align 4
; STRIDED-NEXT:    [[INC]] = add i32 [[TMP14]], 1
; STRIDED-NEXT:    [[TOBOOL_NOT:%.*]] = icmp eq i32 [[TMP14]], 0
