...
; CHECK-NEXT:    [[TMP16:%.*]] = icmp eq i64 [[BC_MERGE_RDX]], 3
; CHECK-NEXT:    [[TMP8:%.*]] = select i1 [[TMP16]], i64 -9223372036854775808, i64 [[BC_MERGE_RDX]]
...
; CHECK-NEXT:    [[N_MOD_VF2:%.*]] = and i64 [[N]], 3
; CHECK-NEXT:    [[N_VEC3:%.*]] = sub i64 [[N]], [[N_MOD_VF2]]
; CHECK-NEXT:    [[TMP16:%.*]] = icmp eq i64 [[BC_MERGE_RDX]], 2
; CHECK-NEXT:    [[TMP8:%.*]] = select i1 [[TMP16]], i64 -9223372036854775808, i64 [[BC_MERGE_RDX]]
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <4 x i64> poison, i64 [[TMP8]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <4 x i64> [[BROADCAST_SPLATINSERT]], <4 x i64> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT4:%.*]] = insertelement <4 x i64> poison, i64 [[VEC_EPILOG_RESUME_VAL]], i64 0
...
; CHECK-NEXT:    [[TMP22:%.*]] = icmp eq i8 [[BC_MERGE_RDX]], [[FR]]
; CHECK-NEXT:    [[TMP12:%.*]] = select i1 [[TMP22]], i8 -128, i8 [[BC_MERGE_RDX]]
...
; CHECK:       [[VEC_EPILOG_PH]]:
; CHECK-NEXT:    [[TMP7:%.*]] = icmp eq i64 [[TMP6]], 3
