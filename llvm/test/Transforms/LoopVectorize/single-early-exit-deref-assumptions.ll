...
; CHECK:       [[LOOP6]]:
; CHECK-NEXT:    [[INDEX3:%.*]] = phi i64 [ 0, %[[LOOP2]] ], [ [[INDEX_NEXT5:%.*]], %[[LOOP_INC4:.*]] ]
...
; CHECK-NEXT:    br i1 [[TMP11]], label %[[LOOP_INC4]], label %[[ORACLE_EXIT:.*]]
; CHECK:       [[LOOP_INC4]]:
; CHECK-NEXT:    [[INDEX_NEXT5]] = add nuw i64 [[INDEX3]], 1
; CHECK-NEXT:    [[TMP22:%.*]] = icmp eq i64 [[INDEX_NEXT5]], 4
; CHECK-NEXT:    br i1 [[TMP22]], label %[[ORACLE_EXIT]], label %[[LOOP6]]
; CHECK:       [[ORACLE_EXIT]]:
; CHECK-NEXT:    [[TMP23:%.*]] = add i64 [[INDEX3]], 1
; CHECK-NEXT:    br label %[[LOOP_SPLIT:.*]]
; CHECK:       [[LOOP_SPLIT]]:
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[P1]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP15:%.*]] = call <4 x i8> @llvm.speculative.load.v4i8.p0(ptr [[TMP14]], i64 [[TMP23]])
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i8, ptr [[P2]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP17:%.*]] = call <4 x i8> @llvm.speculative.load.v4i8.p0(ptr [[TMP16]], i64 [[TMP23]])
; CHECK-NEXT:    [[TMP8:%.*]] = icmp ne <4 x i8> [[TMP15]], [[TMP17]]
; CHECK-NEXT:    [[INDEX_NEXT6]] = add nuw i64 [[INDEX]], 4
; CHECK-NEXT:    [[TMP19:%.*]] = freeze <4 x i1> [[TMP8]]
; CHECK-NEXT:    [[TMP20:%.*]] = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> [[TMP19]])
; CHECK-NEXT:    [[TMP21:%.*]] = icmp eq i64 [[INDEX_NEXT6]], 1024
; CHECK-NEXT:    br i1 [[TMP20]], label %[[VECTOR_EARLY_EXIT:.*]], label %[[MIDDLE_BLOCK]]
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    br i1 [[TMP21]], label %[[MIDDLE_BLOCK1:.*]], label %[[LOOP2]], !llvm.loop [[LOOP3:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK1]]:
; CHECK-NEXT:    br label %[[SCALAR_PH]]
; CHECK:       [[VECTOR_EARLY_EXIT]]:
; CHECK-NEXT:    [[TMP24:%.*]] = call i64 @llvm.experimental.cttz.elts.i64.v4i1(<4 x i1> [[TMP8]], i1 false)
; CHECK-NEXT:    [[TMP25:%.*]] = add i64 [[INDEX]], [[TMP24]]
; CHECK-NEXT:    br label %[[LOOP_END:.*]]
; CHECK:       [[SCALAR_PH]]:
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ 1024, %[[MIDDLE_BLOCK1]] ], [ 0, %[[LOOP]] ]
; CHECK-NEXT:    br label %[[LOOP5:.*]]
; CHECK:       [[LOOP5]]:
...
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[LOOP5]], label %[[LOOP_END]], !llvm.loop [[LOOP4:![0-9]+]]
; CHECK:       [[LOOP_END]]:
; CHECK-NEXT:    [[RETVAL:%.*]] = phi i64 [ [[INDEX1]], %[[LOOP5]] ], [ -1, %[[LOOP_INC]] ], [ [[TMP25]], %[[VECTOR_EARLY_EXIT]] ]
; CHECK-NEXT:    ret i64 [[RETVAL]]
;
entry:
  call void @llvm.assume(i1 true) [ "align"(ptr %p1, i64 4), "dereferenceable"(ptr %p1, i64 1024) ]
...
; CHECK-NEXT:    [[INDEX_NEXT5]] = add nuw i64 [[INDEX3]], 1
; CHECK-NEXT:    [[TMP22:%.*]] = icmp eq i64 [[INDEX_NEXT5]], 4
; CHECK-NEXT:    br i1 [[TMP22]], label %[[ORACLE_EXIT]], label %[[LOOP9]]
; CHECK:       [[ORACLE_EXIT]]:
; CHECK-NEXT:    [[TMP23:%.*]] = add i64 [[INDEX3]], 1
; CHECK-NEXT:    br label %[[LOOP_SPLIT:.*]]
; CHECK:       [[LOOP_SPLIT]]:
...
; CHECK-NEXT:    [[TMP19:%.*]] = freeze <4 x i1> [[TMP8]]
; CHECK-NEXT:    [[TMP20:%.*]] = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> [[TMP19]])
; CHECK-NEXT:    [[TMP21:%.*]] = icmp eq i64 [[INDEX_NEXT6]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP20]], label %[[VECTOR_EARLY_EXIT:.*]], label %[[MIDDLE_BLOCK]]
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    br i1 [[TMP21]], label %[[MIDDLE_BLOCK1:.*]], label %[[LOOP2]], !llvm.loop [[LOOP7:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK1]]:
; CHECK-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[N]], [[N_VEC]]
...
; CHECK-NEXT:    br label %[[LOOP_END]]
; CHECK:       [[SCALAR_PH]]:
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], %[[MIDDLE_BLOCK1]] ], [ 0, %[[ENTRY]] ], [ 0, %[[SPEC_LOAD_CHECK]] ]
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[INDEX1:%.*]] = phi i64 [ [[INDEX_NEXT:%.*]], %[[LOOP_INC:.*]] ], [ [[BC_RESUME_VAL]], %[[SCALAR_PH]] ]
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[P1]], i64 [[INDEX1]]
...
; CHECK-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX1]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp ne i64 [[INDEX_NEXT]], [[N]]
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[LOOP]], label %[[LOOP_END]], !llvm.loop [[LOOP8:![0-9]+]]
; CHECK:       [[LOOP_END]]:
; CHECK-NEXT:    [[RETVAL:%.*]] = phi i64 [ [[INDEX1]], %[[LOOP]] ], [ -1, %[[LOOP_INC]] ], [ -1, %[[MIDDLE_BLOCK1]] ], [ [[TMP25]], %[[VECTOR_EARLY_EXIT]] ]
; CHECK-NEXT:    ret i64 [[RETVAL]]
;
entry:
  call void @llvm.assume(i1 true) [ "align"(ptr %p1, i64 4), "dereferenceable"(ptr %p1, i64 %n) ]
...
; CHECK-NEXT:    [[INDEX_NEXT5]] = add nuw i64 [[INDEX3]], 1
; CHECK-NEXT:    [[TMP22:%.*]] = icmp eq i64 [[INDEX_NEXT5]], 4
; CHECK-NEXT:    br i1 [[TMP22]], label %[[ORACLE_EXIT]], label %[[LOOP11]]
; CHECK:       [[ORACLE_EXIT]]:
; CHECK-NEXT:    [[TMP23:%.*]] = add i64 [[INDEX3]], 1
; CHECK-NEXT:    br label %[[LOOP_SPLIT:.*]]
; CHECK:       [[LOOP_SPLIT]]:
...
; CHECK-NEXT:    br i1 [[TMP20]], label %[[VECTOR_EARLY_EXIT:.*]], label %[[MIDDLE_BLOCK]]
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    br i1 [[TMP21]], label %[[MIDDLE_BLOCK1:.*]], label %[[LOOP2]], !llvm.loop [[LOOP9:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK1]]:
...
; CHECK-NEXT:    [[GEP_P2:%.*]] = getelementptr inbounds i8, ptr [[P2]], i64 [[INDEX1]]
...
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[LOOP]], label %[[LOOP_END_LOOPEXIT]], !llvm.loop [[LOOP10:![0-9]+]]
; CHECK:       [[LOOP_END_LOOPEXIT]]:
; CHECK-NEXT:    [[RETVAL_PH:%.*]] = phi i64 [ -1, %[[LOOP_INC]] ], [ [[INDEX1]], %[[LOOP]] ], [ -1, %[[MIDDLE_BLOCK1]] ], [ [[TMP25]], %[[VECTOR_EARLY_EXIT]] ]
; CHECK-NEXT:    br label %[[LOOP_END]]
; CHECK:       [[LOOP_END]]:
; CHECK-NEXT:    [[RETVAL:%.*]] = phi i64 [ 0, %[[ENTRY]] ], [ [[RETVAL_PH]], %[[LOOP_END_LOOPEXIT]] ]
; CHECK-NEXT:    ret i64 [[RETVAL]]
...
; CHECK-NEXT:    br label %[[LOOP2:.*]]
; CHECK:       [[LOOP2]]:
; CHECK-NEXT:    [[INDEX1:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT6:%.*]], %[[VECTOR_EARLY_EXIT:.*]] ]
; CHECK-NEXT:    br label %[[LOOP21:.*]]
; CHECK:       [[LOOP21]]:
; CHECK-NEXT:    [[INDEX3:%.*]] = phi i64 [ 0, %[[LOOP2]] ], [ [[INDEX_NEXT5:%.*]], %[[LOOP_INC4:.*]] ]
; CHECK-NEXT:    [[TMP6:%.*]] = add i64 [[INDEX3]], [[INDEX1]]
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[P1]], i64 [[TMP6]]
; CHECK-NEXT:    [[TMP18:%.*]] = load i8, ptr [[TMP7]], align 1
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[P2]], i64 [[TMP6]]
; CHECK-NEXT:    [[TMP10:%.*]] = load i8, ptr [[TMP9]], align 1
...
; CHECK-NEXT:    [[INDEX_NEXT5]] = add nuw i64 [[INDEX3]], 1
; CHECK-NEXT:    [[TMP22:%.*]] = icmp eq i64 [[INDEX_NEXT5]], 4
; CHECK-NEXT:    br i1 [[TMP22]], label %[[ORACLE_EXIT]], label %[[LOOP21]]
; CHECK:       [[ORACLE_EXIT]]:
; CHECK-NEXT:    [[TMP23:%.*]] = add i64 [[INDEX3]], 1
; CHECK-NEXT:    br label %[[LOOP_SPLIT:.*]]
; CHECK:       [[LOOP_SPLIT]]:
; CHECK-NEXT:    [[TMP24:%.*]] = getelementptr inbounds i8, ptr [[P1]], i64 [[INDEX1]]
; CHECK-NEXT:    [[TMP15:%.*]] = call <4 x i8> @llvm.speculative.load.v4i8.p0(ptr [[TMP24]], i64 [[TMP23]])
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i8, ptr [[P2]], i64 [[INDEX1]]
; CHECK-NEXT:    [[TMP17:%.*]] = call <4 x i8> @llvm.speculative.load.v4i8.p0(ptr [[TMP16]], i64 [[TMP23]])
; CHECK-NEXT:    [[TMP8:%.*]] = icmp ne <4 x i8> [[TMP15]], [[TMP17]]
; CHECK-NEXT:    [[INDEX_NEXT6]] = add nuw i64 [[INDEX1]], 4
; CHECK-NEXT:    [[TMP19:%.*]] = freeze <4 x i1> [[TMP8]]
; CHECK-NEXT:    [[TMP20:%.*]] = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> [[TMP19]])
; CHECK-NEXT:    [[TMP21:%.*]] = icmp eq i64 [[INDEX_NEXT6]], 1024
; CHECK-NEXT:    br i1 [[TMP20]], label %[[VECTOR_EARLY_EXIT1:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_EARLY_EXIT]]:
; CHECK-NEXT:    br i1 [[TMP21]], label %[[MIDDLE_BLOCK:.*]], label %[[LOOP2]], !llvm.loop [[LOOP18:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    br label %[[LOOP_END:.*]]
; CHECK:       [[VECTOR_EARLY_EXIT1]]:
; CHECK-NEXT:    [[TMP25:%.*]] = call i64 @llvm.experimental.cttz.elts.i64.v4i1(<4 x i1> [[TMP8]], i1 false)
; CHECK-NEXT:    [[TMP26:%.*]] = add i64 [[INDEX1]], [[TMP25]]
; CHECK-NEXT:    br label %[[LOOP_END]]
; CHECK:       [[SCALAR_PH]]:
...
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[LOOP20]], label %[[LOOP_END]], !llvm.loop [[LOOP19:![0-9]+]]
; CHECK:       [[LOOP_END]]:
; CHECK-NEXT:    [[RETVAL:%.*]] = phi i64 [ [[INDEX]], %[[LOOP20]] ], [ -1, %[[LOOP_INC]] ], [ -1, %[[MIDDLE_BLOCK]] ], [ [[TMP26]], %[[VECTOR_EARLY_EXIT1]] ]
; CHECK-NEXT:    ret i64 [[RETVAL]]
; CHECK:       [[LPAD]]:
