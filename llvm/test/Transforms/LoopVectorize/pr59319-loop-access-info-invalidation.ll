...
; CHECK-NEXT:    [[TMP10:%.*]] = add i64 4, [[TMP9]]
...
; CHECK:       vector.ph5:
; CHECK-NEXT:    [[N_MOD_VF6:%.*]] = urem i64 [[TMP3]], 4
; CHECK-NEXT:    [[N_VEC:%.*]] = sub i64 [[TMP3]], [[N_MOD_VF6]]
...
; CHECK-NEXT:    [[BOUND118:%.*]] = icmp ult ptr [[TMP18]], [[SCEVGEP15]]
...
; CHECK-NEXT:    [[CMP_N27:%.*]] = icmp eq i64 [[TMP17]], [[N_VEC25]]
