...
; CHECK-NEXT:    store <4 x i32> [[BROADCAST_SPLAT]], ptr [[TMP3]], align 4, !alias.scope [[META9:![0-9]+]]
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
...
; CHECK-NEXT:    br label [[LATCH]]
; CHECK:       cond_store_k:
; CHECK-NEXT:    store i32 [[K]], ptr [[A]], align 4
; CHECK-NEXT:    br label [[LATCH]]
; CHECK:       latch:
; CHECK-NEXT:    [[I_NEXT]] = add nuw nsw i64 [[I]], 1
; CHECK-NEXT:    [[COND:%.*]] = icmp slt i64 [[I_NEXT]], [[N]]
...
; CHECK-NEXT:    [[TMP23:%.*]] = add nuw i64 [[TMP4]], [[INDEX]]
; CHECK-NEXT:    [[TMP24:%.*]] = getelementptr inbounds i32, ptr [[VAR2]], i64 [[TMP23]]
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x i32>, ptr [[TMP24]], align 4, !alias.scope [[META23:![0-9]+]]
...
; CHECK:       cond_store:
; CHECK-NEXT:    store i32 [[TMP4]], ptr [[ARRAYIDX5]], align 4
; CHECK-NEXT:    br label [[LATCH]]
; CHECK:       latch:
...
; CHECK-NEXT:    store i32 [[ARG6:%.*]], ptr [[I]], align 4
; CHECK-NEXT:    [[I6:%.*]] = getelementptr inbounds i16, ptr [[ARG3:%.*]], i64 [[ARG5:%.*]]
; CHECK-NEXT:    [[ARG4:%.*]] = load i32, ptr [[I]], align 4
...
; CHECK:       bb26:
; CHECK-NEXT:    [[I12_LCSSA:%.*]] = phi i32 [ [[I12]], [[BB7]] ]
; CHECK-NEXT:    store i32 [[I12_LCSSA]], ptr [[I]], align 4
; CHECK-NEXT:    ret void
;
bb:
  %i = alloca i32
