...
; VF2-NEXT:    [[TMP0:%.*]] = add <2 x i64> [[VEC_IND]], [[VEC_IND1]]
; VF2-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[TMP0]], i64 0
; VF2-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP1]]
; VF2-NEXT:    [[TMP3:%.*]] = extractelement <2 x i64> [[TMP0]], i64 1
...
; VF2-NEXT:    [[TMP7:%.*]] = insertelement <2 x i64> poison, i64 [[TMP5]], i64 0
; VF2-NEXT:    [[TMP8:%.*]] = insertelement <2 x i64> [[TMP7]], i64 [[TMP6]], i64 1
; VF2-NEXT:    [[TMP9:%.*]] = add nsw <2 x i64> [[TMP8]], splat (i64 42)
; VF2-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[INDEX]]
...
; VF2-NEXT:    [[TMP11:%.*]] = icmp eq i64 [[INDEX_NEXT]], 1000
...
; VF4-NEXT:    [[TMP0:%.*]] = add <4 x i64> [[VEC_IND]], [[VEC_IND1]]
...
; VF4-NEXT:    br i1 [[TMP19]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; VF4:       middle.block:
...
; VF4-NEXT:    [[TMP4:%.*]] = add <4 x i64> [[VEC_IND]], [[VEC_IND1]]
...
; VF2-NEXT:    [[TMP1:%.*]] = add <2 x i64> [[VEC_IND]], [[VEC_IND1]]
...
; VF4-NEXT:    [[TMP1:%.*]] = add <4 x i64> [[VEC_IND]], [[VEC_IND1]]
...
; VF4-NEXT:    br i1 [[TMP20]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP14:![0-9]+]]
; VF4:       middle.block:
; VF4-NEXT:    br label [[SCALAR_PH:%.*]]
; VF4:       scalar.ph:
;
...
; VF2-NEXT:    [[VEC_IND_NEXT]] = add nsw <2 x i64> [[VEC_IND]], splat (i64 4)
; VF2-NEXT:    [[VEC_IND_NEXT2]] = add nsw <2 x i64> [[VEC_IND1]], splat (i64 2)
; VF2-NEXT:    [[TMP17:%.*]] = icmp eq i64 [[INDEX_NEXT]], 498
...
; VF4-NEXT:    [[TMP5:%.*]] = add <4 x i64> [[VEC_IND]], [[VEC_IND1]]
...
; VF4-NEXT:    [[VEC_IND_NEXT]] = add nsw <4 x i64> [[VEC_IND]], splat (i64 8)
; VF4-NEXT:    [[VEC_IND_NEXT2]] = add nsw <4 x i64> [[VEC_IND1]], splat (i64 4)
; VF4-NEXT:    [[TMP31:%.*]] = icmp eq i64 [[INDEX_NEXT]], 496
...
; VF2-NEXT:    br i1 [[TMP17]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP26:![0-9]+]]
; VF2:       middle.block:
; VF2-NEXT:    br label [[SCALAR_PH:%.*]]
; VF2:       scalar.ph:
;
...
; VF4-NEXT:    br i1 [[TMP31]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP26:![0-9]+]]
; VF4:       middle.block:
; VF4-NEXT:    br label [[SCALAR_PH:%.*]]
; VF4:       scalar.ph:
;
