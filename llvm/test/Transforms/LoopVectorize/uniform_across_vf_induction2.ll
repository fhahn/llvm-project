...
; VF2:       vector.body:
; VF2-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
; VF2-NEXT:    [[DIV11:%.*]] = udiv i64 [[INDEX]], 2
; VF2-NEXT:    [[ADD2:%.*]] = add i64 [[DIV11]], [[DIV11]]
; VF2-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[ADD2]]
; VF2-NEXT:    [[TMP1:%.*]] = load i64, ptr [[TMP0]], align 8
; VF2-NEXT:    [[TMP2:%.*]] = add nsw i64 [[TMP1]], 42
...
; VF2-NEXT:    store <2 x i64> [[BROADCAST_SPLAT]], ptr [[TMP3]], align 8
; VF2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 2
; VF2-NEXT:    [[TMP4:%.*]] = icmp eq i64 [[INDEX_NEXT]], 1000
; VF2-NEXT:    br i1 [[TMP4]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP3:![0-9]+]]
; VF2:       middle.block:
; VF2-NEXT:    br label [[EXIT:%.*]]
; VF2:       exit:
; VF2-NEXT:    ret void
