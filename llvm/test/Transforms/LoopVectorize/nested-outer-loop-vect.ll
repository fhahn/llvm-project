...
; RUN: opt -passes=loop-vectorize -enable-vplan-native-path -disable-outer-loop-memory-safety-check -verify-loop-info -verify-dom-info -S %s | FileCheck %s
...
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <4 x ptr> [[TMP4]], i64 0
; CHECK-NEXT:    store <4 x i32> [[TMP2]], ptr [[TMP10]], align 4
