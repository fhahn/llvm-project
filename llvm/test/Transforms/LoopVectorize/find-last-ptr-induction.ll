...
; Find-last reductions with a pointer-typed index; not recognized yet.
...
; Negative test: selected pointer is not a pointer induction.
...
; Negative test: pointer index paired with a min/max reduction (argmax).
...
; Negative test: pointer induction step is not the canonical IV type.
