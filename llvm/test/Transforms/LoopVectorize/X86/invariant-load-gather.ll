...
; CHECK-NEXT:    [[TMP10:%.*]] = icmp ne ptr [[A]], null
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT6:%.*]] = insertelement <16 x i1> poison, i1 [[TMP10]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT7:%.*]] = shufflevector <16 x i1> [[BROADCAST_SPLATINSERT6]], <16 x i1> poison, <16 x i32> zeroinitializer
...
; CHECK-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <16 x i32> @llvm.masked.gather.v16i32.v16p0(<16 x ptr> align 4 [[BROADCAST_SPLAT6]], <16 x i1> [[BROADCAST_SPLAT7]], <16 x i32> poison), !alias.scope [[META3]]
...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT14:%.*]] = insertelement <8 x i1> poison, i1 [[TMP9]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT15:%.*]] = shufflevector <8 x i1> [[BROADCAST_SPLATINSERT14]], <8 x i1> poison, <8 x i32> zeroinitializer
...
; CHECK-NEXT:    [[WIDE_MASKED_GATHER13:%.*]] = call <8 x i32> @llvm.masked.gather.v8i32.v8p0(<8 x ptr> align 4 [[BROADCAST_SPLAT13]], <8 x i1> [[BROADCAST_SPLAT15]], <8 x i32> poison), !alias.scope [[META3]]
