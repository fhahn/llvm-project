...
; SSE2:  Cost of 11 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; SSE2:  Cost of 22 for VF 16: REPLICATE store ir<%valB>, ir<%out>
;
; SSE42-LABEL: 'test'
...
; AVX1:  Cost of 8.5 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; AVX1:  Cost of 17 for VF 16: REPLICATE store ir<%valB>, ir<%out>
; AVX1:  Cost of 34 for VF 32: REPLICATE store ir<%valB>, ir<%out>
;
; AVX2-LABEL: 'test'
...
; AVX2:  Cost of 8.5 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; AVX2:  Cost of 17 for VF 16: REPLICATE store ir<%valB>, ir<%out>
; AVX2:  Cost of 34 for VF 32: REPLICATE store ir<%valB>, ir<%out>
;
; AVX512-LABEL: 'test'
