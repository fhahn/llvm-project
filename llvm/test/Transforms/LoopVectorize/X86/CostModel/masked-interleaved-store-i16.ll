; NOTE: Assertions have been autogenerated by utils/update_analyze_test_checks.py UTC_ARGS: --filter "LV: Found an estimated cost of [0-9]+ for VF 1 For instruction:\s*store i16 %[0,2], ptr %[a-zA-Z0-7]+, align 2" --filter "Cost of [1-9][0-9]*(\.[0-9]+)? for VF [0-9]+: (profitable to scalarize\s+store i16 %[02]|REPLICATE store ir<%[02]>|INTERLEAVE-GROUP with factor [0-9]+ at <badref>)"
...
; DISABLED_MASKED_STRIDED:  Cost of 2 for VF 2: REPLICATE store ir<%0>, ir<%arrayidx6>
; DISABLED_MASKED_STRIDED:  Cost of 4 for VF 4: REPLICATE store ir<%0>, ir<%arrayidx6>
; DISABLED_MASKED_STRIDED:  Cost of 8 for VF 8: REPLICATE store ir<%0>, ir<%arrayidx6>
; DISABLED_MASKED_STRIDED:  Cost of 16.5 for VF 16: REPLICATE store ir<%0>, ir<%arrayidx6>
;
...
; ENABLED_MASKED_STRIDED:  Cost of 2 for VF 2: REPLICATE store ir<%0>, ir<%arrayidx6>
; ENABLED_MASKED_STRIDED:  Cost of 4 for VF 4: REPLICATE store ir<%0>, ir<%arrayidx6>
;
entry:
  br label %for.body
