; NOTE: Assertions have been autogenerated by utils/update_analyze_test_checks.py UTC_ARGS: --filter-out-after "Selecting VF" --filter "Cost of [0-9]+(\.[0-9]+)? for VF [0-9]+: .*(store|mul)" --filter "Cost for VF [0-9]+:" --filter "LV: Selecting VF" --version 6
