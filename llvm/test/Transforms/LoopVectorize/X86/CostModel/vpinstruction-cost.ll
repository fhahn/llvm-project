...
; CHECK:  Cost of 0 for VF 1: EMIT branch-on-cond ir<%c> (!prof estimated {1073741824, 1073741824})
...
; CHECK:  Cost of 0 for VF 1: EMIT branch-on-cond ir<%exitcond> (!prof estimated {67108864, 2080374784})
...
; CHECK:  Cost of 0 for VF 1: EMIT branch-on-cond ir<%ec> (!prof estimated {67108864, 2080374784})
...
; CHECK:  Cost of 0 for VF 1: EMIT switch ir<%l>, ir<-12>, ir<13>, ir<0> (!prof estimated {536870912, 536870912, 536870912, 536870912})
