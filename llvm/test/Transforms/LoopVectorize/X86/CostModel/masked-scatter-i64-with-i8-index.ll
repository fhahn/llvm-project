...
; SSE2:  Cost of 5 for VF 4: REPLICATE store ir<%valB>, ir<%out>
; SSE2:  Cost of 10 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; SSE2:  Cost of 20 for VF 16: REPLICATE store ir<%valB>, ir<%out>
;
; SSE42-LABEL: 'test'
...
; AVX1:  Cost of 4.5 for VF 4: REPLICATE store ir<%valB>, ir<%out>
; AVX1:  Cost of 9 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; AVX1:  Cost of 18 for VF 16: REPLICATE store ir<%valB>, ir<%out>
; AVX1:  Cost of 36 for VF 32: REPLICATE store ir<%valB>, ir<%out>
;
; AVX2-LABEL: 'test'
...
; AVX2:  Cost of 4.5 for VF 4: REPLICATE store ir<%valB>, ir<%out>
; AVX2:  Cost of 9 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; AVX2:  Cost of 18 for VF 16: REPLICATE store ir<%valB>, ir<%out>
; AVX2:  Cost of 36 for VF 32: REPLICATE store ir<%valB>, ir<%out>
;
; AVX512-LABEL: 'test'
