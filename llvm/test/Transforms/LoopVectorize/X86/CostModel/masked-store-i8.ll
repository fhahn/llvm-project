; NOTE: Assertions have been autogenerated by utils/update_analyze_test_checks.py UTC_ARGS: --filter "LV: Found an estimated cost of [0-9]+ for VF 1 For instruction:\s*store i8 %valB, ptr %out" --filter "Cost of [1-9][0-9]*(\.[0-9]+)? for VF [0-9]+: (profitable to scalarize\s+store i8 %valB|WIDEN store .*, ir<%valB>|REPLICATE store ir<%valB>)"
...
; SSE2:  Cost of 2.5 for VF 2: REPLICATE store ir<%valB>, ir<%out>
; SSE2:  Cost of 5.5 for VF 4: REPLICATE store ir<%valB>, ir<%out>
; SSE2:  Cost of 11.5 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; SSE2:  Cost of 23.5 for VF 16: REPLICATE store ir<%valB>, ir<%out>
;
; SSE42-LABEL: 'test'
; SSE42:  LV: Found an estimated cost of 1 for VF 1 For instruction: store i8 %valB, ptr %out, align 1
; SSE42:  Cost of 2 for VF 2: REPLICATE store ir<%valB>, ir<%out>
; SSE42:  Cost of 4 for VF 4: REPLICATE store ir<%valB>, ir<%out>
; SSE42:  Cost of 8 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; SSE42:  Cost of 16 for VF 16: REPLICATE store ir<%valB>, ir<%out>
;
; AVX1-LABEL: 'test'
; AVX1:  LV: Found an estimated cost of 1 for VF 1 For instruction: store i8 %valB, ptr %out, align 1
; AVX1:  Cost of 2 for VF 2: REPLICATE store ir<%valB>, ir<%out>
; AVX1:  Cost of 4 for VF 4: REPLICATE store ir<%valB>, ir<%out>
; AVX1:  Cost of 8 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; AVX1:  Cost of 16 for VF 16: REPLICATE store ir<%valB>, ir<%out>
; AVX1:  Cost of 32.5 for VF 32: REPLICATE store ir<%valB>, ir<%out>
;
; AVX2-LABEL: 'test'
; AVX2:  LV: Found an estimated cost of 1 for VF 1 For instruction: store i8 %valB, ptr %out, align 1
; AVX2:  Cost of 2 for VF 2: REPLICATE store ir<%valB>, ir<%out>
; AVX2:  Cost of 4 for VF 4: REPLICATE store ir<%valB>, ir<%out>
; AVX2:  Cost of 8 for VF 8: REPLICATE store ir<%valB>, ir<%out>
; AVX2:  Cost of 16 for VF 16: REPLICATE store ir<%valB>, ir<%out>
; AVX2:  Cost of 32.5 for VF 32: REPLICATE store ir<%valB>, ir<%out>
;
; AVX512-LABEL: 'test'
