...
; CHECK: Cost of 1 for VF 2: EMIT-SCALAR ir<%shifted> = lshr vp<{{.+}}>, ir<2>
; CHECK: Cost of 1 for VF 4: EMIT-SCALAR ir<%shifted> = lshr vp<{{.+}}>, ir<2>
...
; CHECK: Cost of 0 for VF 2: EMIT-SCALAR ir<%div> = sdiv ir<%add.offset>, ir<8>
; CHECK: Cost of 0 for VF 4: EMIT-SCALAR ir<%div> = sdiv ir<%add.offset>, ir<8>
; CHECK: Cost of 0 for VF 8: EMIT-SCALAR ir<%div> = sdiv ir<%add.offset>, ir<8>
