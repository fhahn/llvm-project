...
; AVX:       [[VECTOR_BODY]]:
; AVX-NEXT:    store <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>, ptr @arr2, align 4, !llvm.access.group [[ACC_GRP0:![0-9]+]]
...
; AVX-NEXT:    [[TMP1:%.*]] = extractelement <8 x i64> [[VEC_PHI]], i64 0
; AVX-NEXT:    [[TMP3:%.*]] = getelementptr inbounds [8 x [8 x i32]], ptr @arr, i64 0, i64 [[TMP1]], i64 0
; AVX-NEXT:    store <8 x i32> [[TMP2]], ptr [[TMP3]], align 4, !llvm.access.group [[ACC_GRP0]]
...
; AVX-NEXT:    br i1 [[TMP6]], label %[[VECTOR_LATCH:.*]], label %[[FOR_BODY31]], !llvm.loop [[LOOP1:![0-9]+]]
; AVX:       [[VECTOR_LATCH]]:
