...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [8 x i32], ptr @arr2, i64 0, i64 [[TMP0]]
...
; CHECK-NEXT:    [[TMP6:%.*]] = icmp eq i64 [[TMP5]], 8
...
; AVX:       [[VECTOR_BODY]]:
; AVX-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [8 x i32], ptr @arr2, i64 0, i64 0
; AVX-NEXT:    store <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>, ptr [[TMP0]], align 4
...
; AVX-NEXT:    [[TMP5:%.*]] = extractelement <8 x i64> [[TMP4]], i64 0
; AVX-NEXT:    [[TMP6:%.*]] = icmp eq i64 [[TMP5]], 8
