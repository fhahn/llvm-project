...
; CHECK-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <4 x i20> @llvm.masked.gather.v4i20.v4p0(<4 x ptr> align 4 [[WIDE_GEP]], <4 x i1> splat (i1 true), <4 x i20> poison), !llvm.access.group [[ACC_GRP0:![0-9]+]]
; CHECK-NEXT:    [[TMP2:%.*]] = add <4 x i20> [[WIDE_MASKED_GATHER]], [[WIDE_MASKED_GATHER]]
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i20.v4p0(<4 x i20> [[TMP2]], <4 x ptr> align 4 [[WIDE_GEP]], <4 x i1> splat (i1 true)), !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    [[L:%.*]] = load i20, ptr [[G]], align 4, !llvm.access.group [[ACC_GRP0]]
; CHECK-NEXT:    [[ADD:%.*]] = add i20 [[L]], [[L]]
; CHECK-NEXT:    store i20 [[ADD]], ptr [[G]], align 4, !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    br i1 [[EC_OUTER]], label %[[EXIT]], label %[[OUTER]], !llvm.loop [[LOOP5:![0-9]+]]
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    ret void
;
entry:
...
inner:
  ...
  %l = load i20, ptr %g, !llvm.access.group !2
  %add = add i20 %l, %l
  store i20 %add, ptr %g, !llvm.access.group !2
  %j.next = add i64 %j, 1
...
!2 = distinct !{}
!3 = !{!"llvm.loop.parallel_accesses", !2}
