...
; CHECK:       [[VEC_EPILOG_PH]]:
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> splat (i32 1), i32 [[TMP1]], i64 0
...
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 32, %[[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VEC_EPILOG_VECTOR_BODY]] ]
...
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[IV:%.*]] = phi i64 [ [[IV_NEXT:%.*]], %[[LOOP]] ], [ 0, %[[VEC_EPILOG_SCALAR_PH]] ]
; CHECK-NEXT:    [[ACC:%.*]] = phi i32 [ [[MUL:%.*]], %[[LOOP]] ], [ 0, %[[VEC_EPILOG_SCALAR_PH]] ]
...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[RESULT:%.*]] = phi i32 [ [[MUL]], %[[LOOP]] ], [ [[TMP5]], %[[VEC_EPILOG_MIDDLE_BLOCK]] ]
