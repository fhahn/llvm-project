...
; COST-NEXT:    [[TMP0:%.*]] = sub i64 0, [[START2]]
; COST-NEXT:    [[TMP5:%.*]] = add i64 [[END1]], [[TMP0]]
; COST-NEXT:    [[TMP1:%.*]] = add i64 [[TMP5]], -8
...
; FORCED-NEXT:    [[TMP0:%.*]] = sub i64 0, [[START2]]
; FORCED-NEXT:    [[TMP5:%.*]] = add i64 [[END1]], [[TMP0]]
; FORCED-NEXT:    [[TMP1:%.*]] = add i64 [[TMP5]], -8
