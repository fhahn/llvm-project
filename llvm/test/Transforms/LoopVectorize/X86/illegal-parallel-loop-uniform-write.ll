...
; CHECK-NEXT:    [[TMP16:%.*]] = add nsw <4 x i32> [[WIDE_LOAD]], splat (i32 1)
; CHECK-NEXT:    [[TMP17:%.*]] = extractelement <4 x i32> [[TMP16]], i64 3
; CHECK-NEXT:    store i32 [[TMP17]], ptr [[ARRAYIDX7_US]], align 4, !llvm.mem.parallel_loop_access [[META0]]
