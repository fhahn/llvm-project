...
; CHECK-NEXT:    br label [[VEC_EPILOG_VECTOR_BODY:%.*]]
; CHECK:       vec.epilog.vector.body:
; CHECK-NEXT:    [[INDEX1:%.*]] = phi i32 [ 0, [[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT3:%.*]], [[VEC_EPILOG_VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP3:%.*]] = add i32 [[INDEX_NEXT3]], 1024
; CHECK-NEXT:    [[TMP5:%.*]] = icmp eq i32 [[TMP3]], 1052
; CHECK-NEXT:    br i1 [[TMP5]], label [[VEC_EPILOG_MIDDLE_BLOCK:%.*]], label [[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP12:![0-9]+]]
; CHECK:       vec.epilog.middle.block:
