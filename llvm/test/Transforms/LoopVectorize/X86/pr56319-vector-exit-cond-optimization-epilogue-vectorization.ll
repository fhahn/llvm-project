...
; CHECK-NEXT:    [[INDEX2:%.*]] = phi i64 [ 0, [[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT5:%.*]], [[VEC_EPILOG_VECTOR_BODY]] ]
; CHECK-NEXT:    [[INDEX1:%.*]] = add i64 [[INDEX2]], 32
...
; CHECK-NEXT:    [[INDEX_NEXT4:%.*]] = add i64 [[INDEX_NEXT5]], 32
