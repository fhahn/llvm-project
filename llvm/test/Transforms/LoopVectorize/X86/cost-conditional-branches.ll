...
; CHECK-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <8 x i64> @llvm.masked.gather.v8i64.v8p0(<8 x ptr> align 8 [[WIDE_GEP]], <8 x i1> [[TMP2]], <8 x i64> poison)
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 8
; CHECK-NEXT:    [[VEC_IND_NEXT]] = add <8 x i32> [[VEC_IND]], splat (i32 8)
; CHECK-NEXT:    [[TMP62:%.*]] = icmp eq i32 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP62]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP63:%.*]] = or <8 x i64> [[WIDE_MASKED_GATHER]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[PREDPHI:%.*]] = select <8 x i1> [[TMP2]], <8 x i64> [[TMP63]], <8 x i64> zeroinitializer
; CHECK-NEXT:    [[TMP64:%.*]] = extractelement <8 x i64> [[PREDPHI]], i64 7
...
; CHECK:       if.then:
; CHECK-NEXT:    [[TMP65:%.*]] = urem i32 [[A]], [[C]]
; CHECK-NEXT:    [[MUL:%.*]] = sub i32 0, [[TMP65]]
...
; CHECK:       exit:
; CHECK-NEXT:    [[RES_LCSSA:%.*]] = phi i64 [ [[RES]], [[LOOP_LATCH]] ], [ [[TMP64]], [[MIDDLE_BLOCK]] ]
...
; CHECK-NEXT:    [[TMP18:%.*]] = fcmp oeq <4 x double> [[STRIDED_VEC7]], zeroinitializer
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <4 x i1> [[TMP15]], i64 0
...
; CHECK-NEXT:    [[TMP20:%.*]] = extractelement <4 x i1> [[TMP15]], i64 1
...
; CHECK-NEXT:    [[TMP23:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP22]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP23]], align 8
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE9]]
; CHECK:       pred.store.continue9:
; CHECK-NEXT:    [[TMP24:%.*]] = extractelement <4 x i1> [[TMP15]], i64 2
; CHECK-NEXT:    br i1 [[TMP24]], label [[PRED_STORE_IF10:%.*]], label [[PRED_STORE_CONTINUE11:%.*]]
; CHECK:       pred.store.if10:
; CHECK-NEXT:    [[TMP25:%.*]] = add i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP26:%.*]] = shl nsw i64 [[TMP25]], 2
; CHECK-NEXT:    [[TMP27:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP26]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP27]], align 8
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE11]]
; CHECK:       pred.store.continue11:
; CHECK-NEXT:    [[TMP28:%.*]] = extractelement <4 x i1> [[TMP15]], i64 3
; CHECK-NEXT:    br i1 [[TMP28]], label [[PRED_STORE_IF12:%.*]], label [[PRED_STORE_CONTINUE13:%.*]]
; CHECK:       pred.store.if12:
; CHECK-NEXT:    [[TMP29:%.*]] = add i64 [[INDEX]], 3
; CHECK-NEXT:    [[TMP30:%.*]] = shl nsw i64 [[TMP29]], 2
; CHECK-NEXT:    [[TMP31:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP30]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP31]], align 8
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE13]]
; CHECK:       pred.store.continue13:
; CHECK-NEXT:    [[TMP32:%.*]] = extractelement <4 x i1> [[TMP16]], i64 0
; CHECK-NEXT:    br i1 [[TMP32]], label [[PRED_STORE_IF14:%.*]], label [[PRED_STORE_CONTINUE15:%.*]]
...
; CHECK-NEXT:    [[TMP33:%.*]] = extractelement <4 x i1> [[TMP16]], i64 1
; CHECK-NEXT:    br i1 [[TMP33]], label [[PRED_STORE_IF16:%.*]], label [[PRED_STORE_CONTINUE17:%.*]]
; CHECK:       pred.store.if16:
; CHECK-NEXT:    [[TMP34:%.*]] = add i64 [[INDEX]], 5
; CHECK-NEXT:    [[TMP35:%.*]] = shl nsw i64 [[TMP34]], 2
; CHECK-NEXT:    [[TMP36:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP35]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP36]], align 8
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE17]]
; CHECK:       pred.store.continue17:
; CHECK-NEXT:    [[TMP37:%.*]] = extractelement <4 x i1> [[TMP16]], i64 2
; CHECK-NEXT:    br i1 [[TMP37]], label [[PRED_STORE_IF18:%.*]], label [[PRED_STORE_CONTINUE19:%.*]]
; CHECK:       pred.store.if18:
; CHECK-NEXT:    [[TMP38:%.*]] = add i64 [[INDEX]], 6
; CHECK-NEXT:    [[TMP39:%.*]] = shl nsw i64 [[TMP38]], 2
...
; CHECK-NEXT:    [[TMP41:%.*]] = extractelement <4 x i1> [[TMP16]], i64 3
; CHECK-NEXT:    br i1 [[TMP41]], label [[PRED_STORE_IF20:%.*]], label [[PRED_STORE_CONTINUE21:%.*]]
; CHECK:       pred.store.if20:
; CHECK-NEXT:    [[TMP42:%.*]] = add i64 [[INDEX]], 7
...
; CHECK-NEXT:    [[TMP45:%.*]] = extractelement <4 x i1> [[TMP17]], i64 0
...
; CHECK-NEXT:    [[TMP46:%.*]] = extractelement <4 x i1> [[TMP17]], i64 1
; CHECK-NEXT:    br i1 [[TMP46]], label [[PRED_STORE_IF24:%.*]], label [[PRED_STORE_CONTINUE25:%.*]]
; CHECK:       pred.store.if24:
; CHECK-NEXT:    [[TMP47:%.*]] = add i64 [[INDEX]], 9
; CHECK-NEXT:    [[TMP48:%.*]] = shl nsw i64 [[TMP47]], 2
; CHECK-NEXT:    [[TMP49:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP48]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP49]], align 8
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE25]]
; CHECK:       pred.store.continue25:
; CHECK-NEXT:    [[TMP50:%.*]] = extractelement <4 x i1> [[TMP17]], i64 2
; CHECK-NEXT:    br i1 [[TMP50]], label [[PRED_STORE_IF26:%.*]], label [[PRED_STORE_CONTINUE27:%.*]]
; CHECK:       pred.store.if26:
; CHECK-NEXT:    [[TMP51:%.*]] = add i64 [[INDEX]], 10
; CHECK-NEXT:    [[TMP52:%.*]] = shl nsw i64 [[TMP51]], 2
; CHECK-NEXT:    [[TMP53:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP52]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP53]], align 8
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE27]]
; CHECK:       pred.store.continue27:
; CHECK-NEXT:    [[TMP54:%.*]] = extractelement <4 x i1> [[TMP17]], i64 3
; CHECK-NEXT:    br i1 [[TMP54]], label [[PRED_STORE_IF28:%.*]], label [[PRED_STORE_CONTINUE29:%.*]]
; CHECK:       pred.store.if28:
; CHECK-NEXT:    [[TMP55:%.*]] = add i64 [[INDEX]], 11
; CHECK-NEXT:    [[TMP56:%.*]] = shl nsw i64 [[TMP55]], 2
; CHECK-NEXT:    [[TMP57:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP56]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP57]], align 8
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE29]]
; CHECK:       pred.store.continue29:
; CHECK-NEXT:    [[TMP58:%.*]] = extractelement <4 x i1> [[TMP18]], i64 0
; CHECK-NEXT:    br i1 [[TMP58]], label [[PRED_STORE_IF30:%.*]], label [[PRED_STORE_CONTINUE31:%.*]]
...
; CHECK-NEXT:    [[TMP59:%.*]] = extractelement <4 x i1> [[TMP18]], i64 1
; CHECK-NEXT:    br i1 [[TMP59]], label [[PRED_STORE_IF32:%.*]], label [[PRED_STORE_CONTINUE33:%.*]]
; CHECK:       pred.store.if32:
; CHECK-NEXT:    [[TMP60:%.*]] = add i64 [[INDEX]], 13
; CHECK-NEXT:    [[TMP61:%.*]] = shl nsw i64 [[TMP60]], 2
; CHECK-NEXT:    [[TMP62:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP61]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP62]], align 8
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE33]]
; CHECK:       pred.store.continue33:
; CHECK-NEXT:    [[TMP63:%.*]] = extractelement <4 x i1> [[TMP18]], i64 2
; CHECK-NEXT:    br i1 [[TMP63]], label [[PRED_STORE_IF34:%.*]], label [[PRED_STORE_CONTINUE35:%.*]]
; CHECK:       pred.store.if34:
; CHECK-NEXT:    [[TMP64:%.*]] = add i64 [[INDEX]], 14
; CHECK-NEXT:    [[TMP65:%.*]] = shl nsw i64 [[TMP64]], 2
; CHECK-NEXT:    [[TMP66:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP65]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP66]], align 8
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE35]]
; CHECK:       pred.store.continue35:
; CHECK-NEXT:    [[TMP67:%.*]] = extractelement <4 x i1> [[TMP18]], i64 3
; CHECK-NEXT:    br i1 [[TMP67]], label [[PRED_STORE_IF36:%.*]], label [[PRED_STORE_CONTINUE37]]
; CHECK:       pred.store.if36:
; CHECK-NEXT:    [[TMP68:%.*]] = add i64 [[INDEX]], 15
; CHECK-NEXT:    [[TMP69:%.*]] = shl nsw i64 [[TMP68]], 2
...
; CHECK-NEXT:    br i1 [[TMP71]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP6:![0-9]+]]
; CHECK:       middle.block:
; CHECK-NEXT:    br label [[VEC_EPILOG_ITER_CHECK:%.*]]
; CHECK:       vec.epilog.iter.check:
; CHECK-NEXT:    [[MIN_EPILOG_ITERS_CHECK:%.*]] = icmp ule i64 [[TMP3]], 4
; CHECK-NEXT:    br i1 [[MIN_EPILOG_ITERS_CHECK]], label [[VEC_EPILOG_SCALAR_PH]], label [[VEC_EPILOG_PH]], !prof [[PROF7:![0-9]+]]
; CHECK:       vec.epilog.ph:
; CHECK-NEXT:    [[VEC_EPILOG_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], [[VEC_EPILOG_ITER_CHECK]] ], [ 0, [[VECTOR_MAIN_LOOP_ITER_CHECK]] ]
; CHECK-NEXT:    [[TMP72:%.*]] = and i64 [[TMP0]], 3
; CHECK-NEXT:    [[TMP73:%.*]] = icmp eq i64 [[TMP72]], 0
; CHECK-NEXT:    [[TMP74:%.*]] = select i1 [[TMP73]], i64 4, i64 [[TMP72]]
; CHECK-NEXT:    [[N_VEC38:%.*]] = sub i64 [[TMP0]], [[TMP74]]
; CHECK-NEXT:    br label [[VEC_EPILOG_VECTOR_BODY:%.*]]
; CHECK:       vec.epilog.vector.body:
; CHECK-NEXT:    [[INDEX39:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL]], [[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT50:%.*]], [[PRED_STORE_CONTINUE49:%.*]] ]
...
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC38]], [[VEC_EPILOG_MIDDLE_BLOCK]] ], [ [[N_VEC]], [[VEC_EPILOG_ITER_CHECK]] ], [ 0, [[ITER_CHECK:%.*]] ]
; CHECK-NEXT:    br label [[LOOP_HEADER:%.*]]
; CHECK:       loop.header:
...
; CHECK-NEXT:    br label [[VEC_EPILOG_VECTOR_BODY:%.*]]
; CHECK:       vec.epilog.vector.body:
; CHECK-NEXT:    [[INDEX63:%.*]] = phi i32 [ 992, [[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT81:%.*]], [[PRED_UDIV_CONTINUE80:%.*]] ]
; CHECK-NEXT:    [[VEC_IND64:%.*]] = phi <8 x i32> [ <i32 992, i32 993, i32 994, i32 995, i32 996, i32 997, i32 998, i32 999>, [[VEC_EPILOG_PH]] ], [ [[VEC_IND_NEXT82:%.*]], [[PRED_UDIV_CONTINUE80]] ]
...
; CHECK-NEXT:    br label [[VEC_EPILOG_SCALAR_PH]]
; CHECK:       vec.epilog.scalar.ph:
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i32 [ 1000, [[VEC_EPILOG_MIDDLE_BLOCK]] ], [ 992, [[VEC_EPILOG_ITER_CHECK]] ]
; CHECK-NEXT:    br label [[LOOP_HEADER:%.*]]
; CHECK:       loop.header:
