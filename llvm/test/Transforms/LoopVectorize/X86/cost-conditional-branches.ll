...
; CHECK-NEXT:    [[TMP40:%.*]] = xor <32 x i1> [[BROADCAST_SPLAT]], splat (i1 true)
; CHECK-NEXT:    br label [[LOOP_HEADER:%.*]]
; CHECK:       vector.body:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i32 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[PRED_UREM_CONTINUE62:%.*]] ]
; CHECK-NEXT:    [[TMP41:%.*]] = extractelement <32 x i1> [[TMP40]], i32 0
; CHECK-NEXT:    br i1 [[TMP41]], label [[PRED_UREM_IF:%.*]], label [[PRED_UREM_CONTINUE:%.*]]
; CHECK:       pred.urem.if:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE]]
; CHECK:       pred.urem.continue:
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <32 x i1> [[TMP40]], i32 1
; CHECK-NEXT:    br i1 [[TMP2]], label [[PRED_UREM_IF1:%.*]], label [[PRED_UREM_CONTINUE2:%.*]]
; CHECK:       pred.urem.if1:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE2]]
; CHECK:       pred.urem.continue2:
; CHECK-NEXT:    [[TMP3:%.*]] = extractelement <32 x i1> [[TMP40]], i32 2
; CHECK-NEXT:    br i1 [[TMP3]], label [[PRED_UREM_IF3:%.*]], label [[PRED_UREM_CONTINUE4:%.*]]
; CHECK:       pred.urem.if3:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE4]]
; CHECK:       pred.urem.continue4:
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <32 x i1> [[TMP40]], i32 3
; CHECK-NEXT:    br i1 [[TMP4]], label [[PRED_UREM_IF5:%.*]], label [[PRED_UREM_CONTINUE6:%.*]]
; CHECK:       pred.urem.if5:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE6]]
; CHECK:       pred.urem.continue6:
; CHECK-NEXT:    [[TMP5:%.*]] = extractelement <32 x i1> [[TMP40]], i32 4
; CHECK-NEXT:    br i1 [[TMP5]], label [[PRED_UREM_IF7:%.*]], label [[PRED_UREM_CONTINUE8:%.*]]
; CHECK:       pred.urem.if7:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE8]]
; CHECK:       pred.urem.continue8:
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <32 x i1> [[TMP40]], i32 5
; CHECK-NEXT:    br i1 [[TMP6]], label [[PRED_UREM_IF9:%.*]], label [[PRED_UREM_CONTINUE10:%.*]]
; CHECK:       pred.urem.if9:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE10]]
; CHECK:       pred.urem.continue10:
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <32 x i1> [[TMP40]], i32 6
; CHECK-NEXT:    br i1 [[TMP7]], label [[PRED_UREM_IF11:%.*]], label [[PRED_UREM_CONTINUE12:%.*]]
; CHECK:       pred.urem.if11:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE12]]
; CHECK:       pred.urem.continue12:
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <32 x i1> [[TMP40]], i32 7
; CHECK-NEXT:    br i1 [[TMP8]], label [[PRED_UREM_IF13:%.*]], label [[PRED_UREM_CONTINUE14:%.*]]
; CHECK:       pred.urem.if13:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE14]]
; CHECK:       pred.urem.continue14:
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <32 x i1> [[TMP40]], i32 8
...
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <32 x i1> [[TMP40]], i32 9
...
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <32 x i1> [[TMP40]], i32 10
...
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <32 x i1> [[TMP40]], i32 11
...
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <32 x i1> [[TMP40]], i32 12
...
; CHECK-NEXT:    [[TMP14:%.*]] = extractelement <32 x i1> [[TMP40]], i32 13
...
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <32 x i1> [[TMP40]], i32 14
...
; CHECK-NEXT:    [[TMP16:%.*]] = extractelement <32 x i1> [[TMP40]], i32 15
...
; CHECK-NEXT:    [[TMP17:%.*]] = extractelement <32 x i1> [[TMP40]], i32 16
...
; CHECK-NEXT:    [[TMP18:%.*]] = extractelement <32 x i1> [[TMP40]], i32 17
...
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <32 x i1> [[TMP40]], i32 18
...
; CHECK-NEXT:    [[TMP20:%.*]] = extractelement <32 x i1> [[TMP40]], i32 19
...
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <32 x i1> [[TMP40]], i32 20
...
; CHECK-NEXT:    [[TMP22:%.*]] = extractelement <32 x i1> [[TMP40]], i32 21
...
; CHECK-NEXT:    [[TMP23:%.*]] = extractelement <32 x i1> [[TMP40]], i32 22
...
; CHECK-NEXT:    [[TMP24:%.*]] = extractelement <32 x i1> [[TMP40]], i32 23
...
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <32 x i1> [[TMP40]], i32 24
...
; CHECK-NEXT:    [[TMP26:%.*]] = extractelement <32 x i1> [[TMP40]], i32 25
...
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <32 x i1> [[TMP40]], i32 26
...
; CHECK-NEXT:    [[TMP28:%.*]] = extractelement <32 x i1> [[TMP40]], i32 27
...
; CHECK-NEXT:    [[TMP29:%.*]] = extractelement <32 x i1> [[TMP40]], i32 28
...
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <32 x i1> [[TMP40]], i32 29
...
; CHECK-NEXT:    [[TMP31:%.*]] = extractelement <32 x i1> [[TMP40]], i32 30
...
; CHECK-NEXT:    [[TMP32:%.*]] = extractelement <32 x i1> [[TMP40]], i32 31
...
; CHECK-NEXT:    [[TMP33:%.*]] = icmp eq i32 [[INDEX_NEXT]], 96
; CHECK-NEXT:    br i1 [[TMP33]], label [[MIDDLE_BLOCK:%.*]], label [[LOOP_HEADER]], !llvm.loop [[LOOP10:![0-9]+]]
; CHECK:       middle.block:
...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT63:%.*]] = insertelement <4 x i1> poison, i1 [[CMP_I]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT64:%.*]] = shufflevector <4 x i1> [[BROADCAST_SPLATINSERT63]], <4 x i1> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP34:%.*]] = xor <4 x i1> [[BROADCAST_SPLAT64]], splat (i1 true)
; CHECK-NEXT:    br label [[VEC_EPILOG_VECTOR_BODY:%.*]]
; CHECK:       vec.epilog.vector.body:
; CHECK-NEXT:    [[INDEX65:%.*]] = phi i32 [ [[VEC_EPILOG_RESUME_VAL]], [[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT74:%.*]], [[PRED_UREM_CONTINUE73:%.*]] ]
; CHECK-NEXT:    [[TMP35:%.*]] = extractelement <4 x i1> [[TMP34]], i32 0
; CHECK-NEXT:    br i1 [[TMP35]], label [[PRED_UREM_IF66:%.*]], label [[PRED_UREM_CONTINUE67:%.*]]
; CHECK:       pred.urem.if66:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE67]]
; CHECK:       pred.urem.continue67:
; CHECK-NEXT:    [[TMP36:%.*]] = extractelement <4 x i1> [[TMP34]], i32 1
; CHECK-NEXT:    br i1 [[TMP36]], label [[PRED_UREM_IF68:%.*]], label [[PRED_UREM_CONTINUE69:%.*]]
; CHECK:       pred.urem.if68:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE69]]
; CHECK:       pred.urem.continue69:
; CHECK-NEXT:    [[TMP37:%.*]] = extractelement <4 x i1> [[TMP34]], i32 2
; CHECK-NEXT:    br i1 [[TMP37]], label [[PRED_UREM_IF70:%.*]], label [[PRED_UREM_CONTINUE71:%.*]]
; CHECK:       pred.urem.if70:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE71]]
; CHECK:       pred.urem.continue71:
; CHECK-NEXT:    [[TMP38:%.*]] = extractelement <4 x i1> [[TMP34]], i32 3
; CHECK-NEXT:    br i1 [[TMP38]], label [[PRED_UREM_IF72:%.*]], label [[PRED_UREM_CONTINUE73]]
; CHECK:       pred.urem.if72:
; CHECK-NEXT:    br label [[PRED_UREM_CONTINUE73]]
; CHECK:       pred.urem.continue73:
; CHECK-NEXT:    [[INDEX_NEXT74]] = add nuw i32 [[INDEX65]], 4
; CHECK-NEXT:    [[TMP39:%.*]] = icmp eq i32 [[INDEX_NEXT74]], 100
; CHECK-NEXT:    br i1 [[TMP39]], label [[VEC_EPILOG_MIDDLE_BLOCK:%.*]], label [[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP12:![0-9]+]]
; CHECK:       vec.epilog.middle.block:
