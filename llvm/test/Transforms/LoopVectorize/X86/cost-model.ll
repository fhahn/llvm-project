...
; CHECK-NEXT:    [[TMP8:%.*]] = call i64 @llvm.usub.sat.i64(i64 [[B]], i64 1)
; CHECK-NEXT:    [[TMP9:%.*]] = freeze i64 [[TMP8]]
; CHECK-NEXT:    [[UMIN:%.*]] = call i64 @llvm.umin.i64(i64 [[TMP9]], i64 [[A]])
; CHECK-NEXT:    [[TMP5:%.*]] = trunc i64 [[UMIN]] to i32
; CHECK-NEXT:    [[TMP6:%.*]] = add i32 1, [[TMP5]]
; CHECK-NEXT:    [[TMP7:%.*]] = icmp ult i32 [[TMP6]], 1
; CHECK-NEXT:    [[TMP11:%.*]] = icmp ugt i64 [[UMIN]], 4294967295
; CHECK-NEXT:    [[TMP34:%.*]] = or i1 [[TMP7]], [[TMP11]]
; CHECK-NEXT:    [[TMP13:%.*]] = icmp slt i32 [[TMP5]], 0
; CHECK-NEXT:    [[TMP33:%.*]] = icmp ugt i64 [[UMIN]], 4294967295
; CHECK-NEXT:    [[TMP35:%.*]] = or i1 [[TMP13]], [[TMP33]]
; CHECK-NEXT:    [[TMP14:%.*]] = or i1 [[TMP34]], [[TMP35]]
...
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[IV:%.*]] = phi i32 [ 0, %[[PH]] ], [ [[IV_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[RED:%.*]] = phi i64 [ 3, %[[PH]] ], [ [[RED_MUL:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[RED_MUL]] = mul nsw i64 [[RED]], [[P_EXT]]
; CHECK-NEXT:    [[IV_NEXT]] = add nuw nsw i32 [[IV]], 1
; CHECK-NEXT:    [[EC:%.*]] = icmp eq i32 [[IV_NEXT]], [[N]]
; CHECK-NEXT:    br i1 [[EC]], label %[[EXIT:.*]], label %[[VECTOR_BODY]]
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[TMP1:%.*]] = phi i64 [ [[RED_MUL]], %[[VECTOR_BODY]] ]
