...
; CHECK-NEXT:    [[IND_END:%.*]] = add i32 [[DOTCAST]], 190
...
; UNROLL-NO-IC-NEXT:    [[IND_END:%.*]] = add i32 [[DOTCAST]], 190
...
; CHECK-NEXT:    [[OFFSET_IDX:%.*]] = add i32 [[INDEX]], -20
...
; UNROLL-NO-IC-NEXT:    [[OFFSET_IDX:%.*]] = add i32 [[INDEX]], -20
