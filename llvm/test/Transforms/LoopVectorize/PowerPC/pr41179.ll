...
; CHECK-NEXT:    [[TMP0:%.*]] = add i64 [[START2]], -1
; CHECK-NEXT:    [[UMIN:%.*]] = call i64 @llvm.umin.i64(i64 [[END1]], i64 [[TMP0]])
; CHECK-NEXT:    [[TMP2:%.*]] = trunc i64 [[UMIN]] to i32
; CHECK-NEXT:    [[TMP9:%.*]] = trunc i64 [[START2]] to i32
; CHECK-NEXT:    [[TMP10:%.*]] = sub i32 0, [[TMP2]]
; CHECK-NEXT:    [[TMP3:%.*]] = add i32 [[TMP10]], [[TMP9]]
