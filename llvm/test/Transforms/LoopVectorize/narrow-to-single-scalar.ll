...
; The select is only used by the extract computing the exit value. An extract of
; a single-scalar operand is folded away, so narrowing the select does not
; introduce a broadcast.
