...
; CHECK-NEXT:    [[TMP39:%.*]] = or <4 x i1> [[TMP2]], [[TMP18]]
; CHECK-NEXT:    [[TMP49:%.*]] = or <4 x i1> [[TMP3]], [[TMP19]]
; CHECK-NEXT:    [[TMP16:%.*]] = select <4 x i1> [[TMP39]], <4 x i1> zeroinitializer, <4 x i1> [[TMP14]]
; CHECK-NEXT:    [[TMP17:%.*]] = select <4 x i1> [[TMP49]], <4 x i1> zeroinitializer, <4 x i1> [[TMP15]]
