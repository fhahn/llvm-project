...
; VF8UF2:       [[VECTOR_BODY]]:
; VF8UF2-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 8
; VF8UF2-NEXT:    [[WIDE_LOAD1:%.*]] = load <8 x i8>, ptr [[A]], align 1
...
; VF8UF2-NEXT:    br label %[[VECTOR_BODY:.*]]
; VF8UF2:       [[VECTOR_BODY]]:
; VF8UF2-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 8
; VF8UF2-NEXT:    [[WIDE_LOAD1:%.*]] = load <8 x i8>, ptr [[A]], align 1
...
; VF8UF2-NEXT:    br label %[[VECTOR_BODY:.*]]
; VF8UF2:       [[VECTOR_BODY]]:
; VF8UF2-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 8
; VF8UF2-NEXT:    [[WIDE_LOAD1:%.*]] = load <8 x i8>, ptr [[A]], align 1
; VF8UF2-NEXT:    [[WIDE_LOAD2:%.*]] = load <8 x i8>, ptr [[TMP8]], align 1
