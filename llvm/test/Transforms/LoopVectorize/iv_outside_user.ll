...
; CHECK-NEXT:    [[TMP7:%.*]] = sub nsw i32 0, [[SMIN1]]
; CHECK-NEXT:    [[TMP9:%.*]] = add i32 [[TMP03]], [[TMP7]]
...
; CHECK-NEXT:    [[TMP10:%.*]] = sub nsw i32 0, [[SMIN]]
; CHECK-NEXT:    [[TMP11:%.*]] = add i32 [[TMP11]], [[TMP10]]
; CHECK-NEXT:    [[TMP15:%.*]] = add i32 [[TMP11]], -8
; CHECK-NEXT:    [[TMP17:%.*]] = lshr i32 [[TMP15]], 3
; CHECK-NEXT:    [[TMP14:%.*]] = add nuw nsw i32 [[TMP17]], 1
...
; CHECK:       [[BB4]]:
; CHECK-NEXT:    [[TMP17:%.*]] = phi i32 [ [[BC_RESUME_VAL]], %[[SCALAR_PH]] ], [ [[TMP14:%.*]], %[[BB4]] ]
; CHECK-NEXT:    [[TMP14]] = add i32 [[TMP17]], -8
; CHECK-NEXT:    [[TMP16:%.*]] = icmp sgt i32 [[TMP14]], 0
; CHECK-NEXT:    br i1 [[TMP16]], label %[[BB4]], label %[[BB1_LOOPEXIT]], {{!llvm.loop ![0-9]+}}
;
BB0:
  br label %BB1
