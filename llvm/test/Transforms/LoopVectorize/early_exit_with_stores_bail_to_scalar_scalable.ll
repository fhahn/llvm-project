...
; RUN: opt -p loop-vectorize -force-vector-width=4 -scalable-vectorization=on -force-target-supports-scalable-vectors -enable-early-exit-vectorization-with-side-effects -early-exit-vectorization-bail-to-scalar -S %s | FileCheck %s
