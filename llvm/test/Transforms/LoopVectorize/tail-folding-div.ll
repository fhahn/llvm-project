...
; CHECK-NEXT:    br i1 [[TMP3]], label %[[PRED_LOAD_IF1:.*]], label %[[PRED_STORE_CONTINUE:.*]]
; CHECK:       [[PRED_LOAD_IF1]]:
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i64, ptr [[A]], i64 [[OFFSET_IDX]]
; CHECK-NEXT:    [[TMP10:%.*]] = load i64, ptr [[TMP9]], align 4
; CHECK-NEXT:    [[TMP16:%.*]] = sdiv i64 [[TMP10]], [[OFFSET_IDX]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i64, ptr [[A]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP11:%.*]] = load i64, ptr [[TMP8]], align 4
; CHECK-NEXT:    [[TMP19:%.*]] = sdiv i64 [[TMP11]], [[TMP1]]
...
; CHECK-NEXT:    [[VEC_IND:%.*]] = phi <2 x i16> [ <i16 0, i16 1>, %[[VECTOR_PH]] ], [ [[VEC_IND_NEXT:%.*]], %[[PRED_LOAD_CONTINUE2]] ]
...
; CHECK-NEXT:    [[TMP6:%.*]] = sdiv i64 [[TMP5]], [[TMP8]]
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i64, ptr [[C]], i64 [[INDEX]]
; CHECK-NEXT:    store i64 [[TMP6]], ptr [[TMP9]], align 4
...
; CHECK-NEXT:    [[TMP28:%.*]] = sdiv i64 [[TMP14]], [[TMP17]]
...
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[TMP1:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_STORE_CONTINUE4:.*]] ]
...
; CHECK-NEXT:    [[TMP10:%.*]] = load i64, ptr [[TMP9]], align 4
; CHECK-NEXT:    [[TMP17:%.*]] = sdiv i64 [[TMP10]], [[B]]
...
; CHECK:       [[PRED_STORE_IF3]]:
; CHECK-NEXT:    [[TMP7:%.*]] = add i64 [[TMP1]], 1
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i64, ptr [[A]], i64 [[TMP7]]
; CHECK-NEXT:    [[TMP11:%.*]] = load i64, ptr [[TMP8]], align 4
; CHECK-NEXT:    [[TMP20:%.*]] = sdiv i64 [[TMP11]], [[B]]
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr i64, ptr [[C]], i64 [[TMP7]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i64, ptr [[A]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP10:%.*]] = load i64, ptr [[TMP9]], align 4
; CHECK-NEXT:    [[TMP17:%.*]] = sdiv i64 [[TMP10]], -1
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr i64, ptr [[C]], i64 [[TMP1]]
; CHECK-NEXT:    store i64 [[TMP17]], ptr [[TMP16]], align 4
; CHECK-NEXT:    br label %[[PRED_STORE_CONTINUE]]
; CHECK:       [[PRED_STORE_CONTINUE]]:
...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i64, ptr [[A]], i64 [[TMP7]]
; CHECK-NEXT:    [[TMP11:%.*]] = load i64, ptr [[TMP8]], align 4
; CHECK-NEXT:    [[TMP20:%.*]] = sdiv i64 [[TMP11]], -1
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr i64, ptr [[C]], i64 [[TMP7]]
; CHECK-NEXT:    store i64 [[TMP20]], ptr [[TMP19]], align 4
; CHECK-NEXT:    br label %[[PRED_STORE_CONTINUE4]]
; CHECK:       [[PRED_STORE_CONTINUE4]]:
