...
; CHECK-VF1-IC2-NEXT:    [[TMP20:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 [[TMP2]]
; CHECK-VF1-IC2-NEXT:    br i1 [[TMP7]], label [[PRED_LOAD_IF:%.*]], label [[PRED_LOAD_CONTINUE:%.*]]
; CHECK-VF1-IC2:       pred.load.if:
; CHECK-VF1-IC2-NEXT:    [[TMP21:%.*]] = load i32, ptr [[TMP15]], align 4, !alias.scope [[META9:![0-9]+]], !noalias [[META6]]
; CHECK-VF1-IC2-NEXT:    br label [[PRED_LOAD_CONTINUE]]
; CHECK-VF1-IC2:       pred.load.continue:
; CHECK-VF1-IC2-NEXT:    [[TMP16:%.*]] = phi i32 [ poison, [[VECTOR_BODY]] ], [ [[TMP21]], [[PRED_LOAD_IF]] ]
; CHECK-VF1-IC2-NEXT:    br i1 [[TMP8]], label [[PRED_LOAD_IF5:%.*]], label [[PRED_LOAD_CONTINUE6:%.*]]
; CHECK-VF1-IC2:       pred.load.if5:
; CHECK-VF1-IC2-NEXT:    [[TMP18:%.*]] = load i32, ptr [[TMP20]], align 4, !alias.scope [[META9]], !noalias [[META6]]
; CHECK-VF1-IC2-NEXT:    br label [[PRED_LOAD_CONTINUE6]]
; CHECK-VF1-IC2:       pred.load.continue6:
; CHECK-VF1-IC2-NEXT:    [[TMP19:%.*]] = phi i32 [ poison, [[PRED_LOAD_CONTINUE]] ], [ [[TMP18]], [[PRED_LOAD_IF5]] ]
; CHECK-VF1-IC2-NEXT:    [[TMP17:%.*]] = add nsw i32 [[TMP16]], 1
; CHECK-VF1-IC2-NEXT:    [[INC8:%.*]] = add nsw i32 [[TMP19]], 1
...
; CHECK-VF1-IC2:       pred.store.if9:
; CHECK-VF1-IC2-NEXT:    store i32 [[INC8]], ptr [[TMP20]], align 4, !alias.scope [[META9]], !noalias [[META6]]
; CHECK-VF1-IC2-NEXT:    br label [[PRED_STORE_CONTINUE6]]
; CHECK-VF1-IC2:       pred.store.continue10:
; CHECK-VF1-IC2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 2
