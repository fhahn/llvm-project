...
; CHECK:       [[INNER]]:
; CHECK-NEXT:    [[IV:%.*]] = phi i64 [ 1, %[[VEC_EPILOG_SCALAR_PH]] ], [ [[IV_NEXT:%.*]], %[[INNER]] ]
; CHECK-NEXT:    [[IV_2:%.*]] = phi i8 [ 0, %[[VEC_EPILOG_SCALAR_PH]] ], [ [[IV_2_NEXT:%.*]], %[[INNER]] ]
...
; CHECK-PROFITABLE-BY-DEFAULT:       [[OUTER_HEADER]]:
...
; CHECK-PROFITABLE-BY-DEFAULT:       [[MIDDLE_BLOCK]]:
; CHECK-PROFITABLE-BY-DEFAULT-NEXT:    br label %[[OUTER_LATCH]]
