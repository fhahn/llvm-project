...
; CHECK:       vector.body3:
; CHECK-NEXT:    [[INDEX4:%.*]] = phi i32 [ 0, [[VECTOR_PH2]] ], [ [[INDEX_NEXT6:%.*]], [[VECTOR_BODY3]] ]
; CHECK-NEXT:    [[TMP10:%.*]] = trunc i32 [[INDEX4]] to i8
; CHECK-NEXT:    [[IV_2_NEXT5:%.*]] = add i8 [[TMP10]], 1
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr [[A]], i8 [[IV_2_NEXT5]]
...
; CHECK-NEXT:    br i1 [[TMP12]], label [[MIDDLE_BLOCK7:%.*]], label [[VECTOR_BODY3]], !llvm.loop [[LOOP3:![0-9]+]]
; CHECK:       middle.block7:
