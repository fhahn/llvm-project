...
; CHECK-NEXT:    [[BC_MERGE_RDX3:%.*]] = phi i64 [ [[TMP9]], %[[VEC_EPILOG_ITER_CHECK]] ], [ -9223372036854775808, %[[VECTOR_MAIN_LOOP_ITER_CHECK]] ]
...
; CHECK-NEXT:    [[BC_MERGE_RDX6:%.*]] = phi i32 [ [[TMP8]], %[[VEC_EPILOG_ITER_CHECK]] ], [ -2147483648, %[[VECTOR_MAIN_LOOP_ITER_CHECK]] ]
...
; CHECK-NEXT:    [[TMP19:%.*]] = and i32 [[TMP0]], 3
; CHECK-NEXT:    [[N_VEC8:%.*]] = sub i32 [[TMP0]], [[TMP19]]
...
; CHECK-NEXT:    [[VEC_PHI20:%.*]] = phi <4 x i32> [ [[BROADCAST_SPLAT18]], %[[VEC_EPILOG_PH]] ], [ [[TMP12:%.*]], %[[VEC_EPILOG_VECTOR_BODY]] ]
