...
; RVA23-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <vscale x 2 x i1> poison, i1 [[TMP2]], i64 0
; RVA23-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <vscale x 2 x i1> [[BROADCAST_SPLATINSERT]], <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer
; RVA23-NEXT:    [[TMP3:%.*]] = zext <vscale x 2 x i1> [[BROADCAST_SPLAT]] to <vscale x 2 x i8>
; RVA23-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[B:%.*]], align 8
; RVA23-NEXT:    [[TMP5:%.*]] = load i64, ptr [[TMP4]], align 8
; RVA23-NEXT:    [[TMP6:%.*]] = icmp sgt i64 [[TMP5]], 0
; RVA23-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <vscale x 2 x i1> poison, i1 [[TMP6]], i64 0
; RVA23-NEXT:    [[BROADCAST_SPLAT2:%.*]] = shufflevector <vscale x 2 x i1> [[BROADCAST_SPLATINSERT1]], <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer
; RVA23-NEXT:    [[TMP7:%.*]] = zext <vscale x 2 x i1> [[BROADCAST_SPLAT2]] to <vscale x 2 x i8>
; RVA23-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[C:%.*]], align 8
; RVA23-NEXT:    [[TMP9:%.*]] = load i64, ptr [[TMP8]], align 8
; RVA23-NEXT:    [[TMP10:%.*]] = icmp sgt i64 [[TMP9]], 0
; RVA23-NEXT:    [[BROADCAST_SPLATINSERT3:%.*]] = insertelement <vscale x 2 x i1> poison, i1 [[TMP10]], i64 0
; RVA23-NEXT:    [[BROADCAST_SPLAT4:%.*]] = shufflevector <vscale x 2 x i1> [[BROADCAST_SPLATINSERT3]], <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer
; RVA23-NEXT:    [[TMP11:%.*]] = zext <vscale x 2 x i1> [[BROADCAST_SPLAT4]] to <vscale x 2 x i8>
; RVA23-NEXT:    br label [[VECTOR_BODY:%.*]]
; RVA23:       vector.body:
...
; RVA23-NEXT:    [[TMP13:%.*]] = or <vscale x 2 x i8> [[VEC_PHI]], [[TMP3]]
; RVA23-NEXT:    [[TMP14:%.*]] = or <vscale x 2 x i8> [[TMP13]], [[TMP7]]
; RVA23-NEXT:    [[TMP15:%.*]] = or <vscale x 2 x i8> [[TMP14]], splat (i8 1)
; RVA23-NEXT:    [[TMP16:%.*]] = or <vscale x 2 x i8> [[TMP15]], [[TMP11]]
...
; RVA23ZVL1024B-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <vscale x 1 x i1> poison, i1 [[TMP2]], i64 0
; RVA23ZVL1024B-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <vscale x 1 x i1> [[BROADCAST_SPLATINSERT]], <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer
; RVA23ZVL1024B-NEXT:    [[TMP3:%.*]] = zext <vscale x 1 x i1> [[BROADCAST_SPLAT]] to <vscale x 1 x i8>
...
; RVA23ZVL1024B-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <vscale x 1 x i1> poison, i1 [[TMP6]], i64 0
; RVA23ZVL1024B-NEXT:    [[BROADCAST_SPLAT2:%.*]] = shufflevector <vscale x 1 x i1> [[BROADCAST_SPLATINSERT1]], <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer
; RVA23ZVL1024B-NEXT:    [[TMP7:%.*]] = zext <vscale x 1 x i1> [[BROADCAST_SPLAT2]] to <vscale x 1 x i8>
...
; RVA23ZVL1024B-NEXT:    [[BROADCAST_SPLATINSERT3:%.*]] = insertelement <vscale x 1 x i1> poison, i1 [[TMP10]], i64 0
; RVA23ZVL1024B-NEXT:    [[BROADCAST_SPLAT4:%.*]] = shufflevector <vscale x 1 x i1> [[BROADCAST_SPLATINSERT3]], <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer
; RVA23ZVL1024B-NEXT:    [[TMP11:%.*]] = zext <vscale x 1 x i1> [[BROADCAST_SPLAT4]] to <vscale x 1 x i8>
; RVA23ZVL1024B-NEXT:    br label [[VECTOR_BODY:%.*]]
; RVA23ZVL1024B:       vector.body:
...
; RVA23ZVL1024B-NEXT:    [[TMP13:%.*]] = or <vscale x 1 x i8> [[VEC_PHI]], [[TMP3]]
; RVA23ZVL1024B-NEXT:    [[TMP14:%.*]] = or <vscale x 1 x i8> [[TMP13]], [[TMP7]]
; RVA23ZVL1024B-NEXT:    [[TMP15:%.*]] = or <vscale x 1 x i8> [[TMP14]], splat (i8 1)
; RVA23ZVL1024B-NEXT:    [[TMP16:%.*]] = or <vscale x 1 x i8> [[TMP15]], [[TMP11]]
