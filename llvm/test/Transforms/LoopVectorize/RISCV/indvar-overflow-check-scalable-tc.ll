...
; VF is scalable, as is TC. TC * MaxVScale does not fit in 32 bits, but it is
; far below the range of the i64 induction variable, so the IV increment still
; gets nuw.
define void @tc_maxvscale_exceeds_32_bits(ptr noalias %a, ptr noalias %b) #0 {
; CHECK-LABEL: define void @tc_maxvscale_exceeds_32_bits(
...
; IV increment can be proven and it must not have nuw.
