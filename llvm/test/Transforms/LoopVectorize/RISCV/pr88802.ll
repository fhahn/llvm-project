...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT3:%.*]] = insertelement <vscale x 8 x i32> poison, i32 [[TMP2]], i64 0
...
; CHECK-NEXT:    [[PREDPHI:%.*]] = select <vscale x 8 x i1> [[TMP7]], <vscale x 8 x i32> [[TMP3]], <vscale x 8 x i32> [[BROADCAST_SPLAT4]]
...
; CHECK-NEXT:    [[TMP13:%.*]] = sub i64 [[TMP10]], 1
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <vscale x 8 x i8> [[TMP9]], i64 [[TMP13]]
