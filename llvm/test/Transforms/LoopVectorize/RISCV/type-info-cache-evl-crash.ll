...
; CHECK-NEXT:    [[TMP8:%.*]] = icmp ult <vscale x 8 x i32> [[TMP4]], zeroinitializer
; CHECK-NEXT:    [[TMP6:%.*]] = select <vscale x 8 x i1> [[TMP8]], <vscale x 8 x i32> [[TMP4]], <vscale x 8 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP7:%.*]] = trunc <vscale x 8 x i32> [[TMP6]] to <vscale x 8 x i8>
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i8.nxv8p0(<vscale x 8 x i8> [[TMP7]], <vscale x 8 x ptr> align 1 [[BROADCAST_SPLAT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP11]]), !alias.scope [[META3:![0-9]+]], !noalias [[META0]]
