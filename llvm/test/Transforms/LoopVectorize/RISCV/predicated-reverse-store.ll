...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr float, ptr null, i64 [[IV_NEXT]]
...
; CHECK-NEXT:    call void @llvm.vp.store.nxv4f32.p0(<vscale x 4 x float> zeroinitializer, ptr align 4 [[TMP9]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP1]])
