...
; CHECK-NEXT:    EMIT-SCALAR vp<[[VP11:%[0-9]+]]> = resume-for-epilogue vp<[[VP8]]>, ir<5>
...
; CHECK-NEXT:    EMIT-SCALAR vp<[[VP12:%[0-9]+]]> = resume-for-epilogue vp<%n.vec>, ir<0>
...
; CHECK-EMPTY:
; CHECK-NEXT:  middle.block:
; CHECK-NEXT:    EMIT-SCALAR vp<[[VP4:%[0-9]+]]> = resume-for-epilogue ir<16>, ir<0>
; CHECK-NEXT:    EMIT-SCALAR vp<[[VP5:%[0-9]+]]> = resume-for-epilogue ir<16>, ir<0>
...
; CHECK-NEXT:    EMIT-SCALAR vp<[[VP8:%[0-9]+]]> = resume-for-epilogue ir<16>, ir<0>
; CHECK-NEXT:    EMIT-SCALAR vp<[[VP9:%[0-9]+]]> = resume-for-epilogue vp<[[VP2]]>, ir<%off>
; CHECK-NEXT:  Successor(s): ir-bb<exit>
; CHECK-EMPTY:
; CHECK-NEXT:  ir-bb<exit>:
; CHECK-NEXT:  No successors
...
; CHECK-NEXT:    EMIT-SCALAR vp<[[VP11:%[0-9]+]]> = resume-for-epilogue vp<%n.vec>, ir<0>
; CHECK-NEXT:    EMIT-SCALAR vp<[[VP12:%[0-9]+]]> = resume-for-epilogue vp<[[VP6]]>, ir<%p>
; CHECK-NEXT:    EMIT branch-on-cond vp<%cmp.n>
