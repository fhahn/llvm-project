...
; RUN: opt -passes=loop-vectorize -pass-remarks=loop-vectorize -enable-vplan-native-path -disable-outer-loop-memory-safety-check -debug -disable-output %s 2>&1 | FileCheck %s
