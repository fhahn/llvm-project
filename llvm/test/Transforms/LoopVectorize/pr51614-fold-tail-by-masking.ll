...
; CHECK-NEXT:    [[VEC_IND1:%.*]] = phi <2 x i16> [ <i16 41, i16 40>, [[VECTOR_PH]] ], [ [[VEC_IND_NEXT1:%.*]], [[PRED_LOAD_CONTINUE4]] ]
...
; CHECK-NEXT:    [[TMP3:%.*]] = add nsw <2 x i16> [[VEC_IND1]], splat (i16 -1)
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x i1> [[TMP1]], i64 0
; CHECK-NEXT:    br i1 [[TMP2]], label [[PRED_LOAD_IF:%.*]], label [[PRED_LOAD_CONTINUE:%.*]]
; CHECK:       pred.load.if:
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <2 x i16> [[TMP3]], i64 0
...
; CHECK-NEXT:    [[VEC_IND_NEXT1]] = add nsw <2 x i16> [[VEC_IND1]], splat (i16 -2)
