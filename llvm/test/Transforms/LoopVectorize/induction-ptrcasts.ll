...
; VF1-NEXT:    [[TMP6:%.*]] = sub i64 0, [[SMIN]]
; VF1-NEXT:    [[TMP10:%.*]] = add i64 ptrtoint (ptr @f to i64), [[TMP6]]
; VF1-NEXT:    [[TMP0:%.*]] = add i64 [[TMP10]], -1
...
; VF2-NEXT:    [[TMP7:%.*]] = sub i64 0, [[SMIN]]
; VF2-NEXT:    [[TMP8:%.*]] = add i64 ptrtoint (ptr @f to i64), [[TMP7]]
; VF2-NEXT:    [[TMP0:%.*]] = add i64 [[TMP8]], -1
