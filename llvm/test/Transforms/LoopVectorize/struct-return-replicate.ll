...
; VF4:       [[PRED_CALL_IF3]]:
; VF4-NEXT:    [[TMP18:%.*]] = extractelement <4 x float> [[WIDE_LOAD]], i64 2
; VF4-NEXT:    [[TMP12:%.*]] = tail call { float, float } @fn2(float [[TMP18]]) #[[ATTR3]]
; VF4-NEXT:    br label %[[PRED_CALL_CONTINUE4]]
; VF4:       [[PRED_CALL_CONTINUE4]]:
; VF4-NEXT:    [[TMP27:%.*]] = phi { float, float } [ poison, %[[PRED_CALL_CONTINUE2]] ], [ [[TMP12]], %[[PRED_CALL_IF3]] ]
...
; VF4-NEXT:    br label %[[VECTOR_BODY:.*]]
; VF4:       [[VECTOR_BODY]]:
; VF4-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[LATCH2:.*]] ]
; VF4-NEXT:    [[TMP0:%.*]] = getelementptr float, ptr [[A]], i64 [[INDEX]]
; VF4-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x float>, ptr [[TMP0]], align 4
; VF4-NEXT:    [[TMP1:%.*]] = extractelement <4 x float> [[WIDE_LOAD]], i64 0
; VF4-NEXT:    [[TMP2:%.*]] = tail call { float, float } @fn2(float [[TMP1]]) #[[ATTR3]]
; VF4-NEXT:    [[TMP3:%.*]] = extractelement <4 x float> [[WIDE_LOAD]], i64 1
; VF4-NEXT:    [[TMP4:%.*]] = tail call { float, float } @fn2(float [[TMP3]]) #[[ATTR3]]
; VF4-NEXT:    [[TMP5:%.*]] = extractelement <4 x float> [[WIDE_LOAD]], i64 2
; VF4-NEXT:    [[TMP6:%.*]] = tail call { float, float } @fn2(float [[TMP5]]) #[[ATTR3]]
; VF4-NEXT:    [[TMP7:%.*]] = extractelement <4 x float> [[WIDE_LOAD]], i64 3
; VF4-NEXT:    [[TMP8:%.*]] = tail call { float, float } @fn2(float [[TMP7]]) #[[ATTR3]]
; VF4-NEXT:    [[TMP9:%.*]] = extractvalue { float, float } [[TMP2]], 0
; VF4-NEXT:    [[TMP10:%.*]] = insertelement <4 x float> poison, float [[TMP9]], i64 0
; VF4-NEXT:    [[TMP11:%.*]] = insertvalue { <4 x float>, <4 x float> } poison, <4 x float> [[TMP10]], 0
; VF4-NEXT:    [[TMP12:%.*]] = extractvalue { float, float } [[TMP2]], 1
; VF4-NEXT:    [[TMP13:%.*]] = extractvalue { <4 x float>, <4 x float> } [[TMP11]], 1
; VF4-NEXT:    [[TMP14:%.*]] = insertelement <4 x float> [[TMP13]], float [[TMP12]], i64 0
; VF4-NEXT:    [[TMP15:%.*]] = insertvalue { <4 x float>, <4 x float> } [[TMP11]], <4 x float> [[TMP14]], 1
; VF4-NEXT:    [[TMP16:%.*]] = extractvalue { float, float } [[TMP4]], 0
; VF4-NEXT:    [[TMP17:%.*]] = extractvalue { <4 x float>, <4 x float> } [[TMP15]], 0
; VF4-NEXT:    [[TMP18:%.*]] = insertelement <4 x float> [[TMP17]], float [[TMP16]], i64 1
; VF4-NEXT:    [[TMP19:%.*]] = insertvalue { <4 x float>, <4 x float> } [[TMP15]], <4 x float> [[TMP18]], 0
; VF4-NEXT:    [[TMP20:%.*]] = extractvalue { float, float } [[TMP4]], 1
; VF4-NEXT:    [[TMP21:%.*]] = extractvalue { <4 x float>, <4 x float> } [[TMP19]], 1
; VF4-NEXT:    [[TMP22:%.*]] = insertelement <4 x float> [[TMP21]], float [[TMP20]], i64 1
; VF4-NEXT:    [[TMP23:%.*]] = insertvalue { <4 x float>, <4 x float> } [[TMP19]], <4 x float> [[TMP22]], 1
; VF4-NEXT:    [[TMP24:%.*]] = extractvalue { float, float } [[TMP6]], 0
; VF4-NEXT:    [[TMP25:%.*]] = extractvalue { <4 x float>, <4 x float> } [[TMP23]], 0
; VF4-NEXT:    [[TMP26:%.*]] = insertelement <4 x float> [[TMP25]], float [[TMP24]], i64 2
; VF4-NEXT:    [[TMP27:%.*]] = insertvalue { <4 x float>, <4 x float> } [[TMP23]], <4 x float> [[TMP26]], 0
; VF4-NEXT:    [[TMP28:%.*]] = extractvalue { float, float } [[TMP6]], 1
; VF4-NEXT:    [[TMP29:%.*]] = extractvalue { <4 x float>, <4 x float> } [[TMP27]], 1
; VF4-NEXT:    [[TMP30:%.*]] = insertelement <4 x float> [[TMP29]], float [[TMP28]], i64 2
; VF4-NEXT:    [[TMP31:%.*]] = insertvalue { <4 x float>, <4 x float> } [[TMP27]], <4 x float> [[TMP30]], 1
; VF4-NEXT:    [[TMP32:%.*]] = extractvalue { float, float } [[TMP8]], 0
; VF4-NEXT:    [[TMP33:%.*]] = extractvalue { <4 x float>, <4 x float> } [[TMP31]], 0
; VF4-NEXT:    [[TMP34:%.*]] = insertelement <4 x float> [[TMP33]], float [[TMP32]], i64 3
; VF4-NEXT:    [[TMP35:%.*]] = insertvalue { <4 x float>, <4 x float> } [[TMP31]], <4 x float> [[TMP34]], 0
; VF4-NEXT:    [[TMP36:%.*]] = extractvalue { float, float } [[TMP8]], 1
; VF4-NEXT:    [[TMP37:%.*]] = extractvalue { <4 x float>, <4 x float> } [[TMP35]], 1
; VF4-NEXT:    [[TMP38:%.*]] = insertelement <4 x float> [[TMP37]], float [[TMP36]], i64 3
; VF4-NEXT:    [[TMP39:%.*]] = insertvalue { <4 x float>, <4 x float> } [[TMP35]], <4 x float> [[TMP38]], 1
; VF4-NEXT:    store float 0.000000e+00, ptr [[P]], align 4
; VF4-NEXT:    br i1 [[C]], label %[[LATCH2]], label %[[IF1:.*]]
; VF4:       [[IF1]]:
; VF4-NEXT:    [[TMP40:%.*]] = extractvalue { <4 x float>, <4 x float> } [[TMP39]], 1
; VF4-NEXT:    [[TMP41:%.*]] = extractelement <4 x float> [[TMP40]], i64 3
; VF4-NEXT:    store float [[TMP41]], ptr [[Q]], align 4
; VF4-NEXT:    br label %[[LATCH2]]
; VF4:       [[LATCH2]]:
; VF4-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; VF4-NEXT:    [[TMP42:%.*]] = icmp eq i64 [[INDEX_NEXT]], 1024
; VF4-NEXT:    br i1 [[TMP42]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP6:![0-9]+]]
; VF4:       [[MIDDLE_BLOCK]]:
;
...
; VF2IC2-NEXT:    br label %[[VECTOR_BODY:.*]]
; VF2IC2:       [[VECTOR_BODY]]:
; VF2IC2-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[LATCH3:.*]] ]
; VF2IC2-NEXT:    [[TMP0:%.*]] = getelementptr float, ptr [[A]], i64 [[INDEX]]
; VF2IC2-NEXT:    [[TMP1:%.*]] = getelementptr float, ptr [[TMP0]], i64 2
; VF2IC2-NEXT:    [[WIDE_LOAD:%.*]] = load <2 x float>, ptr [[TMP0]], align 4
; VF2IC2-NEXT:    [[WIDE_LOAD1:%.*]] = load <2 x float>, ptr [[TMP1]], align 4
; VF2IC2-NEXT:    [[TMP2:%.*]] = extractelement <2 x float> [[WIDE_LOAD]], i64 0
; VF2IC2-NEXT:    [[TMP3:%.*]] = tail call { float, float } @fn2(float [[TMP2]]) #[[ATTR3]]
; VF2IC2-NEXT:    [[TMP4:%.*]] = extractelement <2 x float> [[WIDE_LOAD]], i64 1
; VF2IC2-NEXT:    [[TMP5:%.*]] = tail call { float, float } @fn2(float [[TMP4]]) #[[ATTR3]]
; VF2IC2-NEXT:    [[TMP6:%.*]] = extractelement <2 x float> [[WIDE_LOAD1]], i64 0
; VF2IC2-NEXT:    [[TMP7:%.*]] = tail call { float, float } @fn2(float [[TMP6]]) #[[ATTR3]]
; VF2IC2-NEXT:    [[TMP8:%.*]] = extractelement <2 x float> [[WIDE_LOAD1]], i64 1
; VF2IC2-NEXT:    [[TMP9:%.*]] = tail call { float, float } @fn2(float [[TMP8]]) #[[ATTR3]]
; VF2IC2-NEXT:    [[TMP10:%.*]] = extractvalue { float, float } [[TMP7]], 0
; VF2IC2-NEXT:    [[TMP11:%.*]] = insertelement <2 x float> poison, float [[TMP10]], i64 0
; VF2IC2-NEXT:    [[TMP12:%.*]] = insertvalue { <2 x float>, <2 x float> } poison, <2 x float> [[TMP11]], 0
; VF2IC2-NEXT:    [[TMP13:%.*]] = extractvalue { float, float } [[TMP7]], 1
; VF2IC2-NEXT:    [[TMP14:%.*]] = extractvalue { <2 x float>, <2 x float> } [[TMP12]], 1
; VF2IC2-NEXT:    [[TMP15:%.*]] = insertelement <2 x float> [[TMP14]], float [[TMP13]], i64 0
; VF2IC2-NEXT:    [[TMP16:%.*]] = insertvalue { <2 x float>, <2 x float> } [[TMP12]], <2 x float> [[TMP15]], 1
; VF2IC2-NEXT:    [[TMP17:%.*]] = extractvalue { float, float } [[TMP9]], 0
; VF2IC2-NEXT:    [[TMP18:%.*]] = extractvalue { <2 x float>, <2 x float> } [[TMP16]], 0
; VF2IC2-NEXT:    [[TMP19:%.*]] = insertelement <2 x float> [[TMP18]], float [[TMP17]], i64 1
; VF2IC2-NEXT:    [[TMP20:%.*]] = insertvalue { <2 x float>, <2 x float> } [[TMP16]], <2 x float> [[TMP19]], 0
; VF2IC2-NEXT:    [[TMP21:%.*]] = extractvalue { float, float } [[TMP9]], 1
; VF2IC2-NEXT:    [[TMP22:%.*]] = extractvalue { <2 x float>, <2 x float> } [[TMP20]], 1
; VF2IC2-NEXT:    [[TMP23:%.*]] = insertelement <2 x float> [[TMP22]], float [[TMP21]], i64 1
; VF2IC2-NEXT:    [[TMP24:%.*]] = insertvalue { <2 x float>, <2 x float> } [[TMP20]], <2 x float> [[TMP23]], 1
; VF2IC2-NEXT:    store float 0.000000e+00, ptr [[P]], align 4
; VF2IC2-NEXT:    br i1 [[C]], label %[[LATCH3]], label %[[IF2:.*]]
; VF2IC2:       [[IF2]]:
; VF2IC2-NEXT:    [[TMP25:%.*]] = extractvalue { <2 x float>, <2 x float> } [[TMP24]], 1
; VF2IC2-NEXT:    [[TMP26:%.*]] = extractelement <2 x float> [[TMP25]], i64 1
; VF2IC2-NEXT:    store float [[TMP26]], ptr [[Q]], align 4
; VF2IC2-NEXT:    br label %[[LATCH3]]
; VF2IC2:       [[LATCH3]]:
; VF2IC2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; VF2IC2-NEXT:    [[TMP27:%.*]] = icmp eq i64 [[INDEX_NEXT]], 1024
; VF2IC2-NEXT:    br i1 [[TMP27]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP6:![0-9]+]]
; VF2IC2:       [[MIDDLE_BLOCK]]:
;
entry:
  br label %loop
