...
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <2 x i16> [[WIDE_LOAD]], i64 1
; CHECK-NEXT:    store i16 [[TMP7]], ptr [[L_2]], align 2, !alias.scope [[META6:![0-9]+]], !noalias [[META0]]
...
; CHECK:       vector.ph:
; CHECK-NEXT:    [[N_MOD_VF:%.*]] = and i64 [[TMP5]], 1
