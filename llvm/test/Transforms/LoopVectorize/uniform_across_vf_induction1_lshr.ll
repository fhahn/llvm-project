...
; VF2-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[INDEX]]
; VF2-NEXT:    [[WIDE_LOAD:%.*]] = load <2 x i64>, ptr [[TMP0]], align 8
; VF2-NEXT:    [[TMP1:%.*]] = add nsw <2 x i64> [[WIDE_LOAD]], splat (i64 42)
; VF2-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[INDEX]]
; VF2-NEXT:    store <2 x i64> [[TMP1]], ptr [[TMP2]], align 8
...
; VF4-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[INDEX]]
; VF4-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x i64>, ptr [[TMP0]], align 8
; VF4-NEXT:    [[TMP1:%.*]] = add nsw <4 x i64> [[WIDE_LOAD]], splat (i64 42)
; VF4-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[INDEX]]
; VF4-NEXT:    store <4 x i64> [[TMP1]], ptr [[TMP2]], align 8
...
; VF4-NEXT:    [[TMP1:%.*]] = extractelement <4 x i64> [[TMP0]], i64 0
; VF4-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP1]]
; VF4-NEXT:    [[TMP3:%.*]] = extractelement <4 x i64> [[TMP0]], i64 1
; VF4-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP3]]
; VF4-NEXT:    [[TMP5:%.*]] = extractelement <4 x i64> [[TMP0]], i64 2
; VF4-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP5]]
; VF4-NEXT:    [[TMP7:%.*]] = extractelement <4 x i64> [[TMP0]], i64 3
...
; VF2-NEXT:    [[TMP4:%.*]] = load i64, ptr [[TMP2]], align 8
; VF2-NEXT:    [[TMP5:%.*]] = load i64, ptr [[TMP3]], align 8
; VF2-NEXT:    [[TMP6:%.*]] = insertelement <2 x i64> poison, i64 [[TMP4]], i64 0
; VF2-NEXT:    [[TMP7:%.*]] = insertelement <2 x i64> [[TMP6]], i64 [[TMP5]], i64 1
; VF2-NEXT:    [[TMP8:%.*]] = add nsw <2 x i64> [[TMP7]], splat (i64 42)
; VF2-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP0]]
; VF2-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP1]]
; VF2-NEXT:    [[TMP11:%.*]] = extractelement <2 x i64> [[TMP8]], i64 0
; VF2-NEXT:    store i64 [[TMP11]], ptr [[TMP9]], align 8
; VF2-NEXT:    [[TMP12:%.*]] = extractelement <2 x i64> [[TMP8]], i64 1
; VF2-NEXT:    store i64 [[TMP12]], ptr [[TMP10]], align 8
; VF2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 2
; VF2-NEXT:    [[TMP13:%.*]] = icmp eq i64 [[INDEX_NEXT]], 500
; VF2-NEXT:    br i1 [[TMP13]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP5:![0-9]+]]
; VF2:       middle.block:
; VF2-NEXT:    br label [[EXIT:%.*]]
; VF2:       exit:
; VF2-NEXT:    ret void
...
; VF4-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP0]]
...
; VF4-NEXT:    [[TMP8:%.*]] = load i64, ptr [[TMP4]], align 8
; VF4-NEXT:    [[TMP9:%.*]] = load i64, ptr [[TMP5]], align 8
; VF4-NEXT:    [[TMP10:%.*]] = load i64, ptr [[TMP6]], align 8
; VF4-NEXT:    [[TMP11:%.*]] = load i64, ptr [[TMP7]], align 8
; VF4-NEXT:    [[TMP12:%.*]] = insertelement <4 x i64> poison, i64 [[TMP8]], i64 0
; VF4-NEXT:    [[TMP13:%.*]] = insertelement <4 x i64> [[TMP12]], i64 [[TMP9]], i64 1
; VF4-NEXT:    [[TMP14:%.*]] = insertelement <4 x i64> [[TMP13]], i64 [[TMP10]], i64 2
; VF4-NEXT:    [[TMP15:%.*]] = insertelement <4 x i64> [[TMP14]], i64 [[TMP11]], i64 3
; VF4-NEXT:    [[TMP16:%.*]] = add nsw <4 x i64> [[TMP15]], splat (i64 42)
; VF4-NEXT:    [[TMP17:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP0]]
; VF4-NEXT:    [[TMP18:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP1]]
; VF4-NEXT:    [[TMP19:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP2]]
; VF4-NEXT:    [[TMP20:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP3]]
; VF4-NEXT:    [[TMP21:%.*]] = extractelement <4 x i64> [[TMP16]], i64 0
; VF4-NEXT:    store i64 [[TMP21]], ptr [[TMP17]], align 8
; VF4-NEXT:    [[TMP22:%.*]] = extractelement <4 x i64> [[TMP16]], i64 1
; VF4-NEXT:    store i64 [[TMP22]], ptr [[TMP18]], align 8
; VF4-NEXT:    [[TMP23:%.*]] = extractelement <4 x i64> [[TMP16]], i64 2
; VF4-NEXT:    store i64 [[TMP23]], ptr [[TMP19]], align 8
; VF4-NEXT:    [[TMP24:%.*]] = extractelement <4 x i64> [[TMP16]], i64 3
; VF4-NEXT:    store i64 [[TMP24]], ptr [[TMP20]], align 8
; VF4-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; VF4-NEXT:    [[TMP25:%.*]] = icmp eq i64 [[INDEX_NEXT]], 500
; VF4-NEXT:    br i1 [[TMP25]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP5:![0-9]+]]
; VF4:       middle.block:
; VF4-NEXT:    br label [[EXIT:%.*]]
; VF4:       exit:
; VF4-NEXT:    ret void
...
; VF2-NEXT:    [[TMP7:%.*]] = extractelement <2 x i64> [[TMP4]], i64 0
; VF2-NEXT:    store i64 [[TMP7]], ptr [[TMP5]], align 8
; VF2-NEXT:    [[TMP8:%.*]] = extractelement <2 x i64> [[TMP4]], i64 1
...
; VF4-NEXT:    [[TMP11:%.*]] = extractelement <4 x i64> [[TMP6]], i64 0
; VF4-NEXT:    store i64 [[TMP11]], ptr [[TMP7]], align 8
; VF4-NEXT:    [[TMP12:%.*]] = extractelement <4 x i64> [[TMP6]], i64 1
; VF4-NEXT:    store i64 [[TMP12]], ptr [[TMP8]], align 8
; VF4-NEXT:    [[TMP13:%.*]] = extractelement <4 x i64> [[TMP6]], i64 2
; VF4-NEXT:    store i64 [[TMP13]], ptr [[TMP9]], align 8
; VF4-NEXT:    [[TMP14:%.*]] = extractelement <4 x i64> [[TMP6]], i64 3
...
; VF2-NEXT:    store i64 [[TMP12]], ptr [[TMP10]], align 8
; VF2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 2
; VF2-NEXT:    [[TMP13:%.*]] = icmp eq i64 [[INDEX_NEXT]], 332
; VF2-NEXT:    br i1 [[TMP13]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP7:![0-9]+]]
; VF2:       middle.block:
...
; VF4-NEXT:    store i64 [[TMP24]], ptr [[TMP20]], align 8
; VF4-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; VF4-NEXT:    [[TMP25:%.*]] = icmp eq i64 [[INDEX_NEXT]], 332
; VF4-NEXT:    br i1 [[TMP25]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP7:![0-9]+]]
; VF4:       middle.block:
...
; VF2-NEXT:    [[TMP14:%.*]] = extractelement <2 x i64> [[TMP11]], i64 0
; VF2-NEXT:    store i64 [[TMP14]], ptr [[TMP12]], align 8
; VF2-NEXT:    [[TMP15:%.*]] = extractelement <2 x i64> [[TMP11]], i64 1
...
; VF4-NEXT:    [[TMP5:%.*]] = extractelement <4 x i64> [[TMP4]], i64 0
; VF4-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP5]]
; VF4-NEXT:    [[TMP7:%.*]] = extractelement <4 x i64> [[TMP4]], i64 1
; VF4-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP7]]
; VF4-NEXT:    [[TMP9:%.*]] = extractelement <4 x i64> [[TMP4]], i64 2
; VF4-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP9]]
; VF4-NEXT:    [[TMP11:%.*]] = extractelement <4 x i64> [[TMP4]], i64 3
...
; VF4-NEXT:    [[TMP26:%.*]] = extractelement <4 x i64> [[TMP21]], i64 0
; VF4-NEXT:    store i64 [[TMP26]], ptr [[TMP22]], align 8
; VF4-NEXT:    [[TMP27:%.*]] = extractelement <4 x i64> [[TMP21]], i64 1
; VF4-NEXT:    store i64 [[TMP27]], ptr [[TMP23]], align 8
; VF4-NEXT:    [[TMP28:%.*]] = extractelement <4 x i64> [[TMP21]], i64 2
; VF4-NEXT:    store i64 [[TMP28]], ptr [[TMP24]], align 8
; VF4-NEXT:    [[TMP29:%.*]] = extractelement <4 x i64> [[TMP21]], i64 3
...
; VF2-NEXT:    [[TMP2:%.*]] = extractelement <2 x i64> [[TMP1]], i64 0
; VF2-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP2]]
; VF2-NEXT:    [[TMP4:%.*]] = extractelement <2 x i64> [[TMP1]], i64 1
...
; VF4-NEXT:    [[TMP2:%.*]] = extractelement <4 x i64> [[TMP1]], i64 0
; VF4-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP2]]
; VF4-NEXT:    [[TMP4:%.*]] = extractelement <4 x i64> [[TMP1]], i64 1
; VF4-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP4]]
; VF4-NEXT:    [[TMP6:%.*]] = extractelement <4 x i64> [[TMP1]], i64 2
; VF4-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP6]]
; VF4-NEXT:    [[TMP8:%.*]] = extractelement <4 x i64> [[TMP1]], i64 3
...
; VF4-NEXT:    br i1 [[TMP20]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP11:![0-9]+]]
; VF4:       middle.block:
; VF4-NEXT:    br label [[SCALAR_PH:%.*]]
; VF4:       scalar.ph:
;
...
; VF2-NEXT:    [[TMP8:%.*]] = extractelement <2 x i64> [[TMP5]], i64 0
; VF2-NEXT:    store i64 [[TMP8]], ptr [[TMP6]], align 8
; VF2-NEXT:    [[TMP9:%.*]] = extractelement <2 x i64> [[TMP5]], i64 1
...
; VF4-NEXT:    [[TMP12:%.*]] = extractelement <4 x i64> [[TMP7]], i64 0
; VF4-NEXT:    store i64 [[TMP12]], ptr [[TMP8]], align 8
; VF4-NEXT:    [[TMP13:%.*]] = extractelement <4 x i64> [[TMP7]], i64 1
; VF4-NEXT:    store i64 [[TMP13]], ptr [[TMP9]], align 8
; VF4-NEXT:    [[TMP14:%.*]] = extractelement <4 x i64> [[TMP7]], i64 2
; VF4-NEXT:    store i64 [[TMP14]], ptr [[TMP10]], align 8
; VF4-NEXT:    [[TMP15:%.*]] = extractelement <4 x i64> [[TMP7]], i64 3
...
; VF2-NEXT:    [[TMP15:%.*]] = extractelement <2 x i64> [[TMP12]], i64 0
; VF2-NEXT:    store i64 [[TMP15]], ptr [[TMP13]], align 8
; VF2-NEXT:    [[TMP16:%.*]] = extractelement <2 x i64> [[TMP12]], i64 1
...
; VF4-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP6]]
; VF4-NEXT:    [[TMP8:%.*]] = extractelement <4 x i64> [[TMP5]], i64 1
; VF4-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP8]]
; VF4-NEXT:    [[TMP10:%.*]] = extractelement <4 x i64> [[TMP5]], i64 2
; VF4-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP10]]
; VF4-NEXT:    [[TMP12:%.*]] = extractelement <4 x i64> [[TMP5]], i64 3
...
; VF4-NEXT:    [[TMP27:%.*]] = extractelement <4 x i64> [[TMP22]], i64 0
; VF4-NEXT:    store i64 [[TMP27]], ptr [[TMP23]], align 8
; VF4-NEXT:    [[TMP28:%.*]] = extractelement <4 x i64> [[TMP22]], i64 1
; VF4-NEXT:    store i64 [[TMP28]], ptr [[TMP24]], align 8
; VF4-NEXT:    [[TMP29:%.*]] = extractelement <4 x i64> [[TMP22]], i64 2
; VF4-NEXT:    store i64 [[TMP29]], ptr [[TMP25]], align 8
; VF4-NEXT:    [[TMP30:%.*]] = extractelement <4 x i64> [[TMP22]], i64 3
