...
; VF4IC2:       [[VECTOR_BODY]]:
; VF4IC2-NEXT:    [[TMP0:%.*]] = ashr <4 x i32> [[BROADCAST_SPLAT]], <i32 0, i32 8, i32 16, i32 24>
; VF4IC2-NEXT:    [[TMP1:%.*]] = ashr <4 x i32> [[BROADCAST_SPLAT]], <i32 32, i32 40, i32 48, i32 56>
; VF4IC2-NEXT:    [[TMP2:%.*]] = icmp ne <4 x i32> [[TMP0]], zeroinitializer
; VF4IC2-NEXT:    [[TMP3:%.*]] = icmp ne <4 x i32> [[TMP1]], zeroinitializer
...
; VF4IC2:       [[MIDDLE_BLOCK]]:
; VF4IC2-NEXT:    [[TMP8:%.*]] = extractelement <4 x i32> [[TMP1]], i32 3
; VF4IC2-NEXT:    br label %[[RETURN:.*]]
; VF4IC2:       [[VECTOR_EARLY_EXIT]]:
; VF4IC2-NEXT:    [[TMP9:%.*]] = call i64 @llvm.experimental.cttz.elts.i64.v4i1(<4 x i1> [[TMP3]], i1 false)
; VF4IC2-NEXT:    [[TMP10:%.*]] = add i64 4, [[TMP9]]
; VF4IC2-NEXT:    [[TMP11:%.*]] = call i64 @llvm.experimental.cttz.elts.i64.v4i1(<4 x i1> [[TMP2]], i1 false)
...
; VF8IC1:       [[VECTOR_BODY]]:
; VF8IC1-NEXT:    [[TMP0:%.*]] = ashr <8 x i32> [[BROADCAST_SPLAT]], <i32 0, i32 8, i32 16, i32 24, i32 32, i32 40, i32 48, i32 56>
; VF8IC1-NEXT:    [[TMP1:%.*]] = icmp ne <8 x i32> [[TMP0]], zeroinitializer
; VF8IC1-NEXT:    [[TMP2:%.*]] = freeze <8 x i1> [[TMP1]]
...
; VF8IC1:       [[MIDDLE_BLOCK]]:
; VF8IC1-NEXT:    [[TMP4:%.*]] = extractelement <8 x i32> [[TMP0]], i32 7
; VF8IC1-NEXT:    br label %[[RETURN:.*]]
; VF8IC1:       [[VECTOR_EARLY_EXIT]]:
; VF8IC1-NEXT:    [[TMP5:%.*]] = call i64 @llvm.experimental.cttz.elts.i64.v8i1(<8 x i1> [[TMP1]], i1 false)
