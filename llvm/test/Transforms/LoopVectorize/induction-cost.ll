...
; %ptr.iv is stored to memory and thus used as a value, not only for
; addressing, so it cannot be scalarized and remains a
; WIDEN-POINTER-INDUCTION. %arr.iv is only used for addressing and is
; scalarized as usual.
