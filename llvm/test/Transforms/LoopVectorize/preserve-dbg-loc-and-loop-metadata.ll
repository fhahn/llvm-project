...
; CHECK-NEXT:    [[TMP8:%.*]] = add i64 [[END1]], [[TMP0]]
; CHECK-NEXT:    [[TMP1:%.*]] = add i64 [[TMP8]], -8
...
; DEBUGLOC-NEXT:    [[TMP0:%.*]] = sub i64 0, [[START2]]
; DEBUGLOC-NEXT:    [[TMP7:%.*]] = add i64 [[END1]], [[TMP0]]
; DEBUGLOC-NEXT:    [[TMP1:%.*]] = add i64 [[TMP7]], -8
; DEBUGLOC-NEXT:    [[TMP2:%.*]] = lshr i64 [[TMP1]], 3
; DEBUGLOC-NEXT:    [[TMP3:%.*]] = add nuw nsw i64 [[TMP2]], 1
...
; DEBUGLOC-NEXT:    [[TMP8:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]], !dbg [[DBG37:![0-9]+]]
; DEBUGLOC-NEXT:    br i1 [[TMP8]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !dbg [[DBG37]], !llvm.loop [[LOOP38:![0-9]+]]
; DEBUGLOC:       [[MIDDLE_BLOCK]]:
