...
; CHECK:       pred.store.if:
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr i8, ptr null, i64 [[TMP2]]
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i8, ptr [[TMP10]], i64 -1
; CHECK-NEXT:    store i8 95, ptr [[TMP11]], align 1
...
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr i8, ptr null, i64 [[TMP13]]
...
; CHECK-NEXT:    [[TMP16:%.*]] = extractelement <4 x i1> [[TMP8]], i32 2
; CHECK-NEXT:    br i1 [[TMP16]], label [[PRED_STORE_IF4:%.*]], label [[PRED_STORE_CONTINUE5:%.*]]
; CHECK:       pred.store.if4:
; CHECK-NEXT:    [[TMP17:%.*]] = add i64 [[OFFSET_IDX]], -2
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr null, i64 [[TMP17]]
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr inbounds i8, ptr [[TMP18]], i64 -1
; CHECK-NEXT:    store i8 95, ptr [[TMP19]], align 1
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE5]]
; CHECK:       pred.store.continue5:
; CHECK-NEXT:    [[TMP20:%.*]] = extractelement <4 x i1> [[TMP8]], i32 3
; CHECK-NEXT:    br i1 [[TMP20]], label [[PRED_STORE_IF6:%.*]], label [[PRED_STORE_CONTINUE7]]
; CHECK:       pred.store.if6:
; CHECK-NEXT:    [[TMP21:%.*]] = add i64 [[OFFSET_IDX]], -3
; CHECK-NEXT:    [[TMP22:%.*]] = getelementptr i8, ptr null, i64 [[TMP21]]
; CHECK-NEXT:    [[TMP23:%.*]] = getelementptr inbounds i8, ptr [[TMP22]], i64 -1
; CHECK-NEXT:    store i8 95, ptr [[TMP23]], align 1
...
; CHECK-NEXT:    [[TMP25:%.*]] = load i8, ptr [[INCDEC_PTR]], align 1
...
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[START_1]], i64 [[OFFSET_IDX]]
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, <4 x ptr> [[TMP1]], i64 1
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr ptr, ptr [[TMP2]], i32 0
