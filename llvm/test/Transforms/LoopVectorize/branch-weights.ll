...
; MAINVF4IC1_EPI4:    br i1 [[TMP5]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP28:![0-9]+]]
; MAINVF4IC1_EPI4:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
...
; MAINVF4IC1_EPI4:  [[LOOP]]:
; MAINVF4IC1_EPI4:    [[CMP_LOOP:%.*]] = icmp eq i64 [[IV_NEXT:%.*]], [[N]]
; MAINVF4IC1_EPI4:    br i1 [[CMP_LOOP]], label %[[EXIT]], label %[[LOOP]], !prof [[PROF29:![0-9]+]], !llvm.loop [[LOOP30:![0-9]+]]
; MAINVF4IC1_EPI4:  [[EXIT]]:
;
...
; MAINVF4IC2_EPI4:    br i1 [[TMP6]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP28:![0-9]+]]
; MAINVF4IC2_EPI4:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
...
; MAINVF4IC2_EPI4:  [[LOOP]]:
; MAINVF4IC2_EPI4:    [[CMP_LOOP:%.*]] = icmp eq i64 [[IV_NEXT:%.*]], [[N]]
; MAINVF4IC2_EPI4:    br i1 [[CMP_LOOP]], label %[[EXIT]], label %[[LOOP]], !prof [[PROF29:![0-9]+]], !llvm.loop [[LOOP30:![0-9]+]]
; MAINVF4IC2_EPI4:  [[EXIT]]:
;
...
; MAINVF8IC1_EPI2:    br i1 [[TMP5]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP28:![0-9]+]]
; MAINVF8IC1_EPI2:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
...
; MAINVF8IC1_EPI2:  [[LOOP]]:
; MAINVF8IC1_EPI2:    [[CMP_LOOP:%.*]] = icmp eq i64 [[IV_NEXT:%.*]], [[N]]
; MAINVF8IC1_EPI2:    br i1 [[CMP_LOOP]], label %[[EXIT]], label %[[LOOP]], !prof [[PROF29:![0-9]+]], !llvm.loop [[LOOP30:![0-9]+]]
; MAINVF8IC1_EPI2:  [[EXIT]]:
;
entry:
  br label %loop
...
; MAINVF4IC1_EPI4: [[PROF29]] = !{!"branch_weights", i32 1, i32 1023}
; MAINVF4IC1_EPI4: [[LOOP30]] = distinct !{[[LOOP30]], [[META27]], [[META6]], [[META5]]}
;.
...
; MAINVF4IC2_EPI4: [[PROF29]] = !{!"branch_weights", i32 1, i32 1023}
; MAINVF4IC2_EPI4: [[LOOP30]] = distinct !{[[LOOP30]], [[META27]], [[META6]], [[META5]]}
;.
...
; MAINVF8IC1_EPI2: [[PROF29]] = !{!"branch_weights", i32 1, i32 1023}
; MAINVF8IC1_EPI2: [[LOOP30]] = distinct !{[[LOOP30]], [[META27]], [[META6]], [[META5]]}
;.
