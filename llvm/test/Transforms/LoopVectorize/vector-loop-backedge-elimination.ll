...
; VF8UF1-NEXT:    br label %[[VECTOR_BODY1:.*]]
; VF8UF1:       [[VECTOR_BODY1]]:
; VF8UF1-NEXT:    br label %[[MIDDLE_BLOCK:.*]]
; VF8UF1:       [[MIDDLE_BLOCK]]:
...
; VF8UF2-NEXT:    [[FIRST_INACTIVE_LANE:%.*]] = call i64 @llvm.experimental.cttz.elts.i64.v8i1(<8 x i1> splat (i1 true), i1 false)
; VF8UF2-NEXT:    [[TMP3:%.*]] = add i64 8, [[FIRST_INACTIVE_LANE]]
; VF8UF2-NEXT:    [[FIRST_INACTIVE_LANE1:%.*]] = call i64 @llvm.experimental.cttz.elts.i64.v8i1(<8 x i1> zeroinitializer, i1 false)
; VF8UF2-NEXT:    [[TMP4:%.*]] = add i64 0, [[FIRST_INACTIVE_LANE1]]
; VF8UF2-NEXT:    [[TMP5:%.*]] = icmp ne i64 [[FIRST_INACTIVE_LANE1]], 8
; VF8UF2-NEXT:    [[TMP6:%.*]] = select i1 [[TMP5]], i64 [[TMP4]], i64 [[TMP3]]
; VF8UF2-NEXT:    [[LAST_ACTIVE_LANE:%.*]] = sub i64 [[TMP6]], 1
; VF8UF2-NEXT:    [[TMP7:%.*]] = extractelement <8 x i8> [[TMP1]], i64 [[LAST_ACTIVE_LANE]]
; VF8UF2-NEXT:    [[TMP8:%.*]] = sub i64 [[LAST_ACTIVE_LANE]], 8
; VF8UF2-NEXT:    [[TMP9:%.*]] = extractelement <8 x i8> [[TMP2]], i64 [[TMP8]]
; VF8UF2-NEXT:    [[TMP10:%.*]] = icmp uge i64 [[LAST_ACTIVE_LANE]], 8
; VF8UF2-NEXT:    [[TMP18:%.*]] = select i1 [[TMP10]], i8 [[TMP9]], i8 [[TMP7]]
...
; VF16UF1-NEXT:    [[FIRST_INACTIVE_LANE:%.*]] = call i64 @llvm.experimental.cttz.elts.i64.v16i1(<16 x i1> <i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, i1 false)
; VF16UF1-NEXT:    [[LAST_ACTIVE_LANE:%.*]] = sub i64 [[FIRST_INACTIVE_LANE]], 1
; VF16UF1-NEXT:    [[TMP17:%.*]] = extractelement <16 x i8> [[TMP1]], i64 [[LAST_ACTIVE_LANE]]
