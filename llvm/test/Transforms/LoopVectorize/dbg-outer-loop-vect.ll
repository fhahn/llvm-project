...
; RUN: opt < %s -S -passes=loop-vectorize -enable-vplan-native-path -disable-outer-loop-memory-safety-check -force-vector-interleave=1 -force-vector-width=4 | FileCheck %s
