...
loop:
  ...
  br i1 %cmp, label %early, label %latch
...
;.
; VF1IC2: [[LOOP0]] = distinct !{[[LOOP0]], [[META1:![0-9]+]], [[META2:![0-9]+]]}
; VF1IC2: [[META1]] = !{!"llvm.loop.isvectorized", i32 1}
; VF1IC2: [[META2]] = !{!"llvm.loop.unroll.runtime.disable"}
; VF1IC2: [[LOOP3]] = distinct !{[[LOOP3]], [[META1]], [[META2]]}
;.
; VF4IC2: [[LOOP0]] = distinct !{[[LOOP0]], [[META1:![0-9]+]], [[META2:![0-9]+]]}
; VF4IC2: [[META1]] = !{!"llvm.loop.isvectorized", i32 1}
; VF4IC2: [[META2]] = !{!"llvm.loop.unroll.runtime.disable"}
; VF4IC2: [[LOOP3]] = distinct !{[[LOOP3]], [[META1]], [[META2]]}
;.
