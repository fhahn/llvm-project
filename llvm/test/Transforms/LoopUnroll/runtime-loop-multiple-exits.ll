...
; EPILOG-NEXT:    %niter.ncmp.7 = icmp ne i64 %iv_next.7, %unroll_iter
...
; EPILOG-BLOCK-NEXT:    %niter.ncmp.1 = icmp ne i64 %iv_next.1, %unroll_iter
...
; EPILOG-NEXT:    %niter.ncmp.7 = icmp eq i64 %indvars.iv.next.7, %unroll_iter
...
; EPILOG-BLOCK-NEXT:    %niter.ncmp.1 = icmp eq i64 %indvars.iv.next.1, %unroll_iter
...
; EPILOG:       latch.7:
; EPILOG-NEXT:    %niter.ncmp.7 = icmp ne i32 %inc.7, %unroll_iter
...
; EPILOG-BLOCK:       latch.1:
; EPILOG-BLOCK-NEXT:    %niter.ncmp.1 = icmp ne i32 %inc.1, %unroll_iter
