...
; CHECK-NEXT:    [[TMP4:%.*]] = load <4 x i16>, ptr [[PT0_4]], align 2
; CHECK-NEXT:    [[TMP7:%.*]] = load <4 x i16>, ptr [[PT1_4]], align 2
; CHECK-NEXT:    [[TMP6:%.*]] = tail call <4 x i16> @llvm.smin.v4i16(<4 x i16> [[TMP4]], <4 x i16> [[TMP7]])
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast <4 x i16> [[TMP6]] to i64
