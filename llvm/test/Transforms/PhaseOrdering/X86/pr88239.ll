...
; CHECK-SAME: ptr noalias noundef readonly captures(none) [[TMP0:%.*]], ptr noalias noundef writeonly captures(none) initializes((0, 1024)) [[TMP1:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
