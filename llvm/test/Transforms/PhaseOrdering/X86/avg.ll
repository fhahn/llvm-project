...
; AVX2-NEXT:    [[TMP7:%.*]] = insertelement <2 x i64> [[TMP2]], i64 [[A_COERCE2:%.*]], i64 1
; AVX2-NEXT:    [[TMP10:%.*]] = lshr <2 x i64> [[TMP7]], <i64 32, i64 48>
; AVX2-NEXT:    [[A_SROA_4_0_EXTRACT_SHIFT:%.*]] = lshr i64 [[A_COERCE1]], 48
; AVX2-NEXT:    [[TMP24:%.*]] = trunc i64 [[A_COERCE2]] to i32
; AVX2-NEXT:    [[TMP3:%.*]] = insertelement <2 x i64> [[TMP7]], i64 [[B_COERCE0:%.*]], i64 0
...
; AVX2-NEXT:    [[TMP38:%.*]] = lshr <2 x i64> [[TMP5]], <i64 32, i64 48>
...
; AVX2-NEXT:    [[TMP39:%.*]] = insertelement <2 x i32> poison, i32 [[TMP1]], i64 0
; AVX2-NEXT:    [[TMP11:%.*]] = insertelement <2 x i32> [[TMP39]], i32 [[TMP24]], i64 1
; AVX2-NEXT:    [[TMP12:%.*]] = lshr <2 x i32> [[TMP11]], splat (i32 16)
; AVX2-NEXT:    [[TMP13:%.*]] = lshr <2 x i32> [[TMP6]], splat (i32 16)
; AVX2-NEXT:    [[TMP40:%.*]] = and <2 x i64> [[TMP10]], <i64 65535, i64 -1>
; AVX2-NEXT:    [[TMP41:%.*]] = and <2 x i64> [[TMP38]], <i64 65535, i64 -1>
...
; AVX2-NEXT:    [[TMP42:%.*]] = add nuw nsw <2 x i64> [[TMP40]], splat (i64 1)
; AVX2-NEXT:    [[TMP25:%.*]] = add nuw nsw <2 x i64> [[TMP42]], [[TMP41]]
...
; AVX512-NEXT:    [[TMP5:%.*]] = lshr <2 x i64> [[TMP2]], <i64 32, i64 48>
...
; AVX512-NEXT:    [[TMP6:%.*]] = insertelement <2 x i64> [[TMP2]], i64 [[B_COERCE0:%.*]], i64 0
; AVX512-NEXT:    [[TMP7:%.*]] = lshr <2 x i64> [[TMP6]], <i64 48, i64 32>
; AVX512-NEXT:    [[TMP8:%.*]] = insertelement <2 x i64> [[TMP10]], i64 [[B_COERCE0]], i64 0
; AVX512-NEXT:    [[TMP9:%.*]] = trunc <2 x i64> [[TMP8]] to <2 x i32>
; AVX512-NEXT:    [[TMP13:%.*]] = lshr <2 x i64> [[TMP8]], <i64 32, i64 48>
; AVX512-NEXT:    [[TMP11:%.*]] = and <2 x i64> [[TMP2]], splat (i64 65535)
...
; AVX512-NEXT:    [[TMP21:%.*]] = and <2 x i64> [[TMP5]], <i64 65535, i64 -1>
; AVX512-NEXT:    [[TMP24:%.*]] = and <2 x i64> [[TMP13]], <i64 65535, i64 -1>
