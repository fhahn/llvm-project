...
; CHECK:       [[BB13]]:
; CHECK-NEXT:    [[ARG_OFF6:%.*]] = add i32 [[ARG]], 127
; CHECK-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i32 [[ARG_OFF6]], 255
; CHECK-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[BB14:.*]], label %[[BB12_LOOPEXIT:.*]]
; CHECK:       [[BB12_LOOPEXIT]]:
; CHECK-NEXT:    [[I3_PROMOTED:%.*]] = load <2 x i32>, ptr [[I3]], align 8, !tbaa [[INT_TBAA5:![0-9]+]]
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[WIDE_LOAD9:%.*]] = phi <2 x i32> [ [[TMP3:%.*]], %[[VECTOR_BODY]] ], [ [[I3_PROMOTED]], %[[BB12_LOOPEXIT]] ]
; CHECK-NEXT:    [[INDEX:%.*]] = phi i32 [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ], [ 0, %[[BB12_LOOPEXIT]] ]
; CHECK-NEXT:    [[VEC_IND:%.*]] = phi <2 x i32> [ [[VEC_IND_NEXT:%.*]], %[[VECTOR_BODY]] ], [ <i32 0, i32 1>, %[[BB12_LOOPEXIT]] ]
; CHECK-NEXT:    [[TMP3]] = mul nsw <2 x i32> [[WIDE_LOAD9]], [[VEC_IND]]
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 2
; CHECK-NEXT:    [[VEC_IND_NEXT]] = add nuw nsw <2 x i32> [[VEC_IND]], splat (i32 2)
; CHECK-NEXT:    [[TMP1:%.*]] = icmp eq i32 [[INDEX_NEXT]], [[I10]]
; CHECK-NEXT:    br i1 [[TMP1]], label %[[BB12_LOOPEXIT_LOOPEXIT8:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP9:![0-9]+]]
; CHECK:       [[BB12_LOOPEXIT_LOOPEXIT8]]:
; CHECK-NEXT:    store <2 x i32> [[TMP3]], ptr [[I3]], align 8, !tbaa [[INT_TBAA5]]
; CHECK-NEXT:    br label %[[BB12_LOOPEXIT1:.*]]
; CHECK:       [[BB12_LOOPEXIT1]]:
; CHECK-NEXT:    [[DOTPRE:%.*]] = load i64, ptr [[I3]], align 8, !tbaa [[CHAR_TBAA13:![0-9]+]]
; CHECK-NEXT:    br label %[[BB12]]
; CHECK:       [[BB12]]:
; CHECK-NEXT:    [[TMP2:%.*]] = phi i64 [ [[DOTPRE]], %[[BB12_LOOPEXIT1]] ], [ 180388626456, %[[BB]] ]
; CHECK-NEXT:    store i64 [[TMP2]], ptr [[ARG1]], align 4, !tbaa [[CHAR_TBAA13]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr nonnull [[I3]]) #[[ATTR2]]
; CHECK-NEXT:    ret void
; CHECK:       [[BB14]]:
; CHECK-NEXT:    [[I24_2:%.*]] = phi i32 [ [[I24_3:%.*]], %[[BB14]] ], [ 0, %[[BB13]] ]
; CHECK-NEXT:    [[I15:%.*]] = and i32 [[I24_2]], 1
; CHECK-NEXT:    [[I16:%.*]] = zext nneg i32 [[I15]] to i64
; CHECK-NEXT:    [[I5_I_I:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[I3]], i64 [[I16]]
...
; CHECK-NEXT:    br i1 [[I11_NOT_3]], label %[[BB12_LOOPEXIT1]], label %[[BB14]], !llvm.loop [[LOOP14:![0-9]+]]
;
bb:
