...
; CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i8>, ptr [[P2]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP3:%.*]] = zext <4 x i8> [[TMP2]] to <4 x i32>
; CHECK-NEXT:    [[TMP4:%.*]] = sub nsw <4 x i32> [[TMP1]], [[TMP3]]
; CHECK-NEXT:    [[TMP5:%.*]] = load <4 x i8>, ptr [[RRRAYIDX3]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP6:%.*]] = zext <4 x i8> [[TMP5]] to <4 x i32>
; CHECK-NEXT:    [[TMP7:%.*]] = load <4 x i8>, ptr [[RRRAYIDX5]], align 1, !tbaa [[CHAR_TBAA0]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = shufflevector <4 x i32> [[TMP11]], <4 x i32> poison, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP13:%.*]] = shufflevector <4 x i32> [[TMP11]], <4 x i32> poison, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP14:%.*]] = shufflevector <4 x i32> [[TMP11]], <4 x i32> poison, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP32:%.*]] = shufflevector <4 x i32> [[TMP11]], <4 x i32> poison, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP33:%.*]] = add nsw <4 x i32> [[TMP32]], [[TMP13]]
; CHECK-NEXT:    [[TMP34:%.*]] = sub nsw <4 x i32> [[TMP14]], [[TMP12]]
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <4 x i32> [[TMP33]], <4 x i32> [[TMP34]], <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP15:%.*]] = shufflevector <4 x i32> [[TMP33]], <4 x i32> [[TMP34]], <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP52:%.*]] = shufflevector <4 x i32> [[TMP33]], <4 x i32> [[TMP34]], <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP16:%.*]] = shufflevector <4 x i32> [[TMP33]], <4 x i32> [[TMP34]], <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP17:%.*]] = add nsw <4 x i32> [[TMP15]], [[TMP16]]
; CHECK-NEXT:    [[TMP53:%.*]] = sub nsw <4 x i32> [[TMP18]], [[TMP52]]
; CHECK-NEXT:    [[TMP19:%.*]] = shufflevector <4 x i32> [[TMP17]], <4 x i32> [[TMP53]], <4 x i32> <i32 0, i32 1, i32 4, i32 5>
...
; CHECK-NEXT:    [[TMP20:%.*]] = load <4 x i8>, ptr [[RDD_PTR]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP21:%.*]] = zext <4 x i8> [[TMP20]] to <4 x i32>
; CHECK-NEXT:    [[TMP22:%.*]] = load <4 x i8>, ptr [[RDD_PTR64]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP23:%.*]] = zext <4 x i8> [[TMP22]] to <4 x i32>
; CHECK-NEXT:    [[TMP24:%.*]] = sub nsw <4 x i32> [[TMP21]], [[TMP23]]
; CHECK-NEXT:    [[TMP25:%.*]] = load <4 x i8>, ptr [[RRRAYIDX3_1]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP26:%.*]] = zext <4 x i8> [[TMP25]] to <4 x i32>
; CHECK-NEXT:    [[TMP27:%.*]] = load <4 x i8>, ptr [[RRRAYIDX5_1]], align 1, !tbaa [[CHAR_TBAA0]]
...
; CHECK-NEXT:    [[TMP54:%.*]] = shufflevector <4 x i32> [[TMP31]], <4 x i32> poison, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP38:%.*]] = shufflevector <4 x i32> [[TMP31]], <4 x i32> poison, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP58:%.*]] = shufflevector <4 x i32> [[TMP31]], <4 x i32> poison, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP72:%.*]] = shufflevector <4 x i32> [[TMP31]], <4 x i32> poison, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP78:%.*]] = add nsw <4 x i32> [[TMP72]], [[TMP38]]
; CHECK-NEXT:    [[TMP111:%.*]] = sub nsw <4 x i32> [[TMP58]], [[TMP54]]
; CHECK-NEXT:    [[TMP112:%.*]] = shufflevector <4 x i32> [[TMP78]], <4 x i32> [[TMP111]], <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP35:%.*]] = shufflevector <4 x i32> [[TMP78]], <4 x i32> [[TMP111]], <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP113:%.*]] = shufflevector <4 x i32> [[TMP78]], <4 x i32> [[TMP111]], <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP36:%.*]] = shufflevector <4 x i32> [[TMP78]], <4 x i32> [[TMP111]], <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP37:%.*]] = add nsw <4 x i32> [[TMP35]], [[TMP36]]
; CHECK-NEXT:    [[TMP114:%.*]] = sub nsw <4 x i32> [[TMP112]], [[TMP113]]
; CHECK-NEXT:    [[TMP39:%.*]] = shufflevector <4 x i32> [[TMP37]], <4 x i32> [[TMP114]], <4 x i32> <i32 0, i32 1, i32 4, i32 5>
...
; CHECK-NEXT:    [[TMP40:%.*]] = load <4 x i8>, ptr [[RDD_PTR_1]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP41:%.*]] = zext <4 x i8> [[TMP40]] to <4 x i32>
; CHECK-NEXT:    [[TMP42:%.*]] = load <4 x i8>, ptr [[RDD_PTR64_1]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP43:%.*]] = zext <4 x i8> [[TMP42]] to <4 x i32>
; CHECK-NEXT:    [[TMP44:%.*]] = sub nsw <4 x i32> [[TMP41]], [[TMP43]]
; CHECK-NEXT:    [[TMP45:%.*]] = load <4 x i8>, ptr [[RRRAYIDX3_2]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP46:%.*]] = zext <4 x i8> [[TMP45]] to <4 x i32>
; CHECK-NEXT:    [[TMP47:%.*]] = load <4 x i8>, ptr [[RRRAYIDX5_2]], align 1, !tbaa [[CHAR_TBAA0]]
...
; CHECK-NEXT:    [[TMP115:%.*]] = shufflevector <4 x i32> [[TMP51]], <4 x i32> poison, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP116:%.*]] = shufflevector <4 x i32> [[TMP51]], <4 x i32> poison, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP117:%.*]] = shufflevector <4 x i32> [[TMP51]], <4 x i32> poison, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP118:%.*]] = shufflevector <4 x i32> [[TMP51]], <4 x i32> poison, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP119:%.*]] = add nsw <4 x i32> [[TMP118]], [[TMP116]]
; CHECK-NEXT:    [[TMP120:%.*]] = sub nsw <4 x i32> [[TMP117]], [[TMP115]]
; CHECK-NEXT:    [[TMP121:%.*]] = shufflevector <4 x i32> [[TMP119]], <4 x i32> [[TMP120]], <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP55:%.*]] = shufflevector <4 x i32> [[TMP119]], <4 x i32> [[TMP120]], <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP122:%.*]] = shufflevector <4 x i32> [[TMP119]], <4 x i32> [[TMP120]], <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP56:%.*]] = shufflevector <4 x i32> [[TMP119]], <4 x i32> [[TMP120]], <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP57:%.*]] = add nsw <4 x i32> [[TMP55]], [[TMP56]]
; CHECK-NEXT:    [[TMP73:%.*]] = sub nsw <4 x i32> [[TMP121]], [[TMP122]]
; CHECK-NEXT:    [[TMP59:%.*]] = shufflevector <4 x i32> [[TMP57]], <4 x i32> [[TMP73]], <4 x i32> <i32 0, i32 1, i32 4, i32 5>
...
; CHECK-NEXT:    [[TMP60:%.*]] = load <4 x i8>, ptr [[RDD_PTR_2]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP61:%.*]] = zext <4 x i8> [[TMP60]] to <4 x i32>
; CHECK-NEXT:    [[TMP62:%.*]] = load <4 x i8>, ptr [[RDD_PTR64_2]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP63:%.*]] = zext <4 x i8> [[TMP62]] to <4 x i32>
; CHECK-NEXT:    [[TMP64:%.*]] = sub nsw <4 x i32> [[TMP61]], [[TMP63]]
; CHECK-NEXT:    [[TMP65:%.*]] = load <4 x i8>, ptr [[RRRAYIDX3_3]], align 1, !tbaa [[CHAR_TBAA0]]
; CHECK-NEXT:    [[TMP66:%.*]] = zext <4 x i8> [[TMP65]] to <4 x i32>
; CHECK-NEXT:    [[TMP67:%.*]] = load <4 x i8>, ptr [[RRRAYIDX5_3]], align 1, !tbaa [[CHAR_TBAA0]]
...
; CHECK-NEXT:    [[TMP123:%.*]] = shufflevector <4 x i32> [[TMP71]], <4 x i32> poison, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP124:%.*]] = shufflevector <4 x i32> [[TMP71]], <4 x i32> poison, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP125:%.*]] = shufflevector <4 x i32> [[TMP71]], <4 x i32> poison, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP126:%.*]] = shufflevector <4 x i32> [[TMP71]], <4 x i32> poison, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP127:%.*]] = add nsw <4 x i32> [[TMP126]], [[TMP124]]
; CHECK-NEXT:    [[TMP128:%.*]] = sub nsw <4 x i32> [[TMP125]], [[TMP123]]
; CHECK-NEXT:    [[TMP129:%.*]] = shufflevector <4 x i32> [[TMP127]], <4 x i32> [[TMP128]], <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP75:%.*]] = shufflevector <4 x i32> [[TMP127]], <4 x i32> [[TMP128]], <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP130:%.*]] = shufflevector <4 x i32> [[TMP127]], <4 x i32> [[TMP128]], <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP76:%.*]] = shufflevector <4 x i32> [[TMP127]], <4 x i32> [[TMP128]], <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP77:%.*]] = add nsw <4 x i32> [[TMP75]], [[TMP76]]
; CHECK-NEXT:    [[TMP131:%.*]] = sub nsw <4 x i32> [[TMP129]], [[TMP130]]
; CHECK-NEXT:    [[TMP79:%.*]] = shufflevector <4 x i32> [[TMP77]], <4 x i32> [[TMP131]], <4 x i32> <i32 0, i32 1, i32 4, i32 5>
; CHECK-NEXT:    [[TMP80:%.*]] = sub <4 x i32> [[TMP59]], [[TMP79]]
; CHECK-NEXT:    [[TMP81:%.*]] = sub <4 x i32> [[TMP19]], [[TMP39]]
; CHECK-NEXT:    [[TMP82:%.*]] = add nsw <4 x i32> [[TMP80]], [[TMP81]]
; CHECK-NEXT:    [[TMP83:%.*]] = lshr <4 x i32> [[TMP82]], splat (i32 15)
; CHECK-NEXT:    [[TMP84:%.*]] = and <4 x i32> [[TMP83]], splat (i32 65537)
; CHECK-NEXT:    [[TMP85:%.*]] = mul nuw <4 x i32> [[TMP84]], splat (i32 65535)
; CHECK-NEXT:    [[TMP86:%.*]] = add <4 x i32> [[TMP85]], [[TMP82]]
; CHECK-NEXT:    [[TMP87:%.*]] = xor <4 x i32> [[TMP86]], [[TMP85]]
; CHECK-NEXT:    [[TMP88:%.*]] = add <4 x i32> [[TMP79]], [[TMP59]]
; CHECK-NEXT:    [[TMP89:%.*]] = add <4 x i32> [[TMP39]], [[TMP19]]
; CHECK-NEXT:    [[TMP90:%.*]] = add nsw <4 x i32> [[TMP88]], [[TMP89]]
; CHECK-NEXT:    [[TMP91:%.*]] = lshr <4 x i32> [[TMP90]], splat (i32 15)
; CHECK-NEXT:    [[TMP92:%.*]] = and <4 x i32> [[TMP91]], splat (i32 65537)
; CHECK-NEXT:    [[TMP93:%.*]] = mul nuw <4 x i32> [[TMP92]], splat (i32 65535)
; CHECK-NEXT:    [[TMP94:%.*]] = add <4 x i32> [[TMP93]], [[TMP90]]
; CHECK-NEXT:    [[TMP95:%.*]] = xor <4 x i32> [[TMP94]], [[TMP93]]
; CHECK-NEXT:    [[TMP96:%.*]] = add <4 x i32> [[TMP87]], [[TMP95]]
; CHECK-NEXT:    [[TMP97:%.*]] = sub nsw <4 x i32> [[TMP89]], [[TMP88]]
; CHECK-NEXT:    [[TMP98:%.*]] = lshr <4 x i32> [[TMP97]], splat (i32 15)
; CHECK-NEXT:    [[TMP99:%.*]] = and <4 x i32> [[TMP98]], splat (i32 65537)
; CHECK-NEXT:    [[TMP100:%.*]] = mul nuw <4 x i32> [[TMP99]], splat (i32 65535)
; CHECK-NEXT:    [[TMP101:%.*]] = add <4 x i32> [[TMP100]], [[TMP97]]
; CHECK-NEXT:    [[TMP102:%.*]] = xor <4 x i32> [[TMP101]], [[TMP100]]
; CHECK-NEXT:    [[TMP103:%.*]] = add <4 x i32> [[TMP96]], [[TMP102]]
; CHECK-NEXT:    [[TMP104:%.*]] = sub nsw <4 x i32> [[TMP81]], [[TMP80]]
; CHECK-NEXT:    [[TMP105:%.*]] = lshr <4 x i32> [[TMP104]], splat (i32 15)
; CHECK-NEXT:    [[TMP106:%.*]] = and <4 x i32> [[TMP105]], splat (i32 65537)
; CHECK-NEXT:    [[TMP107:%.*]] = mul nuw <4 x i32> [[TMP106]], splat (i32 65535)
; CHECK-NEXT:    [[TMP108:%.*]] = add <4 x i32> [[TMP107]], [[TMP104]]
; CHECK-NEXT:    [[TMP109:%.*]] = xor <4 x i32> [[TMP108]], [[TMP107]]
; CHECK-NEXT:    [[TMP110:%.*]] = add <4 x i32> [[TMP103]], [[TMP109]]
; CHECK-NEXT:    [[TMP74:%.*]] = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> [[TMP110]])
