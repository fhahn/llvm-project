...
; CHECK:       [[OUTER_HEADER]]:
; CHECK-NEXT:    [[OUTER_IV_1:%.*]] = phi i32 [ [[INDVARS_IV_NEXT3:%.*]], %[[OUTER_LATCH:.*]] ], [ 1, %[[ENTRY]] ]
...
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[INNER]], label %[[OUTER_LATCH_LOOPEXIT:.*]]
; CHECK:       [[OUTER_LATCH_LOOPEXIT]]:
; CHECK-NEXT:    br label %[[OUTER_LATCH]]
; CHECK:       [[OUTER_LATCH]]:
; CHECK-NEXT:    [[INDVARS_IV_NEXT3]] = add nuw i32 [[OUTER_IV_1]], 1
; CHECK-NEXT:    [[EXITCOND4:%.*]] = icmp ne i32 [[INDVARS_IV_NEXT3]], -2147483648
; CHECK-NEXT:    br i1 [[EXITCOND4]], label %[[OUTER_HEADER]], label %[[EXIT:.*]]
; CHECK:       [[EXIT]]:
