...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <8 x i8> %a to <8 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <8 x i8> %b to <8 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp2 = add <8 x i16> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i16> %tmp2
;
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <4 x i16> %a to <4 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <4 x i16> %b to <4 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp2 = add <4 x i32> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <4 x i32> %tmp2
;
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <2 x i32> %a to <2 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <2 x i32> %b to <2 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp2 = add <2 x i64> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x i64> %tmp2
;
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <16 x i8> %a to <16 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <16 x i8> %b to <16 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp2 = add <16 x i16> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <16 x i16> %tmp2
;
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <8 x i16> %a to <8 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <8 x i16> %b to <8 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp2 = add <8 x i32> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i32> %tmp2
;
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <4 x i32> %a to <4 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <4 x i32> %b to <4 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp2 = add <4 x i64> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <4 x i64> %tmp2
;
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <8 x i8> %a to <8 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <8 x i8> %b to <8 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp2 = sub <8 x i16> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i16> %tmp2
;
  %tmp0 = zext <8 x i8> %a to <8 x i16>
  %tmp1 = zext <8 x i8> %b to <8 x i16>
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <4 x i16> %a to <4 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <4 x i16> %b to <4 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp2 = sub <4 x i32> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <4 x i32> %tmp2
;
  %tmp0 = zext <4 x i16> %a to <4 x i32>
  %tmp1 = zext <4 x i16> %b to <4 x i32>
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <2 x i32> %a to <2 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <2 x i32> %b to <2 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp2 = sub <2 x i64> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x i64> %tmp2
;
  %tmp0 = zext <2 x i32> %a to <2 x i64>
  %tmp1 = zext <2 x i32> %b to <2 x i64>
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <16 x i8> %a to <16 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <16 x i8> %b to <16 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp2 = sub <16 x i16> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <16 x i16> %tmp2
;
  %tmp0 = zext <16 x i8> %a to <16 x i16>
  %tmp1 = zext <16 x i8> %b to <16 x i16>
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <8 x i16> %a to <8 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <8 x i16> %b to <8 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp2 = sub <8 x i32> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i32> %tmp2
;
  %tmp0 = zext <8 x i16> %a to <8 x i32>
  %tmp1 = zext <8 x i16> %b to <8 x i32>
...
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <4 x i32> %a to <4 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp1 = zext <4 x i32> %b to <4 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp2 = sub <4 x i64> %tmp0, %tmp1
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <4 x i64> %tmp2
;
  %tmp0 = zext <4 x i32> %a to <4 x i64>
  %tmp1 = zext <4 x i32> %b to <4 x i64>
...
; COST-LABEL: 'uaddw_8h'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <8 x i8> %a to <8 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp1 = add <8 x i16> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i16> %tmp1
;
  %tmp0 = zext <8 x i8> %a to <8 x i16>
...
; COST-LABEL: 'uaddw_4s'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <4 x i16> %a to <4 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp1 = add <4 x i32> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <4 x i32> %tmp1
;
  %tmp0 = zext <4 x i16> %a to <4 x i32>
...
; COST-LABEL: 'uaddw_2d'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <2 x i32> %a to <2 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp1 = add <2 x i64> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x i64> %tmp1
;
  %tmp0 = zext <2 x i32> %a to <2 x i64>
...
; COST-LABEL: 'uaddw2_8h'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <16 x i8> %a to <16 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp1 = add <16 x i16> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <16 x i16> %tmp1
;
  %tmp0 = zext <16 x i8> %a to <16 x i16>
...
; COST-LABEL: 'uaddw2_4s'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <8 x i16> %a to <8 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp1 = add <8 x i32> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i32> %tmp1
;
  %tmp0 = zext <8 x i16> %a to <8 x i32>
...
; COST-LABEL: 'uaddw2_2d'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <4 x i32> %a to <4 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp1 = add <4 x i64> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <4 x i64> %tmp1
;
  %tmp0 = zext <4 x i32> %a to <4 x i64>
...
; COST-LABEL: 'usubw_8h'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <8 x i8> %a to <8 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp1 = sub <8 x i16> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i16> %tmp1
;
  %tmp0 = zext <8 x i8> %a to <8 x i16>
...
; COST-LABEL: 'usubw_4s'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <4 x i16> %a to <4 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp1 = sub <4 x i32> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <4 x i32> %tmp1
;
  %tmp0 = zext <4 x i16> %a to <4 x i32>
...
; COST-LABEL: 'usubw_2d'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <2 x i32> %a to <2 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp1 = sub <2 x i64> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x i64> %tmp1
;
  %tmp0 = zext <2 x i32> %a to <2 x i64>
...
; COST-LABEL: 'usubw2_8h'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <16 x i8> %a to <16 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp1 = sub <16 x i16> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <16 x i16> %tmp1
;
  %tmp0 = zext <16 x i8> %a to <16 x i16>
...
; COST-LABEL: 'usubw2_4s'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <8 x i16> %a to <8 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp1 = sub <8 x i32> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i32> %tmp1
;
  %tmp0 = zext <8 x i16> %a to <8 x i32>
...
; COST-LABEL: 'usubw2_2d'
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %tmp0 = zext <4 x i32> %a to <4 x i64>
; COST-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %tmp1 = sub <4 x i64> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <4 x i64> %tmp1
;
  %tmp0 = zext <4 x i32> %a to <4 x i64>
...
; COST-LABEL: 'neg_wrong_operand_order'
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp0 = zext <8 x i8> %a to <8 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp1 = sub <8 x i16> %tmp0, %b
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i16> %tmp1
;
  %tmp0 = zext <8 x i8> %a to <8 x i16>
...
; COST-LABEL: 'neg_non_widening_op'
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp0 = zext <8 x i8> %a to <8 x i16>
; COST-NEXT:  Cost Model: Found an estimated cost of 88 for instruction: %tmp1 = udiv <8 x i16> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <8 x i16> %tmp1
;
  %tmp0 = zext <8 x i8> %a to <8 x i16>
...
; COST-LABEL: 'neg_illegal_vector_type_0'
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp0 = zext <16 x i4> %a to <16 x i8>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp1 = sub <16 x i8> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <16 x i8> %tmp1
;
...
; COST-LABEL: 'neg_llegal_vector_type_1'
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp0 = zext <1 x i16> %a to <1 x i32>
; COST-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %tmp1 = add <1 x i32> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <1 x i32> %tmp1
;
...
; COST-LABEL: 'neg_llegal_vector_type_3'
; COST-NEXT:  Cost Model: Found an estimated cost of 15 for instruction: %tmp0 = zext <3 x i34> %a to <3 x i68>
; COST-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp1 = add <3 x i68> %b, %tmp0
; COST-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <3 x i68> %tmp1
;
