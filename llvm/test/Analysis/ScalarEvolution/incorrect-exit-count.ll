...
; CHECK-NEXT:    --> 3 U: [3,4) S: [3,4) Exits: 3 LoopDispositions: { %for.cond6: Invariant, %outer.loop: Invariant }
...
; CHECK-NEXT:    --> (6 + @__const.f.g) U: [0,-1) S: [-9223372036854775808,9223372036854775807) Exits: (6 + @__const.f.g) LoopDispositions: { %for.cond6: Invariant, %outer.loop: Invariant }
...
; CHECK-NEXT:    --> 2 U: [2,3) S: [2,3) Exits: 2 LoopDispositions: { %for.cond6: Invariant, %outer.loop: Invariant }
...
; CHECK-NEXT:    --> 3 U: [3,4) S: [3,4) Exits: 3 LoopDispositions: { %inner.loop: Invariant, %outer.loop: Invariant }
...
; CHECK-NEXT:    --> (6 + @__const.f.g) U: [0,-1) S: [-9223372036854775808,9223372036854775807) Exits: (6 + @__const.f.g) LoopDispositions: { %inner.loop: Invariant, %outer.loop: Invariant }
...
; CHECK-NEXT:    --> 2 U: [2,3) S: [2,3) Exits: 2 LoopDispositions: { %inner.loop: Invariant, %outer.loop: Invariant }
; CHECK-NEXT:    %storemerge1921.lcssa25.3 = phi i32 [ %storemerge1921.3, %for.end.3 ]
; CHECK-NEXT:    --> 3 U: [3,4) S: [3,4) Exits: 3 LoopDispositions: { %outer.loop: Invariant, %for.cond6: Invariant, %inner.loop: Invariant }
