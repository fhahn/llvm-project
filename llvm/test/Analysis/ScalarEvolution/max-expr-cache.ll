...
; CHECK-NEXT:    %tmp49 = ashr i32 %tmp48, 3
; CHECK-NEXT:    --> (((7 + (256 umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umax (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>)) /u 8) U: [0,33) S: [0,33) Exits: <<Unknown>> LoopDispositions: { %bb4: Computable, %bb53: Invariant }
; CHECK-NEXT:    %tmp51 = select i1 %tmp50, i32 %tmp49, i32 0
; CHECK-NEXT:    --> (((7 + (256 umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umax (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin (1 + (256 umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>))<nuw><nsw> umin {%tmp3,+,-256}<%bb4>)) /u 8) U: [0,33) S: [0,33) Exits: <<Unknown>> LoopDispositions: { %bb4: Computable, %bb53: Invariant }
; CHECK-NEXT:    %tmp52 = zext i32 %tmp51 to i64
; CHECK-NEXT:    --> (((7 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw> umax (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>)) /u 8) U: [0,33) S: [0,33) Exits: <<Unknown>> LoopDispositions: { %bb4: Computable, %bb53: Invariant }
; CHECK-NEXT:    %tmp54 = phi i64 [ undef, %bb4 ], [ %tmp59, %bb53 ]
; CHECK-NEXT:    --> {undef,+,1}<nsw><%bb53> U: full-set S: full-set Exits: (-1 + (((7 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw> umax (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>)) /u 8))<nsw> LoopDispositions: { %bb53: Computable, %bb4: Uniform }
; CHECK-NEXT:    %tmp55 = trunc i64 %tmp54 to i32
; CHECK-NEXT:    --> {(trunc i64 undef to i32),+,1}<%bb53> U: full-set S: full-set Exits: (-1 + (trunc i64 (((7 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw> umax (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>)) /u 8) to i32))<nsw> LoopDispositions: { %bb53: Computable, %bb4: Uniform }
; CHECK-NEXT:    %tmp56 = shl nsw i32 %tmp55, 3
; CHECK-NEXT:    --> {(8 * (trunc i64 undef to i32)),+,8}<%bb53> U: [0,-7) S: [-2147483648,2147483641) Exits: (-8 + (8 * (trunc i64 (((7 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw> umax (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>)) /u 8) to i32))<nuw><nsw>)<nsw> LoopDispositions: { %bb53: Computable, %bb4: Uniform }
; CHECK-NEXT:    %tmp57 = sext i32 %tmp56 to i64
; CHECK-NEXT:    --> (sext i32 {(8 * (trunc i64 undef to i32)),+,8}<%bb53> to i64) U: [0,-7) S: [-2147483648,2147483641) Exits: (-8 + (8 * (((7 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw> umax (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>)) /u 8))<nuw><nsw>)<nsw> LoopDispositions: { %bb53: Computable, %bb4: Uniform }
; CHECK-NEXT:    %tmp58 = getelementptr inbounds i8, ptr null, i64 %tmp57
; CHECK-NEXT:    --> ((sext i32 {(8 * (trunc i64 undef to i32)),+,8}<%bb53> to i64) + null) U: [0,-7) S: [-2147483648,2147483641) Exits: (-8 + (8 * (((7 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw> umax (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>)) /u 8))<nuw><nsw> + null) LoopDispositions: { %bb53: Computable, %bb4: Uniform }
; CHECK-NEXT:    %tmp59 = add nsw i64 %tmp54, 1
; CHECK-NEXT:    --> {(1 + undef),+,1}<nsw><%bb53> U: full-set S: full-set Exits: (((7 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw> umax (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>)) /u 8) LoopDispositions: { %bb53: Computable, %bb4: Uniform }
; CHECK-NEXT:    %tmp62 = add nuw nsw i64 %tmp5, 1
; CHECK-NEXT:    --> {1,+,1}<nuw><%bb4> U: [1,0) S: [1,0) Exits: <<Unknown>> LoopDispositions: { %bb4: Computable, %bb53: Invariant }
; CHECK-NEXT:  Determining loop execution counts for: @umax
; CHECK-NEXT:  Loop %bb53: backedge-taken count is (-1 + (-1 * undef) + (((7 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw> umax (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>)) /u 8))
; CHECK-NEXT:  Loop %bb53: constant max backedge-taken count is i64 -1
; CHECK-NEXT:  Loop %bb53: symbolic max backedge-taken count is (-1 + (-1 * undef) + (((7 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw> umax (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64) umin (1 + (256 umin (zext i32 {%tmp3,+,-256}<%bb4> to i64)))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>))<nuw><nsw>)) /u 8))
; CHECK-NEXT:  Loop %bb53: Trip multiple is 1
; CHECK-NEXT:  Loop %bb4: <multiple exits> Unpredictable backedge-taken count.
; CHECK-NEXT:  Loop %bb4: Unpredictable constant max backedge-taken count.
; CHECK-NEXT:  Loop %bb4: Unpredictable symbolic max backedge-taken count.
