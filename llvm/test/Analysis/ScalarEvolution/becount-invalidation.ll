...
; CHECK-NEXT:    --> 0 U: [0,1) S: [0,1) Exits: 0 LoopDispositions: { %loop2.header: Invariant, %loop.header: Invariant }
...
; CHECK-NEXT:    --> 1 U: [1,2) S: [1,2) Exits: 1 LoopDispositions: { %loop2.header: Invariant, %loop.header: Invariant }
