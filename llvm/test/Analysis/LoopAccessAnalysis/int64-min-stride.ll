...
; Exercise a stride of INT64_MIN elements. Computing the magnitude of the stride
; must not rely on std::abs(INT64_MIN), which is signed-overflow UB; the
; dependence analysis must complete and report a sensible verdict.
