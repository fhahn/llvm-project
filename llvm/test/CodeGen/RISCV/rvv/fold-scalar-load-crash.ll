...
; RV32-NEXT:    lui a5, %hi(g)
; RV32-NEXT:  .LBB0_1: # %for.body
; RV32-NEXT:    # =>This Inner Loop Header: Depth=1
; RV32-NEXT:    mv a6, a1
; RV32-NEXT:    th.lbib a7, (a6), -1, 0
; RV32-NEXT:    th.lrb a0, a6, a0, 0
; RV32-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; RV32-NEXT:    vmv.s.x v9, a7
...
; RV32-NEXT:    zext.b a6, a0
; RV32-NEXT:    sw zero, %lo(g)(a5)
; RV32-NEXT:    mv a0, a4
; RV32-NEXT:    bnez a6, .LBB0_1
...
; RV64-NEXT:    lui a5, %hi(g)
; RV64-NEXT:  .LBB0_1: # %for.body
; RV64-NEXT:    # =>This Inner Loop Header: Depth=1
; RV64-NEXT:    mv a6, a1
; RV64-NEXT:    th.lbib a7, (a6), -1, 0
; RV64-NEXT:    sext.w a0, a0
; RV64-NEXT:    th.lrb a0, a6, a0, 0
; RV64-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; RV64-NEXT:    vmv.s.x v9, a7
...
; RV64-NEXT:    zext.b a6, a0
; RV64-NEXT:    sw zero, %lo(g)(a5)
; RV64-NEXT:    mv a0, a4
; RV64-NEXT:    bnez a6, .LBB0_1
