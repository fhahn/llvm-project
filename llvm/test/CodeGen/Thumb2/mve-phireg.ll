...
; CHECK-NEXT:  @ %bb.3:
; CHECK-NEXT:    movw r0, :lower16:g
; CHECK-NEXT:    movt r0, :upper16:g
; CHECK-NEXT:  .LBB0_4: @ %for.body10
; CHECK-NEXT:    @ =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    str r6, [r0]
; CHECK-NEXT:    cbnz r6, .LBB0_5
; CHECK-NEXT:    le .LBB0_4
; CHECK-NEXT:  .LBB0_5: @ %for.cond4.loopexit
; CHECK-NEXT:    bl l
...
; CHECK-NEXT:    str r6, [r0]
; CHECK-NEXT:    cbz r6, .LBB0_8
; CHECK-NEXT:    le .LBB0_7
; CHECK-NEXT:  .LBB0_8: @ %vector.body115.ph
...
; CHECK-NEXT:    movw r8, :lower16:.L_MergedGlobals
; CHECK-NEXT:    vldr s15, .LCPI1_1
; CHECK-NEXT:    movt r8, :upper16:.L_MergedGlobals
...
; CHECK-NEXT:    vmov q0[2], q0[0], r6, r6
...
; CHECK-NEXT:    vmov q1[3], q1[1], r2, r6
...
; CHECK-NEXT:    movw r1, :lower16:g
; CHECK-NEXT:    vstrw.32 q1, [r0]
; CHECK-NEXT:    movt r1, :upper16:g
