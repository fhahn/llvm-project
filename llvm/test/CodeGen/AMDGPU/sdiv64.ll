...
; GCN-IR-NEXT:    s_sub_u32 s14, s2, s4
; GCN-IR-NEXT:    s_subb_u32 s15, s3, s4
...
; GCN-IR-NEXT:    s_flbit_i32_b64 s18, s[14:15]
; GCN-IR-NEXT:    s_or_b64 s[10:11], s[10:11], s[8:9]
; GCN-IR-NEXT:    s_flbit_i32_b64 s8, s[2:3]
...
; GCN-IR-NEXT:    s_cselect_b32 s11, 0, s15
; GCN-IR-NEXT:    s_cselect_b32 s10, 0, s14
...
; GCN-IR-NEXT:    s_lshl_b64 s[10:11], s[14:15], s10
; GCN-IR-NEXT:    s_lshr_b64 s[14:15], s[14:15], s17
; GCN-IR-NEXT:    s_add_u32 s16, s2, -1
; GCN-IR-NEXT:    s_addc_u32 s17, s3, -1
; GCN-IR-NEXT:    s_not_b64 s[20:21], s[8:9]
; GCN-IR-NEXT:    s_add_u32 s18, s20, s18
; GCN-IR-NEXT:    s_addc_u32 s19, s21, 0
...
; GCN-IR-NEXT:    s_sub_u32 s8, s16, s14
; GCN-IR-NEXT:    s_subb_u32 s8, s17, s15
...
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v14, v2
...
; GCN-IR-NEXT:    v_not_b32_e32 v14, v14
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[6:7], v4
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], v[6:7], v9
; GCN-IR-NEXT:    v_add_i32_e32 v14, vcc, v14, v2
...
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, v12, v6
; GCN-IR-NEXT:    v_subb_u32_e32 v2, vcc, v13, v7, vcc
...
; GCN-IR-NEXT:    s_sub_u32 s14, s10, s9
; GCN-IR-NEXT:    s_subb_u32 s15, s11, s9
...
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[10:11], s[14:15], 0
; GCN-IR-NEXT:    s_flbit_i32_b64 s18, s[14:15]
...
; GCN-IR-NEXT:    s_add_u32 s18, s20, s18
; GCN-IR-NEXT:    s_addc_u32 s19, s21, 0
; GCN-IR-NEXT:  .LBB5_2: ; %udiv-do-while
; GCN-IR-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-IR-NEXT:    s_lshl_b64 s[14:15], s[14:15], 1
; GCN-IR-NEXT:    s_lshr_b32 s8, s11, 31
; GCN-IR-NEXT:    s_lshl_b64 s[10:11], s[10:11], 1
...
; GCN-IR-NEXT:    s_mov_b64 s[12:13], s[8:9]
; GCN-IR-NEXT:    s_and_b64 vcc, exec, s[20:21]
; GCN-IR-NEXT:    s_cbranch_vccz .LBB5_2
; GCN-IR-NEXT:  ; %bb.3: ; %udiv-loop-exit
; GCN-IR-NEXT:    s_lshl_b64 s[2:3], s[10:11], 1
; GCN-IR-NEXT:    s_or_b64 s[10:11], s[8:9], s[2:3]
; GCN-IR-NEXT:  .LBB5_4: ; %udiv-end
; GCN-IR-NEXT:    s_xor_b64 s[4:5], s[6:7], s[4:5]
; GCN-IR-NEXT:    s_xor_b64 s[6:7], s[10:11], s[4:5]
; GCN-IR-NEXT:    s_sub_u32 s4, s6, s4
; GCN-IR-NEXT:    s_subb_u32 s5, s7, s5
...
; GCN-IR-NEXT:    s_and_b64 s[18:19], s[8:9], s[2:3]
...
; GCN-IR-NEXT:    v_xor_b32_e32 v0, v0, v10
; GCN-IR-NEXT:    v_xor_b32_e32 v1, v1, v10
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, v0, v10
; GCN-IR-NEXT:    v_subb_u32_e32 v3, vcc, v1, v10, vcc
; GCN-IR-NEXT:    v_ffbh_u32_e32 v0, v2
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, 32, v0
; GCN-IR-NEXT:    v_ffbh_u32_e32 v1, v3
; GCN-IR-NEXT:    v_min_u32_e32 v13, v0, v1
; GCN-IR-NEXT:    v_add_i32_e32 v4, vcc, 0xffffffc5, v13
...
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], 24, v0
; GCN-IR-NEXT:    v_sub_i32_e32 v13, vcc, 58, v13
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v9, 0
; GCN-IR-NEXT:    v_subb_u32_e64 v14, s[6:7], 0, 0, vcc
...
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, v11, v6
; GCN-IR-NEXT:    v_subb_u32_e32 v0, vcc, v12, v7, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v4, v8, v4
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v8, 31, v0
; GCN-IR-NEXT:    v_or_b32_e32 v5, v9, v5
; GCN-IR-NEXT:    v_and_b32_e32 v0, 1, v8
...
; GCN-IR-NEXT:    v_mov_b32_e32 v9, v1
; GCN-IR-NEXT:    v_mov_b32_e32 v8, v0
...
; GCN-IR-NEXT:    v_ffbh_u32_e32 v1, v3
; GCN-IR-NEXT:    v_min_u32_e32 v13, v0, v1
; GCN-IR-NEXT:    v_add_i32_e32 v4, vcc, 0xffffffd0, v13
; GCN-IR-NEXT:    v_addc_u32_e64 v5, s[6:7], 0, -1, vcc
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[2:3]
; GCN-IR-NEXT:    v_cmp_lt_u64_e32 vcc, 63, v[4:5]
; GCN-IR-NEXT:    v_cmp_ne_u64_e64 s[6:7], 63, v[4:5]
...
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], s[6:7], v0
; GCN-IR-NEXT:    v_sub_i32_e32 v13, vcc, 47, v13
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v9, 0
; GCN-IR-NEXT:    v_subb_u32_e64 v14, s[6:7], 0, 0, vcc
...
; GCN-IR-NEXT:    v_sub_i32_e64 v6, s[4:5], 48, v0
...
; GCN-IR-NEXT:    v_add_i32_e32 v9, vcc, 0xffffffcf, v0
...
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, 0x7fff, v4
; GCN-IR-NEXT:    v_subb_u32_e32 v0, vcc, 0, v5, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v2, v6, v2
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v6, 31, v0
; GCN-IR-NEXT:    v_and_b32_e32 v0, 1, v6
...
; GCN-IR-NEXT:    v_mov_b32_e32 v7, 0
; GCN-IR-NEXT:    v_addc_u32_e64 v10, s[8:9], 0, -1, vcc
; GCN-IR-NEXT:  .LBB19_2: ; %udiv-do-while
; GCN-IR-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GCN-IR-NEXT:    v_lshrrev_b32_e32 v0, 31, v3
; GCN-IR-NEXT:    v_or_b32_e32 v4, v4, v0
...
; GCN-IR-NEXT:    v_mov_b32_e32 v6, v0
; GCN-IR-NEXT:    s_andn2_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    s_cbranch_execnz .LBB19_2
; GCN-IR-NEXT:  ; %bb.3: ; %udiv-loop-exit
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; GCN-IR-NEXT:    v_or_b32_e32 v2, v0, v2
; GCN-IR-NEXT:  .LBB19_4: ; %Flow
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-IR-NEXT:    v_xor_b32_e32 v0, v2, v8
; GCN-IR-NEXT:    v_xor_b32_e32 v1, v3, v8
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, v0, v8
