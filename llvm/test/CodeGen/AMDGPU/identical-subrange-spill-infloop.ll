...
; CHECK-NEXT:    s_getpc_b64 s[60:61]
; CHECK-NEXT:    s_add_u32 s60, s60, g@gotpcrel32@lo+4
; CHECK-NEXT:    s_addc_u32 s61, s61, g@gotpcrel32@hi+12
; CHECK-NEXT:    s_load_dwordx2 s[60:61], s[60:61], 0x0
; CHECK-NEXT:    s_and_b64 vcc, exec, -1
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    global_store_dword v2, v2, s[60:61]
...
; CHECK-NEXT:    image_sample_lz v2, v[0:1], s[44:51], s[20:23] dmask:0x1
...
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    buffer_store_dwordx3 v[2:4], off, s[20:23], 0
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    buffer_store_dwordx4 v[0:3], off, s[20:23], 0
; CHECK-NEXT:    ; implicit-def: $vgpr4
; CHECK-NEXT:  .LBB0_6: ; %Flow12
; CHECK-NEXT:    s_andn2_saveexec_b64 s[18:19], s[4:5]
; CHECK-NEXT:    s_cbranch_execz .LBB0_9
; CHECK-NEXT:  ; %bb.7: ; %bb33.preheader
; CHECK-NEXT:    s_mov_b32 s4, 0
; CHECK-NEXT:    s_mov_b32 s20, s4
; CHECK-NEXT:    s_mov_b32 s21, s4
; CHECK-NEXT:    v_mov_b32_e32 v0, s20
; CHECK-NEXT:    v_mov_b32_e32 v2, 0
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    image_sample_lz v5, v[0:1], s[8:15], s[4:7] dmask:0x1
; CHECK-NEXT:    image_sample_lz v6, v[0:1], s[36:43], s[4:7] dmask:0x1
; CHECK-NEXT:    s_getpc_b64 s[20:21]
; CHECK-NEXT:    s_add_u32 s20, s20, g@gotpcrel32@lo+4
; CHECK-NEXT:    s_addc_u32 s21, s21, g@gotpcrel32@hi+12
; CHECK-NEXT:    s_load_dwordx2 s[20:21], s[20:21], 0x0
; CHECK-NEXT:    s_and_b64 vcc, exec, 0
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    global_store_dword v2, v2, s[20:21]
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    v_sub_f32_e32 v5, v6, v5
; CHECK-NEXT:    v_mul_f32_e32 v5, v5, v4
; CHECK-NEXT:    v_add_f32_e32 v5, v3, v5
; CHECK-NEXT:    v_sub_f32_e32 v3, v3, v5
