...
; GCN-IR-NEXT:    s_flbit_i32_b64 s4, s[6:7]
...
; GCN-IR-NEXT:    s_or_b64 s[14:15], s[10:11], s[14:15]
; GCN-IR-NEXT:    s_and_b64 s[10:11], s[14:15], exec
...
; GCN-IR-NEXT:    s_not_b64 s[18:19], s[4:5]
; GCN-IR-NEXT:    s_add_u32 s16, s18, s16
; GCN-IR-NEXT:    s_addc_u32 s17, s19, 0
...
; GCN-IR-NEXT:    s_and_b64 s[18:19], s[8:9], s[6:7]
...
; GCN-IR-NEXT:    s_or_b64 s[10:11], s[4:5], s[8:9]
...
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v10, v4
...
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[8:9]
...
; GCN-IR-NEXT:    s_and_b64 s[4:5], s[10:11], exec
...
; GCN-IR-NEXT:    s_and_b64 s[16:17], s[6:7], s[2:3]
...
; GCN-IR-NEXT:    s_sub_u32 s4, 59, s12
; GCN-IR-NEXT:    s_subb_u32 s5, 0, 0
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[8:9], s[2:3], 0
; GCN-IR-NEXT:    v_cmp_gt_u64_e64 s[10:11], s[4:5], 63
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[14:15], s[4:5], 63
; GCN-IR-NEXT:    s_or_b64 s[10:11], s[8:9], s[10:11]
...
; GCN-IR-NEXT:  ; %bb.1: ; %udiv-bb1
; GCN-IR-NEXT:    s_add_i32 s10, s4, 1
; GCN-IR-NEXT:    s_sub_i32 s4, 63, s4
; GCN-IR-NEXT:    s_lshl_b64 s[8:9], s[2:3], s4
; GCN-IR-NEXT:    s_lshr_b64 s[10:11], s[2:3], s10
; GCN-IR-NEXT:    s_add_u32 s12, s12, 0xffffffc4
...
; GCN-IR-NEXT:    s_ashr_i32 s6, s4, 31
; GCN-IR-NEXT:    s_and_b32 s4, s6, 1
; GCN-IR-NEXT:    s_and_b32 s6, s6, 24
...
; GCN-IR-NEXT:  ; %bb.3: ; %udiv-loop-exit
; GCN-IR-NEXT:    s_lshl_b64 s[6:7], s[8:9], 1
; GCN-IR-NEXT:    s_or_b64 s[8:9], s[4:5], s[6:7]
...
; GCN-IR-NEXT:    v_add_i32_e32 v4, vcc, 0xffffffd0, v12
...
; GCN-IR-NEXT:    s_mov_b64 s[6:7], 0x8000
; GCN-IR-NEXT:    v_addc_u32_e32 v11, vcc, -1, v1, vcc
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], s[6:7], v4
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], s[6:7], v2
; GCN-IR-NEXT:    v_sub_i32_e32 v12, vcc, 47, v12
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v9, 0
; GCN-IR-NEXT:    v_subb_u32_e64 v13, s[6:7], 0, 0, vcc
...
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, v10, v6
; GCN-IR-NEXT:    v_subb_u32_e32 v2, vcc, v11, v7, vcc
...
; GCN-IR-NEXT:    v_add_i32_e32 v10, vcc, 0xffffffcf, v2
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v9, 0
...
; GCN-IR-NEXT:    v_or_b32_e32 v6, v6, v2
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, 0x7fff, v6
...
; GCN-IR-NEXT:    v_min_u32_e32 v7, s4, v2
; GCN-IR-NEXT:    s_mov_b32 s8, 0
; GCN-IR-NEXT:    v_sub_i32_e64 v5, s[4:5], 48, v7
; GCN-IR-NEXT:    v_mov_b32_e32 v1, s8
; GCN-IR-NEXT:    v_subb_u32_e64 v6, s[4:5], 0, 0, s[4:5]
; GCN-IR-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[0:1]
; GCN-IR-NEXT:    v_cmp_lt_u64_e64 s[4:5], 63, v[5:6]
; GCN-IR-NEXT:    s_mov_b64 s[6:7], 0
; GCN-IR-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
...
; GCN-IR-NEXT:    s_and_b64 s[8:9], s[4:5], vcc
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[8:9]
; GCN-IR-NEXT:    s_cbranch_execz .LBB14_4
; GCN-IR-NEXT:  ; %bb.1: ; %udiv-bb1
; GCN-IR-NEXT:    v_add_i32_e32 v6, vcc, 1, v5
; GCN-IR-NEXT:    v_sub_i32_e32 v3, vcc, 63, v5
; GCN-IR-NEXT:    v_lshl_b64 v[3:4], v[0:1], v3
; GCN-IR-NEXT:    v_lshr_b64 v[5:6], v[0:1], v6
; GCN-IR-NEXT:    v_add_i32_e32 v9, vcc, 0xffffffcf, v7
; GCN-IR-NEXT:    v_mov_b32_e32 v7, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
; GCN-IR-NEXT:    v_addc_u32_e64 v10, s[8:9], 0, -1, vcc
; GCN-IR-NEXT:  .LBB14_2: ; %udiv-do-while
; GCN-IR-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-IR-NEXT:    v_lshl_b64 v[5:6], v[5:6], 1
; GCN-IR-NEXT:    v_lshrrev_b32_e32 v1, 31, v4
; GCN-IR-NEXT:    v_or_b32_e32 v5, v5, v1
; GCN-IR-NEXT:    v_lshl_b64 v[3:4], v[3:4], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v1, vcc, 0x7fff, v5
; GCN-IR-NEXT:    v_subb_u32_e32 v1, vcc, 0, v6, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v3, v7, v3
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v7, 31, v1
; GCN-IR-NEXT:    v_and_b32_e32 v1, 1, v7
; GCN-IR-NEXT:    v_and_b32_e32 v7, 0x8000, v7
; GCN-IR-NEXT:    v_sub_i32_e32 v5, vcc, v5, v7
; GCN-IR-NEXT:    v_subbrev_u32_e32 v6, vcc, 0, v6, vcc
...
; GCN-IR-NEXT:    s_andn2_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    s_cbranch_execnz .LBB14_2
; GCN-IR-NEXT:  ; %bb.3: ; %udiv-loop-exit
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    v_lshl_b64 v[3:4], v[3:4], 1
; GCN-IR-NEXT:    v_or_b32_e32 v3, v1, v3
; GCN-IR-NEXT:  .LBB14_4: ; %Flow
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-IR-NEXT:    v_lshl_b64 v[1:2], v[3:4], 15
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, v0, v1
; GCN-IR-NEXT:    v_subb_u32_e32 v1, vcc, 0, v2, vcc
; GCN-IR-NEXT:    s_setpc_b64 s[30:31]
  %x.shr = lshr i64 %x, 40
