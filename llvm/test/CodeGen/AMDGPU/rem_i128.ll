...
; GFX9-NEXT:    v_addc_co_u32_e64 v9, s[8:9], 0, 0, vcc
...
; GFX9-NEXT:    v_addc_co_u32_e64 v11, s[8:9], 0, 0, vcc
...
; GFX9-NEXT:    v_sub_co_u32_e32 v8, vcc, v6, v8
; GFX9-NEXT:    v_subb_co_u32_e32 v9, vcc, v9, v11, vcc
; GFX9-NEXT:    v_subb_co_u32_e64 v10, s[8:9], 0, 0, vcc
; GFX9-NEXT:    v_subb_co_u32_e64 v11, s[8:9], 0, 0, s[8:9]
; GFX9-NEXT:    s_mov_b64 s[8:9], 0x7f
; GFX9-NEXT:    v_cmp_lt_u64_e32 vcc, s[8:9], v[8:9]
; GFX9-NEXT:    v_or_b32_e32 v15, v9, v11
...
; GFX9-NEXT:    v_or_b32_e32 v14, v6, v10
...
; GFX9-NEXT:    v_cndmask_b32_e64 v15, v1, 0, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v14, v0, 0, s[4:5]
...
; GFX9-NEXT:    v_sub_u32_e32 v6, 0x7f, v8
; GFX9-NEXT:    v_addc_co_u32_e32 v22, vcc, 0, v9, vcc
; GFX9-NEXT:    v_sub_u32_e32 v9, 64, v6
; GFX9-NEXT:    v_lshlrev_b64 v[12:13], v6, v[2:3]
; GFX9-NEXT:    v_lshrrev_b64 v[14:15], v9, v[0:1]
...
; GFX9-NEXT:    v_or_b32_e32 v11, v12, v14
...
; GFX9-NEXT:    v_lshlrev_b64 v[10:11], v6, v[0:1]
; GFX9-NEXT:    v_sub_u32_e32 v6, 64, v21
; GFX9-NEXT:    v_lshrrev_b64 v[12:13], v21, v[0:1]
; GFX9-NEXT:    v_lshlrev_b64 v[14:15], v6, v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e32 v11, 0, v11, vcc
; GFX9-NEXT:    v_or_b32_e32 v14, v12, v14
; GFX9-NEXT:    v_subrev_u32_e32 v12, 64, v21
; GFX9-NEXT:    v_or_b32_e32 v6, v13, v15
...
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v6, v1, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v6, v12, v14, vcc
; GFX9-NEXT:    v_lshrrev_b64 v[14:15], v21, v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v12, v6, v0, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v15, 0, v15, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v14, 0, v14, vcc
...
; GFX9-NEXT:    v_lshlrev_b64 v[29:30], 1, v[10:11]
; GFX9-NEXT:    v_lshlrev_b64 v[14:15], 1, v[14:15]
; GFX9-NEXT:    v_or_b32_e32 v10, v16, v29
...
; GFX9-NEXT:    v_or_b32_e32 v11, v17, v30
...
; GFX9-NEXT:    v_or3_b32 v8, v8, v6, v16
...
; GFX9-NEXT:    v_and_b32_e32 v6, 1, v29
...
; GFX9-NEXT:    v_lshlrev_b64 v[12:13], 1, v[8:9]
; GFX9-NEXT:    v_lshlrev_b64 v[14:15], 1, v[10:11]
; GFX9-NEXT:    v_lshrrev_b32_e32 v7, 31, v11
; GFX9-NEXT:    v_or_b32_e32 v12, v12, v7
; GFX9-NEXT:    v_or_b32_e32 v14, v6, v14
; GFX9-NEXT:  .LBB0_4: ; %Flow
; GFX9-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v20, v14, 0
; GFX9-NEXT:    v_mov_b32_e32 v8, 0
; GFX9-NEXT:    v_mul_lo_u32 v11, v15, v4
; GFX9-NEXT:    v_mul_lo_u32 v16, v14, v5
; GFX9-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v19, v14, v[7:8]
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v4, 0
; GFX9-NEXT:    v_mul_lo_u32 v14, v12, v19
; GFX9-NEXT:    v_mul_lo_u32 v13, v13, v20
; GFX9-NEXT:    v_mov_b32_e32 v7, v9
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v20, v15, v[7:8]
; GFX9-NEXT:    v_add3_u32 v5, v5, v16, v11
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v20, v[4:5]
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v10, v8
; GFX9-NEXT:    v_addc_co_u32_e64 v9, s[4:5], 0, 0, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v19, v15, v[8:9]
; GFX9-NEXT:    v_add3_u32 v5, v13, v5, v14
...
; GFX9-NEXT:    v_ffbh_u32_e32 v10, v4
; GFX9-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[8:9]
; GFX9-NEXT:    v_add_u32_e32 v10, 32, v10
; GFX9-NEXT:    v_ffbh_u32_e32 v11, v5
; GFX9-NEXT:    v_min_u32_e32 v10, v10, v11
; GFX9-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
...
; GFX9-NEXT:    v_min_u32_e32 v8, v8, v9
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v10, v8, vcc
; GFX9-NEXT:    v_ffbh_u32_e32 v10, v2
; GFX9-NEXT:    v_add_u32_e32 v10, 32, v10
...
; GFX9-NEXT:    v_addc_co_u32_e64 v13, s[8:9], 0, 0, vcc
; GFX9-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[2:3]
; GFX9-NEXT:    s_mov_b64 s[6:7], 0
; GFX9-NEXT:    v_cndmask_b32_e32 v10, v12, v10, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, 0, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v10, vcc, v8, v10
; GFX9-NEXT:    v_subb_co_u32_e32 v11, vcc, v11, v13, vcc
; GFX9-NEXT:    v_subb_co_u32_e64 v12, s[8:9], 0, 0, vcc
; GFX9-NEXT:    v_subb_co_u32_e64 v13, s[8:9], 0, 0, s[8:9]
; GFX9-NEXT:    s_mov_b64 s[8:9], 0x7f
; GFX9-NEXT:    v_cmp_lt_u64_e32 vcc, s[8:9], v[10:11]
; GFX9-NEXT:    v_or_b32_e32 v17, v11, v13
...
; GFX9-NEXT:    v_or_b32_e32 v16, v8, v12
; GFX9-NEXT:    s_or_b64 s[4:5], s[4:5], vcc
...
; GFX9-NEXT:    v_cndmask_b32_e64 v17, v1, 0, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v16, v0, 0, s[4:5]
; GFX9-NEXT:    s_and_b64 s[4:5], s[8:9], vcc
; GFX9-NEXT:    s_and_saveexec_b64 s[8:9], s[4:5]
; GFX9-NEXT:    s_cbranch_execz .LBB1_4
; GFX9-NEXT:  ; %bb.1: ; %udiv-bb1
; GFX9-NEXT:    v_add_co_u32_e32 v22, vcc, 1, v10
; GFX9-NEXT:    v_sub_u32_e32 v8, 0x7f, v10
; GFX9-NEXT:    v_addc_co_u32_e32 v23, vcc, 0, v11, vcc
; GFX9-NEXT:    v_sub_u32_e32 v11, 64, v8
; GFX9-NEXT:    v_lshlrev_b64 v[14:15], v8, v[2:3]
; GFX9-NEXT:    v_lshrrev_b64 v[16:17], v11, v[0:1]
; GFX9-NEXT:    v_addc_co_u32_e32 v24, vcc, 0, v12, vcc
; GFX9-NEXT:    v_sub_u32_e32 v10, 63, v10
; GFX9-NEXT:    v_addc_co_u32_e32 v25, vcc, 0, v13, vcc
; GFX9-NEXT:    v_lshlrev_b64 v[10:11], v10, v[0:1]
; GFX9-NEXT:    v_or_b32_e32 v12, v15, v17
; GFX9-NEXT:    v_or_b32_e32 v13, v14, v16
...
; GFX9-NEXT:    v_lshlrev_b64 v[12:13], v8, v[0:1]
; GFX9-NEXT:    v_sub_u32_e32 v8, 64, v22
; GFX9-NEXT:    v_lshrrev_b64 v[14:15], v22, v[0:1]
; GFX9-NEXT:    v_lshlrev_b64 v[16:17], v8, v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e32 v13, 0, v13, vcc
; GFX9-NEXT:    v_or_b32_e32 v16, v14, v16
; GFX9-NEXT:    v_subrev_u32_e32 v14, 64, v22
; GFX9-NEXT:    v_or_b32_e32 v8, v15, v17
; GFX9-NEXT:    v_lshrrev_b64 v[14:15], v14, v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e32 v12, 0, v12, vcc
; GFX9-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v22
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v3, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v10, v2, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v15, v8, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v22
; GFX9-NEXT:    v_cndmask_b32_e64 v17, v8, v1, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v14, v16, vcc
; GFX9-NEXT:    v_lshrrev_b64 v[14:15], v22, v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v16, v8, v0, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v19, 0, v15, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v18, 0, v14, vcc
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    v_lshlrev_b64 v[30:31], 1, v[12:13]
; GFX9-NEXT:    v_lshlrev_b64 v[18:19], 1, v[18:19]
; GFX9-NEXT:    v_or_b32_e32 v12, v20, v30
...
; GFX9-NEXT:    v_or_b32_e32 v13, v21, v31
...
; GFX9-NEXT:    v_or3_b32 v10, v10, v8, v14
; GFX9-NEXT:    v_and_b32_e32 v8, 1, v30
...
; GFX9-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX9-NEXT:    v_lshlrev_b64 v[14:15], 1, v[10:11]
; GFX9-NEXT:    v_lshlrev_b64 v[16:17], 1, v[12:13]
; GFX9-NEXT:    v_lshrrev_b32_e32 v9, 31, v13
; GFX9-NEXT:    v_or_b32_e32 v14, v14, v9
; GFX9-NEXT:    v_or_b32_e32 v16, v8, v16
; GFX9-NEXT:  .LBB1_4: ; %Flow
; GFX9-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v4, v16, 0
; GFX9-NEXT:    v_mov_b32_e32 v10, 0
; GFX9-NEXT:    v_mul_lo_u32 v13, v17, v6
; GFX9-NEXT:    v_mul_lo_u32 v18, v16, v7
; GFX9-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v5, v16, v[9:10]
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v16, v6, 0
; GFX9-NEXT:    v_mul_lo_u32 v16, v14, v5
; GFX9-NEXT:    v_mul_lo_u32 v15, v15, v4
; GFX9-NEXT:    v_mov_b32_e32 v9, v11
; GFX9-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v4, v17, v[9:10]
...
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v5, v17, v[10:11]
; GFX9-NEXT:    v_add3_u32 v7, v15, v7, v16
