...
; GCN-IR-NEXT:    s_lshr_b64 s[2:3], s[2:3], s13
; GCN-IR-NEXT:    s_add_u32 s12, s6, -1
; GCN-IR-NEXT:    s_addc_u32 s13, s7, -1
; GCN-IR-NEXT:    s_not_b64 s[16:17], s[4:5]
; GCN-IR-NEXT:    s_add_u32 s14, s16, s14
; GCN-IR-NEXT:    s_addc_u32 s15, s17, 0
...
; GCN-IR-NEXT:    s_sub_u32 s4, s12, s2
; GCN-IR-NEXT:    s_subb_u32 s4, s13, s3
; GCN-IR-NEXT:    s_ashr_i32 s8, s4, 31
; GCN-IR-NEXT:    s_mov_b32 s9, s8
; GCN-IR-NEXT:    s_and_b32 s4, s8, 1
; GCN-IR-NEXT:    s_and_b64 s[16:17], s[8:9], s[6:7]
; GCN-IR-NEXT:    s_sub_u32 s2, s2, s16
; GCN-IR-NEXT:    s_subb_u32 s3, s3, s17
...
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v12, v6
...
; GCN-IR-NEXT:    v_not_b32_e32 v12, v12
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[0:1], v4
; GCN-IR-NEXT:    v_lshr_b64 v[0:1], v[0:1], v9
; GCN-IR-NEXT:    v_add_i32_e32 v12, vcc, v12, v6
...
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, v10, v6
; GCN-IR-NEXT:    v_subb_u32_e32 v0, vcc, v11, v7, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v4, v8, v4
...
; GCN-IR-NEXT:    v_sub_i32_e32 v4, vcc, 0x7fff, v0
...
; GCN-IR-NEXT:    s_sub_u32 s4, 59, s10
; GCN-IR-NEXT:    s_subb_u32 s5, 0, 0
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[8:9], s[2:3], 0
; GCN-IR-NEXT:    v_cmp_gt_u64_e64 s[12:13], s[4:5], 63
...
; GCN-IR-NEXT:  ; %bb.1: ; %udiv-bb1
; GCN-IR-NEXT:    s_add_i32 s11, s4, 1
...
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[0:1], v2
; GCN-IR-NEXT:    v_lshr_b64 v[0:1], v[0:1], v7
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, 0xffffffc4, v4
; GCN-IR-NEXT:    v_mov_b32_e32 v6, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v7, 0
; GCN-IR-NEXT:    v_addc_u32_e64 v9, s[8:9], 0, -1, vcc
...
; GCN-IR-NEXT:    v_min_u32_e32 v2, s4, v0
...
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, 0xffffffcf, v2
; GCN-IR-NEXT:    v_mov_b32_e32 v6, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v7, 0
; GCN-IR-NEXT:    v_addc_u32_e64 v9, s[8:9], 0, -1, vcc
; GCN-IR-NEXT:  .LBB17_2: ; %udiv-do-while
; GCN-IR-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GCN-IR-NEXT:    v_lshrrev_b32_e32 v2, 31, v1
; GCN-IR-NEXT:    v_or_b32_e32 v4, v4, v2
; GCN-IR-NEXT:    v_lshl_b64 v[0:1], v[0:1], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, 0x7fff, v4
...
; GCN-IR-NEXT:    s_andn2_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    s_cbranch_execnz .LBB17_2
; GCN-IR-NEXT:  ; %bb.3: ; %udiv-loop-exit
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    v_lshl_b64 v[0:1], v[0:1], 1
; GCN-IR-NEXT:    v_or_b32_e32 v0, v2, v0
; GCN-IR-NEXT:  .LBB17_4: ; %Flow
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-IR-NEXT:    s_setpc_b64 s[30:31]
  %x.shr = lshr i64 %x, 40
