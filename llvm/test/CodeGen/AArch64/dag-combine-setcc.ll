...
; CHECK-NEXT:    sbcs xzr, x1, x10
; CHECK-NEXT:    csel x11, x0, x8, lo
; CHECK-NEXT:    csel x12, x1, x10, lo
; CHECK-NEXT:    subs x8, x2, x11
; CHECK-NEXT:    sbc x10, x3, x12
; CHECK-NEXT:    cmp x3, x12
; CHECK-NEXT:    ccmp x2, x11, #0, eq
