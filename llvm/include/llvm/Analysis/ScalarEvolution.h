...
public:
  ...
  bool isKnownViaInduction(CmpPredicate Pred, SCEVUse LHS, SCEVUse RHS);

  /// Test if the given expression is known to satisfy the condition described
  /// by Pred, LHS, and RHS.
  bool isKnownPredicate(CmpPredicate Pred, SCEVUse LHS, SCEVUse RHS);
  ...
  std::optional<bool> evaluatePredicate(CmpPredicate Pred, SCEVUse LHS,
                                        SCEVUse RHS);

  /// Test if the given expression is known to satisfy the condition described
  /// by Pred, LHS, and RHS in the given Context.
  bool isKnownPredicateAt(CmpPredicate Pred, SCEVUse LHS, SCEVUse RHS,
  ...
  std::optional<bool> evaluatePredicateAt(CmpPredicate Pred, SCEVUse LHS,
                                          SCEVUse RHS,
                                          const Instruction *CtxI);
  ...
  struct LoopInvariantPredicate {
    ...
    LoopInvariantPredicate(CmpPredicate Pred, SCEVUse LHS, SCEVUse RHS)
  ...
  getLoopInvariantPredicate(CmpPredicate Pred, SCEVUse LHS, SCEVUse RHS,
  ...
  /// ICMP_EQ or ICMP_NE.
  bool SimplifyICmpOperands(CmpPredicate &Pred, SCEVUse &LHS,
...
private:
  ...
  bool isImpliedCond(CmpPredicate Pred, SCEVUse LHS, SCEVUse RHS,
  ...
  bool isImpliedCondBalancedTypes(CmpPredicate Pred, SCEVUse LHS,
  ...
  /// true everywhere.
  bool isImpliedCond(CmpPredicate Pred, SCEVUse LHS, SCEVUse RHS,
                     CmpPredicate FoundPred, SCEVUse FoundLHS,
                     SCEVUse FoundRHS,
                     const Instruction *Context = nullptr);
  ...
  /// true in given Context. If Context is nullptr, then the found predicate is
  /// true everywhere.
  bool isImpliedCondOperands(CmpPredicate Pred, SCEVUse LHS,
  ...
  /// arguments.
  bool isImpliedViaOperations(CmpPredicate Pred, SCEVUse LHS,
                              SCEVUse RHS, SCEVUse FoundLHS,
                              SCEVUse FoundRHS, unsigned Depth = 0);
  ...
  /// whenever the condition described by Pred, FoundLHS, and FoundRHS is
  /// true.
  bool isImpliedCondOperandsHelper(CmpPredicate Pred, SCEVUse LHS,
                                   SCEVUse RHS, SCEVUse FoundLHS,
                                   SCEVUse FoundRHS);
  ...
  bool isImpliedCondOperandsViaRanges(CmpPredicate Pred, SCEVUse LHS,
                                      SCEVUse RHS, CmpPredicate FoundPred,
                                      SCEVUse FoundLHS,
                                      SCEVUse FoundRHS);
  ...
  bool isImpliedCondOperandsViaNoOverflow(CmpPredicate Pred, SCEVUse LHS,
                                          SCEVUse RHS, SCEVUse FoundLHS,
                                          SCEVUse FoundRHS);
  ...
  bool isImpliedCondOperandsViaAddRecStart(CmpPredicate Pred, SCEVUse LHS,
                                           SCEVUse RHS,
                                           SCEVUse FoundLHS,
                                           SCEVUse FoundRHS,
                                           const Instruction *CtxI);
  ...
  /// basic blocks.
  bool isImpliedViaMerge(CmpPredicate Pred, SCEVUse LHS, SCEVUse RHS,
                         SCEVUse FoundLHS, SCEVUse FoundRHS,
                         unsigned Depth);
  ...
  bool isImpliedCondOperandsViaShift(CmpPredicate Pred, SCEVUse LHS,
                                     SCEVUse RHS, SCEVUse FoundLHS,
                                     SCEVUse FoundRHS);
