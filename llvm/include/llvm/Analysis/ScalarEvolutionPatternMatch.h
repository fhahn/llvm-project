...
/// Match unsigned remainder, i.e. a SCEVURemExpr node.
template <typename Op0_t, typename Op1_t>
inline SCEVBinaryExpr_match<SCEVURemExpr, Op0_t, Op1_t>
m_scev_URem(const Op0_t &Op0, const Op1_t &Op1) {
  return m_scev_Binary<SCEVURemExpr>(Op0, Op1);
}
