...
struct VPCostContext {
  ...
  /// divided by to account for it only executing conditionally. This is the
  /// reciprocal entry probability derived from the branch weights recorded on
  /// \p VPBB at VPlan0 construction (carried onto the replicate region's ".if"
  /// block). Returns 1 (no scaling) if the probability is unknown or when
  /// computing code size.
