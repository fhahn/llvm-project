...
/// Return a MemoryLocation for \p R with alias analysis metadata populated
/// from \p R, if the recipe is supported and std::nullopt otherwise. The
/// pointer of the location is conservatively set to nullptr.
