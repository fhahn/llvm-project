...
public:
  ...
  /// Returns the blocks of the region containing \p FirstBB in reverse
  /// post-order, up to and including \p LastBB, which must be reachable from
  /// \p FirstBB. That is a conservative superset of the blocks that may
