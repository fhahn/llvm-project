...
Value *SCEVExpander::expand(SCEVUse S) {
  ...
  // The location V is available at, and hence the location the result may be
  // cached for. Caching a value for a point it does not dominate would hand it
  // to a later expansion there.
