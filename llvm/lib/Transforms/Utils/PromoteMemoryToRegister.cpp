...
template <typename PT>
bool isAndOnlyUsedByNoaliasOrProvenanceNoAliasIdentifyPArg(const IntrinsicInst *II,
                                                           unsigned OpNo,
                                                           PT &pt) {
return isAndOnlyUsedByNoaliasOrProvenanceNoAliasIdentifyPArg(const_cast<IntrinsicInst *>(II),
                                                           OpNo,
                                                           pt);
}
...
template <typename PT>
bool onlyUsedByNoaliasOrProvenanceNoAliasIdentifyPArg(const Value *V, PT &pt) {
  return onlyUsedByNoaliasOrProvenanceNoAliasIdentifyPArg(const_cast< Value *>(V), pt);
}
