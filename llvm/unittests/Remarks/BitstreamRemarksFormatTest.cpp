...
TEST(BitstreamRemarksFormat, RecordIDs) {
  ...
  EXPECT_EQ(remarks::RECORD_REMARK, 5);
  EXPECT_EQ(remarks::RECORD_REMARK_HEADER, 6);
  EXPECT_EQ(remarks::RECORD_REMARK_DEBUG_LOC, 7);
  EXPECT_EQ(remarks::RECORD_REMARK_HOTNESS, 8);
  EXPECT_EQ(remarks::RECORD_REMARK_ARG_V, 9);
  EXPECT_EQ(remarks::RECORD_REMARK_ARG_KV_INT, 10);
  EXPECT_EQ(remarks::RECORD_REMARK_ARG_KV, 11);
  EXPECT_EQ(remarks::RECORD_REMARK_TAG, 12);
  EXPECT_EQ(remarks::RECORD_REMARK_BLOB, 13);
  EXPECT_EQ(remarks::RECORD_LAST, 11);
}
