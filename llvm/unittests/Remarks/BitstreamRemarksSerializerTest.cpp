...
TEST(BitstreamRemarkSerializer, SeparateRemarkFileNoOptionals) {
  ...
  check(R,
        ...
        "  <Remark header codeid=6 abbrevid=5 op0=0 op1=1/>\n"
        "  <Remark codeid=5 abbrevid=4 op0=2 op1=2/>\n"
        "</Remarks>\n"
        "<Meta BlockID=8 NumWords=8 BlockCodeSize=3>\n"
        "  <String table codeid=3 abbrevid=6/> blob data = "
        "'pass\\x00function\\x00remark\\x00'\n"
        "</Meta>\n",
        "<BLOCKINFO_BLOCK/>\n"
...
TEST(BitstreamRemarkSerializer, SeparateRemarkFileNoOptionalsSeparateStrTab) {
  ...
  check(R,
        ...
        "</Meta>\n"
        "<Remarks BlockID=9 NumWords=2 BlockCodeSize=4>\n"
        "  <Remark header codeid=6 abbrevid=5 op0=1 op1=0/>\n"
        "  <Remark codeid=5 abbrevid=4 op0=2 op1=2/>\n"
        "</Remarks>\n"
        "<Meta BlockID=8 NumWords=8 BlockCodeSize=3>\n"
        "  <String table codeid=3 abbrevid=6/> blob data = "
...
TEST(BitstreamRemarkSerializer, SeparateRemarkFileDebugLoc) {
  ...
  check(R,
        ...
        "  <Remark header codeid=6 abbrevid=5 op0=0 op1=1/>\n"
        "  <Remark codeid=5 abbrevid=4 op0=2 op1=2/>\n"
        "  <Remark debug location codeid=7 abbrevid=6 op0=3 op1=99 op2=55/>\n"
        "</Remarks>\n"
        "<Meta BlockID=8 NumWords=9 BlockCodeSize=3>\n"
        "  <String table codeid=3 abbrevid=6/> blob data = "
        "'pass\\x00function\\x00remark\\x00path\\x00'\n"
        "</Meta>\n",
        "<BLOCKINFO_BLOCK/>\n"
        "<Meta BlockID=8 NumWords=7 BlockCodeSize=3>\n"
        "  <Container info codeid=1 abbrevid=4 op0=1 op1=0/>\n"
...
TEST(BitstreamRemarkSerializer, SeparateRemarkFileHotness) {
  ...
  check(R,
        ...
        "  <Remark header codeid=6 abbrevid=5 op0=0 op1=1/>\n"
        "  <Remark codeid=5 abbrevid=4 op0=2 op1=2/>\n"
        "  <Remark hotness codeid=8 abbrevid=7 op0=999999999/>\n"
        "</Remarks>\n"
        "<Meta BlockID=8 NumWords=8 BlockCodeSize=3>\n"
        "  <String table codeid=3 abbrevid=6/> blob data = "
        "'pass\\x00function\\x00remark\\x00'\n"
...
TEST(BitstreamRemarkSerializer, SeparateRemarkFileArgNoDebugLoc) {
  ...
  check(R,
        ...
        "  <Remark header codeid=6 abbrevid=5 op0=0 op1=1/>\n"
        "  <Remark codeid=5 abbrevid=4 op0=2 op1=2/>\n"
        "  <Argument KV codeid=11 abbrevid=8 op0=3 op1=4/>\n"
        "</Remarks>\n"
        "<Meta BlockID=8 NumWords=10 BlockCodeSize=3>\n"
        "  <String table codeid=3 abbrevid=6/> blob data = "
        "'pass\\x00function\\x00remark\\x00key\\x00value\\x00'\n"
        "</Meta>\n",
        "<BLOCKINFO_BLOCK/>\n"
        "<Meta BlockID=8 NumWords=7 BlockCodeSize=3>\n"
        "  <Container info codeid=1 abbrevid=4 op0=1 op1=0/>\n"
...
TEST(BitstreamRemarkSerializer, SeparateRemarkFileArgDebugLoc) {
  ...
  check(R,
        ...
        "  <Remark codeid=5 abbrevid=4 op0=2 op1=2/>\n"
        "  <Argument KV codeid=11 abbrevid=8 op0=3 op1=4/>\n"
        "  <Remark debug location codeid=7 abbrevid=6 op0=5 op1=99 op2=55/>\n"
        "</Remarks>\n"
        "<Meta BlockID=8 NumWords=11 BlockCodeSize=3>\n"
        "  <String table codeid=3 abbrevid=6/> blob data = "
        "'pass\\x00function\\x00remark\\x00key\\x00value\\x00path\\x00'\n"
        "</Meta>\n",
        "<BLOCKINFO_BLOCK/>\n"
        "<Meta BlockID=8 NumWords=7 BlockCodeSize=3>\n"
        "  <Container info codeid=1 abbrevid=4 op0=1 op1=0/>\n"
...
TEST(BitstreamRemarkSerializer, SeparateRemarkFileAll) {
  ...
  check(R,
        ...
        "  <Remark version codeid=2 abbrevid=5 op0=1/>\n"
        "</Meta>\n"
        "<Remarks BlockID=9 NumWords=6 BlockCodeSize=4>\n"
        "  <Remark header codeid=6 abbrevid=5 op0=0 op1=1/>\n"
        "  <Remark codeid=5 abbrevid=4 op0=2 op1=2/>\n"
        "  <Remark debug location codeid=7 abbrevid=6 op0=3 op1=99 op2=55/>\n"
        "  <Remark hotness codeid=8 abbrevid=7 op0=999999999/>\n"
        "  <Argument KV codeid=11 abbrevid=8 op0=4 op1=5/>\n"
        "  <Remark debug location codeid=7 abbrevid=6 op0=6 op1=11 op2=66/>\n"
        "</Remarks>\n"
        "<Meta BlockID=8 NumWords=13 BlockCodeSize=3>\n"
        "  <String table codeid=3 abbrevid=6/> blob data = "
        "'pass\\x00function\\x00remark\\x00path\\x00key\\x00value\\x00argpa"
        "th\\x00'\n"
        "</Meta>\n",
        "<BLOCKINFO_BLOCK/>\n"
        "<Meta BlockID=8 NumWords=7 BlockCodeSize=3>\n"
