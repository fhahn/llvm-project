...
// CHECK-128-NEXT:  [[ENTRY:.*:]]
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 16
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <2 x double>, ptr [[Y]], align 16, !tbaa [[CHAR_TBAA7:![0-9]+]]
...
// CHECK-256-NEXT:  [[ENTRY:.*:]]
// CHECK-256-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 32
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <4 x double>, ptr [[Y]], align 16, !tbaa [[CHAR_TBAA7:![0-9]+]]
...
// CHECK-512-NEXT:  [[ENTRY:.*:]]
// CHECK-512-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 64
// CHECK-512-NEXT:    [[TMP0:%.*]] = load <8 x double>, ptr [[Y]], align 16, !tbaa [[CHAR_TBAA7:![0-9]+]]
...
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 16
// CHECK-128-NEXT:    store <2 x double> [[CAST_FIXED]], ptr [[Y]], align 16, !tbaa [[CHAR_TBAA7]]
// CHECK-128-NEXT:    ret void
//
...
// CHECK-256-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 32
// CHECK-256-NEXT:    store <4 x double> [[CAST_FIXED]], ptr [[Y]], align 16, !tbaa [[CHAR_TBAA7]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-512-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 64
// CHECK-512-NEXT:    store <8 x double> [[CAST_FIXED]], ptr [[Y]], align 16, !tbaa [[CHAR_TBAA7]]
// CHECK-512-NEXT:    ret void
//
...
// CHECK-128-NEXT:  [[ENTRY:.*:]]
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 16
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <8 x bfloat>, ptr [[Y]], align 16, !tbaa [[CHAR_TBAA9:![0-9]+]]
...
// CHECK-256-NEXT:  [[ENTRY:.*:]]
// CHECK-256-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 32
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <16 x bfloat>, ptr [[Y]], align 16, !tbaa [[CHAR_TBAA9:![0-9]+]]
...
// CHECK-512-NEXT:  [[ENTRY:.*:]]
// CHECK-512-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 64
// CHECK-512-NEXT:    [[TMP0:%.*]] = load <32 x bfloat>, ptr [[Y]], align 16, !tbaa [[CHAR_TBAA9:![0-9]+]]
...
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 16
// CHECK-128-NEXT:    store <8 x bfloat> [[CAST_FIXED]], ptr [[Y]], align 16, !tbaa [[CHAR_TBAA9]]
// CHECK-128-NEXT:    ret void
//
...
// CHECK-256-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 32
// CHECK-256-NEXT:    store <16 x bfloat> [[CAST_FIXED]], ptr [[Y]], align 16, !tbaa [[CHAR_TBAA9]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-512-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 64
// CHECK-512-NEXT:    store <32 x bfloat> [[CAST_FIXED]], ptr [[Y]], align 16, !tbaa [[CHAR_TBAA9]]
// CHECK-512-NEXT:    ret void
//
...
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <2 x i8>, ptr [[Y]], align 2, !tbaa [[CHAR_TBAA11:![0-9]+]]
...
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <4 x i8>, ptr [[Y]], align 2, !tbaa [[CHAR_TBAA11:![0-9]+]]
...
// CHECK-512-NEXT:    [[TMP0:%.*]] = load <8 x i8>, ptr [[Y]], align 2, !tbaa [[CHAR_TBAA11:![0-9]+]]
...
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 2
// CHECK-128-NEXT:    store <2 x i8> [[CAST_FIXED]], ptr [[Y]], align 2, !tbaa [[CHAR_TBAA11]]
// CHECK-128-NEXT:    ret void
//
...
// CHECK-256-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 4
// CHECK-256-NEXT:    store <4 x i8> [[CAST_FIXED]], ptr [[Y]], align 2, !tbaa [[CHAR_TBAA11]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-512-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 8
// CHECK-512-NEXT:    store <8 x i8> [[CAST_FIXED]], ptr [[Y]], align 2, !tbaa [[CHAR_TBAA11]]
// CHECK-512-NEXT:    ret void
//
...
// CHECK-128: [[CHAR_TBAA5]] = !{[[META6:![0-9]+]], [[META3]], i64 16}
// CHECK-128: [[META6]] = !{!"struct_int64", [[META3]], i64 0, [[META3]], i64 16}
// CHECK-128: [[CHAR_TBAA7]] = !{[[META8:![0-9]+]], [[META3]], i64 16}
// CHECK-128: [[META8]] = !{!"struct_float64", [[META3]], i64 0, [[META3]], i64 16}
// CHECK-128: [[CHAR_TBAA9]] = !{[[META10:![0-9]+]], [[META3]], i64 16}
// CHECK-128: [[META10]] = !{!"struct_bfloat16", [[META3]], i64 0, [[META3]], i64 16}
// CHECK-128: [[CHAR_TBAA11]] = !{[[META12:![0-9]+]], [[META3]], i64 2}
// CHECK-128: [[META12]] = !{!"struct_bool", [[META3]], i64 0, [[META3]], i64 2}
//.
// CHECK-256: [[META3:![0-9]+]] = !{!"omnipotent char", [[META4:![0-9]+]], i64 0}
// CHECK-256: [[META4]] = !{!"Simple C/C++ TBAA"}
// CHECK-256: [[CHAR_TBAA5]] = !{[[META6:![0-9]+]], [[META3]], i64 32}
// CHECK-256: [[META6]] = !{!"struct_int64", [[META3]], i64 0, [[META3]], i64 32}
// CHECK-256: [[CHAR_TBAA7]] = !{[[META8:![0-9]+]], [[META3]], i64 32}
// CHECK-256: [[META8]] = !{!"struct_float64", [[META3]], i64 0, [[META3]], i64 32}
// CHECK-256: [[CHAR_TBAA9]] = !{[[META10:![0-9]+]], [[META3]], i64 32}
// CHECK-256: [[META10]] = !{!"struct_bfloat16", [[META3]], i64 0, [[META3]], i64 32}
// CHECK-256: [[CHAR_TBAA11]] = !{[[META12:![0-9]+]], [[META3]], i64 4}
// CHECK-256: [[META12]] = !{!"struct_bool", [[META3]], i64 0, [[META3]], i64 4}
//.
// CHECK-512: [[META3:![0-9]+]] = !{!"omnipotent char", [[META4:![0-9]+]], i64 0}
// CHECK-512: [[META4]] = !{!"Simple C/C++ TBAA"}
// CHECK-512: [[CHAR_TBAA5]] = !{[[META6:![0-9]+]], [[META3]], i64 64}
// CHECK-512: [[META6]] = !{!"struct_int64", [[META3]], i64 0, [[META3]], i64 64}
// CHECK-512: [[CHAR_TBAA7]] = !{[[META8:![0-9]+]], [[META3]], i64 64}
// CHECK-512: [[META8]] = !{!"struct_float64", [[META3]], i64 0, [[META3]], i64 64}
// CHECK-512: [[CHAR_TBAA9]] = !{[[META10:![0-9]+]], [[META3]], i64 64}
// CHECK-512: [[META10]] = !{!"struct_bfloat16", [[META3]], i64 0, [[META3]], i64 64}
// CHECK-512: [[CHAR_TBAA11]] = !{[[META12:![0-9]+]], [[META3]], i64 8}
// CHECK-512: [[META12]] = !{!"struct_bool", [[META3]], i64 0, [[META3]], i64 8}
//.
