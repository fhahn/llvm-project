...
// CHECK-LABEL:  @test01(
// CHECK:   = tail call ptr @llvm.noalias.decl.p0.p0.i64
// CHECK:   = tail call ptr @llvm.provenance.noalias.p0.p0.p0.p0.i64
// CHECK:   = tail call ptr @llvm.provenance.noalias.p0.p0.p0.p0.i64
...
// CHECK: declare ptr @llvm.provenance.noalias.p0.p0.p0.p0.i64
